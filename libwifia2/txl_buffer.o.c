...
union anon_union.conflict2554_for_field_0 {
...
union anon_union.conflict1077_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflict1052_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflict102d_for_field_3 {
...
struct anon_struct.conflictaaa {
    uint32_t tx_key[2];
    uint32_t rx_key[2];
};
...
struct anon_struct.conflictae1 {
    uint32_t key[4];
};

union anon_union.conflictb0a_for_u {
...

{
  ...
  do {
    *unaff_s0 = unaff_s4 + -0x4e2;
    iVar5 = _L0();
    unaff_s0[1] = iVar5 << 0xe;
    iVar5 = _L0();
    unaff_s0[2] = (1 << (iVar5 + 1U & 0x1f)) + -1;
    unaff_s0[3] = 0;
...

{
  ...
  while( true ) {
    iVar3 = _L0();
    unaff_s0[1] = iVar3 << 0xe;
    iVar3 = _L0();
    unaff_s0[2] = (unaff_s7 << (iVar3 + 1U & 0x1f)) + -1;
    unaff_s0[3] = 0;
    unaff_s0[4] = unaff_s3;
    unaff_s0[5] = 0;
    unaff_s0[6] = 0;
    ...
    uVar4 = *(uint *)(unaff_s1 + 0xa0);
    unaff_s0[0xd] = unaff_s2;
    unaff_s0[0xe] = unaff_s6;
    unaff_s0[0xc] = uVar4 & 0xff;
...

{
  ...
  while( true ) {
    iVar2 = _L0();
    unaff_s0[1] = iVar2 << 0xe;
    iVar2 = _L0();
    unaff_s0[2] = (unaff_s6 << (iVar2 + 1U & 0x1f)) + -1;
    unaff_s0[3] = 0;
    unaff_s0[4] = unaff_s1;
    unaff_s0[5] = 0;
    unaff_s0[6] = 0;
    unaff_s0[7] = 0;
    unaff_s0[8] = 0;
    uVar3 = *(uint *)(unaff_s5 + 0xa0);
    puVar1 = unaff_s0 + 0xf;
    unaff_s0[10] = 0;
    unaff_s0[9] = uVar3 & 0xff;
    unaff_s0[0xb] = 0;
    unaff_s0[0xc] = 0;
    unaff_s0[0xd] = 0;
...

{
  ...
  *(uint8_t *)(txdesc->buf + 0x3b) = user_idx;
  ...
  if ((uVar1 & 8) == 0) {
    FUN_000101be((int)txdesc->buf + uVar5 + 0x14c);
  }
