...
union anon_union.conflict2a41_for_field_0 {
...
union anon_union.conflict126f_for_field_4 {
...
union anon_union.conflict124a_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflict1294_for_field_5 {
    uint32_t dataendptr;
...
struct anon_struct.conflict355e {
    uint32_t dummy;
...
struct anon_struct.conflict3491 {
...
union anon_union.conflict3659_for_u {
...
union anon_union.conflict2fe8_for_rate_map {
    uint8_t ht[4];
};
...

{
  ...
  if (*(char *)((int)env + 0x23) != '\0') {
    ...
    if (((*(byte *)((int)env + 0x21) ^ bVar1) & 0xc) != 0) {
      FUN_00010066(0,0,0);
      FUN_00010076(*(undefined *)((int)env + 0x20),bVar1 & 0xc);
    }
...

{
  ...
  FUN_00010066();
  FUN_00010076(*(undefined *)(unaff_s0 + 0x20),unaff_s1 & 0xc);
  *(byte *)(unaff_s0 + 0x21) = unaff_s1;
...

{
  ...
  _L0(0,CONCAT31(in_register_00002029,vif_index));
