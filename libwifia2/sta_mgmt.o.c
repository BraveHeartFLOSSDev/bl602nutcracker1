...
union anon_union.conflict1fdf_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflict2029_for_field_5 {
    uint32_t dataendptr;
...
union anon_union.conflict2004_for_field_4 {
...
union anon_union.conflict29ab_for_field_0 {
...
struct anon_struct.conflict3985 {
    uint8_t mac[6];
    uint8_t used;
};
...
struct anon_struct.conflict35d0 {
...
struct anon_struct.conflict369d {
    uint32_t dummy;
...
union anon_union.conflict3798_for_u {
    struct anon_struct.conflict35d0 sta;
    struct anon_struct.conflict369d ap;
};
...
union anon_union.conflict3121_for_rate_map {
    uint8_t ht[4];
};
...

{
  ...
  while ((sta_entry->tx_desc_post).first != (co_list_hdr *)0x0) {
    FUN_0001004e(&sta_entry->tx_desc_post);
    FUN_00010058(1);
  }
  FUN_0001001c(sta_entry,0,0x1b0);
...

{
  ...
  while( true ) {
    FUN_00010058(param_1);
    if (*(int *)(unaff_s0 + 0x19c) == 0) break;
    FUN_0001004e();
    param_1 = 1;
  }
  FUN_0001001c(0,0x1b0);
...

{
  ...
  DAT_000010fa = 0;
  DAT_00001111 = 0;
  FUN_000100fe(0,0x5c0,_DAT_000005c0);
  FUN_0001010e(0x1290);
  do {
...

{
  ...
  while (iVar2 = unaff_s1, _LVL12(param_1), iVar2 != unaff_s2) {
    FUN_00010094(iVar2);
...

{
  ...
  if (iVar5 == 0) {
    ...
    _LVL24(iVar5 + 0x1e,&param->mac_addr,6);
    bVar7 = param->ampdu_spacing_min;
    if (bVar7 < 0x10) {
      bVar7 = 0x10;
    }
    *(byte *)(iVar5 + 0x14) = bVar7;
    *(uint16_t *)(iVar5 + 0xc) = param->ampdu_size_max_ht;
    *(uint32_t *)(iVar5 + 8) = param->ampdu_size_max_vht;
    *(uint32_t *)(iVar5 + 0x10) = param->paid_gid;
    *(uint8_t *)(iVar5 + 0x1a) = param->inst_nbr;
    *(int8_t *)(iVar5 + 0x24) = param->rssi;
    *(uint32_t *)(iVar5 + 0x28) = param->tsflo;
    *(uint32_t *)(iVar5 + 0x2c) = param->tsfhi;
    *(uint8_t *)(iVar5 + 0x30) = param->data_rate;
    uVar4 = (char)(iVar5 >> 4) * '\x13';
    *sta_idx = uVar4;
    *(uint8_t *)(iVar5 + 0x1b) = uVar4;
    *(undefined4 *)(iVar5 + 4) = 0x19000;
    *(undefined2 *)(iVar5 + 0x188) = 0xffff;
    puVar8 = (undefined2 *)(iVar5 + 0x18a);
    do {
      *puVar8 = 0xffff;
      puVar8 = puVar8 + 1;
    } while (puVar8 != (undefined2 *)(iVar5 + 0x19c));
    bVar7 = *sta_idx;
    *(undefined *)(iVar5 + 0x31) = 0;
    iVar3 = (uint)bVar1 * 0x5d8;
    *(uint *)(iVar5 + 0x10c) = (uint)bVar7 * 0x3c;
    if ((*(uint *)(iVar3 + 0x5c4) & 8) == 0) {
      *(int *)(iVar5 + 0xac) = iVar3 + 0x5c0;
      uVar4 = _L0(0,0x10d,*(undefined4 *)(iVar3 + 0x5c0));
      return uVar4;
    }
    *(int *)(iVar5 + 0xac) = iVar5 + 0xa8;
    _L0(0,0x102,*(undefined4 *)(iVar5 + 0xa8));
    iVar2 = _DAT_44b00120;
    piVar9 = (int *)(iVar5 + 0x11c);
    iVar6 = _DAT_44b00120 + -1000000;
    do {
      *piVar9 = iVar2;
      piVar9[1] = iVar6;
      piVar9 = piVar9 + 3;
    } while (piVar9 != (int *)(iVar5 + 0x188));
    FUN_000102a0(iVar3 + 0x350,iVar5);
    *(undefined *)(iVar5 + 0x1d) = 1;
    uVar4 = '\0';
  }
  return uVar4;
}
...

{
  ...
  if (iVar3 == 0) {
    ...
    _LVL24(iVar3 + 0x1e,(int)unaff_s1 + 10,6);
    bVar6 = *(byte *)(unaff_s1 + 4);
    if (bVar6 < 0x10) {
      bVar6 = 0x10;
    }
    *(byte *)(iVar3 + 0x14) = bVar6;
    *(undefined2 *)(iVar3 + 0xc) = *(undefined2 *)(unaff_s1 + 2);
    *(undefined4 *)(iVar3 + 8) = *unaff_s1;
    *(undefined4 *)(iVar3 + 0x10) = unaff_s1[1];
    *(undefined *)(iVar3 + 0x1a) = *(undefined *)((int)unaff_s1 + 0x11);
    *(undefined *)(iVar3 + 0x24) = *(undefined *)((int)unaff_s1 + 0x13);
    *(undefined4 *)(iVar3 + 0x28) = unaff_s1[5];
    *(undefined4 *)(iVar3 + 0x2c) = unaff_s1[6];
    *(undefined *)(iVar3 + 0x30) = *(undefined *)(unaff_s1 + 7);
    bVar6 = (char)(iVar3 >> 4) * '\x13';
    *unaff_s3 = bVar6;
    *(byte *)(iVar3 + 0x1b) = bVar6;
    *(undefined4 *)(iVar3 + 4) = 0x19000;
    *(undefined2 *)(iVar3 + 0x188) = 0xffff;
    puVar7 = (undefined2 *)(iVar3 + 0x18a);
    do {
      *puVar7 = 0xffff;
      puVar7 = puVar7 + 1;
    } while (puVar7 != (undefined2 *)(iVar3 + 0x19c));
    bVar6 = *unaff_s3;
    *(undefined *)(iVar3 + 0x31) = 0;
    iVar2 = unaff_s2 * 0x5d8;
    *(uint *)(iVar3 + 0x10c) = (uint)bVar6 * 0x3c;
    if ((*(uint *)(iVar2 + 0x5c4) & 8) == 0) {
      *(int *)(iVar3 + 0xac) = iVar2 + 0x5c0;
      uVar4 = _L0(0,0x10d,*(undefined4 *)(iVar2 + 0x5c0));
      return uVar4;
    }
    *(int *)(iVar3 + 0xac) = iVar3 + 0xa8;
    _L0(0,0x102,*(undefined4 *)(iVar3 + 0xa8));
    iVar1 = _DAT_44b00120;
    piVar8 = (int *)(iVar3 + 0x11c);
    iVar5 = _DAT_44b00120 + -1000000;
    do {
      *piVar8 = iVar1;
      piVar8[1] = iVar5;
      piVar8 = piVar8 + 3;
    } while (piVar8 != (int *)(iVar3 + 0x188));
    FUN_000102a0(iVar2 + 0x350,iVar3);
    *(undefined *)(iVar3 + 0x1d) = 1;
    uVar4 = 0;
  }
  return uVar4;
}
...

{
  ...
  *(undefined *)(unaff_s0 + 0x30) = *(undefined *)(unaff_s1 + 7);
  bVar5 = (char)(unaff_s0 >> 4) * '\x13';
  *unaff_s3 = bVar5;
  *(byte *)(unaff_s0 + 0x1b) = bVar5;
  *(undefined4 *)(unaff_s0 + 4) = 0x19000;
  *(undefined2 *)(unaff_s0 + 0x188) = 0xffff;
  puVar6 = (undefined2 *)(unaff_s0 + 0x18a);
  do {
    *puVar6 = 0xffff;
    puVar6 = puVar6 + 1;
  } while (puVar6 != (undefined2 *)(unaff_s0 + 0x19c));
  bVar5 = *unaff_s3;
  *(undefined *)(unaff_s0 + 0x31) = 0;
  iVar2 = unaff_s2 * 0x5d8;
  *(uint *)(unaff_s0 + 0x10c) = (uint)bVar5 * 0x3c;
  if ((*(uint *)(iVar2 + 0x5c4) & 8) != 0) {
    *(int *)(unaff_s0 + 0xac) = unaff_s0 + 0xa8;
    _L0(0,0x102,*(undefined4 *)(unaff_s0 + 0xa8));
    iVar1 = _DAT_44b00120;
    piVar7 = (int *)(unaff_s0 + 0x11c);
    iVar4 = _DAT_44b00120 + -1000000;
    do {
      *piVar7 = iVar1;
      piVar7[1] = iVar4;
      piVar7 = piVar7 + 3;
    } while (piVar7 != (int *)(unaff_s0 + 0x188));
    FUN_000102a0(iVar2 + 0x350);
    *(undefined *)(unaff_s0 + 0x1d) = 1;
    return 0;
  }
  *(int *)(unaff_s0 + 0xac) = iVar2 + 0x5c0;
  uVar3 = _L0(0,0x10d,*(undefined4 *)(iVar2 + 0x5c0));
  return uVar3;
}
...

{
  ...
  FUN_000102a0(unaff_s1 + 0x350 + unaff_s2);
  *(undefined *)(unaff_s0 + 0x1d) = 1;
  return 0;
}
...

{
  ...
  FUN_00010312((uint)*(byte *)(iVar1 + 0x1a) * 0x5d8 + 0x350,iVar1);
  FUN_0001031c(iVar1);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
...

{
  ...
  while( true ) {
    ...
    iStack36 = 0;
    iVar2 = _L0(p_vif_entry);
    if (iVar2 == 0) {
      return iVar1;
    }
    iVar2 = FUN_0001047a(pcVar3);
    if (iVar2 == 0) {
      return iVar1;
    }
    iVar2 = FUN_0001048a(p_vif_entry,p_sta_entry,&iStack36);
    if (iStack36 != 0) break;
    if (iVar2 == 0) {
      iVar2 = _LVL66(&p_sta_entry->tx_desc_post);
    }
    *(undefined *)(iVar2 + 0x2d5) = 0;
    iVar1 = iVar1 + 1;
    _L0(*(undefined *)(iVar2 + 0x2e));
...

{
  ...
  while( true ) {
    ...
    iVar1 = FUN_0001048a(&stack0x0000000c);
...

{
  ...
  while( true ) {
    ...
    if ((iVar1 == 0) || (iVar1 = FUN_0001048a(&stack0x0000000c), in_stack_0000000c != 0)) {
      return unaff_s0;
    }
    if (iVar1 == 0) {
      iVar1 = _LVL66();
  ...
  do {
    ...
    do {
      *(undefined *)(iVar2 + 0x2d5) = 0;
      ...
      iVar2 = FUN_0001048a(&stack0x0000000c);
      if (in_stack_0000000c != 0) {
        return unaff_s0;
      }
    } while (iVar2 != 0);
