...

{
  ...
  do {
    if (cVar4 == (co_list_hdr)0x0) {
      ...
      if (*pRet != '\0') {
_L0:
        while (cVar1 = *(co_list_hdr *)cVar4, iVar2 != 0) {
          iVar2 = iVar2 + -1;
          cVar4 = cVar1;
        }
...

{
  ...
  while ((cVar1 != (co_list_hdr)list_hdr && (cVar1 != (co_list_hdr)0x0))) {
...

{
  ...
  if (elt_ref_hdr != (co_list_hdr *)0x0) {
    ...
    cVar2 = (co_list_hdr)list->first;
    while ((cVar2 != (co_list_hdr)elt_ref_hdr && (cVar2 != (co_list_hdr)0x0))) {
      cVar1 = cVar2;
      cVar2 = *(co_list_hdr *)cVar2;
    }
...

{
  ...
  if (elt_ref_hdr != (co_list_hdr *)0x0) {
    ...
    cVar3 = (co_list_hdr)list->first;
    while ((cVar3 != (co_list_hdr)elt_ref_hdr && (cVar3 != (co_list_hdr)0x0))) {
      cVar2 = cVar3;
