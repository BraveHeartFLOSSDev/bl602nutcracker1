...
union anon_union.conflicte2d_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflict146f {
    uint _unused_rand;
    char * _strtok_last;
...
struct anon_struct.conflict15b4 {
    uchar * _nextf[30];
    uint _nmalloc[30];
};
...
union anon_union.conflict15fb_for__new {
...

{
  ...
  if ((bd_addr_type & 1) == 0) {
    do {
      ...
      iVar2 = FUN_00010044(auStack40,bd_address);
      if (iVar2 != 0) {
    ...
    do {
      ...
      iVar2 = FUN_0001008c(auStack40,bd_address);
      if (iVar2 != 0) {
        return (uint16_t)iVar1;
      }
      iVar1 = iVar1 + 1;
...
void llm_util_adv_data_update(int *piRam00000014)

{
  if (*piRam00000014 != 0) {
    FUN_000101b4(*piRam00000014 + 0xc);
    FUN_000101c0(*piRam00000014);
    *piRam00000014 = 0;
  }
  if (piRam00000014[1] != 0) {
    FUN_000101d6(piRam00000014[1] + 0xc);
    FUN_000101e2(piRam00000014[1]);
    piRam00000014[1] = 0;
  }
  return;
}
...

{
  ...
  FUN_000101b4();
  FUN_000101c0(**(undefined4 **)(unaff_s0 + 0x14));
  **(undefined4 **)(unaff_s0 + 0x14) = 0;
  iVar1 = *(int *)(*(int *)(unaff_s0 + 0x14) + 4);
  if (iVar1 != 0) {
    FUN_000101d6(iVar1 + 0xc);
    FUN_000101e2(*(undefined4 *)(*(int *)(unaff_s0 + 0x14) + 4));
  ...
  do {
    ...
    if ((bd_addr_to_add == (bd_addr *)0x0) && (iVar3 == 1)) {
      *(undefined *)((int)piVar1 + 0xd) = 0;
      ...
      iVar2 = _L0(bd_addr_to_add,piVar1 + 1);
...

{
  ...
  iVar1 = _LVL68(bd_address,CONCAT31(in_register_0000202d,bd_addr_type),0,0,acStack17);
  if ((iVar1 == 0xb) && (in_black_list != (_Bool *)0x0)) {
    *in_black_list = true;
  }
  if ((acStack17[0] == '\0') &&
     (uVar2 = FUN_000102cc(bd_address,CONCAT31(in_register_0000202d,bd_addr_type)), uVar2 < 4)) {
    acStack17[0] = '\x01';
  }
...

{
  ...
  iVar1 = _LVL68();
  if ((iVar1 == 0xb) && (unaff_s0 != (undefined *)0x0)) {
    *unaff_s0 = 1;
  }
...

{
  ...
  if (iVar2 != 0) {
    ...
    *(byte *)(iVar2 + 0xc) = bd_addr_type & 1;
    uVar3 = FUN_0001033a(bd_addr_to_add,CONCAT31(in_register_0000202d,bd_addr_type));
    *(bool *)(iVar2 + 0xd) = uVar3 < 4;
    FUN_00010354(0x18,iVar2);
    uVar1 = '\0';
    if (*(char *)(iVar2 + 0xd) != '\0') {
      FUN_00010368(iVar2 + 4,bd_addr_type & 1);
    }
  }
  return uVar1;
}
...

{
  ...
  if (iVar2 != 0) {
    ...
    *(bool *)(iVar2 + 0xd) = uVar3 < 4;
    ...
    uVar1 = 0;
    if (*(char *)(iVar2 + 0xd) != '\0') {
      FUN_00010368(iVar2 + 4,unaff_s4 & 1);
    }
  }
  return uVar1;
}
...

{
  ...
  FUN_000103b4(0x18,piVar1,0);
  if (*(char *)((int)piVar1 + 0xd) != '\0') {
    FUN_000103ca(piVar1 + 1,*(undefined *)(piVar1 + 3));
  }
  FUN_000103d4(piVar1);
  return '\0';
}
...

{
  ...
  FUN_000103b4();
  if (*(char *)(unaff_s0 + 0xd) != '\0') {
    FUN_000103ca(unaff_s0 + 4,*(undefined *)(unaff_s0 + 0xc));
  }
  FUN_000103d4();
  return 0;
}
...
void llm_end_evt_defer(int iRam00000014,undefined4 uRam00000048,undefined2 param_3)

{
  ...
  if ((uVar1 & 0xf0) == 0x10) {
    if ((*(char *)(iRam00000014 + 0x1c) == '\x01') && (*(char *)(iRam00000014 + 0x21) == '\0')) {
      (*pcRam00000000)(&msg_param.sup_to,iRam00000014 + 0x10,6,pcRam00000000);
      msg_param.peer_addr.addr[2] = *(uint8_t *)(iRam00000014 + 0x20);
      _L0(0x3c,0,auStack36);
      FUN_00010444(uRam00000048,1,0);
      uVar1 = FUN_0001044e(0);
      FUN_0001045c(0,uVar1 & 0xf);
    }
  }
  if ((DAT_0000005a != '\x03') && (DAT_00000059 != '\0')) {
    puVar2 = (undefined *)FUN_00010482(0x801,0,0x201f,4);
    DAT_00000059 = '\0';
    if (DAT_0000005a == '\x01') {
...
void _L0(int iRam00000014,undefined4 uRam00000048,undefined2 param_3)
...

{
  ...
  _L0();
  FUN_00010444(*(undefined4 *)(unaff_s0 + 0x48),1,0);
  uVar1 = FUN_0001044e(0);
  FUN_0001045c(0,uVar1 & 0xf);
...

{
  ...
  FUN_0001045c();
  if ((*(char *)(unaff_s0 + 0x5a) != '\x03') && (*(char *)(unaff_s0 + 0x59) != '\0')) {
    puVar1 = (undefined *)FUN_00010482(0x801,0,0x201f,4);
    *(undefined *)(unaff_s0 + 0x59) = 0;
    if (*(char *)(unaff_s0 + 0x5a) == '\x01') {
      _DAT_280001ac = _DAT_280001ac & 0xffffffc0 | (uint)bRam00000000;
      _DAT_28000078 = (uint)bRam00000000 << 0x1c | _DAT_28000078 & 0xfffffff;
...

{
  ...
  iVar3 = CONCAT31(in_register_0000202d,rx_hdl);
  uVar2 = _L0(0);
  if ((uVar2 & 0xf) == 2) {
    if ((status & 3) == 0) {
      _Var1 = false;
  ...
  if (((uVar2 != 0x24) && ((status & 0x1f) == 0)) &&
     (uVar4 = *(ushort *)(iVar3 * 0xe + 0x280083d2) & 0xf, uVar4 < 7)) {
    uVar4 = 1 << uVar4;
    if ((uVar4 & 0x57) == 0) {
      if (((uVar4 & 0x20) != 0) && ((uVar2 & 0xf0) == 0x10)) {
        FUN_000105ea(iVar3,CONCAT22(in_register_0000202a,status));
      }
    }
    else {
      if ((uVar2 & 0xf) == 1) {
