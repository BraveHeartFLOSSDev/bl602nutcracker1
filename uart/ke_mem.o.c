...
union anon_union.conflict12b_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflict8b5 {
    uchar * _nextf[30];
    uint _nmalloc[30];
};
...
struct anon_struct.conflict770 {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict8fc_for__new {
...
// WARNING: Removing unreachable block (ram,0x000100ac)
...
// WARNING: Removing unreachable block (ram,0x0001017a)
...

{
  ...
  iVar2 = 0;
  do {
    iVar3 = *(int *)(((iVar2 + (uint)type & 1) + 4) * 4 + 8);
    iVar1 = 0;
    while (iVar3 != 0) {
...

{
  ...
  *(undefined4 *)pRet = 0;
  ...
  iVar2 = 0;
  while( true ) {
    iVar3 = *(int *)((((uint)type + iVar2 & 1) + 4) * 4 + 8);
    iVar5 = 0;
    while (iVar3 != 0) {
...
// WARNING: Removing unreachable block (ram,0x00010328)
...

{
  ...
  if (iVar1 == 0) {
    ...
    iVar1 = 0;
    do {
      puVar3 = *(undefined2 **)(((CONCAT31(in_register_0000202d,type) + iVar1 & 1U) + 4) * 4 + 8);
...
// WARNING: Removing unreachable block (ram,0x000103fe)
...

{
  ...
  *(undefined2 *)((int)mem_ptr + -4) = 0xf00f;
  ...
  iVar7 = 0;
  do {
    while (iVar3 = FUN_00010414(iVar7,mem_ptr), iVar3 == 0) {
      if (iVar7 != 0) {
        uVar4 = 0;
        goto _L0;
      }
      ...
      *(undefined2 *)(unaff_s1 + -1) = 0xa55a;
      if (uVar4 == unaff_s0 + unaff_s2) {
        ...
        *unaff_s1 = uVar2;
        ...
        unaff_s0 = unaff_s0 + (uint)*(ushort *)(uVar4 + 2);
      }
      else {
        *unaff_s1 = uVar4;
...

{
  ...
  if (iVar3 == 0) {
    ...
    *(undefined2 *)((int)mem_ptr + -4) = 0xf00f;
    ...
    iVar3 = 0;
    do {
      while (iVar4 = FUN_00010524(iVar3,mem_ptr), iVar4 == 0) {
        if (iVar3 != 0) {
          uVar5 = 0;
          goto _L0;
        }
      ...
      uVar6 = *(uint *)((iVar3 + 4) * 4 + 8);
    } while (uVar6 == 0);
    uVar5 = 0;
    while (uVar6 != 0) {
      if (*(ushort *)(uVar6 + 2) + uVar6 == uVar7) {
        uVar7 = (uint)uVar2 + (uint)*(ushort *)(uVar6 + 2);
        iVar3 = *(int *)(uVar6 + 4);
        sVar1 = (short)(uVar7 * 0x10000 >> 0x10);
        *(short *)(uVar6 + 2) = sVar1;
        if (iVar3 != (uVar7 & 0xffff) + uVar6) {
          return;
        }
        *(short *)(uVar6 + 2) = sVar1 + *(short *)(iVar3 + 2);
        iVar3 = *(int *)(iVar3 + 4);
        *(int *)(uVar6 + 4) = iVar3;
        if (iVar3 == 0) {
          return;
...

{
  ...
  do {
    while (iVar3 = FUN_00010524(param_1), iVar3 == 0) {
      if (unaff_s3 != 0) {
        uVar2 = 0;
        goto _L0;
      }
      ...
      *(undefined2 *)(unaff_s0 + -1) = 0xa55a;
      if (uVar4 == unaff_s1 + unaff_s2) {
        ...
        *unaff_s0 = uVar2;
        ...
        unaff_s1 = unaff_s1 + (uint)*(ushort *)(uVar4 + 2);
      }
      else {
        *unaff_s0 = uVar4;
        *(uint *)(uVar4 + 8) = unaff_s2;
