...
union anon_union.conflict73d_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflictebb {
    uchar * _nextf[30];
    uint _nmalloc[30];
};
...
struct anon_struct.conflictd76 {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflictf02_for__new {
