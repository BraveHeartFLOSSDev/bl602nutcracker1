...
union anon_union.conflict6f3_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflicte71 {
    uchar * _nextf[30];
    uint _nmalloc[30];
};
...
union anon_union.conflicteb8_for__new {
...

{
  ...
  auStack52[0] = *(ushort *)&elt_connect[2].ea_cb_stop;
  set_param._0_4_ = (elt_connect->duration_min + 0x270) / 0x271;
  iVar4 = _L0(&set_param.offset,auStack52);
  if (iVar4 == 0) {
    puVar5 = (undefined *)
             FUN_000101f2(0x109,(*(ushort *)&elt_connect[2].ea_cb_start & 0xff) << 8 | 1,2,0x22);
    *puVar5 = 1;
    uVar6 = (uint)auStack52[0];
    uVar3 = auStack52[0] >> 1;
...

{
  ...
  iVar4 = _L0();
  if (iVar4 == 0) {
    puVar5 = (undefined *)FUN_000101f2(0x109,(*(ushort *)(unaff_s0 + 0x74) & 0xff) << 8 | 1,2,0x22);
    *puVar5 = 1;
    ...
    *(short *)(puVar5 + 0x16) =
         (short)(((int)((in_stack_00000014 + uVar6) - *(uint *)(unaff_s0 + 8) % uVar6) % (int)uVar6
                 & 0xffffU) >> 1);
    *(undefined2 *)(puVar5 + 0x18) = 0xffff;
    *(undefined2 *)(puVar5 + 0x1a) = 0xffff;
    *(undefined2 *)(puVar5 + 0x1c) = 0xffff;
...

{
  ...
  *(short *)(puVar4 + 0x16) =
       (short)(((int)((in_stack_00000014 + uVar5) - *(uint *)(unaff_s0 + 8) % uVar5) % (int)uVar5 &
               0xffffU) >> 1);
...

{
  ...
  while (iVar1 = FUN_00010290(list), iVar1 != 0) {
    _L0();
  }
  return;
}
...

{
  ...
  while (iVar1 = FUN_00010290(), iVar1 != 0) {
    _L0();
  }
  return;
}
...

{
  ...
  iVar1 = _L0();
  return (_Bool)((uint)elt->start_latency <= (elt->timestamp - iVar1 & 0xff));
}
...

{
  ...
  iVar1 = _L0();
  return (uint)*(byte *)(unaff_s0 + 0x19) <= (*(int *)(unaff_s0 + 8) - iVar1 & 0xffU);
}
