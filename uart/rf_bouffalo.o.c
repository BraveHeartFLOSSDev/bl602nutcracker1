...

{
  ...
  iVar1 = FUN_0001004e((int)cRam00000000 + ((int)cRam00000000 - CONCAT31(in_register_00002029,dec)))
  ;
  if (iVar1 != 0) {
    cRam00000000 = cRam00000000 - dec;
  }
...

{
  ...
  iVar1 = FUN_0001008e((int)cRam00000000 + (int)cRam00000000 + CONCAT31(in_register_00002029,inc));
  if (iVar1 != 0) {
...

{
  ...
  iVar1 = CONCAT31(in_register_00002029,txpwr_dbm);
  if (cRam00000000 == '\x7f') {
    iVar1 = 0xf;
  }
  cRam00000000 = (char)iVar1;
  iVar1 = FUN_000100da(iVar1 + cRam00000000);
  if (iVar1 != 0) {
    return;
  }
  do {
...

{
  ...
  cRam00000000 = (char)ble_tx_power;
  iVar1 = FUN_000101b2((int)cRam00000000 + (int)cRam00000000);
  if (iVar1 != 0) {
    return;
  }
  do {
