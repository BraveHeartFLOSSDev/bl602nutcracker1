...
union anon_union.conflict1120_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflict189e {
    uchar * _nextf[30];
    uint _nmalloc[30];
};
...
struct anon_struct.conflict1759 {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict18e5_for__new {
...

{
  ...
  if (cmd_desc != (hci_cmd_desc_tag *)0x0) {
    if ((code *)cmd_desc->ret_par_fmt == (code *)0x0) {
      puVar2 = (uint8_t *)_L0(0x802,0,CONCAT22(in_register_0000202e,opcode),1);
      *puVar2 = error;
      _L0();
    }
    else {
      if ((char)cmd_desc->dest_field < '\0') {
        ...
        uVar1 = _LVL4(0,0,auStack18,0xffff);
      }
      if (uVar1 == 0) goto _L0;
    }
    return;
  ...
  auStack18[0] = 1;
_L0:
  _L0(0x801,0,CONCAT22(in_register_0000202e,opcode),auStack18[0]);
  return;
}
...

{
  ...
  _L0(uVar1,msg);
  if ((DAT_00000018 == '\x01') &&
     ((iVar2 = iRam00000000, iRam00000000 != 0 ||
      ((iVar2 = _L0(), iVar2 != 0 && (iVar2 = _DAT_00000008, _DAT_00000008 != 0)))))) {
    uVar3 = *(ushort *)(iVar2 + 4) - 0x801 & 0xffff;
    _DAT_00000010 = iVar2;
    if (uVar3 < 6) {
...

{
  ...
  if ((*(char *)(unaff_s0 + 6) == '\x01') &&
     ((iVar1 = *unaff_s0, iVar1 != 0 ||
      ((iVar1 = _L0(), iVar1 != 0 && (iVar1 = unaff_s0[2], iVar1 != 0)))))) {
    unaff_s0[4] = iVar1;
...

{
  ...
  iVar1 = _L0();
  if ((iVar1 != 0) && (iVar1 = *(int *)(unaff_s0 + 8), iVar1 != 0)) {
...

{
  ...
  iVar2 = _L0(CONCAT22(in_register_0000202a,opcode));
  if (iVar2 == 0) {
    uVar1 = -1;
  }
  else {
...

{
  ...
  uVar1 = CONCAT22(in_register_0000202a,opcode);
  iVar2 = _L0(uVar1,CONCAT31(in_register_0000202d,length));
  if (DAT_00000019 == -0x80) {
    if (iVar2 == 0) goto _L0;
  }
  else {
    iVar3 = (DAT_00000019 + -1) * 0x1000000;
    DAT_00000019 = (char)((uint)iVar3 >> 0x18);
    if (iVar2 == 0) {
_L0:
      _L0(0,uVar1,1);
      return;
...

{
  ...
  if (DAT_00000019 == -0x80) {
    ...
    DAT_00000019 = (char)((uint)iVar2 >> 0x18);
    if (iVar1 == 0) {
_L0:
      _L0(0,1);
      return;
...

{
  ...
  uVar2 = 0x12;
  if (iVar1 != 1) {
    iVar1 = FUN_000102cc(0x805,in_stack_0000000e);
    if (iVar1 != 0) {
...

{
  ...
  if (iVar2 == 0x7f) {
    ...
    iVar2 = FUN_000102cc(0x805,in_stack_0000000e);
    if (iVar2 != 0) {
      if ((in_stack_0000000e != 0) && (*(code **)(unaff_s1 + 4) != (code *)0x0)) {
        if ((*(byte *)(unaff_s1 + 2) & 0x40) == 0) {
          _L0();
...

{
  ...
  if ((((hdl_flags & 0xffe) == 0) && ((hdl_flags & 0xc000) == 0)) &&
    ...
    _DAT_00000014 = FUN_000103da(8,in_mstatus);
    if (_DAT_00000014 == 0) {
      puVar2 = (undefined *)FUN_00010410(0x803,0,0x1a,1);
      *puVar2 = 1;
      _L0();
      do {
...

{
  ...
  iRam00000014 = FUN_000103da();
  if (iRam00000014 != 0) {
    return *(ushort *)(iRam00000014 + 6) + 0x28008000;
  }
  puVar1 = (undefined *)FUN_00010410(unaff_s1 + -0x7fd,0,0x1a,1);
  *puVar1 = 1;
  _L0();
  do {
                    // WARNING: Do nothing block with infinite loop
...

{
  ...
  if ((hdl_flags & 0xffe) == 0) {
    puVar1 = (ushort *)FUN_00010488(0x807,(hdl_flags & 0xff) << 8 | 1,0,0xc);
    *puVar1 = hdl_flags & 0xfff;
    *(char *)(puVar1 + 1) = (char)(CONCAT22(in_register_0000202a,hdl_flags) >> 0xc);
    puVar1[2] = datalen;
    *(int *)(puVar1 + 4) = _DAT_00000014;
    _L0();
  }
  _DAT_00000014 = 0;
  return;
...

{
  ...
  puVar1 = (undefined2 *)FUN_00010488();
  *puVar1 = unaff_s2;
  *(char *)(puVar1 + 1) = (char)(unaff_s0 >> 0xc);
  puVar1[2] = unaff_s3;
  *(undefined4 *)(puVar1 + 4) = *(undefined4 *)(unaff_s1 + 0x14);
  _L0();
