...
void em_buf_init(undefined4 uRam0000014c,undefined4 uRam00000154,undefined *puRam00000158)

{
  ...
  uRam0000014c = 0x5220000;
  _L0(8,0x148);
  uRam00000154 = 0x6260001;
  _L0(8,0x150);
  iVar3 = 0;
...

{
  ...
  *(undefined4 *)(unaff_s2 + 0x14c) = 0x5220000;
  _L0(unaff_s3 + 8,0x148);
  *(undefined4 *)(unaff_s2 + 0x154) = 0x6260001;
  _L0(unaff_s3 + 8,0x150);
  iVar4 = 0;
  puVar1 = (undefined2 *)&DAT_280083d6;
  do {
    iVar4 = iVar4 + 1;
...

{
  ...
  uVar1 = *(ushort *)(&DAT_280082d2 + (uint)desc_to_be_freed->idx * 10);
  if ((short)uVar1 < 0) {
    FUN_000102a8(8,((uVar1 & 0xff) + 0x29) * 8);
  }
  ...
  *(undefined2 *)(&DAT_280082ce + (uint)desc_to_be_freed->idx * 10) = 0;
  _L0(0,desc_to_be_freed);
  return (_Bool)((short)uVar1 < 0);
}
