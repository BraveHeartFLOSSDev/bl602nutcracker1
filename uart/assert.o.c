...
typedef union anon_union.conflictd7_for___value anon_union.conflictd7_for___value, *Panon_union.conflictd7_for___value;
...
struct anon_struct.conflict861 {
    uchar * _nextf[30];
    uint _nmalloc[30];
};

union anon_union.conflictd7_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct _mbstate_t {
    int __count;
    union anon_union.conflictd7_for___value __value;
};
...
struct anon_struct.conflict71c {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict8a8_for__new {
...
union anon_union.conflict8a8 {
    struct anon_struct.conflict71c _reent;
    struct anon_struct.conflict861 _unused;
};

typedef union anon_union.conflictd7 anon_union.conflictd7, *Panon_union.conflictd7;

union anon_union.conflictd7 {
    wint_t __wch;
    uchar __wchb[4];
};
