...
union anon_union.conflict976_for_p {
...

{
  ...
  if (CONCAT31(in_register_00002029,pkt_type) == 0) {
    iVar4 = _L0(*(undefined2 *)&pkt->p,CONCAT22(in_register_0000202e,dest_id));
    ...
    msg._0_4_ = (undefined2 *)
                FUN_000100dc(0x805,CONCAT22(in_register_0000202e,dest_id),*(undefined2 *)&pkt->p,
                             sStack42);
    if (msg._0_4_ != (undefined2 *)0x0) {
      ...
      auStack40[0] = '\x01';
_L0:
      uVar3 = FUN_0001011e(auStack40,0xffffffff);
      return -((uVar3 ^ 1) & 0xff);
    }
  }
  else {
    if ((CONCAT31(in_register_00002029,pkt_type) == 1) &&
       (msg._0_4_ = (undefined2 *)FUN_0001017a(0x807,0,0xc), msg._0_4_ != (undefined2 *)0x0)) {
      iVar4 = FUN_00010196(8,in_mstatus);
...

{
  ...
  if ((cVar1 != '\0') && (*(code **)(iVar2 + 4) != (code *)0x0)) {
    if ((*(byte *)(iVar2 + 2) & 0x40) == 0) {
      ...
      uVar3 = (**(code **)(iVar2 + 4))(0,*(undefined4 *)(unaff_s0 + 2),&stack0x00000006,cVar1);
      uVar3 = uVar3 & 0xff;
    }
    if (uVar3 == 1) {
      return -1;
  ...
  iStack0000000c = FUN_000100dc(0x805,*unaff_s0,sStack00000006);
  if (iStack0000000c == 0) {
    return -1;
  }
  if ((sStack00000006 != 0) && (*(code **)(iVar2 + 4) != (code *)0x0)) {
    if ((*(byte *)(iVar2 + 2) & 0x40) == 0) {
      ...
      (**(code **)(iVar2 + 4))(*(undefined4 *)(unaff_s0 + 2),&stack0x00000006,cVar1);
    }
  }
  uStack00000008 = 1;
  uVar3 = FUN_0001011e(&stack0x00000008,0xffffffff);
  return -((uVar3 ^ 1) & 0xff);
}
...

{
  ...
  if (iStack0000000c == 0) {
    ...
    uStack00000008 = 1;
    uVar1 = FUN_0001011e(&stack0x00000008,0xffffffff);
    iVar2 = -((uVar1 ^ 1) & 0xff);
  }
  return iVar2;
}
...

{
  ...
  iVar2 = _LVL27();
  if ((iVar2 == 1) ||
     (iStack0000000c = FUN_000100dc(0x805,*unaff_s0,in_stack_00000006), iStack0000000c == 0)) {
    iVar2 = -1;
  }
  else {
    if ((in_stack_00000006 != 0) && (*(code **)(unaff_s2 + 4) != (code *)0x0)) {
      if ((*(byte *)(unaff_s2 + 2) & 0x40) == 0) {
        ...
        (**(code **)(unaff_s2 + 4))(*(undefined4 *)(unaff_s0 + 2),&stack0x00000006,unaff_s1);
      }
    }
    uStack00000008 = 1;
    uVar1 = FUN_0001011e(&stack0x00000008,0xffffffff);
...

{
  ...
  if (puStack0000000c != (undefined2 *)0x0) {
    iVar3 = FUN_00010196(8,in_mstatus);
    *(int *)(puStack0000000c + 4) = iVar3;
    if (iVar3 != 0) {
      ...
      *(undefined *)(puStack0000000c + 1) = *(undefined *)(unaff_s0 + 1);
      ...
      uVar2 = FUN_0001011e(&stack0x00000008,0xffffffff);
      return -((uVar2 ^ 1) & 0xff);
    }
  }
  return -1;
...

{
  ...
  iVar2 = _L0((int)param + -0xc);
  uVar1 = *(char *)(iVar2 + 2) + '\x04';
  (*pcRam00000000)(host_buf_data,iVar2,uVar1,pcRam00000000);
  FUN_00010214(*(undefined *)((int)param + 6));
  return uVar1;
}
...

{
  ...
  iVar2 = _L0();
  cVar1 = *(char *)(iVar2 + 2) + '\x04';
  (*pcRam00000000)(iVar2,cVar1,pcRam00000000);
  FUN_00010214(*(undefined *)(unaff_s1 + 6));
  return cVar1;
}
