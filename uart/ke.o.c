...
void ble_ke_init(undefined4 uRam00000010,undefined4 uRam00000014)
...

{
  ...
  while (iVar1 = FUN_00010100(0), iVar1 != 0) {
    _L0();
  }
...

{
  ...
  while (iVar1 = FUN_0001017a(0), iVar1 != 0) {
    _L0();
  }
  while (iVar1 = FUN_0001018c(8), iVar1 != 0) {
    _L0();
  }
  while (iVar1 = FUN_0001019e(0x10), iVar1 != 0) {
    _L0();
  }
  do {
                    // WARNING: Do nothing block with infinite loop
...

{
  ...
  while (iVar1 = FUN_0001017a(), iVar1 != 0) {
    _L0();
  }
  while (iVar1 = FUN_0001018c(8), iVar1 != 0) {
    _L0();
...

{
  ...
  while (iVar1 = FUN_0001018c(param_1), iVar1 != 0) {
    _L0();
    param_1 = unaff_s0 + 8;
  }
  while (iVar1 = FUN_0001019e(0x10), iVar1 != 0) {
...

{
  ...
  while (iVar1 = FUN_0001019e(param_1), iVar1 != 0) {
    _L0();
    param_1 = unaff_s0 + 0x10;
  }
  do {
...

{
  ...
  do {
    _L0();
    iVar1 = FUN_0001019e(unaff_s0 + 0x10);
  } while (iVar1 != 0);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
...

{
  ...
  iVar1 = (*pcRam00000000)(auStack17,pcRam00000000);
  if (iVar1 == 0) {
    iVar1 = _L0();
    auStack17[0] = iVar1 == 0;
  }
