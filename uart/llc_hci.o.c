...
union anon_union.conflict18f7_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflict1f30 {
    uint _unused_rand;
    char * _strtok_last;
...
struct anon_struct.conflict2075 {
    uchar * _nextf[30];
    uint _nmalloc[30];
};

union anon_union.conflict20bc_for__new {
...

{
  ...
  uVar1 = FUN_00010012(CONCAT22(in_register_00002032,dest_id),CONCAT22(in_register_00002036,src_id))
  ;
  if ((uVar1 & 0xf) == 0xf) {
    uVar2 = 0xc;
  }
  else {
    iVar3 = *(int *)((uint)param->conhdl * 4);
    if (*(char *)(iVar3 + 0x52) == '\0') {
      if ((((ushort)(param->tx_octets - 0x1b) < 0xe1) && ((ushort)(param->tx_time - 0x148) < 0x701))
         && (param->conhdl < 3)) {
        if ((*(uint16_t *)(iVar3 + 0x46) != param->tx_octets) ||
           (*(uint16_t *)(iVar3 + 0x4e) != param->tx_time)) {
          *(hci_le_set_data_len_cmd **)(iVar3 + 0xc) = param;
          FUN_00010084(0x107,CONCAT22(in_register_00002032,dest_id));
          uVar2 = 0;
          iVar3 = 1;
          goto _L0;
        }
  ...
  iVar3 = 0;
_L0:
  FUN_00010096(CONCAT22(in_register_00002036,src_id),uVar2,param->conhdl);
  return iVar3;
}
...

{
  ...
  if ((uVar2 & 0xf) == 0xf) {
    ...
    iVar4 = *(int *)((uint)*unaff_s1 * 4);
    if (*(char *)(iVar4 + 0x52) == '\0') {
      if ((((ushort)(unaff_s1[1] - 0x1b) < 0xe1) && ((ushort)(unaff_s1[2] - 0x148) < 0x701)) &&
         (*unaff_s1 < 3)) {
        if ((*(ushort *)(iVar4 + 0x46) != unaff_s1[1]) || (*(ushort *)(iVar4 + 0x4e) != unaff_s1[2])
           ) {
          *(ushort **)(iVar4 + 0xc) = unaff_s1;
          FUN_00010084(0x107,in_stack_0000000c);
          uVar3 = 0;
          uVar1 = 1;
          goto _L0;
        }
...

{
  ...
  uVar1 = _L0(CONCAT22(in_register_00002032,dest_id),CONCAT22(in_register_00002036,src_id));
  uVar2 = 0xc;
  if ((((uVar1 & 0xf) != 0xf) && ((uVar1 & 2) != 0)) &&
     (*(char *)(*(int *)((uint)param->conhdl * 4) + 0xa4) == '\x02')) {
    uVar2 = 0x12;
    if (param->reason == ';') {
      FUN_0001011e(1);
      FUN_0001012c(CONCAT22(in_register_00002032,dest_id),uVar1 & 0xfd);
      *(undefined *)(*(int *)((uint)param->conhdl * 4) + 0xa4) = 0;
      FUN_0001014c(param->conhdl,0xf,param->reason);
      uVar2 = 0;
    }
  }
  FUN_0001015c(CONCAT22(in_register_00002036,src_id),uVar2,param->conhdl);
  return 0;
}
...

{
  ...
  if ((((uVar1 & 0xf) != 0xf) && ((uVar1 & 2) != 0)) &&
    ...
    if (*(char *)(unaff_s0 + 1) == ';') {
      FUN_0001011e(1);
      FUN_0001012c(uVar1 & 0xfd);
      *(undefined *)(*(int *)((uint)*unaff_s0 * 4) + 0xa4) = 0;
      FUN_0001014c(*unaff_s0,0xf,*(undefined *)(unaff_s0 + 1));
      uVar2 = 0;
    }
  }
  FUN_0001015c(uVar2,*unaff_s0);
  return 0;
}
...

{
  ...
  FUN_0001011e();
  FUN_0001012c(unaff_s2 & 0xfd);
  *(undefined *)(*(int *)(unaff_s1 + (uint)*unaff_s0 * 4) + 0xa4) = 0;
  FUN_0001014c(*unaff_s0,0xf,*(undefined *)(unaff_s0 + 1));
  FUN_0001015c(0,*unaff_s0);
  return 0;
}
...

{
  ...
  uVar2 = _L0(uVar4,CONCAT22(in_register_00002036,src_id));
  uVar7 = 0xc;
  if (((uVar2 & 0xf) != 0xf) && ((uVar2 & 2) != 0)) {
    iVar6 = *(int *)((uint)param->conhdl * 4);
    if (*(char *)(iVar6 + 0xa4) == '\x02') {
      puVar1 = *(undefined **)(iVar6 + 4);
      iVar3 = _L0();
      if (iVar3 == 3) {
        *puVar1 = 2;
        uVar5 = *(ushort *)(puVar1 + 0xe);
        if (param->interval_min < *(ushort *)(puVar1 + 0xe)) {
          uVar5 = param->interval_min;
        }
        *(ushort *)(puVar1 + 0xe) = uVar5;
        uVar5 = *(ushort *)(puVar1 + 0x10);
        if (*(ushort *)(puVar1 + 0x10) < param->interval_max) {
          uVar5 = param->interval_max;
        }
        *(ushort *)(puVar1 + 0x10) = uVar5;
        *(uint16_t *)(puVar1 + 6) = param->latency;
        uVar5 = *(ushort *)(puVar1 + 8);
        if (*(ushort *)(puVar1 + 8) < param->timeout) {
          uVar5 = param->timeout;
        }
        *(ushort *)(puVar1 + 8) = uVar5;
        FUN_0001022c(puVar1);
        FUN_0001023a(uVar4,uVar2 & 0xfd);
        *(undefined *)(iVar6 + 0xa4) = 0;
        *(undefined4 *)(*(int *)((uint)param->conhdl * 4) + 4) = 0;
        uVar7 = 0;
      }
      else {
        iVar3 = _L0(param->conhdl);
        uVar7 = 0;
        if (iVar3 == 4) {
          ...
          *(uint16_t *)(puVar1 + 8) = param->timeout;
          FUN_000102c2(param->conhdl,*(undefined4 *)(iVar6 + 0x10),puVar1);
          *(undefined *)(iVar6 + 0xa4) = 3;
          FUN_000102d4(param->conhdl,puVar1);
          FUN_000102e8(0x102,uVar4,4000);
          FUN_000102f6(param->conhdl,1);
          uVar7 = 0;
        }
      }
    }
  }
  FUN_00010260(CONCAT22(in_register_00002036,src_id),uVar7,param->conhdl);
  return 0;
}
        ...
        *(undefined4 *)(*(int *)((uint)*unaff_s0 * 4) + 4) = 0;
        ...
        if (iVar3 == 4) {
          ...
          *(ushort *)(puVar1 + 8) = unaff_s0[4];
          FUN_000102c2(*unaff_s0,*(undefined4 *)(iVar5 + 0x10),puVar1);
          *(undefined *)(iVar5 + 0xa4) = 3;
          FUN_000102d4(*unaff_s0,puVar1);
          FUN_000102e8(0x102,4000);
          FUN_000102f6(*unaff_s0,1);
          uVar6 = 0;
        }
      }
    }
  }
  FUN_00010260(uVar6,*unaff_s0);
  return 0;
}
    ...
    *(undefined4 *)(*(int *)(unaff_s2 + (uint)*unaff_s0 * 4) + 4) = 0;
    ...
    if (iVar1 == 4) {
      ...
      *(ushort *)(unaff_s1 + 8) = unaff_s0[4];
      FUN_000102c2(*unaff_s0,*(undefined4 *)(unaff_s3 + 0x10));
      *(char *)(unaff_s3 + 0xa4) = (char)unaff_s8;
      FUN_000102d4(*unaff_s0);
      FUN_000102e8(0x102,4000);
      FUN_000102f6(*unaff_s0,1);
    }
  }
  FUN_00010260(0,*unaff_s0);
  return 0;
}
...

{
  ...
  iVar1 = _L0();
  if (iVar1 == 4) {
    *(undefined2 *)(unaff_s1 + 0xe) = unaff_s0[1];
    *(undefined2 *)(unaff_s1 + 0x10) = unaff_s0[2];
    *(undefined2 *)(unaff_s1 + 6) = unaff_s0[3];
    *(undefined2 *)(unaff_s1 + 8) = unaff_s0[4];
    FUN_000102c2(*unaff_s0,*(undefined4 *)(unaff_s3 + 0x10));
...
// WARNING: Removing unreachable block (ram,0x000103ae)
...

{
  ...
  uVar3 = FUN_00010314(CONCAT22(in_register_00002032,dest_id),CONCAT22(in_register_00002036,src_id))
  ;
  bVar2 = 0xc;
  if (((uVar3 & 0xf) != 0xf) && ((uVar3 & 2) != 0)) {
    iVar4 = *(int *)((uint)param->conhdl * 4);
    if (*(char *)(iVar4 + 0xa4) == '\t') {
      bVar1 = *(byte *)(iVar4 + 0xa5);
      bVar2 = bVar1 & 0x10;
      if ((bVar1 & 0x10) == 0) {
        if ((uVar3 & 1) != 0) {
          FUN_00010396(0x102,CONCAT22(in_register_00002032,dest_id),4000);
        }
        *(undefined *)(*(int *)((uint)param->conhdl * 4) + 0xa4) = 0xd;
        iVar4 = *(int *)((uint)param->conhdl * 4);
        *(byte *)(iVar4 + 0xa5) = *(byte *)(iVar4 + 0xa5) & 0xf7;
        FUN_000103d6(param->conhdl,3,6,in_mstatus);
      }
      else {
        FUN_0001035e(6);
        bVar2 = 0;
  ...
  FUN_00010370(CONCAT22(in_register_00002036,src_id),bVar2,param->conhdl);
  return 0;
}
...

{
  ...
  bVar2 = 0xc;
  if (((uVar3 & 0xf) != 0xf) && ((uVar3 & 2) != 0)) {
    if (*(char *)(*(int *)((uint)*unaff_s2 * 4) + 0xa4) == '\t') {
      bVar1 = *(byte *)(*(int *)((uint)*unaff_s2 * 4) + 0xa5);
      bVar2 = bVar1 & 0x10;
      if ((bVar1 & 0x10) == 0) {
        if ((uVar3 & 1) != 0) {
          FUN_00010396(0x102,in_stack_0000000c,4000);
        }
        *(undefined *)(*(int *)((uint)*unaff_s2 * 4) + 0xa4) = 0xd;
        *(byte *)(*(int *)((uint)*unaff_s2 * 4) + 0xa5) =
             *(byte *)(*(int *)((uint)*unaff_s2 * 4) + 0xa5) & 0xf7;
        FUN_000103d6(*unaff_s2,3,6,in_mstatus);
      }
      else {
        FUN_0001035e(6);
        bVar2 = 0;
...

{
  ...
  uVar1 = FUN_000103f6(CONCAT22(in_register_00002032,dest_id),CONCAT22(in_register_00002036,src_id))
  ;
  uVar3 = 0xc;
  if (((uVar1 & 0xf) != 0xf) && ((uVar1 & 2) != 0)) {
    if (*(char *)(*(int *)((uint)param->conhdl * 4) + 0xa4) == '\t') {
      iVar2 = FUN_00010434(4,0,CONCAT22(in_register_00002032,dest_id),0x20);
  ...
  FUN_0001048a(CONCAT22(in_register_00002036,src_id),uVar3,param->conhdl);
  return 0;
}
...

{
  ...
  uVar3 = 0xc;
  if (((uVar1 & 0xf) != 0xf) && ((uVar1 & 2) != 0)) {
    if (*(char *)(*(int *)((uint)*unaff_s1 * 4) + 0xa4) == '\t') {
      iVar2 = FUN_00010434(4,0,in_stack_0000000c,0x20);
...

{
  ...
  if ((uVar1 & 0xf) != 0xf) {
    ...
    iVar3 = 0;
    do {
      if (valid_r[iVar3 + -4] == param->reason) {
        FUN_00010504(param->conhdl);
        uVar2 = 0;
        goto _L0;
      }
      iVar3 = iVar3 + 1;
...
_L0:
  if (*(char *)(*(int *)((uint)param->conhdl * 4) + 0xa2) == '\0') {
    FUN_0001052e(CONCAT22(in_register_00002036,src_id),uVar2);
...
// WARNING: Removing unreachable block (ram,0x0001063a)
...

{
  ...
  uVar7 = CONCAT22(in_register_00002036,src_id);
  uVar5 = CONCAT22(in_register_00002032,dest_id);
  bVar2 = _L0(uVar5,uVar7);
  if ((bVar2 & 0xf) == 0xf) {
    uVar6 = (uint)param->conhdl;
  }
  else {
    if ((bVar2 & 4) != 0) {
      uVar6 = (uint)param->conhdl;
    ...
    iVar3 = FUN_000105d0(uVar5 >> 8);
    uVar6 = (uint)param->conhdl;
    if ((iVar3 == 3) && ((*(byte *)(*(int *)(uVar6 * 4) + 0x69) & 1) != 0)) {
      FUN_00010602(uVar7,0);
      FUN_00010614(uVar5,bVar2 | 1);
      piVar1 = (int *)((uVar5 >> 8) * 4);
      _L0(uVar5,bVar2 | 5);
      iVar3 = *piVar1;
      *(undefined *)(iVar3 + 0xa3) = 10;
      *(byte *)(iVar3 + 0xa5) = *(byte *)(iVar3 + 0xa5) | 4;
      iVar3 = _L0(*(undefined4 *)(iVar3 + 0x10));
      if (iVar3 == 0) {
        _LVL118(0x106,uVar5,uVar5);
      }
      else {
        iVar3 = *piVar1;
  ...
  uVar4 = 0xc;
_L72:
  FUN_000105a6(uVar7,uVar4,uVar6);
  return 0;
}
...

{
  ...
  if ((bVar2 & 0xf) == 0xf) {
    ...
    iVar3 = FUN_000105d0(unaff_s3 >> 8);
    uVar5 = (uint)*unaff_s4;
    if ((iVar3 == 3) && ((*(byte *)(*(int *)(uVar5 * 4) + 0x69) & 1) != 0)) {
      FUN_00010602(0);
      FUN_00010614(bVar2 | 1);
...

{
  ...
  iVar1 = FUN_000105d0();
  if ((iVar1 == 3) && ((*(byte *)(*(int *)((uint)*unaff_s4 * 4) + 0x69) & 1) != 0)) {
    FUN_00010602(0);
    FUN_00010614(unaff_s2 | 1);
    _L0(unaff_s2 | 5);
    iVar1 = *(int *)(unaff_s1 * 4);
    *(undefined *)(iVar1 + 0xa3) = 10;
    *(byte *)(iVar1 + 0xa5) = *(byte *)(iVar1 + 0xa5) | 4;
    iVar1 = _L0(*(undefined4 *)(iVar1 + 0x10));
    if (iVar1 == 0) {
      _LVL118(0x106);
    }
    else {
...

{
  ...
  *(byte *)(iVar2 + 0xa5) = *(byte *)(iVar2 + 0xa5) | 4;
  iVar2 = _L0(*(undefined4 *)(iVar2 + 0x10));
  if (iVar2 == 0) {
    _LVL118(0x106);
  }
  else {
...

{
  ...
  bVar1 = _L0(uVar2,CONCAT22(in_register_00002036,src_id));
  if ((bVar1 & 0xf) == 0xf) {
    bVar4 = 0xc;
  }
  else {
    if ((*(ushort *)(*(int *)((uint)param->conhdl * 4) + 0x5c) & 1) == 0) {
      ...
      _LVL125(uVar2,bVar1 | 1);
      *(undefined *)(*(int *)((uint)param->conhdl * 4) + 0xa3) = 1;
      FUN_00010704(param->conhdl);
      FUN_00010718(0x102,uVar2,4000);
    }
    else {
      bVar4 = 0;
    }
  }
  FUN_00010728(CONCAT22(in_register_00002036,src_id),bVar4,param->conhdl);
  iVar3 = *(int *)((uint)param->conhdl * 4);
  if ((*(ushort *)(iVar3 + 0x5c) & 1) != 0) {
    FUN_0001074c(0,iVar3 + 0x69);
  }
  return 0;
}
  ...
  if ((bVar1 & 0xf) == 0xf) {
    ...
    if ((*(ushort *)(*(int *)((uint)*unaff_s1 * 4) + 0x5c) & 1) == 0) {
      ...
      *(undefined *)(*(int *)((uint)*unaff_s1 * 4) + 0xa3) = 1;
      FUN_00010704(*unaff_s1);
      FUN_00010718(0x102,4000);
    }
    else {
      bVar2 = 0;
    }
  }
  FUN_00010728(bVar2,*unaff_s1);
  if ((*(ushort *)(*(int *)((uint)*unaff_s1 * 4) + 0x5c) & 1) != 0) {
    FUN_0001074c(0,*(int *)((uint)*unaff_s1 * 4) + 0x69);
  }
  return 0;
}
...

{
  ...
  *(undefined *)(*(int *)((uint)*unaff_s1 * 4 + unaff_s0) + 0xa3) = 1;
  FUN_00010704(*unaff_s1);
  FUN_00010718(0x102,4000);
  FUN_00010728(*unaff_s1);
  iVar1 = *(int *)(unaff_s0 + (uint)*unaff_s1 * 4);
  if ((*(ushort *)(iVar1 + 0x5c) & 1) != 0) {
    FUN_0001074c(0,iVar1 + 0x69);
  }
  return 0;
}
...

{
  ...
  puVar1 = (undefined *)FUN_0001078e(0x801,param->conhdl,0x2015,10);
  uVar2 = FUN_0001079a(CONCAT22(in_register_00002032,dest_id));
  uVar3 = 0xc;
  if ((uVar2 & 0xf) != 0xf) {
...

{
  ...
  uVar1 = _L0(CONCAT22(in_register_00002032,dest_id),CONCAT22(in_register_00002036,src_id));
  puVar2 = (undefined *)FUN_00010822(0x801,param->conhdl,0xc7b,6);
  if ((uVar1 & 0xf) == 0xf) {
    *puVar2 = 0xc;
  }
  else {
...

{
  ...
  uVar1 = _L0();
  puVar2 = (undefined *)FUN_00010822(0x801,*unaff_s2,0xc7b,6);
  if ((uVar1 & 0xf) == 0xf) {
    *puVar2 = 0xc;
  }
  else {
...

{
  ...
  puVar1 = (undefined *)FUN_00010892(0x801,param->conhdl,0x1405,6);
  uVar2 = FUN_0001089e(CONCAT22(in_register_00002032,dest_id));
  if ((uVar2 & 0xf) == 0xf) {
    *puVar1 = 0xc;
    puVar1[4] = 0;
  }
...

{
  ...
  puVar2 = (undefined *)FUN_00010916(0x801,param->conhdl,0xc2d,6);
  uVar3 = FUN_00010922(CONCAT22(in_register_00002032,dest_id));
  if ((uVar3 & 0xf) == 0xf) {
    uVar1 = 0xc;
_L0:
    *puVar2 = uVar1;
...
undefined4 FUN_00010916(code *pcRam00000014,undefined param_2)
...
_L0:
    ...
    *puVar2 = 0;
    if (*(char *)(unaff_s1 + 1) == '\0') {
      uVar1 = (*pcRam00000014)(*(ushort *)((uint)*unaff_s1 * 0x5c + 0x280080a0) & 0xff,1,
                               pcRam00000014);
    }
    else {
      ...
      uVar1 = (*pcRam00000014)(DAT_0000002c,1,pcRam00000014);
    }
    puVar2[4] = uVar1;
  }
...
undefined4 FUN_00010922(code *pcRam00000014,undefined param_2)
...

{
  ...
  uVar1 = FUN_000109cc(CONCAT22(in_register_00002032,dest_id),CONCAT22(in_register_00002036,src_id))
  ;
  if ((uVar1 & 0xf) == 0xf) {
    iVar10 = 0;
    iVar2 = 0xff;
  ...
  iVar9 = *(int *)((uint)param->conhdl * 4);
  iVar11 = *(int *)(iVar9 + 0x10);
  iVar2 = _L0();
  iVar10 = iVar11 + 0x28;
  if (iVar2 == 4) {
    if ((*(ushort *)(iVar9 + 0x5c) & 1) != 0) {
      iVar2 = 0x1a;
      bVar4 = *(byte *)(iVar9 + 0x69) & 2;
      if ((*(byte *)(iVar9 + 0x69) & 2) == 0) goto _L0;
    }
    if (*(char *)(iVar9 + 0xa6) != '\0') goto _L0;
    iVar2 = 0x1a;
_L0:
    bVar4 = 0;
  }
...
_L0:
    ...
    uVar7 = (uint)param->con_intv_max;
    if (uVar1 <= uVar7) {
      if ((((((uint)param->ce_len_min <= (uint)param->ce_len_max) && (uVar7 < 0xc81)) && (5 < uVar1)
           ) && ((uVar6 = (uint)param->con_latency, uVar6 < 500 &&
                 (uVar5 = (uint)param->superv_to, (uVar5 - 10 & 0xffff) < 0xc77)))) &&
         ((uVar6 + 1) * uVar7 < uVar5 << 2)) {
        uVar8 = (uint)(*(ushort *)(iVar11 + 0x78) >> 1);
        if ((uVar1 <= uVar8) && (uVar8 <= uVar7)) {
          uVar1 = *(ushort *)(*(int *)(iVar9 + 0x10) + 0x12) / 0x4e2;
          if ((param->ce_len_min <= uVar1) &&
             ((uVar1 <= param->ce_len_max && (*(ushort *)(iVar9 + 0x54) == uVar5)))) {
            iVar2 = 0;
            if (*(ushort *)(iVar11 + 0x5e) - 1 == uVar6) goto _L0;
          }
        }
        puVar3 = (undefined *)FUN_00010ac2(0x109,CONCAT22(in_register_00002032,dest_id),0x22);
        *puVar3 = 0;
        iVar2 = 0xff;
...
_L0:
  FUN_00010b1c(CONCAT22(in_register_00002036,src_id),bVar4,param->conhdl);
  iVar9 = FUN_00010b26(2);
  if ((iVar9 != 0) && (iVar2 != 0xff)) {
    FUN_00010b40(iVar2,param->conhdl,iVar10);
  }
  return 0;
}
...
_L0:
    ...
    uVar7 = (uint)unaff_s0[2];
    if (uVar1 <= uVar7) {
      if ((((((uint)unaff_s0[5] <= (uint)unaff_s0[6]) && (uVar7 < 0xc81)) && (5 < uVar1)) &&
          ((uVar6 = (uint)unaff_s0[3], uVar6 < 500 &&
           (uVar5 = (uint)unaff_s0[4], (uVar5 - 10 & 0xffff) < 0xc77)))) &&
         ((uVar6 + 1) * uVar7 < uVar5 << 2)) {
        uVar8 = (uint)(*(ushort *)(iVar11 + 0x78) >> 1);
        if ((uVar1 <= uVar8) && (uVar8 <= uVar7)) {
          uVar1 = *(ushort *)(*(int *)(iVar9 + 0x10) + 0x12) / 0x4e2;
          if ((unaff_s0[5] <= uVar1) &&
             ((uVar1 <= unaff_s0[6] && (*(ushort *)(iVar9 + 0x54) == uVar5)))) {
            iVar2 = 0;
            if (*(ushort *)(iVar11 + 0x5e) - 1 == uVar6) goto _L0;
          }
        }
        puVar3 = (undefined *)FUN_00010ac2(0x109,in_stack_0000000c,0x22);
        *puVar3 = 0;
        iVar2 = 0xff;
...
_L0:
  FUN_00010b1c(bVar4,*unaff_s0);
  iVar9 = FUN_00010b26(2);
  if ((iVar9 != 0) && (iVar2 != 0xff)) {
    FUN_00010b40(iVar2,*unaff_s0,iVar10);
  }
  return 0;
}
...

{
  ...
  if (iVar1 == 4) {
    if ((*(ushort *)(unaff_s2 + 0x5c) & 1) != 0) {
      iVar1 = 0x1a;
      bVar5 = *(byte *)(unaff_s2 + 0x69) & 2;
      if ((*(byte *)(unaff_s2 + 0x69) & 2) == 0) goto _L0;
    }
    if (*(char *)(unaff_s2 + 0xa6) != '\0') goto _L0;
    iVar1 = 0x1a;
_L0:
    bVar5 = 0;
  }
...
_L0:
    uVar2 = (uint)(ushort)unaff_s0[1];
    uVar8 = (uint)(ushort)unaff_s0[2];
    if (uVar2 <= uVar8) {
      if ((((((uint)(ushort)unaff_s0[5] <= (uint)(ushort)unaff_s0[6]) && (uVar8 < 0xc81)) &&
           (5 < uVar2)) &&
          ((uVar7 = (uint)(ushort)unaff_s0[3], uVar7 < 500 &&
           (uVar6 = (uint)(ushort)unaff_s0[4], (uVar6 - 10 & 0xffff) < 0xc77)))) &&
         ((uVar7 + 1) * uVar8 < uVar6 << 2)) {
        uVar9 = (uint)(*(ushort *)(unaff_s5 + 0x78) >> 1);
        if ((uVar2 <= uVar9) && (uVar9 <= uVar8)) {
          uVar2 = *(ushort *)(*(int *)(unaff_s2 + 0x10) + 0x12) / 0x4e2;
          if (((ushort)unaff_s0[5] <= uVar2) &&
             ((uVar2 <= (ushort)unaff_s0[6] && (*(ushort *)(unaff_s2 + 0x54) == uVar6)))) {
            iVar1 = 0;
            if (*(ushort *)(unaff_s5 + 0x5e) - 1 == uVar7) goto _L0;
          }
        }
        puVar3 = (undefined *)FUN_00010ac2(0x109,in_stack_0000000c,0x22);
        *puVar3 = 0;
        iVar1 = 0xff;
        *(undefined2 *)(puVar3 + 2) = unaff_s0[1];
        *(undefined2 *)(puVar3 + 4) = unaff_s0[2];
        *(undefined2 *)(puVar3 + 6) = unaff_s0[3];
        *(undefined2 *)(puVar3 + 8) = unaff_s0[4];
        *(undefined2 *)(puVar3 + 10) = unaff_s0[5];
        *(undefined2 *)(puVar3 + 0xc) = unaff_s0[6];
        _L0();
        goto _L0;
      }
    }
...
_L0:
  FUN_00010b1c(bVar5,*unaff_s0);
  iVar4 = FUN_00010b26(2);
  if ((iVar4 != 0) && (iVar1 != 0xff)) {
    FUN_00010b40(iVar1,*unaff_s0,unaff_s5 + 0x28);
  }
  return 0;
}
...
// WARNING: Removing unreachable block (ram,0x00010b38)
...

{
  ...
  *puVar1 = 0;
  *(undefined2 *)(puVar1 + 2) = unaff_s0[1];
  *(undefined2 *)(puVar1 + 4) = unaff_s0[2];
  *(undefined2 *)(puVar1 + 6) = unaff_s0[3];
  *(undefined2 *)(puVar1 + 8) = unaff_s0[4];
  *(undefined2 *)(puVar1 + 10) = unaff_s0[5];
  *(undefined2 *)(puVar1 + 0xc) = unaff_s0[6];
  _L0();
  FUN_00010b1c(0,*unaff_s0);
  FUN_00010b26(2);
  return 0;
}
...

{
  ...
  _L0();
  FUN_00010b1c(0,*unaff_s0);
  iVar1 = FUN_00010b26(2);
  if ((iVar1 != 0) && (unaff_s1 != 0xff)) {
    FUN_00010b40(*unaff_s0);
  }
  return 0;
}
...

{
  ...
  puVar2 = (undefined *)FUN_00010b94(0x801,param->conhdl,0xc7c,4);
  if ((uVar1 & 0xf) == 0xf) {
    uVar4 = 0xc;
  }
  else {
    piVar5 = (int *)((uVar3 >> 8) * 4);
    if ((uint)*(ushort *)(*(int *)(*piVar5 + 0x10) + 0x78) *
        (uint)*(ushort *)(*(int *)(*piVar5 + 0x10) + 0x5e) <= (uint)param->auth_payl_to << 4) {
      *puVar2 = 0;
      iVar6 = *piVar5;
      *(uint16_t *)(iVar6 + 0x58) = param->auth_payl_to;
      FUN_00010bec(*(int *)(iVar6 + 0x10) + 0x28);
      iVar6 = *piVar5;
      if ((*(byte *)(iVar6 + 0xa5) & 3) == 3) {
        FUN_00010c12(0x103,uVar3,(uint)*(ushort *)(iVar6 + 0x58) - (uint)*(ushort *)(iVar6 + 0x5a));
        FUN_00010c26(0x104,uVar3,*(undefined2 *)(*piVar5 + 0x58));
      }
      goto _L0;
    }
    uVar4 = 0x12;
...

{
  ...
  uVar1 = _L0();
  puVar2 = (undefined *)FUN_00010b94(0x801,*unaff_s2,0xc7c,4);
  if ((uVar1 & 0xf) == 0xf) {
    uVar3 = 0xc;
  }
  else {
    ...
    if ((uint)*(ushort *)(*(int *)(*piVar4 + 0x10) + 0x78) *
      ...
      *puVar2 = 0;
      iVar5 = *piVar4;
      *(undefined2 *)(iVar5 + 0x58) = unaff_s2[1];
      FUN_00010bec(*(int *)(iVar5 + 0x10) + 0x28);
      iVar5 = *piVar4;
      if ((*(byte *)(iVar5 + 0xa5) & 3) == 3) {
        FUN_00010c12(0x103,(uint)*(ushort *)(iVar5 + 0x58) - (uint)*(ushort *)(iVar5 + 0x5a));
        FUN_00010c26(0x104,*(undefined2 *)(*piVar4 + 0x58));
      }
      goto _L0;
    }
    uVar3 = 0x12;
...

{
  ...
  if ((unaff_s0 & 0xf) == 0xf) {
    ...
    if ((uint)*(ushort *)(*(int *)(*piVar3 + 0x10) + 0x78) *
      ...
      *puVar1 = 0;
      iVar4 = *piVar3;
      *(undefined2 *)(iVar4 + 0x58) = unaff_s2[1];
      FUN_00010bec(*(int *)(iVar4 + 0x10) + 0x28);
      iVar4 = *piVar3;
      if ((*(byte *)(iVar4 + 0xa5) & 3) == 3) {
        FUN_00010c12(0x103,(uint)*(ushort *)(iVar4 + 0x58) - (uint)*(ushort *)(iVar4 + 0x5a));
        FUN_00010c26(0x104,*(undefined2 *)(*piVar3 + 0x58));
      }
      goto _L0;
    }
    uVar2 = 0x12;
...

{
  ...
  FUN_00010bec();
  iVar1 = *unaff_s0;
  if ((*(byte *)(iVar1 + 0xa5) & 3) == 3) {
    FUN_00010c12(0x103,(uint)*(ushort *)(iVar1 + 0x58) - (uint)*(ushort *)(iVar1 + 0x5a));
    FUN_00010c26(0x104,*(undefined2 *)(*unaff_s0 + 0x58));
  }
...

{
  ...
  uVar1 = param->conhdl;
  uVar2 = (uint)uVar1;
  puVar3 = (undefined *)FUN_00010c6e(0x801,uVar2,0xc08,4);
  FUN_00010c7a(uVar2);
  FUN_00010c98(*(int *)(*(int *)(uVar2 * 4) + 0x10) + 0x28);
...

{
  ...
  FUN_00010c7a();
  FUN_00010c98(*(int *)(*(int *)(unaff_s0 * 4) + 0x10) + 0x28);
  *(short *)(puVar1 + 2) = (short)unaff_s0;
  *puVar1 = 0;
  _L0(puVar1);
  return 0;
}
...

{
  ...
  FUN_00010c7a();
  FUN_00010c98(*(int *)(*(int *)(unaff_s0 * 4) + 0x10) + 0x28);
  *(short *)(unaff_s1 + 2) = (short)unaff_s0;
  *unaff_s1 = 0;
  _L0();
  return 0;
}
...

{
  ...
  uVar6 = CONCAT22(in_register_00002036,src_id);
  uVar5 = CONCAT22(in_register_00002032,dest_id);
  bVar3 = _L0(uVar5,uVar6);
  if ((bVar3 & 0xf) == 0xf) {
    uVar1 = param->conhdl;
    uVar4 = 0xc;
  }
  else {
    piVar2 = (int *)((uVar5 >> 8) * 4);
    if ((*(ushort *)(*piVar2 + 0x5c) & 2) != 0) {
      _LVL245(uVar6,0,param->conhdl);
      FUN_00010d28(0,uVar5 >> 8);
      return 0;
    }
    if ((bVar3 & 5) != 0) {
      return 2;
    }
    _LVL252(uVar5,bVar3 | 1);
    *(undefined *)(*piVar2 + 0xa3) = 2;
    FUN_00010d68(param->conhdl);
    FUN_00010d7c(0x102,uVar5,4000);
    uVar1 = param->conhdl;
    uVar4 = 0;
  }
  FUN_00010cee(uVar6,uVar4,uVar1);
  return 0;
}
...

{
  ...
  if ((bVar3 & 0xf) == 0xf) {
    ...
    piVar2 = (int *)((unaff_s3 >> 8) * 4);
    if ((*(ushort *)(*piVar2 + 0x5c) & 2) != 0) {
      _LVL245(0,*unaff_s2);
      FUN_00010d28(0,unaff_s3 >> 8);
      return 0;
    }
    if ((bVar3 & 5) != 0) {
      return 2;
    ...
    _LVL252(bVar3 | 1);
    *(undefined *)(*piVar2 + 0xa3) = 2;
    FUN_00010d68(*unaff_s2);
    FUN_00010d7c(0x102,4000);
    uVar1 = *unaff_s2;
    uVar4 = 0;
  }
  FUN_00010cee(uVar4,uVar1);
  return 0;
}
...
// WARNING: Removing unreachable block (ram,0x00010de2)
...

{
  ...
  if (((uVar1 & 0xf) == 0xf) || (param->length == 0)) {
    FUN_00010e08(8,(param->buf->idx + 0x29) * 8);
    FUN_00010e1a(param->conhdl,1);
  }
  else {
    iVar2 = FUN_00010e30(param);
    if (iVar2 == 0) {
      FUN_00010e40(param->conhdl,1);
    }
    FUN_00010e5c(*(undefined4 *)(*(int *)((uint)param->conhdl * 4) + 0x10));
  }
  return 0;
}
...

{
  ...
  uVar1 = _L0();
  if (((uVar1 & 0xf) == 0xf) || (unaff_s0[2] == 0)) {
    FUN_00010e08(8,(*(ushort *)(*(int *)(unaff_s0 + 4) + 4) + 0x29) * 8);
    FUN_00010e1a(*unaff_s0,1);
  }
  else {
    iVar2 = FUN_00010e30();
    if (iVar2 == 0) {
      FUN_00010e40(*unaff_s0,1);
    }
    FUN_00010e5c(*(undefined4 *)(*(int *)((uint)*unaff_s0 * 4) + 0x10));
  }
  return 0;
}
