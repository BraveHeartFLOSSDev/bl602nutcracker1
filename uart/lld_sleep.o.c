...
union anon_union.conflict464_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflicta9d {
    uint _unused_rand;
    char * _strtok_last;
...
struct anon_struct.conflictbe2 {
    uchar * _nextf[30];
    uint _nmalloc[30];
};

union anon_union.conflictc29_for__new {
...

{
  ...
  iVar1 = FUN_0001002c(5000);
  uVar2 = FUN_0001003a(5000);
  uVar3 = FUN_00010048(0x271);
  _DAT_2800003c = uVar3 & 0xffff | iVar1 << 0x15 | (uVar2 & 0xffff) << 10;
  FUN_00010072(5000);
  _DAT_00000004 = 0;
  _DAT_00000008 = 0;
...

{
  ...
  iVar1 = FUN_0001002c();
  uVar2 = FUN_0001003a(unaff_s1 + 0x388);
  uVar3 = FUN_00010048(0x271);
  _DAT_2800003c = uVar3 & 0xffff | iVar1 << 0x15 | (uVar2 & 0xffff) << 10;
  FUN_00010072(unaff_s1 + 0x388);
  _DAT_28000030 = _DAT_28000030 & 0x7fffffff;
...

{
  ...
  uVar1 = FUN_0001003a();
  uVar2 = FUN_00010048(0x271);
  _DAT_2800003c = uVar2 & 0xffff | unaff_s2 << 0x15 | (uVar1 & 0xffff) << 10;
  FUN_00010072(unaff_s1 + 0x388);
  _DAT_28000030 = _DAT_28000030 & 0x7fffffff;
  *(undefined4 *)(unaff_s3 + 4) = 0;
  *(undefined2 *)(unaff_s3 + 8) = 0;
...

{
  ...
  uVar1 = FUN_00010048();
  _DAT_2800003c = uVar1 & 0xffff | unaff_s2 << 0x15 | (unaff_s0 & 0xffff) << 10;
  FUN_00010072(unaff_s1 + 0x388);
  _DAT_28000030 = _DAT_28000030 & 0x7fffffff;
  *(undefined4 *)(unaff_s3 + 4) = 0;
  *(undefined2 *)(unaff_s3 + 8) = 0;
...
// WARNING: Removing unreachable block (ram,0x000100ba)
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
...

{
  ...
  if (CONCAT31(in_register_0000202d,ext_wakeup) == 0) {
    _DAT_28000030 = _DAT_28000030 | 0x80000000;
  }
...
void lld_sleep_wakeup(undefined4 uRam00000010,undefined3 param_2)

{
  ...
  if (DAT_00000009 != '\0') {
    ...
    _DAT_28000040 = uRam00000010;
    _DAT_28000044 = _DAT_0000000c;
    return;
  }
  if (DAT_00000008 != '\0') {
    _DAT_00000008 = 0;
    iVar1 = _L0(_DAT_28000038 - _DAT_00000004);
    _DAT_28000044 = (iVar1 + (uint)DAT_0000002a) / 0x271;
    _DAT_28000040 = (_DAT_28000044 * 0x271 - (iVar1 + (uint)DAT_0000002a)) + 0x270 & 0xffff;
    DAT_0000002a = _DAT_28000040 == 0;
    if ((bool)DAT_0000002a) {
