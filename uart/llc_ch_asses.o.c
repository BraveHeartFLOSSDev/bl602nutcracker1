...
union anon_union.conflict52e_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflictcac {
    uchar * _nextf[30];
    uint _nmalloc[30];
};
...
struct anon_struct.conflictb67 {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflictcf3_for__new {
