...
struct anon_struct.conflict8cb {
    uchar * _nextf[30];
    uint _nmalloc[30];
};

union anon_union.conflict141_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflict786 {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict912_for__new {
...
// WARNING: Removing unreachable block (ram,0x000100c8)
...
// WARNING: Removing unreachable block (ram,0x00010126)
...
// WARNING: Removing unreachable block (ram,0x0001016a)
