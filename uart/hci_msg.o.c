...

{
  ...
  if (in == (uint8_t *)0x0) {
    *out_len = 0xe;
    ...
    puVar1 = in + CONCAT22(in_register_00002036,in_len);
    puVar7 = out + *out_len;
    puStack56 = in;
    p_in = out;
    iVar2 = _LVL15(&puStack56,&p_in,puVar1,puVar7,1);
    iVar3 = iVar2;
    if (iVar2 == 0) {
      uVar4 = 0;
      while ((iVar3 = iVar2, uVar4 < *in && (p_in + -(int)out < (uint8_t *)0xf))) {
        iVar5 = (uVar4 + 1) * 2;
        p_in = out + iVar5;
        iVar3 = _L0(&puStack56,&p_in,puVar1,puVar7,2);
        if (iVar3 != 0) break;
        p_in = out + iVar5 + 6;
        iVar3 = _L0(&puStack56,&p_in,puVar1,puVar7,2);
        if (iVar3 != 0) break;
...

{
  ...
  if (iVar1 == 0) {
    ...
    while ((iVar2 = iVar1, uVar3 < *unaff_s3 && ((uint)(in_stack_0000000c - unaff_s0) < 0xf))) {
      ...
      iVar2 = _L0(&stack0x00000008,&stack0x0000000c,2);
      if (iVar2 != 0) break;
...

{
  ...
  while (iVar1 = _L0(param_1,param_2,param_3), iVar1 == 0) {
    ...
    iVar1 = _L0(&stack0x00000008,&stack0x0000000c,2);
    if (iVar1 != 0) break;
    iVar1 = unaff_s5;
...

{
  ...
  if (in == (uint8_t *)0x0) {
    *out_len = 0;
    ...
    if (out == (uint8_t *)0x0) {
      puVar2 = temp_out.adv_rep[0].data + 0x1c;
      out = (uint8_t *)&p_out;
    }
    else {
      puVar2 = out + *out_len;
    }
    puVar5 = in + CONCAT22(in_register_00002036,in_len);
    ppuStack84 = (uint8_t **)out;
    p_in = out;
    iVar3 = _L0(&ppuStack84,&p_in,puVar5,puVar2,1);
    if (iVar3 == 0) {
      ppuStack84 = (uint8_t **)((int)out + 1);
      iVar4 = _L0(&ppuStack84,&p_in,puVar5,puVar2,1);
      iVar3 = iVar4;
      if (iVar4 == 0) {
        ppuVar6 = (uint8_t **)((int)out + 10);
        iVar7 = 0;
        while (iVar3 = iVar4, iVar7 < (int)(uint)*(byte *)((int)out + 1)) {
          ppuStack84 = ppuVar6 + -2;
          iVar3 = _L0(&ppuStack84,&p_in,puVar5,puVar2,1);
          if (iVar3 != 0) break;
          ppuStack84 = (uint8_t **)((int)ppuVar6 + -7);
          iVar3 = _L0(&ppuStack84,&p_in,puVar5,puVar2,1);
          if (iVar3 != 0) break;
          ppuStack84 = (uint8_t **)((int)ppuVar6 + -6);
          iVar3 = _L0(&ppuStack84,&p_in,puVar5,puVar2,6);
          if ((iVar3 != 0) ||
             (ppuStack84 = ppuVar6, iVar3 = _L0(&ppuStack84,&p_in,puVar5,puVar2,1), iVar3 != 0))
          break;
          ppuStack84 = (uint8_t **)((int)ppuVar6 + 1);
          iVar3 = _L0(&ppuStack84,&p_in,puVar5,puVar2,*(undefined *)ppuVar6);
          if (iVar3 != 0) break;
          ppuStack84 = ppuVar6 + 8;
          iVar3 = _L0(&ppuStack84,&p_in,puVar5,puVar2,1);
          ppuVar6 = (uint8_t **)((int)ppuVar6 + 0x29);
          if (iVar3 != 0) break;
          iVar7 = iVar7 + 1;
        }
      }
...

{
  ...
  iVar1 = _L0();
  if (iVar1 == 0) {
    puStack0000000c = (undefined *)(unaff_s3 + 1);
    iVar2 = _L0(&stack0x0000000c,&stack0x00000010,1);
    iVar1 = iVar2;
    if (iVar2 == 0) {
      puVar3 = (undefined *)(unaff_s3 + 10);
      iVar4 = 0;
      while (iVar1 = iVar2, iVar4 < (int)(uint)*(byte *)(unaff_s3 + 1)) {
        puStack0000000c = puVar3 + -8;
        iVar1 = _L0(&stack0x0000000c,&stack0x00000010,1);
        if (iVar1 != 0) break;
        puStack0000000c = puVar3 + -7;
        iVar1 = _L0(&stack0x0000000c,&stack0x00000010,1);
        if (iVar1 != 0) break;
        puStack0000000c = puVar3 + -6;
        iVar1 = _L0(&stack0x0000000c,&stack0x00000010,6);
        if (iVar1 != 0) break;
        puStack0000000c = puVar3;
        iVar1 = _L0(&stack0x0000000c,&stack0x00000010,1);
        if (iVar1 != 0) break;
        puStack0000000c = puVar3 + 1;
        iVar1 = _L0(&stack0x0000000c,&stack0x00000010,*puVar3);
        if (iVar1 != 0) break;
        puStack0000000c = puVar3 + 0x20;
        iVar1 = _L0(&stack0x0000000c,&stack0x00000010,1);
        puVar3 = puVar3 + 0x29;
        if (iVar1 != 0) break;
        iVar4 = iVar4 + 1;
...

{
  ...
  if (iVar1 == 0) {
    puVar3 = (undefined *)(unaff_s3 + 10);
    iVar4 = 0;
    while (iVar2 = iVar1, iVar4 < (int)(uint)*(byte *)(unaff_s3 + 1)) {
      puStack0000000c = puVar3 + -8;
      iVar2 = _L0(&stack0x0000000c,&stack0x00000010,1);
      if (iVar2 != 0) break;
      puStack0000000c = puVar3 + -7;
      ...
      if (iVar2 != 0) break;
      puStack0000000c = puVar3 + -6;
      iVar2 = _L0(&stack0x0000000c,&stack0x00000010,6);
      if (iVar2 != 0) break;
      puStack0000000c = puVar3;
      iVar2 = _L0(&stack0x0000000c,&stack0x00000010,1);
      if (iVar2 != 0) break;
      puStack0000000c = puVar3 + 1;
      iVar2 = _L0(&stack0x0000000c,&stack0x00000010,*puVar3);
      if (iVar2 != 0) break;
      puStack0000000c = puVar3 + 0x20;
      iVar2 = _L0(&stack0x0000000c,&stack0x00000010,1);
      puVar3 = puVar3 + 0x29;
...

{
  ...
  while( true ) {
    ...
    iVar1 = _L0(&stack0x0000000c,&stack0x00000010,*unaff_s4);
    if (iVar1 != 0) break;
    in_stack_0000000c = unaff_s4 + 0x20;
    iVar1 = _L0(&stack0x0000000c,&stack0x00000010,1);
    if ((iVar1 != 0) ||
       (unaff_s6 = unaff_s6 + 1, iVar1 = unaff_s0, (int)(uint)*(byte *)(unaff_s3 + 1) <= unaff_s6))
    break;
...

{
  ...
  while( true ) {
    ...
    if (iVar1 != 0) break;
    in_stack_0000000c = unaff_s4 + 0x2a;
    iVar1 = _L0(&stack0x0000000c,&stack0x00000010,*puVar2);
    if (iVar1 != 0) break;
...

{
  ...
  if (in == (uint8_t *)0x0) {
    *out_len = 0;
    ...
    if (out == (uint8_t *)0x0) {
      puVar2 = temp_out.adv_rep[0].dir_addr.addr + 3;
      out = (uint8_t *)&p_out;
    }
    else {
      puVar2 = out + *out_len;
    ...
    p_in = out;
    iVar3 = _L0(&ppuStack60,&p_in,puVar5,puVar2,1);
    if (iVar3 == 0) {
      ppuStack60 = (uint8_t **)((int)out + 1);
      iVar4 = _L0(&ppuStack60,&p_in,puVar5,puVar2,1);
      iVar3 = iVar4;
      if (iVar4 == 0) {
        ppuVar6 = (uint8_t **)((int)out + 0x11);
        iVar7 = 0;
        while (iVar3 = iVar4, iVar7 < (int)(uint)*(byte *)((int)out + 1)) {
          ppuStack60 = (uint8_t **)((int)ppuVar6 + -0xf);
          iVar3 = _L0(&ppuStack60,&p_in,puVar5,puVar2,1);
          if (iVar3 != 0) break;
          ppuStack60 = (uint8_t **)((int)ppuVar6 + -0xe);
          iVar3 = _L0(&ppuStack60,&p_in,puVar5,puVar2,1);
          if (iVar3 != 0) break;
          ppuStack60 = (uint8_t **)((int)ppuVar6 + -0xd);
          iVar3 = _L0(&ppuStack60,&p_in,puVar5,puVar2,6);
          if (iVar3 != 0) break;
          ppuStack60 = (uint8_t **)((int)ppuVar6 + -7);
          iVar3 = _L0(&ppuStack60,&p_in,puVar5,puVar2,1);
          if (iVar3 != 0) break;
          ppuStack60 = (uint8_t **)((int)ppuVar6 + -6);
          iVar3 = _L0(&ppuStack60,&p_in,puVar5,puVar2,6);
          if (iVar3 != 0) break;
          ppuStack60 = ppuVar6;
          iVar3 = _L0(&ppuStack60,&p_in,puVar5,puVar2,1);
...

{
  ...
  if (iVar1 == 0) {
    ...
    iVar2 = _L0(&stack0x00000004,&stack0x00000008,1);
    iVar1 = iVar2;
    if (iVar2 == 0) {
      iVar3 = unaff_s3 + 0x11;
      iVar4 = 0;
      while (iVar1 = iVar2, iVar4 < (int)(uint)*(byte *)(unaff_s3 + 1)) {
        ...
        iVar1 = _L0(&stack0x00000004,&stack0x00000008,1);
        if (iVar1 != 0) break;
        iStack00000004 = iVar3 + -0xe;
        iVar1 = _L0(&stack0x00000004,&stack0x00000008,1);
        if (iVar1 != 0) break;
        iStack00000004 = iVar3 + -0xd;
        iVar1 = _L0(&stack0x00000004,&stack0x00000008,6);
        if (iVar1 != 0) break;
...

{
  ...
  if (iVar1 == 0) {
    ...
    while (iVar2 = iVar1, iVar4 < (int)(uint)*(byte *)(unaff_s3 + 1)) {
      ...
      if (iVar2 != 0) break;
      iStack00000004 = iVar3 + -0xd;
      iVar2 = _L0(&stack0x00000004,&stack0x00000008,6);
      if (iVar2 != 0) break;
      iStack00000004 = iVar3 + -7;
      iVar2 = _L0(&stack0x00000004,&stack0x00000008,1);
      if (iVar2 != 0) break;
