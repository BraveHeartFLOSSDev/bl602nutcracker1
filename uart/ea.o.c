...
union anon_union.conflict396_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflictb1b {
    uchar * _nextf[30];
    uint _nmalloc[30];
};
...
struct anon_struct.conflict9d6 {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflictb62_for__new {
    struct anon_struct.conflict9d6 _reent;
    struct anon_struct.conflictb1b _unused;
};
...
_L0:
  do {
    ...
    uVar4 = uVar1 & 0xfffffc0f;
    *(byte *)((int)puVar10 + 0x16) = ((byte)uVar1 & 0xf) + *(char *)((int)puVar10 + 0x16);
    uVar5 = (uVar5 - 1) * 0x10;
    uVar7 = uVar5 & 0xffff | uVar4;
    *(ushort *)(puVar10 + 4) = (ushort)uVar5 | (ushort)uVar4;
    uVar5 = (int)uVar7 >> 0xc & 3;
    peVar2 = new_elt;
    peVar12 = (ea_elt_tag *)0x0;
    while ((peVar6 = peVar2, peVar6 != (ea_elt_tag *)0x0 &&
           (iVar3 = FUN_000101aa(puVar10,peVar6), iVar3 != 0))) {
      if (iVar3 != 5) {
        uVar4 = (uint)peVar6->delay + (uint)peVar6->duration_min;
        uVar8 = uVar4 / 0x271 + peVar6->timestamp;
        if ((uint)*(ushort *)(puVar10 + 5) < uVar4 % 0x271) {
          uVar8 = uVar8 + 1;
        }
        if (uVar5 == 1) {
          uVar8 = uVar8 | 1;
        ...
        uVar8 = uVar8 & 0x7ffffff;
        puVar10[2] = uVar8;
        if (1 < uVar7 >> 0xe) {
          uVar4 = puVar10[3] - uVar8 & 0x7ffffff;
          if (0x4000000 < uVar4) {
            uVar4 = -(uVar8 - puVar10[3] & 0x7ffffff);
          }
          if ((int)uVar4 < (int)(*(ushort *)((int)puVar10 + 0x12) / 0x271)) goto _L0;
        }
      }
      peVar2 = *(ea_elt_tag **)&peVar6->hdr;
      peVar12 = peVar6;
    }
    FUN_00010186(0xc,puVar11,puVar10);
    FUN_00010196(0,peVar12,puVar10);
    puVar10 = puVar11;
  } while( true );
}
...
code_r0x00010186:
  ...
  FUN_00010196(unaff_s11,unaff_s6);
_L0:
  do {
    param_1 = unaff_s9;
    param_2 = unaff_s3;
  ...
  *(byte *)((int)param_2 + 0x16) = ((byte)uVar1 & 0xf) + *(char *)((int)param_2 + 0x16);
  uVar5 = (uVar5 - 1) * 0x10;
  uVar7 = uVar5 & 0xffff | uVar4;
  *(ushort *)(param_2 + 4) = (ushort)uVar5 | (ushort)uVar4;
  uVar5 = (int)uVar7 >> 0xc & 3;
  piVar2 = (int *)unaff_s4;
  unaff_s11 = (int *)0;
  do {
    ...
    unaff_s6 = param_2;
    unaff_s9 = param_1;
    if ((piVar6 == (int *)0x0) || (iVar3 = FUN_000101aa(param_2,piVar6), iVar3 == 0))
    goto code_r0x00010186;
    if (iVar3 != unaff_s5) {
      uVar4 = (uint)*(ushort *)(piVar6 + 5) + (uint)*(ushort *)((int)piVar6 + 0x12);
      uVar8 = uVar4 / unaff_s10 + piVar6[2];
      if ((uint)*(ushort *)(param_2 + 5) < uVar4 % unaff_s10) {
        uVar8 = uVar8 + 1;
      }
      if (uVar5 == 1) {
        uVar8 = uVar8 | 1;
      ...
      uVar8 = uVar8 & unaff_s8;
      param_2[2] = uVar8;
      if (1 < uVar7 >> 0xe) {
        uVar4 = param_2[3] - uVar8 & unaff_s8;
        if (0x4000000 < uVar4) {
          uVar4 = -(uVar8 - param_2[3] & unaff_s8);
        }
        unaff_s9 = param_2;
        if ((int)uVar4 < (int)(*(ushort *)((int)param_2 + 0x12) / unaff_s10)) goto _L0;
      }
    }
    piVar2 = (int *)*piVar6;
    unaff_s11 = piVar6;
...
_L0:
    ...
    iVar3 = FUN_000101aa(param_2,piVar6);
    if (iVar3 == 0) goto _L0;
    if (iVar3 != unaff_s5) {
      uVar4 = (uint)*(ushort *)(piVar6 + 5) + (uint)*(ushort *)((int)piVar6 + 0x12);
      uVar8 = uVar4 / unaff_s10 + piVar6[2];
...

{
  ...
  do {
    iVar2 = FUN_000101aa(param_1,param_2);
    param_1 = unaff_s6;
    if (iVar2 == 0) goto _L0;
    if (iVar2 != unaff_s5) {
      uVar4 = (uint)*(ushort *)(in_stack_00000008 + 5) +
              (uint)*(ushort *)((int)in_stack_00000008 + 0x12);
      uVar3 = uVar4 / unaff_s10 + in_stack_00000008[2];
      if ((uint)*(ushort *)(unaff_s6 + 5) < uVar4 % unaff_s10) {
        uVar3 = uVar3 + 1;
      }
      ...
      uVar3 = uVar3 & unaff_s8;
      unaff_s6[2] = uVar3;
      if (1 < unaff_s7) {
        uVar4 = unaff_s6[3] - uVar3 & unaff_s8;
        if (0x4000000 < uVar4) {
          uVar4 = -(uVar3 - unaff_s6[3] & unaff_s8);
        }
        if ((int)uVar4 < (int)(*(ushort *)((int)unaff_s6 + 0x12) / unaff_s10)) goto _L0;
      }
    }
    param_2 = (int *)*in_stack_00000008;
    while (unaff_s6 = param_1, unaff_s11 = in_stack_00000008, in_stack_00000008 = param_2,
          param_2 == (int *)0x0) {
_L0:
      FUN_00010186(unaff_s9,param_1);
      FUN_00010196(unaff_s11,param_1);
      unaff_s6 = unaff_s9;
_L0:
      do {
        unaff_s9 = unaff_s6;
      ...
      *(byte *)((int)param_1 + 0x16) = ((byte)uVar1 & 0xf) + *(char *)((int)param_1 + 0x16);
      uVar4 = (uVar4 - 1) * 0x10;
      uVar5 = uVar4 & 0xffff | uVar3;
      *(ushort *)(param_1 + 4) = (ushort)uVar4 | (ushort)uVar3;
      in_stack_0000000c = (int)uVar5 >> 0xc & 3;
      unaff_s7 = uVar5 >> 0xe;
...

{
  ...
  _L0();
  FUN_0001024e(unaff_s0 + 0xc);
  FUN_0001025a(unaff_s0 + 0x14);
...

{
  ...
  iVar2 = CONCAT22(in_register_0000202a,size_of_env) + 0x2c;
  peVar1 = (ea_elt_tag *)FUN_00010282(iVar2,0);
  if (peVar1 != (ea_elt_tag *)0x0) {
    (*pcRam00000000)(0,iVar2,pcRam00000000);
  }
  return peVar1;
}
...

{
  ...
  peVar1 = (ea_interval_tag *)_L0(0x10,0);
...
void ea_prog_timer(int *piRam00000014)

{
  ...
  if (uRam00000000 == 0) {
    ...
    if (_DAT_00000008 != 0) {
      ...
      if ((uint)*(byte *)(uRam00000000 + 0x19) < (uint)bVar1) {
        ...
        uVar3 = _DAT_0000001c - uVar2 & 0x7ffffff;
        if ((0x4000000 < uVar3) || (uVar3 == 0)) {
          _DAT_0000001c = uVar2 + 1 & 0x7ffffff;
          _L0();
          return;
        }
      }
  ...
  uVar2 = _L0();
  if (uVar2 - _DAT_0000001c < 0x3ffffff) {
    _DAT_0000001c = uVar2 + 1 & 0x7ffffff;
  }
...
_L0:
  if (((char)uRam00000000 != '\0') && (piVar4 = piRam00000014, -1 < (int)(uVar2 << 5))) {
  ...
  uRam00000000 = uRam00000000 & 0xffffff00 | uVar2 >> 0x1a & 0xffffff01;
  return;
}
...

{
  ...
  if (iVar6 == 0) {
    ...
    *(uint *)(unaff_s0 + 0x1c) = *(int *)(iVar6 + 8) - (uint)*(byte *)(iVar6 + 0x19) & 0x7ffffff;
    if (iVar3 != 0) {
      if ((*(byte *)(iVar3 + 0x16) < *(byte *)(iVar6 + 0x16)) &&
         ((int)((uint)*(ushort *)(iVar6 + 0x10) << 0x14) < 0)) {
        bVar1 = *(byte *)(iVar3 + 0x18);
      }
      else {
        bVar1 = *(byte *)(iVar3 + 0x17);
      }
      if ((uint)*(byte *)(iVar6 + 0x19) < (uint)bVar1) {
        uVar7 = *(int *)(iVar6 + 8) - (uint)bVar1 & 0x7ffffff;
        uVar4 = uVar7 - iVar2 & 0x7ffffff;
        if ((0x4000000 < uVar4) || (uVar4 == 0)) {
          *(uint *)(unaff_s0 + 0x1c) = iVar2 + 1U & 0x7ffffff;
          _L0();
          return;
        }
        *(uint *)(unaff_s0 + 0x1c) = uVar7;
      }
    }
  }
  iVar2 = _L0();
  if ((uint)(iVar2 - *(int *)(unaff_s0 + 0x1c)) < 0x3ffffff) {
    *(uint *)(unaff_s0 + 0x1c) = iVar2 + 1U & 0x7ffffff;
  }
...
_L0:
  if ((bRam00000000 != '\0') && (-1 < iVar2 << 5)) {
    piVar5 = *(int **)(unaff_s0 + 0x14);
    while (piVar5 != (int *)0x0) {
      uVar4 = (uint)*(ushort *)(piVar5 + 1);
      *(short *)((int)piVar5 + 6) =
           (short)((int)((uVar4 - 0x8000000U % uVar4) + (uint)*(ushort *)((int)piVar5 + 6)) %
                  (int)uVar4);
      piVar5 = (int *)*piVar5;
    }
  }
  bRam00000000 = (byte)((uint)iVar2 >> 0x1a) & 1;
  return;
}
...

{
  ...
  iVar1 = _L0();
  if ((uint)(iVar1 - *(int *)(unaff_s0 + 0x1c)) < 0x3ffffff) {
    *(uint *)(unaff_s0 + 0x1c) = iVar1 + 1U & 0x7ffffff;
  }
  _DAT_280000f8 = *(undefined4 *)(unaff_s0 + 0x1c);
  if ((_DAT_2800000c >> 7 & 1) == 0) {
    _DAT_28000018 = 0x80;
  ...
  if ((bRam00000000 != '\0') && (-1 < iVar1 << 5)) {
    piVar3 = *(int **)(unaff_s0 + 0x14);
    while (piVar3 != (int *)0x0) {
      uVar2 = (uint)*(ushort *)(piVar3 + 1);
      *(short *)((int)piVar3 + 6) =
           (short)((int)((uVar2 - 0x8000000U % uVar2) + (uint)*(ushort *)((int)piVar3 + 6)) %
                  (int)uVar2);
      piVar3 = (int *)*piVar3;
    }
  }
  bRam00000000 = (byte)((uint)iVar1 >> 0x1a) & 1;
  return;
}



// WARNING: Removing unreachable block (ram,0x00010686)
// WARNING: Globals starting with '_' overlap smaller symbols at the same address
...
_L0:
    ...
    while( true ) {
      piVar4 = piVar3;
      if ((piVar4 == (int *)0x0) || (uVar7 = _L0(elt,piVar4), uVar7 == 0)) goto _L0;
      if (uVar7 != 5) break;
_L0:
      if (uVar1 < 2) goto _L0;
_L0:
...
_L0:
    ...
    if ((elt->current_prio <= *(byte *)((int)piVar4 + 0x16)) || (_DAT_00000008 == piVar4)) {
      if (uVar1 != 0) {
        uVar7 = (uint)*(ushort *)(piVar4 + 5) + (uint)*(ushort *)((int)piVar4 + 0x12);
        uVar10 = uVar7 / 0x271 + piVar4[2];
...
_L0:
    if (cVar11 != '\0') {
      FUN_00010800(0,ppiVar13,cVar11 + -1);
      do {
        piVar5 = *ppiVar13;
        cVar11 = cVar11 + -1;
        _L0(0xc,ppiVar13);
...
_L0:
    ...
    while( true ) {
      piVar4 = piVar3;
      if ((piVar4 == (int *)0x0) || (uVar9 = _L0(piVar4), uVar9 == 0)) goto _L0;
      if (uVar9 != 5) break;
_L0:
      if (uVar1 < 2) goto _L0;
_L0:
...
_L0:
    ...
    if ((*(byte *)(unaff_s0 + 0x16) <= *(byte *)((int)piVar4 + 0x16)) || (_DAT_00000008 == piVar4))
    {
      if (uVar1 != 0) {
        uVar9 = (uint)*(ushort *)(piVar4 + 5) + (uint)*(ushort *)((int)piVar4 + 0x12);
        uVar7 = uVar9 / 0x271 + piVar4[2];
...
_L0:
    if (cVar10 != '\0') {
      FUN_00010800(0,ppiVar12,cVar10 + -1);
      do {
        piVar5 = *ppiVar12;
        cVar10 = cVar10 + -1;
        _L0(0xc,ppiVar12);
...
_L0:
  ...
  if (unaff_s2 != 0) {
    FUN_00010800(unaff_s9,unaff_s2 - 1 & 0xff);
    do {
      ppiVar1 = (int **)*unaff_s9;
      unaff_s2 = unaff_s2 - 1 & 0xff;
      _L0(unaff_s5 + 0xc,unaff_s9);
      unaff_s9 = ppiVar1;
    } while (unaff_s2 != 0);
  }
  if (unaff_s7 == (int **)0x0) {
...

{
  ...
  while (puVar1 = unaff_s1, _L0(param_1), unaff_s2 != 0) {
    unaff_s2 = unaff_s2 - 1 & 0xff;
  ...
  if (elt != (ea_elt_tag *)0x0) {
    if (_DAT_00000008 == elt) {
      ...
      if (elt == peRam00000000) {
        ...
        iVar1 = FUN_00010950(0,elt,0);
        if ((iVar1 == 0) && (iVar1 = FUN_00010962(0xc,elt,0), iVar1 == 0)) {
          return '\x02';
        }
      }
    }
...

{
  ...
  iVar2 = FUN_00010950();
  if ((iVar2 == 0) && (iVar2 = FUN_00010962(unaff_s1 + 0xc,0), iVar2 == 0)) {
    uVar1 = 2;
  }
  else {
    uVar1 = 0;
...

{
  ...
  if (iVar2 != 0) {
    ...
    uVar6 = *(int *)(iVar5 + 8) - uVar3 & 0x7ffffff;
...

{
  ...
  if (unaff_s1 != 0) {
    ...
    uVar5 = *(int *)(unaff_s0 + 8) - uVar2 & 0x7ffffff;
    if ((0x4000000 < uVar5) || (uVar5 <= bVar1)) {
  ...
  if (unaff_s0 != 0) {
    do {
      uVar5 = *(int *)(unaff_s0 + 8) - (uint)*(byte *)(unaff_s0 + 0x19) & 0x7ffffff;
      if ((uVar5 - uVar2 & 0x7ffffff) < 0x3ffffff) {
        if (uVar5 == uVar2) {
          iVar4 = FUN_00010a6e();
          if ((unaff_s2[2] != 0) && (pcVar6 = *(code **)(unaff_s2[2] + 0x20), pcVar6 != (code *)0x0)
             ) {
            (*pcVar6)();
          }
          pcVar6 = *(code **)(iVar4 + 0x1c);
          unaff_s2[2] = iVar4;
          if (pcVar6 != (code *)0x0) {
            (*pcVar6)(iVar4);
          }
...

{
  ...
  do {
    ...
    iVar1 = *unaff_s3;
    if (iVar1 == 0) goto _L0;
    uVar3 = *(int *)(iVar1 + 8) - (uint)*(byte *)(iVar1 + 0x19) & unaff_s4;
  } while (unaff_s6 < (uVar3 - unaff_s5 & unaff_s4));
  if (uVar3 == unaff_s5) {
    iVar1 = FUN_00010a6e();
    if ((unaff_s3[2] != 0) && (pcVar4 = *(code **)(unaff_s3[2] + 0x20), pcVar4 != (code *)0x0)) {
      (*pcVar4)();
    }
    pcVar4 = *(code **)(iVar1 + 0x1c);
    unaff_s3[2] = iVar1;
    if (pcVar4 != (code *)0x0) {
      (*pcVar4)(iVar1);
    }
...

{
  ...
  iVar1 = FUN_00010a6e();
  if ((*(int *)(unaff_s3 + 8) != 0) &&
     (pcVar2 = *(code **)(*(int *)(unaff_s3 + 8) + 0x20), pcVar2 != (code *)0x0)) {
    (*pcVar2)();
  }
  pcVar2 = *(code **)(iVar1 + 0x1c);
  *(int *)(unaff_s3 + 8) = iVar1;
  if (pcVar2 != (code *)0x0) {
    (*pcVar2)(iVar1);
  }
  do {
