...
union anon_union.conflictb49_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflict1182 {
    uint _unused_rand;
    char * _strtok_last;
...
struct anon_struct.conflict12c7 {
    uchar * _nextf[30];
    uint _nmalloc[30];
};

union anon_union.conflict130e_for__new {
...

{
  ...
  if (DAT_000000d3 == '\x02') {
    ...
    puVar2 = (undefined *)FUN_00010052(0x804,0,0x3e,0x22);
    *puVar2 = 9;
    puVar2[1] = 0;
    puVar3 = puVar2 + 2;
  }
    ...
    iVar1 = _LVL15(7,CONCAT22(in_register_00002032,dest_id));
    if (iVar1 == 0) {
      DAT_000000d3 = 0;
      return 0;
    }
    puVar2 = (undefined *)FUN_000100b8(0x804,0,0x3e,0x42);
    *puVar2 = 8;
    puVar2[1] = 0;
  ...
  (*pcRam00000000)(puVar3,param,0x20,pcRam00000000);
  FUN_0001007a(puVar2);
  DAT_000000d3 = 0;
  return 0;
}
...

{
  ...
  uVar1 = _L0(0,CONCAT22(in_register_00002032,dest_id),CONCAT22(in_register_00002036,src_id));
  if (((uVar1 & 0xf0) != 0x20) && (uVar1 = FUN_000101b2(0), (uVar1 & 0xf) != 3)) {
    return 0;
  }
  iVar2 = FUN_0001014a(0);
  if (iVar2 == 0x23) {
    if ((DAT_0000006e & 0xf0) == 0x10) {
      FUN_000101ec(_DAT_0000006c,0);
      DAT_0000006e = DAT_0000006e & 0xf;
    }
    _DAT_00000048 = 0;
    if ((byte)(DAT_00000050 - 1) < 2) {
_L0:
      FUN_00010218(_DAT_0000004e,0);
      if (DAT_00000050 == 2) {
        FUN_00010232(2,0xffff,0);
      }
      DAT_00000050 = DAT_00000050 & 0xf0;
    }
  }
  else {
    uVar1 = FUN_0001015c(0);
    if (((uVar1 & 0xf0) == 0x20) && (DAT_0000004c == '\0')) {
      if ((DAT_0000006e & 0xf0) == 0x10) {
        FUN_00010198(_DAT_0000006c,0);
        DAT_0000006e = DAT_0000006e & 0xf;
      }
      _DAT_00000048 = 0;
      goto _L0;
    }
    uVar1 = FUN_00010284(0);
...
undefined4
_L0(undefined2 uRam00000044,int iRam00000048,undefined4 uRam0000004c,byte param_4,int iRam00000054,
   undefined3 param_6)

{
  ...
  if (iVar2 == 0x23) {
    if ((DAT_0000006e & 0xf0) == 0x10) {
      FUN_000101ec((undefined2)param_6,0);
      DAT_0000006e = DAT_0000006e & 0xf;
    }
    iRam00000048 = 0;
    if ((byte)(DAT_00000050 - 1) < 2) {
_L0:
      FUN_00010218(uRam0000004c._2_2_,0);
      if (DAT_00000050 == 2) {
        FUN_00010232(2,0xffff,0);
      }
      DAT_00000050 = DAT_00000050 & 0xf0;
    ...
    if (((uVar1 & 0xf0) == 0x20) && (DAT_0000004c == '\0')) {
      if ((DAT_0000006e & 0xf0) == 0x10) {
        FUN_00010198((undefined2)param_6,0);
        DAT_0000006e = DAT_0000006e & 0xf;
      }
      iRam00000048 = 0;
      goto _L0;
...
undefined4
FUN_0001014a(undefined2 uRam00000044,int iRam00000048,undefined4 uRam0000004c,byte param_4,
            int iRam00000054,undefined3 param_6)
...
_L0:
    ...
    uVar2 = FUN_0001015c(0);
    if (((uVar2 & 0xf0) == 0x20) && (DAT_0000004c == '\0')) {
      if ((DAT_0000006e & 0xf0) == 0x10) {
        FUN_00010198((undefined2)param_6,0);
        DAT_0000006e = DAT_0000006e & 0xf;
      }
    ...
    uVar2 = FUN_00010284(0);
    if (((uVar2 & 0xf) != 3) || (DAT_0000004c == '\0')) {
      do {
                    // WARNING: Do nothing block with infinite loop
      } while( true );
    }
...

{
  ...
  if (((uVar1 & 0xf0) == 0x20) && (DAT_0000004c == '\0')) {
    ...
    if (((byte)(DAT_00000050 - 1) < 2) || (DAT_00000050 == 0x11)) {
      FUN_00010218(uRam0000004c._2_2_,0);
      if (DAT_00000050 == 2) {
        FUN_00010232(2,0xffff,0);
      }
...
undefined4
FUN_000101b2(undefined2 uRam00000044,int iRam00000048,undefined4 uRam0000004c,byte param_4,
            int iRam00000054,undefined3 param_6)
...

{
  ...
  *(undefined4 *)(unaff_s0 + 0x48) = 0;
  if ((byte)(*(char *)(unaff_s0 + 0x50) - 1U) < 2) {
    FUN_00010218(*(undefined2 *)(unaff_s0 + 0x4e),0);
