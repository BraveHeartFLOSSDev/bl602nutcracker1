...
union anon_union.conflictca_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflict718 {
    uint _unused_rand;
    char * _strtok_last;
...
struct anon_struct.conflict85d {
    uchar * _nextf[30];
    uint _nmalloc[30];
};

union anon_union.conflict8a4_for__new {
...

{
  ...
  _L0(0);
  FUN_00010058(0,_DAT_28000100);
  uVar1 = _DAT_28000100;
  FUN_00010072(0,_DAT_28000100 >> 0x18 & 3);
  FUN_00010088(0,uVar1 >> 0x14 & 3);
  FUN_0001009e(0,uVar1 >> 0x10 & 3);
  FUN_000100b4(0,uVar1 >> 0xe & 3);
  FUN_000100ca(0,uVar1 >> 0xc & 3);
  FUN_000100e0(0,uVar1 >> 10 & 3);
  FUN_000100f6(0,uVar1 >> 8 & 3);
  FUN_0001010c(0,uVar1 >> 6 & 3);
  FUN_00010122(0,uVar1 >> 4 & 3);
  FUN_00010138(0,uVar1 >> 3 & 1);
  FUN_0001014e(0,uVar1 >> 2 & 1);
  FUN_00010164(0,uVar1 >> 1 & 1);
  do {
...

{
  ...
  FUN_00010058();
  uVar1 = *(uint *)(unaff_s0 + 0x100);
  FUN_00010072(0,uVar1 >> 0x18 & 3);
  FUN_00010088(0,uVar1 >> 0x14 & 3);
  FUN_0001009e(0,uVar1 >> 0x10 & 3);
  FUN_000100b4(0,uVar1 >> 0xe & 3);
  FUN_000100ca(0,uVar1 >> 0xc & 3);
...

{
  ...
  FUN_00010072();
  FUN_00010088(0,unaff_s0 >> 0x14 & 3);
  FUN_0001009e(0,unaff_s0 >> 0x10 & 3);
  FUN_000100b4(0,unaff_s0 >> 0xe & 3);
  FUN_000100ca(0,unaff_s0 >> 0xc & 3);
  FUN_000100e0(0,unaff_s0 >> 10 & 3);
  FUN_000100f6(0,unaff_s0 >> 8 & 3);
  FUN_0001010c(0,unaff_s0 >> 6 & 3);
  FUN_00010122(0,unaff_s0 >> 4 & 3);
  FUN_00010138(0,unaff_s0 >> 3 & 1);
  FUN_0001014e(0,unaff_s0 >> 2 & 1);
  FUN_00010164(0,unaff_s0 >> 1 & 1);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
