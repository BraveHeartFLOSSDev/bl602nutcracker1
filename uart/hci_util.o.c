...
union anon_union.conflictbeb_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
typedef struct anon_struct.conflict1369 anon_struct.conflict1369, *Panon_struct.conflict1369;

typedef struct __tm __tm, *P__tm;

typedef struct _rand48 _rand48, *P_rand48;

struct anon_struct.conflict1369 {
    uchar * _nextf[30];
    uint _nmalloc[30];
};
...
struct anon_struct.conflict1224 {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict13b0 {
    struct anon_struct.conflict1224 _reent;
    struct anon_struct.conflict1369 _unused;
};
...
union anon_union.conflict13b0_for__new {
    struct anon_struct.conflict1224 _reent;
...

{
  ...
  iVar2 = _L0(kVar1,CONCAT31(in_register_0000202d,nb_h2c_cmd_pkts));
  if ((iVar2 == 0) || (auStack18[0] == 0)) {
    if (kVar1 != 0) {
    ...
    if (pcVar3 != (code *)0x0) {
      if (*(char *)(iVar2 + 2) < '\0') {
        (*pcVar3)(msg->param,msg->param,auStack18);
      }
      else {
        FUN_00010366(auStack18,pcVar3);
      }
    }
  }
...

{
  ...
  iVar1 = _L0();
  if ((iVar1 == 0) || (in_stack_0000000e == 0)) {
    if (unaff_s1 != 0) {
    ...
    if (pcVar2 != (code *)0x0) {
      if (*(char *)(iVar1 + 2) < '\0') {
        (*pcVar2)(unaff_s0 + 0xc,unaff_s0 + 0xc,&stack0x0000000e);
      }
      else {
        FUN_00010366(&stack0x0000000e,pcVar2);
      }
    }
  }
...

{
  ...
  auStack18[0] = msg->param_len;
  iVar1 = _L0(*(undefined *)&msg->src_id);
  if (iVar1 != 0) {
    pcVar2 = *(code **)(iVar1 + 4);
    if (pcVar2 != (code *)0x0) {
      if (*(char *)(iVar1 + 2) == '\0') {
        FUN_000103d2(auStack18,pcVar2);
      }
      else {
        (*pcVar2)(msg->param,msg->param,auStack18,auStack18[0]);
      }
    }
    msg->param_len = auStack18[0];
  }
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (pcVar2 != (code *)0x0) {
      if (*(char *)(iVar1 + 2) == '\0') {
        FUN_000103d2(&stack0x0000000e,pcVar2);
      }
      else {
        (*pcVar2)(unaff_s0 + 0xc,unaff_s0 + 0xc,&stack0x0000000e,in_stack_0000000e);
      }
    }
    *(undefined2 *)(unaff_s0 + 10) = in_stack_0000000e;
  }
...

{
  ...
  auStack18[0] = msg->param_len;
  iVar1 = _L0(*(undefined *)msg->param);
  if ((iVar1 != 0) && (pcVar3 = *(code **)(iVar1 + 4), pcVar3 != (code *)0x0)) {
    if (*(char *)(iVar1 + 2) == '\0') {
      uVar2 = FUN_00010436(auStack18,pcVar3);
    }
    else {
      uVar2 = (*pcVar3)(msg->param,msg->param,auStack18,auStack18[0]);
      uVar2 = uVar2 & 0xff;
    }
    if (uVar2 == 0) {
      msg->param_len = auStack18[0];
...

{
  ...
  if ((iVar1 != 0) && (pcVar3 = *(code **)(iVar1 + 4), pcVar3 != (code *)0x0)) {
    if (*(char *)(iVar1 + 2) == '\0') {
      uVar2 = FUN_00010436(&stack0x0000000e,pcVar3);
    }
    else {
      uVar2 = (*pcVar3)(unaff_s0 + 0xc,unaff_s0 + 0xc,&stack0x0000000e,in_stack_0000000e);
      uVar2 = uVar2 & 0xff;
    }
    if (uVar2 == 0) {
      *(undefined2 *)(unaff_s0 + 10) = in_stack_0000000e;
...

{
  ...
  iVar3 = _LVL125(*(undefined *)((int)&msg[1].hdr.next + 2));
  bVar1 = *(byte *)((int)msg->param + 2);
  uVar4 = *(ushort *)msg->param & 0xfff;
  *(uint8_t *)(iVar3 + -4) = (uint8_t)uVar4;
  *(char *)(iVar3 + -3) = (char)((((uint)bVar1 << 0xc | uVar4) << 0x10) >> 0x18);
  uVar2 = *(undefined2 *)&msg[1].hdr.next;
  *(char *)(iVar3 + -2) = (char)uVar2;
  *(char *)(iVar3 + -1) = (char)((ushort)uVar2 >> 8);
  return (uint8_t *)(iVar3 + -4);
}
...

{
  ...
  uVar4 = *(ushort *)(unaff_s0 + 0xc) & 0xfff;
  *(char *)(iVar3 + -4) = (char)uVar4;
  *(char *)(iVar3 + -3) = (char)((((uint)bVar1 << 0xc | uVar4) << 0x10) >> 0x18);
