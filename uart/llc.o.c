...
union anon_union.conflict16d4_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflict1d0d {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict1e99_for__new {
...

{
  ...
  _L0();
  piVar3 = (int *)(unaff_s0 + unaff_s3 * 4);
  if (*piVar3 == 0) {
    return;
  }
  iVar4 = 0;
  do {
    iVar2 = *(int *)(*piVar3 + iVar4 * 4);
    if (iVar2 != 0) {
      FUN_000100a0(iVar2 + -0xc);
    }
    iVar4 = iVar4 + 1;
  } while (iVar4 != 4);
  puVar1 = (undefined4 *)(unaff_s0 + unaff_s3 * 4);
  FUN_000100b2(*puVar1);
  *puVar1 = 0;
  do {
                    // WARNING: Do nothing block with infinite loop
  ...
  do {
    ...
    do {
      ...
      if (unaff_s2 == unaff_s5) {
        FUN_000100b2(*(undefined4 *)(unaff_s0 + unaff_s4));
        *(undefined4 *)(unaff_s0 + unaff_s4) = 0;
        do {
                    // WARNING: Do nothing block with infinite loop
        } while( true );
      }
      param_1 = *(int *)(*unaff_s1 + unaff_s2 * 4);
    } while (param_1 == 0);
    param_1 = param_1 + -0xc;
  } while( true );
}
...

{
  ...
  puVar1 = (uint8_t *)_L0(0x803,CONCAT31(in_register_00002031,conhdl),5,6);
  *puVar1 = status;
  puVar1[4] = reason;
  *(short *)(puVar1 + 2) = (short)CONCAT31(in_register_00002031,conhdl);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  uVar5 = CONCAT22(in_register_0000202e,conhdl);
  iVar4 = CONCAT31(in_register_00002029,status);
  iVar2 = _L0(0);
  if ((iVar2 == 0) && (iVar2 = FUN_00010284(9), iVar2 == 0)) {
    return;
  }
  iVar2 = FUN_00010198(9);
  if (iVar2 != 0) {
    puVar3 = (undefined *)FUN_0001031a(0x804,uVar5,0,0x20);
    *puVar3 = 10;
    puVar3[1] = status;
    *(uint16_t *)(puVar3 + 2) = conhdl;
    if (iVar4 != 0) {
      ...
      *(undefined2 *)(puVar3 + 2) = 0;
      puVar3[5] = uVar1;
      pcVar9 = pcRam00000000;
      *(undefined2 *)(puVar3 + 0x18) = 0;
      *(undefined2 *)(puVar3 + 0x1a) = 0;
      *(undefined2 *)(puVar3 + 0x1c) = 0;
      (*pcVar9)(puVar3 + 6,&param->peer_addr,6,pcVar9);
      (*pcRam00000000)(puVar3 + 0x12,0,6,pcRam00000000);
      pbVar6 = (bd_addr *)0x0;
      puVar3 = puVar3 + 0xc;
      pcVar9 = pcRam00000000;
      goto _L0;
    }
    iVar4 = FUN_00010338(uVar5);
    puVar3[4] = iVar4 != 3;
    uVar7 = (uint)param->ral_ptr;
    puVar10 = puVar3 + 0xc;
    if (uVar7 == 0) {
      (*pcRam00000000)(puVar10,0,6,pcRam00000000);
      puVar10 = puVar3 + 0x12;
_L0:
      (*pcRam00000000)(puVar10,0,6,pcRam00000000);
    }
    else {
      puVar8 = (ushort *)(((uVar7 - 0x22e) / 0x34 & 0xff) * 0x34 + 0x2800822e);
      if (((*puVar8 >> 1 & 1) == 0) || ((param->filter_policy != '\0' && ((*puVar8 >> 3 & 1) == 0)))
         ) {
        iVar4 = 0;
      }
      else {
        iVar4 = (uVar7 + 0x12 & 0xffff) + 0x28008000;
      }
      (*pcRam00000000)(puVar3 + 0x12,iVar4,6,pcRam00000000);
      if (((*puVar8 >> 5 & 1) == 0) || ((puVar3[4] == '\x01' && ((_DAT_28008154 >> 2 & 1) == 0))))
      goto _L0;
      (*pcRam00000000)(puVar10,(param->ral_ptr + 0x2e & 0xffff) + 0x28008000,6,pcRam00000000);
    }
    puVar3[5] = param->peer_addr_type;
    (*pcRam00000000)(puVar3 + 6,&param->peer_addr,6,pcRam00000000);
    *(uint16_t *)(puVar3 + 0x18) = param->con_int;
    *(uint16_t *)(puVar3 + 0x1a) = param->con_lat;
    *(uint16_t *)(puVar3 + 0x1c) = param->sup_to;
    if (puVar3[4] == '\0') {
      puVar3[0x1e] = 0;
    }
    else {
      puVar3[0x1e] = param->sleep_clk_acc;
    }
    goto _L0;
  }
  puVar3 = (undefined *)FUN_000101b0(0x804,uVar5,0,0x14);
  *puVar3 = 1;
  puVar3[1] = status;
  *(uint16_t *)(puVar3 + 2) = conhdl;
  if (iVar4 != 0) {
    ...
    *(undefined2 *)(puVar3 + 0x10) = 0;
    pbVar6 = &param->peer_addr;
    puVar3 = puVar3 + 6;
_L0:
    (*pcVar9)(puVar3,pbVar6,6,pcVar9);
    goto _L0;
  }
  iVar4 = FUN_000101ce(uVar5);
  puVar3[4] = iVar4 != 3;
  puVar10 = puVar3 + 6;
  if ((param->ral_ptr == 0) ||
     (puVar8 = (ushort *)(((param->ral_ptr - 0x22e) / 0x34 & 0xff) * 0x34 + 0x2800822e),
     (*puVar8 >> 1 & 1) == 0)) {
_L0:
    puVar3[5] = param->peer_addr_type & 1;
    (*pcRam00000000)(puVar10,&param->peer_addr,6,pcRam00000000);
  }
  else {
    if ((param->filter_policy != '\0') && ((*puVar8 >> 3 & 1) == 0)) {
      (*pcRam00000000)(puVar10,0,6,pcRam00000000);
      goto _L0;
    }
    puVar3[5] = 1;
    (*pcRam00000000)(puVar10,(param->ral_ptr + 0x12 & 0xffff) + 0x28008000,6,pcRam00000000);
  }
  *(uint16_t *)(puVar3 + 0xc) = param->con_int;
  *(uint16_t *)(puVar3 + 0xe) = param->con_lat;
  *(uint16_t *)(puVar3 + 0x10) = param->sup_to;
  if (puVar3[4] == '\0') {
    puVar3[0x12] = 0;
  }
  else {
    puVar3[0x12] = param->sleep_clk_acc;
  }
_L0:
  do {
                    // WARNING: Do nothing block with infinite loop
...

{
  ...
  iVar2 = FUN_00010198(9);
  if (iVar2 != 0) {
    puVar3 = (undefined *)FUN_0001031a(0x804,0,0x20);
    *puVar3 = 10;
    puVar3[1] = (char)unaff_s2;
    *(undefined2 *)(puVar3 + 2) = unaff_s3;
    if (unaff_s2 != 0) {
      ...
      *(undefined2 *)(puVar3 + 0x1a) = 0;
      *(undefined2 *)(puVar3 + 0x1c) = 0;
      (*pcVar7)(puVar3 + 6,unaff_s1 + 4,6,pcVar7);
      (*pcRam00000000)(puVar3 + 0x12,0,6,pcRam00000000);
    ...
    iVar2 = FUN_00010338();
    puVar3[4] = iVar2 != 3;
    uVar5 = (uint)(ushort)unaff_s1[3];
    puVar8 = puVar3 + 0xc;
    if (uVar5 == 0) {
      (*pcRam00000000)(puVar8,0,6,pcRam00000000);
      puVar8 = puVar3 + 0x12;
_L0:
      (*pcRam00000000)(puVar8,0,6,pcRam00000000);
    }
    else {
      puVar6 = (ushort *)(((uVar5 - 0x22e) / 0x34 & 0xff) * 0x34 + 0x2800822e);
      if (((*puVar6 >> 1 & 1) == 0) ||
         ((*(char *)((int)unaff_s1 + 0x11) != '\0' && ((*puVar6 >> 3 & 1) == 0)))) {
        iVar2 = 0;
      }
      else {
        iVar2 = (uVar5 + 0x12 & 0xffff) + 0x28008000;
      }
      (*pcRam00000000)(puVar3 + 0x12,iVar2,6,pcRam00000000);
      if (((*puVar6 >> 5 & 1) == 0) || ((puVar3[4] == '\x01' && ((_DAT_28008154 >> 2 & 1) == 0))))
      goto _L0;
      (*pcRam00000000)(puVar8,((ushort)unaff_s1[3] + 0x2e & 0xffff) + 0x28008000,6,pcRam00000000);
    }
    puVar3[5] = *(undefined *)(unaff_s1 + 7);
    (*pcRam00000000)(puVar3 + 6,unaff_s1 + 4,6,pcRam00000000);
    *(undefined2 *)(puVar3 + 0x18) = *unaff_s1;
    *(undefined2 *)(puVar3 + 0x1a) = unaff_s1[1];
    *(undefined2 *)(puVar3 + 0x1c) = unaff_s1[2];
    if (puVar3[4] == '\0') {
      puVar3[0x1e] = 0;
    }
    else {
      puVar3[0x1e] = *(undefined *)(unaff_s1 + 8);
    }
    goto _L0;
  }
  puVar3 = (undefined *)FUN_000101b0(0x804,0,0x14);
  *puVar3 = 1;
  puVar3[1] = (char)unaff_s2;
  *(undefined2 *)(puVar3 + 2) = unaff_s3;
  if (unaff_s2 != 0) {
...
_L0:
  ...
  if (((ushort)unaff_s1[3] == 0) ||
     (puVar6 = (ushort *)((((ushort)unaff_s1[3] - 0x22e) / 0x34 & 0xff) * 0x34 + 0x2800822e),
     (*puVar6 >> 1 & 1) == 0)) {
_L0:
    puVar3[5] = *(byte *)(unaff_s1 + 7) & 1;
    (*pcRam00000000)(puVar8,unaff_s1 + 4,6,pcRam00000000);
  }
  else {
    if ((*(char *)((int)unaff_s1 + 0x11) != '\0') && ((*puVar6 >> 3 & 1) == 0)) {
      (*pcRam00000000)(puVar8,0,6,pcRam00000000);
      goto _L0;
    }
    puVar3[5] = 1;
    (*pcRam00000000)(puVar8,((ushort)unaff_s1[3] + 0x12 & 0xffff) + 0x28008000,6,pcRam00000000);
  }
  *(undefined2 *)(puVar3 + 0xc) = *unaff_s1;
  *(undefined2 *)(puVar3 + 0xe) = unaff_s1[1];
  *(undefined2 *)(puVar3 + 0x10) = unaff_s1[2];
  if (puVar3[4] == '\0') {
    puVar3[0x12] = 0;
  }
  else {
    puVar3[0x12] = *(undefined *)(unaff_s1 + 8);
  }
_L0:
  do {
                    // WARNING: Do nothing block with infinite loop
  ...
  *(undefined2 *)(puVar3 + 2) = unaff_s3;
  if (unaff_s2 != 0) {
    if (unaff_s2 == 0x3c) {
      ...
      *(undefined2 *)(puVar3 + 0xe) = 0;
      *(undefined2 *)(puVar3 + 0x10) = 0;
      (*pcVar2)(puVar3 + 6,unaff_s1 + 4,6,pcVar2);
    }
    goto _L0;
  }
  iVar4 = FUN_000101ce();
...
_L0:
    puVar3[5] = *(byte *)(unaff_s1 + 7) & 1;
    (*pcRam00000000)(puVar6,unaff_s1 + 4,6,pcRam00000000);
  }
  else {
    ...
    puVar3[5] = 1;
    (*pcRam00000000)(puVar6,((ushort)unaff_s1[3] + 0x12 & 0xffff) + 0x28008000,6,pcRam00000000);
  }
  *(undefined2 *)(puVar3 + 0xc) = *unaff_s1;
  *(undefined2 *)(puVar3 + 0xe) = unaff_s1[1];
  *(undefined2 *)(puVar3 + 0x10) = unaff_s1[2];
...

{
  ...
  iVar1 = FUN_000101ce();
  *(bool *)(unaff_s0 + 4) = iVar1 != 3;
  iVar1 = unaff_s0 + 6;
  if (((ushort)unaff_s1[3] != 0) &&
     (puVar2 = (ushort *)((((ushort)unaff_s1[3] - 0x22e) / 0x34 & 0xff) * 0x34 + 0x2800822e),
     (*puVar2 >> 1 & 1) != 0)) {
    if ((*(char *)((int)unaff_s1 + 0x11) == '\0') || ((*puVar2 >> 3 & 1) != 0)) {
      *(undefined *)(unaff_s0 + 5) = 1;
      (*pcRam00000000)(iVar1,((ushort)unaff_s1[3] + 0x12 & 0xffff) + 0x28008000,6,pcRam00000000);
      goto _L0;
    }
    (*pcRam00000000)(iVar1,0,6,pcRam00000000);
  }
  *(byte *)(unaff_s0 + 5) = *(byte *)(unaff_s1 + 7) & 1;
  (*pcRam00000000)(iVar1,unaff_s1 + 4,6,pcRam00000000);
_L0:
...

{
  ...
  iVar3 = FUN_00010198(9);
  if (iVar3 != 0) {
    puVar2 = (undefined *)FUN_0001031a(0x804,0,0x20);
    *puVar2 = 10;
    puVar2[1] = (char)unaff_s2;
    *(undefined2 *)(puVar2 + 2) = unaff_s3;
    if (unaff_s2 != 0) {
      if (unaff_s2 != 0x3c) goto _L0;
      puVar2[4] = 1;
      uVar1 = *(undefined *)(unaff_s1 + 7);
      ...
      *(undefined2 *)(puVar2 + 0x1c) = 0;
      (*pcVar7)(puVar2 + 6,unaff_s1 + 4,6,pcVar7);
      (*pcRam00000000)(puVar2 + 0x12,0,6,pcRam00000000);
      puVar4 = (undefined2 *)0x0;
      puVar2 = puVar2 + 0xc;
      pcVar7 = pcRam00000000;
      goto _L0;
...
_L0:
      ...
      if (((*puVar6 >> 1 & 1) == 0) ||
        ...
        iVar3 = (uVar5 + 0x12 & 0xffff) + 0x28008000;
      }
      (*pcRam00000000)(puVar2 + 0x12,iVar3,6,pcRam00000000);
      if (((*puVar6 >> 5 & 1) == 0) || ((puVar2[4] == '\x01' && ((_DAT_28008154 >> 2 & 1) == 0))))
      goto _L0;
      (*pcRam00000000)(puVar8,((ushort)unaff_s1[3] + 0x2e & 0xffff) + 0x28008000,6,pcRam00000000);
    }
    puVar2[5] = *(undefined *)(unaff_s1 + 7);
    (*pcRam00000000)(puVar2 + 6,unaff_s1 + 4,6,pcRam00000000);
    *(undefined2 *)(puVar2 + 0x18) = *unaff_s1;
    *(undefined2 *)(puVar2 + 0x1a) = unaff_s1[1];
    *(undefined2 *)(puVar2 + 0x1c) = unaff_s1[2];
    if (puVar2[4] == '\0') {
      puVar2[0x1e] = 0;
    }
    else {
      puVar2[0x1e] = *(undefined *)(unaff_s1 + 8);
    }
    goto _L0;
  }
  puVar2 = (undefined *)FUN_000101b0(0x804,0,0x14);
  *puVar2 = 1;
  puVar2[1] = (char)unaff_s2;
  *(undefined2 *)(puVar2 + 2) = unaff_s3;
  if (unaff_s2 != 0) {
...
_L0:
  ...
  *(undefined2 *)(puVar2 + 0xc) = *unaff_s1;
  *(undefined2 *)(puVar2 + 0xe) = unaff_s1[1];
  *(undefined2 *)(puVar2 + 0x10) = unaff_s1[2];
  if (puVar2[4] == '\0') {
    puVar2[0x12] = 0;
  }
  else {
    puVar2[0x12] = *(undefined *)(unaff_s1 + 8);
  }
_L0:
  do {
                    // WARNING: Do nothing block with infinite loop
  ...
  if (unaff_s2 != 0) {
    if (unaff_s2 == 0x3c) {
      ...
      *(undefined2 *)(puVar3 + 0x1c) = 0;
      (*pcVar2)(puVar3 + 6,unaff_s1 + 4,6,pcVar2);
      (*pcRam00000000)(puVar3 + 0x12,0,6,pcRam00000000);
      (*pcRam00000000)(puVar3 + 0xc,0,6,pcRam00000000);
    }
    goto _L0;
  }
  iVar4 = FUN_00010338();
...
_L0:
    ...
    if (((*puVar6 >> 1 & 1) == 0) ||
      ...
      iVar4 = (uVar5 + 0x12 & 0xffff) + 0x28008000;
    }
    (*pcRam00000000)(puVar3 + 0x12,iVar4,6,pcRam00000000);
    if (((*puVar6 >> 5 & 1) == 0) || ((puVar3[4] == '\x01' && ((_DAT_28008154 >> 2 & 1) == 0))))
    goto _L0;
...

{
  ...
  *(bool *)(unaff_s0 + 4) = iVar1 != 3;
  ...
  if (uVar2 == 0) {
    ...
    puVar4 = (ushort *)(((uVar2 - 0x22e) / 0x34 & 0xff) * 0x34 + 0x2800822e);
    if (((*puVar4 >> 1 & 1) == 0) ||
       ((*(char *)((int)unaff_s1 + 0x11) != '\0' && ((*puVar4 >> 3 & 1) == 0)))) {
      iVar3 = 0;
    }
    else {
      iVar3 = (uVar2 + 0x12 & 0xffff) + 0x28008000;
    }
    (*pcRam00000000)(unaff_s0 + 0x12,iVar3,6,pcRam00000000);
    if (((*puVar4 >> 5 & 1) != 0) &&
       ((*(char *)(unaff_s0 + 4) != '\x01' || ((_DAT_28008154 >> 2 & 1) != 0)))) {
      (*pcRam00000000)(iVar1,((ushort)unaff_s1[3] + 0x2e & 0xffff) + 0x28008000,6,pcRam00000000);
      goto _L0;
    }
  }
  (*pcRam00000000)(iVar1,0,6,pcRam00000000);
...

{
  ...
  puVar2 = (undefined *)FUN_000104e6(0x804,CONCAT22(in_register_0000202e,conhdl),0,6);
  *puVar2 = 0x14;
  puVar2[4] = chSel;
  *(uint16_t *)(puVar2 + 2) = conhdl;
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  puVar2 = (undefined *)FUN_000104e6(0x804,0,6);
  *puVar2 = 0x14;
  puVar2[4] = unaff_s1;
  *(undefined2 *)(puVar2 + 2) = unaff_s0;
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  uVar6 = (uint)*(ushort *)&elt[2].ea_cb_start;
  piVar7 = (int *)(uVar6 * 4);
  uVar5 = (uVar6 & 0xff) << 8 | 1;
  if (*piVar7 == 0) {
    iVar4 = _LVL97(0xa8,0);
    *piVar7 = iVar4;
  }
  ...
  *(undefined *)((int)puVar3 + 0xa6) = 1;
  (*pcVar1)(puVar3 + 0xf,0,6,pcVar1);
  FUN_00010592((int)puVar3 + 0x5e);
  FUN_0001059e((int)puVar3 + 99);
  if (*(char *)((int)&elt[2].ea_cb_stop + 3) == '\x03') {
    (*pcRam00000000)(puVar3 + 5,0,0x28,pcRam00000000);
    uVar2 = _DAT_0000002c;
    *(undefined *)((int)puVar3 + 0x3a) = DAT_00000031;
    FUN_000105da(0x105,uVar5,uVar2);
  ...
  puVar3[4] = elt;
  *(uint16_t *)(puVar3 + 0x15) = param->sup_to;
  _L0(0x101,uVar5);
  *(undefined *)((int)puVar3 + 0xa1) = 8;
  *(undefined2 *)(puVar3 + 0x17) = 0;
  *(undefined *)((int)puVar3 + 0xa2) = 0;
  _L0((int)puVar3 + 0x69);
  *puVar3 = 0;
  puVar3[1] = 0;
  puVar3[2] = 0;
  ...
  *(undefined *)(iVar4 + 0xa4) = 0;
  _L0(&elt->env);
  uVar2 = _DAT_00000020;
  *(undefined *)((int)puVar3 + 0x52) = 0;
  *(undefined2 *)((int)puVar3 + 0x42) = uVar2;
  *(undefined2 *)((int)puVar3 + 0x4a) = _DAT_00000022;
  puVar3[0x11] = 0x1b00fb;
  *(undefined2 *)(puVar3 + 0x12) = 0x1b;
  puVar3[0x13] = 0x1480848;
  *(undefined2 *)(puVar3 + 0x14) = 0x148;
  *(byte *)((int)puVar3 + 0x53) = *(byte *)((int)puVar3 + 0x53) & 0xfe | 2;
  *(undefined4 *)*piVar7 = 0;
...
void _LVL97(undefined4 uRam00000020,undefined2 uRam0000002c,undefined2 param_3)

{
  ...
  *unaff_s0 = uVar5;
  pcVar1 = pcRam00000000;
  puVar3 = *(undefined4 **)(unaff_s1 + unaff_s8);
  *(undefined *)((int)puVar3 + 0xa6) = 1;
  (*pcVar1)(puVar3 + 0xf,0,6,pcVar1);
  FUN_00010592((int)puVar3 + 0x5e);
  FUN_0001059e((int)puVar3 + 99);
  ...
  puVar3[4] = unaff_s6;
  *(undefined2 *)(puVar3 + 0x15) = *(undefined2 *)(unaff_s5 + 4);
  _L0(0x101);
  *(undefined *)((int)puVar3 + 0xa1) = 8;
  *(undefined2 *)(puVar3 + 0x17) = 0;
  *(undefined *)((int)puVar3 + 0xa2) = 0;
  ...
  *puVar3 = 0;
  ...
  puVar3[3] = 0;
  _L0(0);
  piVar4 = (int *)(unaff_s1 + unaff_s8);
  iVar6 = *piVar4;
  *(undefined2 *)(iVar6 + 0x58) = 3000;
  *(undefined *)(iVar6 + 0xa3) = 0;
  *(undefined *)(iVar6 + 0xa4) = 0;
  _L0();
  uVar2 = (undefined2)uRam00000020;
  *(undefined *)((int)puVar3 + 0x52) = 0;
  *(undefined2 *)((int)puVar3 + 0x42) = uVar2;
  *(undefined2 *)((int)puVar3 + 0x4a) = uRam00000020._2_2_;
  puVar3[0x11] = 0x1b00fb;
  *(undefined2 *)(puVar3 + 0x12) = 0x1b;
  puVar3[0x13] = 0x1480848;
  *(undefined2 *)(puVar3 + 0x14) = 0x148;
...
void FUN_00010592(undefined4 uRam00000020,undefined2 uRam0000002c,undefined2 param_3)

{
  ...
  FUN_00010592();
  FUN_0001059e((int)unaff_s0 + 99);
  if (*(char *)(unaff_s6 + 0x7b) == '\x03') {
    (**unaff_s10)(unaff_s0 + 5,0,0x28,*unaff_s10);
    uVar1 = uRam0000002c;
    *(undefined *)((int)unaff_s0 + 0x3a) = DAT_00000031;
    FUN_000105da(0x105,uVar1);
...

{
  ...
  puVar2 = (undefined *)_L0(0x804,0,10);
  *puVar2 = 3;
  *(uint16_t *)(puVar2 + 2) = conhdl;
  puVar2[1] = status;
  ...
  if (evt == (lld_evt_tag *)0x0) {
    ...
    *(undefined2 *)(puVar2 + 6) = *(undefined2 *)(iVar4 + 6);
    uVar3 = *(undefined2 *)(iVar4 + 8);
  }
  else {
    *(uint16_t *)(puVar2 + 4) = evt->interval >> 1;
    *(short *)(puVar2 + 6) = *(short *)&(evt->evt).field_0xa + -1;
    uVar3 = *(undefined2 *)(*ppiVar1 + 0x15);
  }
  *(undefined2 *)(puVar2 + 8) = uVar3;
_L0:
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
...

{
  ...
  *(short *)(puVar1 + 2) = (short)unaff_s0;
  ...
  if (unaff_s1 == 0) {
    ...
    *(undefined2 *)(puVar1 + 4) = *(undefined2 *)(iVar3 + 0xe);
    *(undefined2 *)(puVar1 + 6) = *(undefined2 *)(iVar3 + 6);
    uVar2 = *(undefined2 *)(iVar3 + 8);
  }
  else {
    *(ushort *)(puVar1 + 4) = *(ushort *)(unaff_s1 + 0x50) >> 1;
    *(short *)(puVar1 + 6) = *(short *)(unaff_s1 + 0x36) + -1;
    uVar2 = *(undefined2 *)(*(int **)(unaff_s0 * 4) + 0x15);
  }
...

{
  ...
  puVar1 = (undefined *)_L0(0x804,CONCAT22(in_register_0000202a,conhdl),0,0xe);
  *(uint16_t *)(puVar1 + 2) = conhdl;
  *puVar1 = 5;
  *(undefined2 *)(puVar1 + 0xc) = *(undefined2 *)param->ediv;
  (*pcRam00000000)(puVar1 + 4,&param->rand,8,pcRam00000000);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  *puVar1 = 5;
  *(undefined2 *)(puVar1 + 0xc) = *(undefined2 *)(unaff_s1 + 9);
  (*pcRam00000000)(puVar1 + 4,unaff_s1 + 1,8,pcRam00000000);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  puVar2 = (undefined *)FUN_00010838(0x804,CONCAT22(in_register_0000202e,conhdl),0,0xc);
  *puVar2 = 4;
  puVar2[1] = status;
  *(uint16_t *)(puVar2 + 2) = conhdl;
  (*pcRam00000000)(puVar2 + 4,feats,8,pcRam00000000);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  puVar2 = (undefined *)FUN_00010838(0x804,0,0xc);
  *puVar2 = 4;
  puVar2[1] = unaff_s3;
  *(undefined2 *)(puVar2 + 2) = unaff_s1;
  (*pcRam00000000)(puVar2 + 4,8,pcRam00000000);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  puVar1 = (undefined *)FUN_00010838();
  *puVar1 = 4;
  puVar1[1] = unaff_s3;
  *(undefined2 *)(puVar1 + 2) = unaff_s1;
  (*pcRam00000000)(puVar1 + 4,8,pcRam00000000);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  puVar2 = (uint8_t *)_L0(0x803,0xc,10);
  *(uint16_t *)(puVar2 + 2) = conhdl;
  piVar1 = (int *)(CONCAT22(in_register_0000202e,conhdl) << 2);
  *puVar2 = status;
  *(undefined2 *)(puVar2 + 6) = *(undefined2 *)(*piVar1 + 0x3e);
  iVar3 = *piVar1;
  *(undefined2 *)(puVar2 + 8) = *(undefined2 *)(iVar3 + 0x40);
  puVar2[4] = *(uint8_t *)(iVar3 + 0x3c);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  *(short *)(puVar1 + 2) = (short)unaff_s0;
  *puVar1 = unaff_s1;
  *(undefined2 *)(puVar1 + 6) = *(undefined2 *)(*(int *)(unaff_s0 * 4) + 0x3e);
  iVar2 = *(int *)(unaff_s0 * 4);
  *(undefined2 *)(puVar1 + 8) = *(undefined2 *)(iVar2 + 0x40);
  puVar1[4] = *(undefined *)(iVar2 + 0x3c);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  puVar1 = (uint8_t *)
           _L0(0x801,CONCAT22(in_register_00002032,conhdl),CONCAT22(in_register_0000202a,opcode),4);
  *puVar1 = status;
  *(uint16_t *)(puVar1 + 2) = conhdl;
  do {
                    // WARNING: Do nothing block with infinite loop
...

{
  ...
  puVar1 = (uint8_t *)
           _L0(0x802,CONCAT22(in_register_00002032,conhdl),CONCAT22(in_register_0000202a,opcode),1);
  *puVar1 = status;
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
...

{
  ...
  puVar1 = (uint16_t *)_L0(0x803,CONCAT22(in_register_0000202a,conhdl),0x11,2);
  *puVar1 = conhdl;
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
...

{
  ...
  puVar1 = (uint8_t *)_L0(0x803,CONCAT22(in_register_0000202a,conhdl),0x30,4);
  *(uint16_t *)(puVar1 + 2) = conhdl;
  *puVar1 = status;
  do {
                    // WARNING: Do nothing block with infinite loop
...

{
  ...
  if (CONCAT31(in_register_0000202d,enc_status) == 0) {
    _LVL203(0x103,uVar1);
    FUN_00010a58(0x104,uVar1);
  }
  else {
    piVar2 = (int *)(CONCAT22(in_register_0000202a,conhdl) * 4);
    iVar4 = *piVar2;
    FUN_000109f2(0x103,uVar1,(uint)*(ushort *)(iVar4 + 0x58) - (uint)*(ushort *)(iVar4 + 0x5a));
    FUN_00010a06(0x104,uVar1,*(undefined2 *)(*piVar2 + 0x58));
  }
  puVar3 = (uint8_t *)FUN_00010a1a(0x803,CONCAT22(in_register_0000202a,conhdl),8,6);
  *(uint16_t *)(puVar3 + 2) = conhdl;
  puVar3[4] = enc_status;
  *puVar3 = status;
  do {
...

{
  ...
  FUN_000109f2();
  FUN_00010a06(0x104,*(undefined2 *)(*unaff_s1 + 0x58));
  puVar1 = (undefined *)FUN_00010a1a(0x803,8,6);
  *(undefined2 *)(puVar1 + 2) = unaff_s2;
  puVar1[4] = unaff_s3;
  *puVar1 = unaff_s4;
  do {
...

{
  ...
  puVar1 = (undefined *)_L0(0x803,CONCAT22(in_register_0000202a,conhdl),0x13,6);
  *(uint16_t *)(puVar1 + 2) = conhdl;
  *(short *)(puVar1 + 4) = (short)CONCAT31(in_register_0000202d,nb_of_pkt);
  *puVar1 = 1;
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
...

{
  ...
  if ((uVar1 & 0xc0) != 0) {
    *(ushort *)(iVar2 + 0x5c) = uVar1 & 0xff3f;
    iVar2 = _LVL213(2);
    if (iVar2 != 0) {
      FUN_00010aea(0,CONCAT22(in_register_0000202a,conhdl),&elt_new->env);
    }
  }
  iVar2 = *piVar3;
...

{
  ...
  iVar1 = *(int *)(CONCAT22(in_register_0000202a,conhdl) * 4);
  iVar2 = _LVL226(iVar1 + 99,5);
  iVar3 = CONCAT22(in_register_0000202a,conhdl) * 0x5c;
  *(undefined2 *)(iVar3 + 0x280080aa) = *(undefined2 *)(iVar1 + 99);
  *(undefined2 *)(iVar3 + 0x280080ac) = *(undefined2 *)(iVar1 + 0x65);
  *(ushort *)(iVar3 + 0x280080ae) = (ushort)(iVar2 << 8) | (ushort)*(byte *)(iVar1 + 0x67);
  FUN_00010bf6(iVar1 + 0x5e,iVar1 + 99,5);
  return;
}
...

{
  ...
  iVar1 = _LVL226();
  iVar2 = unaff_s0 * 0x5c;
  *(undefined2 *)(iVar2 + 0x280080aa) = *(undefined2 *)(unaff_s1 + 99);
  *(undefined2 *)(iVar2 + 0x280080ac) = *(undefined2 *)(unaff_s1 + 0x65);
  *(ushort *)(iVar2 + 0x280080ae) = (ushort)(iVar1 << 8) | (ushort)*(byte *)(unaff_s1 + 0x67);
  FUN_00010bf6(unaff_s1 + 0x5e,5);
  return;
}
...

{
  ...
  uVar2 = (conhdl & 0xff) << 8 | 1;
  uVar3 = _L0(uVar2);
  if ((uVar3 & 0xf) != 0xf) {
    iVar4 = _LVL242(iVar5);
    piVar6 = (int *)(iVar5 << 2);
    if (iVar4 == 3) {
      FUN_00010c5c(iVar5,0);
      FUN_00010c6a(uVar2,uVar3 & 0xfe);
      *(undefined *)(*piVar6 + 0xa3) = 0;
    }
    else {
      uVar1 = *(ushort *)(*piVar6 + 0x5c);
      if ((uVar1 & 0x400) == 0) {
        *(ushort *)(*piVar6 + 0x5c) = uVar1 | 0x800;
      }
      else {
        FUN_00010c9e(uVar2,uVar3 & 0xfd);
        iVar5 = *piVar6;
        *(undefined *)(iVar5 + 0xa4) = 0;
        *(ushort *)(iVar5 + 0x5c) = *(ushort *)(iVar5 + 0x5c) & 0xfbff;
      }
    }
  }
  return;
...

{
  ...
  if ((uVar2 & 0xf) != 0xf) {
    iVar3 = _LVL242();
    piVar4 = (int *)(unaff_s2 * 4);
    if (iVar3 == 3) {
      FUN_00010c5c(0);
      FUN_00010c6a(uVar2 & 0xfe);
      *(undefined *)(*piVar4 + 0xa3) = 0;
    }
    else {
      uVar1 = *(ushort *)(*piVar4 + 0x5c);
      if ((uVar1 & 0x400) == 0) {
        *(ushort *)(*piVar4 + 0x5c) = uVar1 | 0x800;
      }
      else {
        FUN_00010c9e(uVar2 & 0xfd);
        iVar3 = *piVar4;
        *(undefined *)(iVar3 + 0xa4) = 0;
        *(ushort *)(iVar3 + 0x5c) = *(ushort *)(iVar3 + 0x5c) & 0xfbff;
      }
    }
  }
  return;
...

{
  ...
  uVar3 = _L0(uVar2);
  if ((uVar3 & 0xf) != 0xf) {
    iVar4 = _LVL257(CONCAT22(in_register_0000202a,conhdl));
    piVar5 = (int *)(CONCAT22(in_register_0000202a,conhdl) << 2);
    if (iVar4 == 3) {
      FUN_00010d18(uVar2,uVar3 & 0xfe);
      *(undefined *)(*piVar5 + 0xa3) = 0;
    }
    else {
      uVar1 = *(ushort *)(*piVar5 + 0x5c);
      if ((uVar1 & 0x400) == 0) {
        *(ushort *)(*piVar5 + 0x5c) = uVar1 | 0x800;
      }
      else {
        FUN_00010d4a(uVar2,uVar3 & 0xfd);
        iVar4 = *piVar5;
        *(undefined *)(iVar4 + 0xa4) = 0;
        *(ushort *)(iVar4 + 0x5c) = *(ushort *)(iVar4 + 0x5c) & 0xfbff;
      }
    }
  }
  return;
