...
struct at_ip_para_t { // DWARF DIE: 130a
    at_ip_t ip;
    at_ip_t getway;
    at_ip_t netmask;
    at_ip_t dns1;
...
typedef struct anon_struct.conflict15e7 anon_struct.conflict15e7, *Panon_struct.conflict15e7;
...
typedef struct anon_struct.conflict16ad anon_struct.conflict16ad, *Panon_struct.conflict16ad;
...
typedef struct anon_struct.conflict1890 anon_struct.conflict1890, *Panon_struct.conflict1890;

typedef struct anon_struct.conflict18a8 anon_struct.conflict18a8, *Panon_struct.conflict18a8;
...
struct anon_struct.conflict17f7 { // DWARF DIE: 17f7
    at_ip_t setdnsip;
};
...
struct anon_struct.conflict16c6 { // DWARF DIE: 16c6
    char ssid[33];
    char pwd[33];
};

struct at_close_para_t { // DWARF DIE: 1439
    at_di_t linkId;
};

struct at_sendData_para_t { // DWARF DIE: 1544
    at_di_t linkId;
    at_di_t bufferlen;
    at_text_t * buffer;
...
struct anon_struct.conflict16fd { // DWARF DIE: 16fd
    char ssid[64];
    char psk[64];
    int chl;
    int ecn;
...
struct at_tcpserver_para_t { // DWARF DIE: 145f
    at_di_t port;
    at_di_t enable;
    at_di_t tls;
    at_di_t ca;
...
struct at_network_para_t { // DWARF DIE: 14d4
    at_di_t linkId;
    at_text_t type[4];
    at_text_t hostname[256];
    at_di_t port;
...
struct anon_struct.conflict15e7 { // DWARF DIE: 15e7
    s32 method;
};
...
struct anon_struct.conflict1890 { // DWARF DIE: 1890
    int ID;
};

struct anon_struct.conflict1810 { // DWARF DIE: 1810
    int ID;
    int mode;
    int pull;
};

struct at_client_ssl_sni_t { // DWARF DIE: 13ca
    at_di_t linkId;
    at_text_t sni[256];
};

struct anon_struct.conflict1844 { // DWARF DIE: 1844
    int ID;
    int mode;
};

struct at_ble_sync_mode_t { // DWARF DIE: 14ae
    int mode;
};

struct anon_struct.conflict18a8 { // DWARF DIE: 18a8
    int apnum;
};

struct anon_struct.conflict1686 { // DWARF DIE: 1686
    uint32_t sleep_time;
    int weakup_pin;
};

struct anon_struct.conflict16ad { // DWARF DIE: 16ad
    int mode;
};

struct anon_struct.conflict176c { // DWARF DIE: 176c
    char hostname[33];
};

struct anon_struct.conflict15ce { // DWARF DIE: 15ce
    s32 value;
};

struct at_client_ssl_path_para_t { // DWARF DIE: 1367
    at_di_t linkId;
    at_di_t auth_mode;
    at_text_t * ca;
    at_text_t * key;
...
struct anon_struct.conflict1785 { // DWARF DIE: 1785
    char hostname[128];
};

struct anon_struct.conflict15a4 { // DWARF DIE: 15a4
    char hostname[256];
};

struct at_client_ssl_alpn_t { // DWARF DIE: 13ff
    at_di_t linkId;
    at_text_t * * alpn;
};

struct anon_struct.conflict17ae { // DWARF DIE: 17ae
    char hostname[128];
    uint8_t type;
...
union anon_union.conflict18c1_for_u { // DWARF DIE: 18c1
    struct anon_struct.conflict15a4 ping;
    struct anon_struct.conflict15ce wifi;
    struct anon_struct.conflict15e7 scan;
    ...
    struct anon_struct.conflict16ad wifiMode;
    ...
    struct anon_struct.conflict186a writeiodata_para;
    struct anon_struct.conflict1890 readiodata_para;
    struct anon_struct.conflict18a8 deleteap_para;
};

struct at_callback_para_t { // DWARF DIE: 1a2c
...
struct at_callback_rsp_t { // DWARF DIE: 1a79
    u8 status;
    undefined field_0x1;
    undefined field_0x2;
    undefined field_0x3;
...
union anon_union.conflict18c1 { // DWARF DIE: 18c1
    struct anon_struct.conflict15a4 ping;
    struct anon_struct.conflict15ce wifi;
    struct anon_struct.conflict15e7 scan;
    struct at_tcpserver_para_t tcp_server;
...
struct at_callback_t { // DWARF DIE: 1ac9
...
union at_value_t { // DWARF DIE: f92
    at_text_t text[256];
    at_hex_t hex[256];
    at_di_t di;
    at_hi_t hi;
...
struct at_var_descriptor_t { // DWARF DIE: 1002
    char * key;
...

{
  ...
  iVar1 = 0;
  while (iVar2 = FUN_000101c8(*puVar4), iVar2 != 0) {
    iVar1 += 1;
    puVar4 = puVar4 + 5;
    if (iVar1 == 0x16) {
      return AEC_NOT_FOUND;
  ...
  if ((pcVar3 != (code *)0x0) && (iVar1 = (*pcVar3)(value), iVar1 != 0)) {
...

{
  ...
  if (ssid != (char *)0x0) {
    uVar1 = _L0(_DAT_0000013c);
    FUN_0001025c(_DAT_0000013c);
    FUN_0001026c(_DAT_0000013c);
    _DAT_0000013c = uVar1;
    return AEC_OK;
  }
  return AEC_NOT_FOUND;
...

{
  ...
  uVar1 = _L0(uRam0000013c);
  FUN_0001025c(uRam0000013c);
  FUN_0001026c(uRam0000013c);
  uRam0000013c = uVar1;
  return 0;
}
...

{
  ...
  do {
    puVar2 = puVar1 + 5;
    FUN_000102c6((uint)*(byte *)(puVar1 + 1),puVar1[2],puVar1[3]);
    FUN_000102d2();
    FUN_000102e4(*puVar1);
    FUN_000102f0();
    puVar1 = puVar2;
...

{
  ...
  while( true ) {
    ...
    unaff_s0 += 0x14;
    FUN_000102c6((uint)*pbVar1,*puVar3,*puVar2);
  }
  return 0;
}
...

{
  ...
  while( true ) {
    ...
    FUN_000102f0();
    if (unaff_s0 == unaff_s2) break;
    FUN_000102c6((uint)*(byte *)(unaff_s0 + 1),unaff_s0[2],unaff_s0[3]);
    FUN_000102d2();
    param_1 = *unaff_s0;
    unaff_s0 = unaff_s0 + 5;
  }
...

{
  ...
  for (; FUN_000102f0(), unaff_s0 != unaff_s2; unaff_s0 = unaff_s0 + 5) {
    FUN_000102c6((uint)*(byte *)(unaff_s0 + 1),unaff_s0[2],unaff_s0[3]);
    FUN_000102d2();
