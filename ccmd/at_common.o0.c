...
struct at_ip_para_t { // DWARF DIE: 1228
    at_ip_t ip;
    at_ip_t getway;
    at_ip_t netmask;
    at_ip_t dns1;
...
struct at_serial_para_t { // DWARF DIE: 1a46
    u32 baudrate;
    u32 dataBit;
    u32 parity;
    u32 stopBit;
...
typedef struct anon_struct.conflict1505 anon_struct.conflict1505, *Panon_struct.conflict1505;
...
typedef struct anon_struct.conflict15cb anon_struct.conflict15cb, *Panon_struct.conflict15cb;
...
typedef struct anon_struct.conflict1788 anon_struct.conflict1788, *Panon_struct.conflict1788;

typedef struct anon_struct.conflict17ae anon_struct.conflict17ae, *Panon_struct.conflict17ae;

typedef struct anon_struct.conflict17c6 anon_struct.conflict17c6, *Panon_struct.conflict17c6;
...
struct anon_struct.conflict161b { // DWARF DIE: 161b
    char ssid[64];
    char psk[64];
    int chl;
    int ecn;
...
struct anon_struct.conflict1505 { // DWARF DIE: 1505
    s32 method;
};
...
struct anon_struct.conflict16a3 { // DWARF DIE: 16a3
    char hostname[128];
};

struct at_tcpserver_para_t { // DWARF DIE: 137d
    at_di_t port;
    at_di_t enable;
    at_di_t tls;
    at_di_t ca;
...
struct anon_struct.conflict1545 { // DWARF DIE: 1545
    int uartId;
    int uartBaud;
    int dataBit;
    int parity;
...
struct anon_struct.conflict17c6 { // DWARF DIE: 17c6
    int apnum;
};

struct at_client_ssl_sni_t { // DWARF DIE: 12e8
    at_di_t linkId;
    at_text_t sni[256];
};

struct anon_struct.conflict15cb { // DWARF DIE: 15cb
    int mode;
};

struct at_client_ssl_alpn_t { // DWARF DIE: 131d
    at_di_t linkId;
    at_text_t * * alpn;
};

struct at_ble_sync_mode_t { // DWARF DIE: 13cc
    int mode;
};

struct at_network_para_t { // DWARF DIE: 13f2
    at_di_t linkId;
    at_text_t type[4];
...
struct at_close_para_t { // DWARF DIE: 1357
    at_di_t linkId;
};

struct anon_struct.conflict1715 { // DWARF DIE: 1715
    at_ip_t setdnsip;
};

struct anon_struct.conflict1788 { // DWARF DIE: 1788
    int ID;
    int data;
};

struct anon_struct.conflict16cc { // DWARF DIE: 16cc
    char hostname[128];
    uint8_t type;
...
struct anon_struct.conflict168a { // DWARF DIE: 168a
    char hostname[33];
};

struct anon_struct.conflict1762 { // DWARF DIE: 1762
    int ID;
    int mode;
};

struct at_sendData_para_t { // DWARF DIE: 1462
    at_di_t linkId;
    at_di_t bufferlen;
    at_text_t * buffer;
    at_text_t hostname[256];
...
struct anon_struct.conflict14ec { // DWARF DIE: 14ec
    s32 value;
};

struct anon_struct.conflict15e4 { // DWARF DIE: 15e4
    char ssid[33];
    char pwd[33];
};

struct anon_struct.conflict14c2 { // DWARF DIE: 14c2
    char hostname[256];
};

struct at_client_ssl_path_para_t { // DWARF DIE: 1285
    at_di_t linkId;
    at_di_t auth_mode;
    at_text_t * ca;
    at_text_t * key;
...
union anon_union.conflict17df_for_u { // DWARF DIE: 17df
    struct anon_struct.conflict14c2 ping;
    struct anon_struct.conflict14ec wifi;
    struct anon_struct.conflict1505 scan;
    ...
    struct anon_struct.conflict15cb wifiMode;
    ...
    struct anon_struct.conflict1788 writeiodata_para;
    struct anon_struct.conflict17ae readiodata_para;
    struct anon_struct.conflict17c6 deleteap_para;
};

struct at_callback_para_t { // DWARF DIE: 194a
...
struct at_callback_rsp_t { // DWARF DIE: 1997
    u8 status;
    undefined field_0x1;
    undefined field_0x2;
    undefined field_0x3;
...
union anon_union.conflict17df { // DWARF DIE: 17df
    struct anon_struct.conflict14c2 ping;
    struct anon_struct.conflict14ec wifi;
    struct anon_struct.conflict1505 scan;
    struct at_tcpserver_para_t tcp_server;
...
struct at_callback_t { // DWARF DIE: 19e7
...
struct err_info_t { // DWARF DIE: 1ace
...
_L0:
    if (((iVar3 <= (int)paVar2) && ((int)paVar2 <= iVar3 + 2)) && (iVar4 = _LVL50(0xd8), iVar4 == 0)
       ) break;
_L0:
    para.sts = paVar2;
...
_L0:
    if (((iVar3 <= (int)puVar2) && ((int)puVar2 <= iVar3 + 2)) &&
       (iVar4 = _LVL50(unaff_s3 + 0xd8), iVar4 == 0)) break;
_L0:
...
_L0:
    if (((unaff_s4 <= (int)puVar2) && ((int)puVar2 <= unaff_s4 + 2)) &&
       (iVar3 = _LVL50(unaff_s3 + 0xd8), iVar3 == 0)) break;
_L0:
    in_stack_0000000c = puVar2;
