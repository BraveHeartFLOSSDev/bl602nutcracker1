...
struct _on_exit_args { // DWARF DIE: 250
    void * _fnargs[32];
    void * _dso_handle[32];
    __ULong _fntypes;
    __ULong _is_cxa;
...
union anon_union.conflictd7_for___value { // DWARF DIE: d7
    wint_t __wch;
    uchar __wchb[4];
};

struct _mbstate_t { // DWARF DIE: 109
    int __count;
    union anon_union.conflictd7_for___value __value;
};

struct __tm { // DWARF DIE: 1cd
    int __tm_sec;
    int __tm_min;
    int __tm_hour;
    int __tm_mday;
...
union anon_union.conflictd7 { // DWARF DIE: d7
    wint_t __wch;
    uchar __wchb[4];
};
