...

{
  ...
  if (0x40 < key_len) {
    _LVL3(pBuf + 0x50);
    _LVL5(pBuf + 0x50,key,key_len);
    _LVL7(pBuf + 0x50,key);
    key_len = 0x14;
  }
  FUN_00010072(&uStack448,0,0x40);
  FUN_00010080(&uStack448,key,key_len);
  puVar6 = (uint *)(pBuf + 0x3c);
  puVar1 = &uStack448;
  do {
    puVar3 = puVar1 + 2;
  ...
  _LVL14(pBuf + 0x50);
  _LVL16(pBuf + 0x50,&uStack448,0x40);
  iVar5 = 0;
  while (iVar5 < textNum) {
    piVar2 = pTextLen + iVar5;
    ppuVar4 = ppText + iVar5;
    iVar5 = iVar5 + 1;
    _L0(pBuf + 0x50,*ppuVar4,*piVar2);
  }
  _LVL19(pBuf + 0x50,puVar6);
  FUN_000100e4(&uStack448,0,0x40);
  FUN_000100f2(&uStack448,key,key_len);
  puVar1 = &uStack448;
  do {
    puVar3 = puVar1 + 2;
  ...
  _LVL24(pBuf + 0x50);
  _LVL26(pBuf + 0x50,&uStack448,0x40);
  _LVL28(pBuf + 0x50,puVar3,0x14);
  _LVL30(pBuf + 0x50,puVar3);
  FUN_00010154(output,puVar3,outputLen);
  return;
}
...

{
  ...
  _LVL3();
  _LVL5(&stack0x00000054);
  _LVL7(&stack0x00000054);
  FUN_00010072(0,0x40);
  FUN_00010080(0x14);
  ...
  _LVL14(&stack0x00000054);
  _LVL16(&stack0x00000054,0x40);
  iVar4 = 0;
  while (iVar4 < unaff_s7) {
    iVar3 = iVar4 * 4;
    iVar4 = iVar4 + 1;
    _L0(&stack0x00000054,*(undefined4 *)(iVar3 + unaff_s8),*(undefined4 *)(unaff_s9 + iVar3));
  }
  _LVL19(&stack0x00000054,&stack0x00000040);
  FUN_000100e4(0,0x40);
  FUN_000100f2(0x14);
  puVar1 = (uint *)register0x00002008;
  do {
  ...
  _LVL24(&stack0x00000054);
  _LVL26(&stack0x00000054,0x40);
  _LVL28(&stack0x00000054,puVar2,0x14);
  _LVL30(&stack0x00000054,puVar2);
  FUN_00010154(puVar2);
  return;
}
...

{
  ...
  while (iVar3 < unaff_s7) {
    iVar2 = iVar3 * 4;
    iVar3 = iVar3 + 1;
    _L0(&stack0x00000054,*(undefined4 *)(iVar2 + unaff_s8),*(undefined4 *)(unaff_s9 + iVar2));
  }
  _LVL19(&stack0x00000054);
  FUN_000100e4(0,0x40);
  FUN_000100f2();
  do {
    puVar1 = unaff_s0 + 2;
  ...
  _LVL24(&stack0x00000054);
  _LVL26(&stack0x00000054,0x40);
  _LVL28(&stack0x00000054,puVar1,0x14);
  _LVL30(&stack0x00000054,puVar1);
  FUN_00010154(puVar1);
  return;
}
...

{
  _LVL24();
  _LVL26(&stack0x00000054,0x40);
  _LVL28(&stack0x00000054,0x14);
  _LVL30(&stack0x00000054);
  FUN_00010154();
  return;
}
...

{
  ...
  while (_L0(param_1,param_2,param_3), unaff_s3 < unaff_s7) {
...

{
  ...
  _L0(&pText,0,0x78);
  if (prefix == (uchar *)0x0) {
    FUN_00010264(&pText,data,data_len);
    iStack176 = data_len;
  }
  else {
    FUN_000101f0(&pText,prefix,prefix_len);
    iStack176 = prefix_len + 1 + data_len;
    prf_input[prefix_len + -4] = '\0';
    _L0((int)&pText + prefix_len + 1,data,data_len);
  }
  ...
  while (iVar1 = (iVar2 * -0x14 + len) * 0x1000000 >> 0x18, iVar2 < (len + 0x13) / 0x14) {
    ...
    FUN_0001028c(&total_len,&iStack176,1,key,key_len,output + iVar3,(int)(char)iVar1);
    iVar3 = iVar3 + (char)iVar1;
    iVar2 = iVar2 + 1;
    *(char *)((int)&total_len + iStack176 + 3) = *(char *)((int)&total_len + iStack176 + 3) + '\x01'
    ;
  }
  return;
}
...

{
  ...
  if (unaff_s8 == 0) {
    ...
    _L0(unaff_s5 + unaff_s0 + 1);
  }
  iVar1 = unaff_s6 + 1;
  (&stack0x00000008)[unaff_s6] = 0;
  iVar4 = 0;
  iVar3 = 0;
  while (iVar2 = (iVar3 * -0x14 + unaff_s1) * 0x1000000 >> 0x18, iVar3 < (unaff_s1 + 0x13) / 0x14) {
    if (0x14 < iVar2) {
      iVar2 = 0x14;
    }
...

{
  ...
  iVar3 = 0;
  iVar1 = 0;
  while (iVar2 = (iVar1 * -0x14 + unaff_s1) * 0x1000000 >> 0x18, iVar1 < (unaff_s1 + 0x13) / 0x14) {
    if (0x14 < iVar2) {
      iVar2 = 0x14;
    }
    FUN_0001028c(&stack0x00000004,1,unaff_s4 + iVar3,(int)(char)iVar2);
    iVar3 = iVar3 + (char)iVar2;
    iVar1 = iVar1 + 1;
