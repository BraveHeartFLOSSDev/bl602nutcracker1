...
union anon_union.conflict1227_for_key {
...
union anon_union.conflictca8_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflictc5e_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflictc83_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};
...

{
  ...
  while ((int)uVar1 < (int)uRam00000000) {
  ...
  FUN_00010076(0,_DAT_44b00120 / 1000,0);
  return ppVar4;
}
...

{
  ...
  FUN_00010076(0,_DAT_44b00120 / 1000);
  return unaff_s3;
}
...

{
  ...
  FUN_0001020c(unaff_s1);
  FUN_00010230(0,_DAT_44b00120 / 1000);
  return unaff_s1;
}
...

{
  ...
  _L0(0,_DAT_44b00120 / 1000,0);
  iVar1 = FUN_000102ca(pSsid,CONCAT31(in_register_0000202d,ssidLen));
  if (iVar1 == 0) {
    iVar1 = _L0();
    FUN_000102e4(pSsid,CONCAT31(in_register_0000202d,ssidLen));
    *(UINT8 *)(iVar1 + 0x40) = ssidLen;
  }
  if (pPSK != (UINT8 *)0x0) {
    FUN_000102fe(iVar1 + 0x20,pPSK,0x20);
...

{
  ...
  if (iVar1 == 0) {
    iVar1 = _L0();
    FUN_000102e4();
    *(undefined *)(iVar1 + 0x40) = unaff_s2;
  }
  if (unaff_s3 != 0) {
    FUN_000102fe(iVar1 + 0x20,0x20);
...

{
  ...
  *(undefined *)(unaff_s0 + 0x40) = unaff_s2;
  if (unaff_s3 != 0) {
    FUN_000102fe(unaff_s0 + 0x20,0x20);
...

{
  ...
  iVar1 = _L0(CONCAT31(in_register_0000202d,ssidLen));
  FUN_00010370(0,_DAT_44b00120 / 1000,0);
  if (iVar1 != 0) {
    FUN_00010382(iVar1,0,0x43);
  }
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
...

{
  ...
  FUN_000103f2(0,_DAT_44b00120 / 1000,0);
...

{
  ...
  if (unaff_s0 < 0x61) {
    if (unaff_s0 < 0x41) {
      uVar1 = unaff_s0 - 0x30;
      _L0(0,*(uint *)(unaff_s3 + 0x120) / unaff_s1);
    }
    else {
      uVar1 = unaff_s0 - 0x37;
    }
...

{
  ...
  FUN_00010482(0,_DAT_44b00120 / 1000,0);
  if ((pPSK != (UINT8 *)0x0) && (pPassphrase != (UINT8 *)0x0)) {
    if (CONCAT31(in_register_00002035,PassphraseLen) - 8U < 0x38) {
      FUN_000104a6(pPassphrase,pSsid,CONCAT31(in_register_0000202d,ssidLen),pPSK);
    }
    else {
      if (CONCAT31(in_register_00002035,PassphraseLen) == 0x40) {
        iVar3 = 0;
        do {
          iVar2 = FUN_000104f6(*pPassphrase);
          bVar1 = FUN_00010504(pPassphrase[1]);
          pPSK[iVar3 >> 1] = bVar1 | (byte)(iVar2 << 4);
          iVar3 = iVar3 + 2;
...

{
  ...
  FUN_00010482();
  if ((unaff_s4 != 0) && (unaff_s0 != (undefined *)0x0)) {
    if (in_stack_0000000c - 8U < 0x38) {
      ...
      if (in_stack_0000000c == 0x40) {
        iVar3 = 0;
        do {
          iVar2 = FUN_000104f6(*unaff_s0);
          bVar1 = FUN_00010504(unaff_s0[1]);
          *(byte *)((iVar3 >> 1) + unaff_s4) = bVar1 | (byte)(iVar2 << 4);
          iVar3 = iVar3 + 2;
          unaff_s0 = unaff_s0 + 2;
        } while (iVar3 != 0x40);
      }
...

{
  ...
  while( true ) {
    iVar2 = FUN_000104f6(param_1);
    bVar1 = FUN_00010504(unaff_s0[-1]);
    *(byte *)((unaff_s3 >> 1) + unaff_s4) = bVar1 | (byte)(iVar2 << 4);
    unaff_s3 = unaff_s3 + 2;
...

{
  ...
  while( true ) {
    bVar1 = FUN_00010504(param_1);
    *(byte *)((unaff_s3 >> 1) + unaff_s4) = bVar1 | (byte)(unaff_s1 << 4);
    unaff_s3 = unaff_s3 + 2;
    if (unaff_s3 == unaff_s5) break;
    unaff_s1 = FUN_000104f6(*unaff_s0);
    param_1 = (uint)(byte)unaff_s0[1];
    unaff_s0 = unaff_s0 + 2;
  }
  do {
                    // WARNING: Do nothing block with infinite loop
