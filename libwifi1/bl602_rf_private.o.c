...
struct anon_struct.conflict99e {
    uint32_t index;
    int32_t dvga;
};
...
struct anon_struct.conflicta2c {
    uint32_t vbcore;
    uint32_t iet;
    uint32_t vbcore_11n;
    uint32_t iet_11n;
...
struct anon_struct.conflictee3 {
    uint32_t inited;
    struct rf_calib1_tag cal;
    struct rf_calib2_tag lo[21];
    undefined field_0x46;
...
void rf_pri_set_gain_table_regs
               (int iRam00000038,int iRam0000003c,int iRam00000040,uint uRam00000044,
               int iRam00000070,int iRam00000074,int iRam00000078,int iRam0000007c,int iRam000000a8,
               int iRam000000ac,int iRam000000b0,uint uRam000000b4,int iRam000000e0,int iRam000000e4
               ,int iRam000000e8,int iRam000000ec,int iRam00000118,int iRam0000011c,int iRam00000120
               ,uint uRam00000124,int iRam00000150,int iRam00000154,int iRam00000158,
               int iRam0000015c,int iRam00000188,int iRam0000018c,int iRam00000190,uint uRam00000194
               )

{
  _DAT_40001118 =
       ((iRam00000158 << 0x18 |
        ...
        (iRam00000188 << 0xe |
        (iRam0000018c << 0xc |
        (iRam00000190 << 8 | (_DAT_40001118 & 0xffffffe0 | uRam00000194) & 0xfffff8ff) & 0xffffcfff)
        & 0xffff3fff) & 0xffe0ffff) & 0xf8ffffff) & 0xcfffffff | iRam00000154 << 0x1c) & 0x3fffffff
       | iRam00000150 << 0x1e;
  _DAT_4000111c =
       (iRam000000e4 << 0x1c |
       (iRam000000e8 << 0x18 |
       ...
       (iRam00000118 << 0xe |
       (iRam0000011c << 0xc |
       (iRam00000120 << 8 | (_DAT_4000111c & 0xffffffe0 | uRam00000124) & 0xfffff8ff) & 0xffffcfff)
       & 0xffff3fff) & 0xffe0ffff) & 0xf8ffffff) & 0xcfffffff) & 0x3fffffff | iRam000000e0 << 0x1e;
  _DAT_40001120 =
       iRam00000070 << 0x1e |
       (iRam00000074 << 0x1c |
       (iRam00000078 << 0x18 |
       ...
       (iRam000000a8 << 0xe |
       (iRam000000ac << 0xc |
       (iRam000000b0 << 8 | (_DAT_40001120 & 0xffffffe0 | uRam000000b4) & 0xfffff8ff) & 0xffffcfff)
       & 0xffff3fff) & 0xffe0ffff) & 0xf8ffffff) & 0xcfffffff) & 0x3fffffff;
  _DAT_40001124 =
       (_DAT_00000004 << 0x1c |
       ((_DAT_0000000c << 0x10 |
        (iRam00000038 << 0xe |
        ((iRam00000040 << 8 | (_DAT_40001124 & 0xffffffe0 | uRam00000044) & 0xfffff8ff) & 0xffffcfff
        | iRam0000003c << 0xc) & 0xffff3fff) & 0xffe0ffff) & 0xf8ffffff | _DAT_00000008 << 0x18) &
       0xcfffffff) & 0x3fffffff | iRam00000000 << 0x1e;
  return;
}
...

{
  ...
  do {
    ...
    FUN_00010a14(param_ind,uVar1);
    delta = (int)delta >> 1;
    _L0(10);
    uVar4 = _L0();
    if (uVar3 <= uVar4) {
      _LVL285(param_ind,uVar2);
      FUN_00010a44(10);
      uVar5 = _L0();
      uVar1 = center;
      uVar4 = uVar3;
...

{
  ...
  FUN_00010b90(iq,0x400);
  _L0();
  _L0();
  FUN_00010bb4(uRam00000000,_DAT_00000004);
  uVar3 = _L0();
...
void rf_pri_config_channel(uint uRam00000024)

{
  ...
  _DAT_400010c4 = _DAT_400010c4 & 0xc0000000 | uRam00000024;
...

{
  ...
  do {
    if (iq == 0) {
      _DAT_4000107c = _DAT_4000107c & 0xffffffc0 | uVar4;
    }
    else {
      _DAT_4000107c = uVar4 << 8 | _DAT_4000107c & 0xffffc0ff;
    }
    iVar3 = _LVL432(iq,0x400);
    if (iVar3 < 1) {
      uVar1 = uVar1 * 2 & 0xf;
      uVar4 = uVar4 + 1;
      if (uVar1 == 10) {
...

{
  ...
  while( true ) {
    ...
    if (unaff_s3 == 0) {
      uVar3 = unaff_s6 | *(uint *)(unaff_s1 + 0x7c) & 0xffffffc0;
    }
    else {
      uVar3 = unaff_s6 * 0x100 | *(uint *)(unaff_s1 + 0x7c) & unaff_s5;
    }
    *(uint *)(unaff_s1 + 0x7c) = uVar3;
    param_1 = 0x400;
  }
  iVar1 = 0x3f;
  do {
...

{
  ...
  while( true ) {
    ...
    if (unaff_s4 == 0) break;
    if (unaff_s3 == 0) {
      uVar2 = *(uint *)(unaff_s1 + 0x7c) & 0xffffffc0 | unaff_s2;
    }
    else {
      uVar2 = unaff_s2 << 8 | *(uint *)(unaff_s1 + 0x7c) & unaff_s5;
    }
    *(uint *)(unaff_s1 + 0x7c) = uVar2;
    param_1 = 0x400;
  }
  return unaff_s2;
}
...

{
  ...
  _L0(chanfreq_MHz - 0x964 >> 2);
  FUN_0001206c(iRam00000000,_DAT_00000004);
  iVar1 = _L0();
  if (0x14 < iVar1) {
    iVar1 = 0x14;
  }
  return *(ushort *)((iVar1 + 8) * 2 + iRam00000000 + 0xc) & 0xff;
}
...

{
  ...
  _L0(chanfreq_MHz - 0x964 >> 2);
  FUN_000120c2(iRam00000000,_DAT_00000004);
  iVar1 = _L0();
  if (0x14 < iVar1) {
    iVar1 = 0x14;
  }
  return *(ushort *)((iVar1 + 8) * 2 + iRam00000000 + 0xc) >> 8 & 0x1f;
}
...

{
  ...
  if (iRam00000000 == 1) {
    if ((Tsens < 1) && (-4 < Tsens)) {
_L0:
      iRam00000000 = iRam00000000 * -10;
      _L0((int)(char)iRam00000000);
      do {
                    // WARNING: Do nothing block with infinite loop
      } while( true );
    }
...

{
  ...
  piVar8 = (int *)0x0;
  do {
    _DAT_40001064 = *piVar7 << 0x1c | _DAT_40001064 & 0xfc3ffff | piVar7[2] << 0x12;
    _DAT_40001058 = piVar7[1] << 0x10 | _DAT_40001058 & 0xfff8ffff;
    _DAT_40001048 = *piVar8 << 0x1c | _DAT_40001048 & 0xce08ffff | piVar8[3] << 0x14 | 0x70000;
    _L0(10);
    uVar9 = piVar7[3];
    uVar10 = uVar9;
    do {
      uVar10 = uVar10 >> 1;
      _DAT_40001214 = uVar9 | _DAT_40001214 & 0xfffff800;
      _DAT_40001218 = uVar9 | _DAT_40001218 & 0xfffff800;
      _L0();
      _L0();
      FUN_00012486(10);
      iVar1 = FUN_00012494(1,0x400);
      iVar1 = iVar1 >> 10;
      FUN_000124ae(0,uVar9,uVar10,iVar1);
      if (iVar1 < 0x141) {
        uVar4 = uVar10;
        if (0xbf < iVar1) break;
      }
    ...
    uVar2 = FUN_000124f0(0,0x20,0x10,0x3d);
    _LVL640(0,uVar2);
    uVar10 = FUN_00012512(1,0x20,0x10,0x3d);
    _DAT_40001070 = uVar10 << 0x10 | _DAT_40001070 & 0xffc0ffff;
    uVar9 = _LVL647(0,uVar2,2,0x3d);
    _LVL649(0,uVar9);
    uVar2 = FUN_00012558(2,0x400,0x80,0x7a);
    _LVL653(2,uVar2);
    uVar3 = FUN_0001257a(3,0,0x40,0x7a);
    _LVL656(3,uVar3);
    uVar4 = FUN_0001259a(2,uVar2,0x40,0x7a);
    _LVL659(2,uVar4);
    uVar5 = FUN_000125bc(3,0,0x20,0x7a);
    _LVL662(3,uVar5);
    iVar1 = (iVar6 + 0xc) * 8 + uRam00000000;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xffffffc0 | uVar9 & 0x3f;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xfffff03f | (uVar10 & 0x3f) << 6;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xff800fff | (uVar4 & 0x7ff) << 0xc;
    *(uint *)(iVar1 + 0xc) = *(uint *)(iVar1 + 0xc) & 0xfffffc00 | uVar5 & 0x3ff;
    FUN_0001263e(0,uVar9,uVar10,uVar4);
    iVar6 = iVar6 + -1;
    piVar7 = piVar7 + 4;
    piVar8 = piVar8 + 0xe;
    if (iVar6 == -1) {
...

{
  ...
  *(uint *)(unaff_s0 + 0x6c) = uRam00000000 & 0xffff | *(uint *)(unaff_s0 + 0x6c) & 0xfffffff8;
  ...
  do {
    *(uint *)(unaff_s0 + 100) =
         *piVar7 << 0x1c | uStack0000000c & *(uint *)(unaff_s0 + 100) & 0xffc3ffff |
         piVar7[2] << 0x12;
    *(uint *)(unaff_s0 + 0x58) = piVar7[1] << 0x10 | *(uint *)(unaff_s0 + 0x58) & 0xfff8ffff;
    *(uint *)(unaff_s0 + 0x48) =
         *piVar8 << 0x1c | *(uint *)(unaff_s0 + 0x48) & 0xce08ffff | piVar8[3] << 0x14 | 0x70000;
    _L0(10);
    uVar9 = piVar7[3];
    uVar10 = uVar9;
    do {
      uVar10 = uVar10 >> 1;
      *(uint *)(unaff_s0 + 0x214) = uVar9 | *(uint *)(unaff_s0 + 0x214) & 0xfffff800;
      *(uint *)(unaff_s0 + 0x218) = uVar9 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      _L0();
      _L0();
      FUN_00012486(10);
      iVar1 = FUN_00012494(1,0x400);
    ...
    _LVL640(0,uVar2);
    uVar10 = FUN_00012512(1,0x20,0x10,0x3d);
    *(uint *)(unaff_s0 + 0x70) = uVar10 << 0x10 | *(uint *)(unaff_s0 + 0x70) & 0xffc0ffff;
    uVar9 = _LVL647(0,uVar2,2,0x3d);
    _LVL649(0,uVar9);
    uVar2 = FUN_00012558(2,0x400,0x80,0x7a);
    _LVL653(2,uVar2);
...

{
  ...
  do {
    *(uint *)(unaff_s0 + 100) =
         (*piVar6 << 0x1c | uStack0000000c & *(uint *)(unaff_s0 + 100)) & unaff_s4 - 1U |
         piVar6[2] << 0x12;
    *(uint *)(unaff_s0 + 0x58) = piVar6[1] << 0x10 | *(uint *)(unaff_s0 + 0x58) & unaff_s5 - 1U;
    *(uint *)(unaff_s0 + 0x48) =
         (*piVar7 << 0x1c | *(uint *)(unaff_s0 + 0x48) & unaff_s6 - 1U) & unaff_s7 - 1U |
         piVar7[3] << 0x14 | 0x70000;
    _L0(10);
    uVar8 = piVar6[3];
    uVar9 = uVar8;
    do {
      uVar9 = uVar9 >> 1;
      *(uint *)(unaff_s0 + 0x214) = uVar8 | *(uint *)(unaff_s0 + 0x214) & 0xfffff800;
      *(uint *)(unaff_s0 + 0x218) = uVar8 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      _L0();
      _L0();
      FUN_00012486(10);
      iVar1 = FUN_00012494(1,0x400);
      iVar1 = iVar1 >> 10;
      FUN_000124ae(0,uVar8,uVar9,iVar1);
      if (iVar1 < 0x141) {
        uVar4 = uVar9;
        if (0xbf < iVar1) break;
      }
    ...
    uVar2 = FUN_000124f0(0,0x20,0x10,0x3d);
    _LVL640(0,uVar2);
    uVar9 = FUN_00012512(1,0x20,0x10,0x3d);
    *(uint *)(unaff_s0 + 0x70) = uVar9 << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1 - 1U;
    uVar8 = _LVL647(0,uVar2,2,0x3d);
    _LVL649(0,uVar8);
    uVar2 = FUN_00012558(2,0x400,0x80,0x7a);
    _LVL653(2,uVar2);
    uVar3 = FUN_0001257a(3,0,0x40,0x7a);
    ...
    uVar5 = FUN_000125bc(3,0,0x20,0x7a);
    _LVL662(3,uVar5);
    iVar1 = (unaff_s2 + 0xc) * 8 + iRam00000000;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xffffffc0 | uVar8 & 0x3f;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xfffff03f | (uVar9 & 0x3f) << 6;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xff800fff | (uVar4 & 0x7ff) << 0xc;
    *(uint *)(iVar1 + 0xc) = *(uint *)(iVar1 + 0xc) & 0xfffffc00 | uVar5 & 0x3ff;
    FUN_0001263e(0,uVar8,uVar9,uVar4);
    unaff_s2 = unaff_s2 + -1;
    piVar6 = piVar6 + 4;
    piVar7 = piVar7 + 0xe;
    if (unaff_s2 == -1) {
...

{
  ...
  do {
    ...
    do {
      uVar7 = uVar7 >> 1;
      *(uint *)(unaff_s0 + 0x214) = uVar6 | *(uint *)(unaff_s0 + 0x214) & 0xfffff800;
      *(uint *)(unaff_s0 + 0x218) = uVar6 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      _L0();
      _L0();
      FUN_00012486(10);
      iVar1 = FUN_00012494(1,0x400);
      iVar1 = iVar1 >> 10;
      FUN_000124ae(0,uVar6,uVar7,iVar1);
      if (iVar1 < 0x141) {
        uVar4 = uVar7;
        if (0xbf < iVar1) break;
      }
    ...
    uVar2 = FUN_000124f0(0,0x20,0x10,0x3d);
    _LVL640(0,uVar2);
    uVar7 = FUN_00012512(1,0x20,0x10,0x3d);
    *(uint *)(unaff_s0 + 0x70) = uVar7 << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    uVar6 = _LVL647(0,uVar2,2,0x3d);
    _LVL649(0,uVar6);
    uVar2 = FUN_00012558(2,0x400,0x80,0x7a);
    _LVL653(2,uVar2);
    uVar3 = FUN_0001257a(3,0,0x40,0x7a);
    ...
    _LVL662(3,uVar5);
    iVar1 = (unaff_s2 + 0xc) * 8 + iRam00000000;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xffffffc0 | uVar6 & 0x3f;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xfffff03f | (uVar7 & 0x3f) << 6;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xff800fff | (uVar4 & 0x7ff) << 0xc;
    *(uint *)(iVar1 + 0xc) = *(uint *)(iVar1 + 0xc) & 0xfffffc00 | uVar5 & 0x3ff;
    FUN_0001263e(0,uVar6,uVar7,uVar4);
    unaff_s2 = unaff_s2 + -1;
    if (unaff_s2 == -1) {
      _L0();
      *(uint *)(unaff_s0 + 0x1c) = *(uint *)(unaff_s0 + 0x1c) & 0xffffcfff;
...

{
  ...
  do {
    ...
    iVar1 = FUN_00012494(1,0x400);
    iVar1 = iVar1 >> 10;
    FUN_000124ae(0,unaff_s9,unaff_s10,iVar1);
    if (iVar1 < 0x141) {
      uVar3 = unaff_s10;
      if (iVar1 < 0xc0) goto _L0;
_L0:
      FUN_000124dc(1,0x1000);
      uVar2 = FUN_000124f0(0,0x20,0x10,0x3d);
      _LVL640(0,uVar2);
      uVar3 = FUN_00012512(1,0x20,0x10,0x3d);
      *(uint *)(unaff_s0 + 0x70) = uVar3 << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
      uVar4 = _LVL647(0,uVar2,2,0x3d);
      _LVL649(0,uVar4);
      uVar2 = FUN_00012558(2,0x400,0x80,0x7a);
      _LVL653(2,uVar2);
      uVar5 = FUN_0001257a(3,0,0x40,0x7a);
      _LVL656(3,uVar5);
      uVar6 = FUN_0001259a(2,uVar2,0x40,0x7a);
      _LVL659(2,uVar6);
      uVar7 = FUN_000125bc(3,0,0x20,0x7a);
      _LVL662(3,uVar7);
      iVar1 = (unaff_s2 + 0xc) * 8 + iRam00000000;
      *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xffffffc0 | uVar4 & 0x3f;
      *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xfffff03f | (uVar3 & 0x3f) << 6;
      *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xff800fff | (uVar6 & 0x7ff) << 0xc;
      *(uint *)(iVar1 + 0xc) = *(uint *)(iVar1 + 0xc) & 0xfffffc00 | uVar7 & 0x3ff;
      FUN_0001263e(0,uVar4,uVar3,uVar6);
      unaff_s2 = unaff_s2 + -1;
      if (unaff_s2 == -1) {
        _L0();
        *(uint *)(unaff_s0 + 0x1c) = *(uint *)(unaff_s0 + 0x1c) & 0xffffcfff;
...

{
  ...
  do {
    iVar1 = FUN_00012494(param_1,param_2);
    iVar1 = iVar1 >> 10;
    FUN_000124ae(0,unaff_s9,unaff_s10,iVar1);
    if (iVar1 < 0x141) {
      uVar3 = unaff_s10;
...
_L0:
      FUN_000124dc(1,0x1000);
      uVar1 = FUN_000124f0(0,0x20,0x10,0x3d);
      _LVL640(0,uVar1);
      uVar2 = FUN_00012512(1,0x20,0x10,0x3d);
      *(uint *)(unaff_s0 + 0x70) = uVar2 << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
      uVar3 = _LVL647(0,uVar1,2,0x3d);
      _LVL649(0,uVar3);
      uVar1 = FUN_00012558(2,0x400,0x80,0x7a);
      _LVL653(2,uVar1);
      uVar4 = FUN_0001257a(3,0,0x40,0x7a);
      _LVL656(3,uVar4);
      uVar5 = FUN_0001259a(2,uVar1,0x40,0x7a);
      _LVL659(2,uVar5);
      uVar6 = FUN_000125bc(3,0,0x20,0x7a);
      _LVL662(3,uVar6);
      iVar7 = (unaff_s2 + 0xc) * 8 + iRam00000000;
      *(uint *)(iVar7 + 8) = *(uint *)(iVar7 + 8) & 0xffffffc0 | uVar3 & 0x3f;
      *(uint *)(iVar7 + 8) = *(uint *)(iVar7 + 8) & 0xfffff03f | (uVar2 & 0x3f) << 6;
      *(uint *)(iVar7 + 8) = *(uint *)(iVar7 + 8) & 0xff800fff | (uVar5 & 0x7ff) << 0xc;
      *(uint *)(iVar7 + 0xc) = *(uint *)(iVar7 + 0xc) & 0xfffffc00 | uVar6 & 0x3ff;
      FUN_0001263e(0,uVar3,uVar2,uVar5);
      unaff_s2 = unaff_s2 + -1;
      if (unaff_s2 == -1) {
        _L0();
        *(uint *)(unaff_s0 + 0x1c) = *(uint *)(unaff_s0 + 0x1c) & 0xffffcfff;
    ...
    *(uint *)(unaff_s0 + 0x48) =
    ...
    do {
      ...
      *(uint *)(unaff_s0 + 0x218) = uVar3 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      ...
      _L0();
      FUN_00012486(10);
      iVar7 = FUN_00012494(1,0x400);
      iVar7 = iVar7 >> 10;
      FUN_000124ae(0,uVar3,uVar2,iVar7);
      if (iVar7 < 0x141) {
        uVar5 = uVar2;
        if (0xbf < iVar7) break;
      }
...

{
  ...
  do {
    uVar1 = FUN_000124f0(param_1,param_2,param_3,param_4);
    _LVL640(0,uVar1);
    uVar2 = FUN_00012512(1,0x20,0x10,0x3d);
    *(uint *)(unaff_s0 + 0x70) = uVar2 << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    uVar3 = _LVL647(0,uVar1,2,0x3d);
...

{
  ...
  do {
    ...
    uVar1 = FUN_00012512(1,0x20,0x10,0x3d);
    *(uint *)(unaff_s0 + 0x70) = uVar1 << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    uVar2 = _LVL647(0,unaff_s9,2,0x3d);
    _LVL649(0,uVar2);
    uVar3 = FUN_00012558(2,0x400,0x80,0x7a);
    _LVL653(2,uVar3);
    uVar4 = FUN_0001257a(3,0,0x40,0x7a);
    _LVL656(3,uVar4);
    uVar5 = FUN_0001259a(2,uVar3,0x40,0x7a);
    _LVL659(2,uVar5);
    uVar6 = FUN_000125bc(3,0,0x20,0x7a);
    _LVL662(3,uVar6);
    iVar7 = (unaff_s2 + 0xc) * 8 + iRam00000000;
    *(uint *)(iVar7 + 8) = *(uint *)(iVar7 + 8) & 0xffffffc0 | uVar2 & 0x3f;
    *(uint *)(iVar7 + 8) = *(uint *)(iVar7 + 8) & 0xfffff03f | (uVar1 & 0x3f) << 6;
    *(uint *)(iVar7 + 8) = *(uint *)(iVar7 + 8) & 0xff800fff | (uVar5 & 0x7ff) << 0xc;
    *(uint *)(iVar7 + 0xc) = *(uint *)(iVar7 + 0xc) & 0xfffffc00 | uVar6 & 0x3ff;
    FUN_0001263e(0,uVar2,uVar1,uVar5);
    unaff_s2 = unaff_s2 + -1;
    if (unaff_s2 == -1) {
      _L0();
      *(uint *)(unaff_s0 + 0x1c) = *(uint *)(unaff_s0 + 0x1c) & 0xffffcfff;
    ...
    *(uint *)(unaff_s0 + 0x48) =
    ...
    do {
      ...
      *(uint *)(unaff_s0 + 0x218) = uVar2 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      ...
      iVar7 = FUN_00012494(1,0x400);
      iVar7 = iVar7 >> 10;
      FUN_000124ae(0,uVar2,uVar1,iVar7);
      if (iVar7 < 0x141) {
        uVar5 = uVar1;
        if (0xbf < iVar7) break;
      }
    ...
    FUN_000124dc(1,0x1000);
    param_2 = FUN_000124f0(0,0x20,0x10,0x3d);
    param_1 = 0;
    unaff_s3 = unaff_s3 + 4;
    unaff_s8 = unaff_s8 + 0xe;
    unaff_s9 = param_2;
...

{
  ...
  do {
    uVar1 = FUN_00012512(param_1,param_2,param_3,param_4);
    *(uint *)(unaff_s0 + 0x70) = uVar1 << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    uVar2 = _LVL647(0,unaff_s9,2,0x3d);
    _LVL649(0,uVar2);
    uVar3 = FUN_00012558(2,0x400,0x80,0x7a);
    ...
    *(uint *)(unaff_s0 + 0x48) =
    ...
    FUN_000124dc(1,0x1000);
    unaff_s9 = FUN_000124f0(0,0x20,0x10,0x3d);
    _LVL640(0,unaff_s9);
    param_4 = 0x3d;
    param_3 = 0x10;
    param_2 = 0x20;
...

{
  ...
  do {
    uVar1 = _LVL647(param_1,param_2,param_3,param_4);
    _LVL649(0,uVar1);
    uVar2 = FUN_00012558(2,0x400,0x80,0x7a);
    _LVL653(2,uVar2);
    uVar3 = FUN_0001257a(3,0,0x40,0x7a);
    ...
    *(uint *)(iVar6 + 8) = *(uint *)(iVar6 + 8) & 0xffffffc0 | uVar1 & 0x3f;
    *(uint *)(iVar6 + 8) = *(uint *)(iVar6 + 8) & 0xfffff03f | (in_stack_0000001c & 0x3f) << 6;
    *(uint *)(iVar6 + 8) = *(uint *)(iVar6 + 8) & 0xff800fff | (uVar4 & 0x7ff) << 0xc;
    *(uint *)(iVar6 + 0xc) = *(uint *)(iVar6 + 0xc) & 0xfffffc00 | uVar5 & 0x3ff;
    FUN_0001263e(0,uVar1,in_stack_0000001c,uVar4);
    unaff_s2 = unaff_s2 + -1;
    if (unaff_s2 == -1) {
      _L0();
      *(uint *)(unaff_s0 + 0x1c) = *(uint *)(unaff_s0 + 0x1c) & 0xffffcfff;
    ...
    *(uint *)(unaff_s0 + 0x48) =
    ...
    do {
      ...
      *(uint *)(unaff_s0 + 0x218) = uVar4 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      ...
      _L0();
      FUN_00012486(10);
      iVar6 = FUN_00012494(1,0x400);
      iVar6 = iVar6 >> 10;
      FUN_000124ae(0,uVar4,uVar1,iVar6);
      if (iVar6 < 0x141) {
        uVar5 = uVar1;
        if (0xbf < iVar6) break;
      }
    ...
    param_2 = FUN_000124f0(0,0x20,0x10,0x3d);
    _LVL640(0,param_2);
    in_stack_0000001c = FUN_00012512(1,0x20,0x10,0x3d);
    param_4 = 0x3d;
    *(uint *)(unaff_s0 + 0x70) = in_stack_0000001c << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    param_3 = 2;
    param_1 = 0;
    unaff_s3 = unaff_s3 + 4;
    unaff_s8 = unaff_s8 + 0xe;
...

{
  ...
  do {
    ...
    _LVL662(3,uVar5);
    iVar6 = (unaff_s2 + 0xc) * 8 + iRam00000000;
    *(uint *)(iVar6 + 8) = *(uint *)(iVar6 + 8) & 0xffffffc0 | in_stack_00000018 & 0x3f;
    *(uint *)(iVar6 + 8) = *(uint *)(iVar6 + 8) & 0xfffff03f | (in_stack_0000001c & 0x3f) << 6;
    *(uint *)(iVar6 + 8) = *(uint *)(iVar6 + 8) & 0xff800fff | (uVar4 & 0x7ff) << 0xc;
    *(uint *)(iVar6 + 0xc) = *(uint *)(iVar6 + 0xc) & 0xfffffc00 | uVar5 & 0x3ff;
    FUN_0001263e(0,in_stack_00000018,in_stack_0000001c,uVar4);
    unaff_s2 = unaff_s2 + -1;
    if (unaff_s2 == -1) {
      _L0();
      *(uint *)(unaff_s0 + 0x1c) = *(uint *)(unaff_s0 + 0x1c) & 0xffffcfff;
    ...
    *(uint *)(unaff_s0 + 0x48) =
    ...
    do {
      ...
      *(uint *)(unaff_s0 + 0x218) = uVar5 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      ...
      iVar6 = FUN_00012494(1,0x400);
      iVar6 = iVar6 >> 10;
      FUN_000124ae(0,uVar5,uVar4,iVar6);
      if (iVar6 < 0x141) {
        uVar1 = uVar4;
        if (0xbf < iVar6) break;
      }
    ...
    in_stack_0000001c = FUN_00012512(1,0x20,0x10,0x3d);
    *(uint *)(unaff_s0 + 0x70) = in_stack_0000001c << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    param_2 = _LVL647(0,uVar2,2,0x3d);
    param_1 = 0;
    unaff_s3 = unaff_s3 + 4;
    unaff_s8 = unaff_s8 + 0xe;
...

{
  ...
  do {
    uVar2 = FUN_00012558(param_1,param_2,param_3,param_4);
    _LVL653(2,uVar2);
    uVar3 = FUN_0001257a(3,0,0x40,0x7a);
    _LVL656(3,uVar3);
    uVar4 = FUN_0001259a(2,uVar2,0x40,0x7a);
    ...
    *(uint *)(unaff_s0 + 0x48) =
    ...
    in_stack_0000001c = FUN_00012512(1,0x20,0x10,0x3d);
    *(uint *)(unaff_s0 + 0x70) = in_stack_0000001c << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    in_stack_00000018 = _LVL647(0,uVar2,2,0x3d);
    _LVL649(0,in_stack_00000018);
    param_4 = 0x7a;
    param_3 = 0x80;
    param_2 = 0x400;
    param_1 = 2;
...

{
  ...
  do {
    ...
    uVar2 = FUN_0001257a(3,0,0x40,0x7a);
    _LVL656(3,uVar2);
    uVar3 = FUN_0001259a(2,unaff_s9,0x40,0x7a);
    _LVL659(2,uVar3);
    uVar4 = FUN_000125bc(3,0,0x20,0x7a);
    _LVL662(3,uVar4);
    iVar5 = (unaff_s2 + 0xc) * 8 + iRam00000000;
    *(uint *)(iVar5 + 8) = *(uint *)(iVar5 + 8) & 0xffffffc0 | in_stack_00000018 & 0x3f;
    *(uint *)(iVar5 + 8) = *(uint *)(iVar5 + 8) & 0xfffff03f | (in_stack_0000001c & 0x3f) << 6;
    *(uint *)(iVar5 + 8) = *(uint *)(iVar5 + 8) & 0xff800fff | (uVar3 & 0x7ff) << 0xc;
    *(uint *)(iVar5 + 0xc) = *(uint *)(iVar5 + 0xc) & 0xfffffc00 | uVar4 & 0x3ff;
    FUN_0001263e(0,in_stack_00000018,in_stack_0000001c,uVar3);
    unaff_s2 = unaff_s2 + -1;
    if (unaff_s2 == -1) {
      _L0();
      *(uint *)(unaff_s0 + 0x1c) = *(uint *)(unaff_s0 + 0x1c) & 0xffffcfff;
    ...
    *(uint *)(unaff_s0 + 0x48) =
    ...
    do {
      ...
      *(uint *)(unaff_s0 + 0x218) = uVar4 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      ...
      _L0();
      FUN_00012486(10);
      iVar5 = FUN_00012494(1,0x400);
      iVar5 = iVar5 >> 10;
      FUN_000124ae(0,uVar4,uVar3,iVar5);
      if (iVar5 < 0x141) {
        uVar1 = uVar3;
        if (0xbf < iVar5) break;
      }
    ...
    *(uint *)(unaff_s0 + 0x70) = in_stack_0000001c << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    in_stack_00000018 = _LVL647(0,uVar2,2,0x3d);
    _LVL649(0,in_stack_00000018);
    param_2 = FUN_00012558(2,0x400,0x80,0x7a);
    param_1 = 2;
    unaff_s3 = unaff_s3 + 4;
    unaff_s8 = unaff_s8 + 0xe;
    unaff_s9 = param_2;
...

{
  ...
  do {
    uVar2 = FUN_0001257a(param_1,param_2,param_3,param_4);
    _LVL656(3,uVar2);
    uVar3 = FUN_0001259a(2,unaff_s9,0x40,0x7a);
    _LVL659(2,uVar3);
    uVar4 = FUN_000125bc(3,0,0x20,0x7a);
    ...
    *(uint *)(unaff_s0 + 0x70) = in_stack_0000001c << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    in_stack_00000018 = _LVL647(0,uVar2,2,0x3d);
    _LVL649(0,in_stack_00000018);
    unaff_s9 = FUN_00012558(2,0x400,0x80,0x7a);
    _LVL653(2,unaff_s9);
    param_4 = 0x7a;
    param_3 = 0x40;
    param_2 = 0;
...

{
  ...
  do {
    ...
    *(uint *)(unaff_s0 + 0x70) = in_stack_0000001c << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    ...
    unaff_s9 = FUN_00012558(2,0x400,0x80,0x7a);
    _LVL653(2,unaff_s9);
    param_2 = FUN_0001257a(3,0,0x40,0x7a);
    param_1 = 3;
    unaff_s3 = unaff_s3 + 4;
    unaff_s8 = unaff_s8 + 0xe;
  } while( true );
...

{
  ...
  do {
    uVar3 = FUN_0001259a(param_1,param_2,param_3,param_4);
    _LVL659(2,uVar3);
    uVar4 = FUN_000125bc(3,0,0x20,0x7a);
    _LVL662(3,uVar4);
    iVar5 = (unaff_s2 + 0xc) * 8 + iRam00000000;
...

{
  ...
  do {
    ...
    *(uint *)(iVar5 + 8) = *(uint *)(iVar5 + 8) & 0xffffffc0 | in_stack_00000018 & 0x3f;
    *(uint *)(iVar5 + 8) = *(uint *)(iVar5 + 8) & 0xfffff03f | (in_stack_0000001c & 0x3f) << 6;
    *(uint *)(iVar5 + 8) = *(uint *)(iVar5 + 8) & 0xff800fff | (in_stack_00000014 & 0x7ff) << 0xc;
    *(uint *)(iVar5 + 0xc) = *(uint *)(iVar5 + 0xc) & 0xfffffc00 | uVar4 & 0x3ff;
    ...
    *(uint *)(unaff_s0 + 0x48) =
    ...
    do {
      ...
      *(uint *)(unaff_s0 + 0x218) = uVar6 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      ...
      iVar5 = FUN_00012494(1,0x400);
      iVar5 = iVar5 >> 10;
      FUN_000124ae(0,uVar6,uVar4,iVar5);
      if (iVar5 < 0x141) {
        uVar1 = uVar4;
        if (0xbf < iVar5) break;
      }
    ...
    *(uint *)(unaff_s0 + 0x70) = in_stack_0000001c << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    ...
    uVar3 = FUN_0001257a(3,0,0x40,0x7a);
    _LVL656(3,uVar3);
    param_2 = FUN_0001259a(2,uVar2,0x40,0x7a);
    param_1 = 2;
    unaff_s3 = unaff_s3 + 4;
    unaff_s8 = unaff_s8 + 0xe;
...

{
  ...
  do {
    uVar4 = FUN_000125bc(param_1,param_2,param_3,param_4);
    _LVL662(3,uVar4);
    iVar5 = (unaff_s2 + 0xc) * 8 + iRam00000000;
    *(uint *)(iVar5 + 8) = *(uint *)(iVar5 + 8) & 0xffffffc0 | in_stack_00000018 & 0x3f;
    *(uint *)(iVar5 + 8) = *(uint *)(iVar5 + 8) & 0xfffff03f | (in_stack_0000001c & 0x3f) << 6;
    ...
    *(uint *)(unaff_s0 + 0x70) = in_stack_0000001c << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    ...
    uVar3 = FUN_0001257a(3,0,0x40,0x7a);
    _LVL656(3,uVar3);
    in_stack_00000014 = FUN_0001259a(2,uVar2,0x40,0x7a);
    _LVL659(2,in_stack_00000014);
    param_4 = 0x7a;
    param_3 = 0x20;
    param_2 = 0;
    param_1 = 3;
...

{
  ...
  do {
    ...
    *(uint *)(iVar4 + 8) = *(uint *)(iVar4 + 8) & 0xffffffc0 | in_stack_00000018 & 0x3f;
    *(uint *)(iVar4 + 8) = *(uint *)(iVar4 + 8) & 0xfffff03f | (in_stack_0000001c & 0x3f) << 6;
    *(uint *)(iVar4 + 8) = *(uint *)(iVar4 + 8) & 0xff800fff | (in_stack_00000014 & 0x7ff) << 0xc;
    *(uint *)(iVar4 + 0xc) = *(uint *)(iVar4 + 0xc) & 0xfffffc00 | in_stack_00000010 & 0x3ff;
    FUN_0001263e(0,in_stack_00000018,in_stack_0000001c,in_stack_00000014);
    unaff_s2 = unaff_s2 + -1;
    if (unaff_s2 == -1) {
      _L0();
    ...
    *(uint *)(unaff_s0 + 0x48) =
    ...
    do {
      ...
      *(uint *)(unaff_s0 + 0x218) = uVar5 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      ...
      _L0();
      FUN_00012486(10);
      iVar4 = FUN_00012494(1,0x400);
      iVar4 = iVar4 >> 10;
      FUN_000124ae(0,uVar5,uVar6,iVar4);
      if (iVar4 < 0x141) {
        uVar1 = uVar6;
        if (0xbf < iVar4) break;
      }
    ...
    *(uint *)(unaff_s0 + 0x70) = in_stack_0000001c << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    ...
    in_stack_00000014 = FUN_0001259a(2,uVar2,0x40,0x7a);
    _LVL659(2,in_stack_00000014);
    param_2 = FUN_000125bc(3,0,0x20,0x7a);
    param_1 = 3;
    unaff_s3 = unaff_s3 + 4;
    unaff_s8 = unaff_s8 + 0xe;
    ...
    *(uint *)(unaff_s0 + 0x48) =
    ...
    do {
      ...
      *(uint *)(unaff_s0 + 0x218) = uVar5 | *(uint *)(unaff_s0 + 0x218) & 0xfffff800;
      ...
      _L0();
      FUN_00012486(10);
      iVar2 = FUN_00012494(1,0x400);
      iVar2 = iVar2 >> 10;
      FUN_000124ae(0,uVar5,uVar6,iVar2);
      if (iVar2 < 0x141) {
        uVar1 = uVar6;
        if (0xbf < iVar2) break;
      }
    ...
    FUN_000124dc(1,0x1000);
    uVar3 = FUN_000124f0(0,0x20,0x10,0x3d);
    _LVL640(0,uVar3);
    param_3 = FUN_00012512(1,0x20,0x10,0x3d);
    *(uint *)(unaff_s0 + 0x70) = param_3 << 0x10 | *(uint *)(unaff_s0 + 0x70) & unaff_s1;
    param_2 = _LVL647(0,uVar3,2,0x3d);
    _LVL649(0,param_2);
    uVar3 = FUN_00012558(2,0x400,0x80,0x7a);
    _LVL653(2,uVar3);
    uVar4 = FUN_0001257a(3,0,0x40,0x7a);
    _LVL656(3,uVar4);
    param_4 = FUN_0001259a(2,uVar3,0x40,0x7a);
    _LVL659(2,param_4);
    uVar6 = FUN_000125bc(3,0,0x20,0x7a);
    _LVL662(3,uVar6);
    unaff_s11 = (int *)0x0;
    iVar2 = (unaff_s2 + 0xb) * 8 + iRam00000000;
    *(uint *)(iVar2 + 8) = *(uint *)(iVar2 + 8) & 0xffffffc0 | param_2 & 0x3f;
    *(uint *)(iVar2 + 8) = *(uint *)(iVar2 + 8) & 0xfffff03f | (param_3 & 0x3f) << 6;
    unaff_s9 = 0xff800fff;
    *(uint *)(iVar2 + 8) = *(uint *)(iVar2 + 8) & 0xff800fff | (param_4 & 0x7ff) << 0xc;
    *(uint *)(iVar2 + 0xc) = *(uint *)(iVar2 + 0xc) & 0xfffffc00 | uVar6 & 0x3ff;
    param_1 = 0;
    unaff_s2 = unaff_s2 + -1;
    unaff_s3 = unaff_s3 + 4;
    unaff_s8 = unaff_s8 + 0xe;
...

{
  ...
  if ((_DAT_40001020 & 0x100) != 0) {
    ...
    uVar1 = FUN_0001277c(1);
    uVar2 = uVar1 & 0x3f;
    *(uint *)(iRam00000000 + 0x60) = *(uint *)(iRam00000000 + 0x60) & 0xffffffc0 | uVar2;
    _DAT_4000116c = _DAT_4000116c & 0xffc0ffff | uVar1 << 0x10;
    FUN_000127ba(0,uVar1);
    *(uint *)(iRam00000000 + 0x58) = *(uint *)(iRam00000000 + 0x58) & 0xffffffc0 | uVar2;
    _DAT_4000116c = uVar1 | _DAT_4000116c & 0xffffffc0;
    _L0(0,uVar1);
    *(uint *)(iRam00000000 + 0x50) = *(uint *)(iRam00000000 + 0x50) & 0xffffffc0 | uVar2;
    _DAT_40001168 = uVar1 << 0x10 | _DAT_40001168 & 0xffc0ffff;
    _L0(0,uVar1);
    *(uint *)(iRam00000000 + 0x48) = *(uint *)(iRam00000000 + 0x48) & 0xffffffc0 | uVar2;
    _DAT_40001168 = uVar1 | _DAT_40001168 & 0xffffffc0;
    _L0(0,uVar1);
    uVar1 = FUN_0001286c(0);
    uVar2 = (uVar1 & 0x3f) << 6;
    *(uint *)(iRam00000000 + 0x60) = *(uint *)(iRam00000000 + 0x60) & 0xfffff03f | uVar2;
    _DAT_4000116c = _DAT_4000116c & 0xc0ffffff | uVar1 << 0x18;
    FUN_000128aa(0,uVar1);
    *(uint *)(iRam00000000 + 0x58) = *(uint *)(iRam00000000 + 0x58) & 0xfffff03f | uVar2;
    _DAT_4000116c = _DAT_4000116c & 0xffffc0ff | uVar1 << 8;
    _L0(0,uVar1);
    *(uint *)(iRam00000000 + 0x50) = *(uint *)(iRam00000000 + 0x50) & 0xfffff03f | uVar2;
    _DAT_40001168 = uVar1 << 0x18 | _DAT_40001168 & 0xc0ffffff;
    _L0(0,uVar1);
    *(uint *)(iRam00000000 + 0x48) = *(uint *)(iRam00000000 + 0x48) & 0xfffff03f | uVar2;
...

{
  ...
  *(uint *)(unaff_s0 + 0x48) = *(uint *)(unaff_s0 + 0x48) & 0xffff8fff | 0x6300;
  ...
  uVar2 = uVar1 & 0x3f;
  *(uint *)(iRam00000000 + 0x60) = *(uint *)(iRam00000000 + 0x60) & 0xffffffc0 | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & 0xffc0ffff | uVar1 << 0x10;
  FUN_000127ba(0,uVar1);
  *(uint *)(iRam00000000 + 0x58) = *(uint *)(iRam00000000 + 0x58) & 0xffffffc0 | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = uVar1 | *(uint *)(unaff_s0 + 0x16c) & 0xffffffc0;
  _L0(0,uVar1);
  *(uint *)(iRam00000000 + 0x50) = *(uint *)(iRam00000000 + 0x50) & 0xffffffc0 | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 0x10 | *(uint *)(unaff_s0 + 0x168) & 0xffc0ffff;
  _L0(0,uVar1);
  *(uint *)(iRam00000000 + 0x48) = *(uint *)(iRam00000000 + 0x48) & 0xffffffc0 | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 | *(uint *)(unaff_s0 + 0x168) & 0xffffffc0;
  _L0(0,uVar1);
  uVar1 = FUN_0001286c(0);
  uVar2 = (uVar1 & 0x3f) << 6;
  *(uint *)(iRam00000000 + 0x60) = *(uint *)(iRam00000000 + 0x60) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & 0xc0ffffff | uVar1 << 0x18;
  FUN_000128aa(0,uVar1);
  *(uint *)(iRam00000000 + 0x58) = *(uint *)(iRam00000000 + 0x58) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & 0xffffc0ff | uVar1 << 8;
  _L0(0,uVar1);
  *(uint *)(iRam00000000 + 0x50) = *(uint *)(iRam00000000 + 0x50) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 0x18 | *(uint *)(unaff_s0 + 0x168) & 0xc0ffffff;
  _L0(0,uVar1);
  *(uint *)(iRam00000000 + 0x48) = *(uint *)(iRam00000000 + 0x48) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 8 | *(uint *)(unaff_s0 + 0x168) & 0xffffc0ff;
  _L0(0,uVar1);
  _L0();
...

{
  ...
  *(uint *)(unaff_s0 + 0x48) = *(uint *)(unaff_s0 + 0x48) & 0xffff8fff | 0x6300;
  uVar1 = FUN_0001277c(1);
  uVar2 = uVar1 & 0x3f;
  *(uint *)(*unaff_s1 + 0x60) = *(uint *)(*unaff_s1 + 0x60) & 0xffffffc0 | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & unaff_s5 - 1U | uVar1 << 0x10;
  FUN_000127ba(0,uVar1);
  *(uint *)(*unaff_s1 + 0x58) = *(uint *)(*unaff_s1 + 0x58) & 0xffffffc0 | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = uVar1 | *(uint *)(unaff_s0 + 0x16c) & 0xffffffc0;
  _L0(0,uVar1);
  *(uint *)(*unaff_s1 + 0x50) = *(uint *)(*unaff_s1 + 0x50) & 0xffffffc0 | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 0x10 | *(uint *)(unaff_s0 + 0x168) & unaff_s5 - 1U;
  _L0(0,uVar1);
  *(uint *)(*unaff_s1 + 0x48) = *(uint *)(*unaff_s1 + 0x48) & 0xffffffc0 | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 | *(uint *)(unaff_s0 + 0x168) & 0xffffffc0;
  _L0(0,uVar1);
  uVar1 = FUN_0001286c(0);
  uVar2 = (uVar1 & 0x3f) << 6;
  *(uint *)(*unaff_s1 + 0x60) = *(uint *)(*unaff_s1 + 0x60) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & 0xc0ffffff | uVar1 << 0x18;
  FUN_000128aa(0,uVar1);
  *(uint *)(*unaff_s1 + 0x58) = *(uint *)(*unaff_s1 + 0x58) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & 0xffffc0ff | uVar1 << 8;
  _L0(0,uVar1);
  *(uint *)(*unaff_s1 + 0x50) = *(uint *)(*unaff_s1 + 0x50) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 0x18 | *(uint *)(unaff_s0 + 0x168) & 0xc0ffffff;
  _L0(0,uVar1);
  *(uint *)(*unaff_s1 + 0x48) = *(uint *)(*unaff_s1 + 0x48) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 8 | *(uint *)(unaff_s0 + 0x168) & 0xffffc0ff;
  _L0(0,uVar1);
  _L0();
  *(uint *)(unaff_s0 + 0x14) = *(uint *)(unaff_s0 + 0x14) | 0xc000;
...

{
  ...
  *(uint *)(unaff_s0 + 0x168) = unaff_s2 | *(uint *)(unaff_s0 + 0x168) & 0xffffffc0;
  ...
  uVar2 = (uVar1 & 0x3f) << 6;
  *(uint *)(*unaff_s1 + 0x60) = *(uint *)(*unaff_s1 + 0x60) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & unaff_s8 | uVar1 << 0x18;
  FUN_000128aa(0,uVar1);
  *(uint *)(*unaff_s1 + 0x58) = *(uint *)(*unaff_s1 + 0x58) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & unaff_s6 + 0xffU | uVar1 << 8;
  _L0(0,uVar1);
  *(uint *)(*unaff_s1 + 0x50) = *(uint *)(*unaff_s1 + 0x50) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 0x18 | *(uint *)(unaff_s0 + 0x168) & unaff_s8;
  _L0(0,uVar1);
  *(uint *)(*unaff_s1 + 0x48) = *(uint *)(*unaff_s1 + 0x48) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 8 | *(uint *)(unaff_s0 + 0x168) & unaff_s6 + 0xffU;
  _L0(0,uVar1);
  _L0();
  *(uint *)(unaff_s0 + 0x14) = *(uint *)(unaff_s0 + 0x14) | 0xc000;
  return;
...

{
  ...
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & unaff_s8 | uVar1 << 0x18;
  FUN_000128aa(0,uVar1);
  *(uint *)(*unaff_s1 + 0x58) = *(uint *)(*unaff_s1 + 0x58) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & unaff_s6 | uVar1 << 8;
  _L0(0,uVar1);
  *(uint *)(*unaff_s1 + 0x50) = *(uint *)(*unaff_s1 + 0x50) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 0x18 | *(uint *)(unaff_s0 + 0x168) & unaff_s8;
  _L0(0,uVar1);
  *(uint *)(*unaff_s1 + 0x48) = *(uint *)(*unaff_s1 + 0x48) & 0xfffff03f | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 8 | *(uint *)(unaff_s0 + 0x168) & unaff_s6;
  _L0(0,uVar1);
  _L0();
  *(uint *)(unaff_s0 + 0x14) = *(uint *)(unaff_s0 + 0x14) | 0xc000;
  return;
...

{
  ...
  uVar1 = FUN_0001286c(0);
  uVar2 = (uVar1 & 0x3f) << 6;
  *(uint *)(*unaff_s1 + 0x60) = *(uint *)(*unaff_s1 + 0x60) & unaff_s4 | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & unaff_s8 | uVar1 << 0x18;
  FUN_000128aa(0,uVar1);
  *(uint *)(*unaff_s1 + 0x58) = *(uint *)(*unaff_s1 + 0x58) & unaff_s4 | uVar2;
  *(uint *)(unaff_s0 + 0x16c) = *(uint *)(unaff_s0 + 0x16c) & unaff_s6 | uVar1 << 8;
  _L0(0,uVar1);
  *(uint *)(*unaff_s1 + 0x50) = *(uint *)(*unaff_s1 + 0x50) & unaff_s4 | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 0x18 | *(uint *)(unaff_s0 + 0x168) & unaff_s8;
  _L0(0,uVar1);
  *(uint *)(*unaff_s1 + 0x48) = *(uint *)(*unaff_s1 + 0x48) & unaff_s4 | uVar2;
  *(uint *)(unaff_s0 + 0x168) = uVar1 << 8 | *(uint *)(unaff_s0 + 0x168) & unaff_s6;
  _L0(0,uVar1);
  _L0();
  *(uint *)(unaff_s0 + 0x14) = *(uint *)(unaff_s0 + 0x14) | 0xc000;
...

{
  ...
  if ((_DAT_40001020 & 0x400) != 0) {
    ...
    iVar2 = _L0(1);
    iVar3 = FUN_000129ee(0);
    uVar5 = _DAT_40001080;
    iVar1 = iRam00000000;
    *(uint *)(iRam00000000 + 8) =
         *(uint *)(iRam00000000 + 8) & 0xffffffc0 | _DAT_40001080 >> 0x18 & 0x3f;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xfffff03f | (uVar5 >> 0x10 & 0x3f) << 6;
    *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xfffc0fff | (uVar5 >> 8 & 0x3f) << 0xc;
    *(uint *)(iVar1 + 8) = (uVar5 & 0x3f) << 0x12 | *(uint *)(iVar1 + 8) & 0xff03ffff;
    FUN_00012a80(0,*(uint *)(iVar1 + 8) & 0x3f,*(uint *)(iVar1 + 8) >> 0xc & 0x3f,
                 *(uint *)(iVar1 + 8) >> 6 & 0x3f,*(uint *)(iVar1 + 8) >> 0x12 & 0x3f);
    iVar1 = iRam00000000;
    uVar5 = *(uint *)(iRam00000000 + 8) & 0x3f;
    if (uVar5 < (*(uint *)(iRam00000000 + 8) >> 6 & 0x3f)) {
      uVar5 = *(uint *)(iRam00000000 + 8) >> 6 & 0x3f;
    }
    if (uVar5 < (*(uint *)(iRam00000000 + 8) >> 0xc & 0x3f)) {
      uVar5 = *(uint *)(iRam00000000 + 8) >> 0xc & 0x3f;
    }
    if (uVar5 < (*(uint *)(iRam00000000 + 8) >> 0x12 & 0x3f)) {
      uVar5 = *(uint *)(iRam00000000 + 8) >> 0x12 & 0x3f;
    }
    uVar4 = 0x18;
    if (0x27 < uVar5) {
      uVar4 = 0x3f - uVar5;
    ...
    uVar4 = uVar4 & 0xff;
    *(uint *)(iRam00000000 + 8) =
         *(uint *)(iRam00000000 + 8) & 0xffffffc0 | *(int *)(iRam00000000 + 8) + uVar4 & 0x3f;
    *(uint *)(iVar1 + 8) =
         ((*(uint *)(iVar1 + 8) >> 6) + uVar4 & 0x3f) << 6 | *(uint *)(iVar1 + 8) & 0xfffff03f;
    *(uint *)(iVar1 + 8) =
         ((*(uint *)(iVar1 + 8) >> 0xc) + uVar4 & 0x3f) << 0xc | *(uint *)(iVar1 + 8) & 0xfffc0fff;
    *(uint *)(iVar1 + 8) =
         ((*(uint *)(iVar1 + 8) >> 0x12) + uVar4 & 0x3f) << 0x12 | *(uint *)(iVar1 + 8) & 0xff03ffff
    ;
    _LVL772(*(uint *)(iVar1 + 8) & 0x3f);
    FUN_00012b5e(0,*(uint *)(iRam00000000 + 8) >> 6 & 0x3f);
    FUN_00012b90(0,*(uint *)(iRam00000000 + 8) & 0x3f,*(uint *)(iRam00000000 + 8) >> 0xc & 0x3f,
                 *(uint *)(iRam00000000 + 8) >> 6 & 0x3f,*(uint *)(iRam00000000 + 8) >> 0x12 & 0x3f)
    ;
    _L0();
    if ((iVar2 == 2) || (iVar3 == 2)) {
...

{
  ...
  *(uint *)(unaff_s2 + 0x1c) = *(uint *)(unaff_s2 + 0x1c) | 0x800;
  ...
  iVar3 = FUN_000129ee(0);
  iVar1 = iRam00000000;
  uVar5 = *(uint *)(unaff_s2 + 0x80);
  *(uint *)(iRam00000000 + 8) = *(uint *)(iRam00000000 + 8) & 0xffffffc0 | uVar5 >> 0x18 & 0x3f;
  *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xfffff03f | (uVar5 >> 0x10 & 0x3f) << 6;
  *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xfffc0fff | (uVar5 >> 8 & 0x3f) << 0xc;
  *(uint *)(iVar1 + 8) = (uVar5 & 0x3f) << 0x12 | *(uint *)(iVar1 + 8) & 0xff03ffff;
  FUN_00012a80(0,*(uint *)(iVar1 + 8) & 0x3f,*(uint *)(iVar1 + 8) >> 0xc & 0x3f,
...

{
  ...
  iVar2 = FUN_000129ee();
  iVar1 = iRam00000000;
  uVar4 = *(uint *)(unaff_s2 + 0x80);
  *(uint *)(iRam00000000 + 8) = *(uint *)(iRam00000000 + 8) & 0xffffffc0 | uVar4 >> 0x18 & 0x3f;
  *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xfffff03f | (uVar4 >> 0x10 & 0x3f) << 6;
  *(uint *)(iVar1 + 8) = *(uint *)(iVar1 + 8) & 0xfffc0fff | (uVar4 >> 8 & 0x3f) << 0xc;
  *(uint *)(iVar1 + 8) = (uVar4 & 0x3f) << 0x12 | *(uint *)(iVar1 + 8) & 0xff03ffff;
  FUN_00012a80(0,*(uint *)(iVar1 + 8) & 0x3f,*(uint *)(iVar1 + 8) >> 0xc & 0x3f,
               *(uint *)(iVar1 + 8) >> 6 & 0x3f,*(uint *)(iVar1 + 8) >> 0x12 & 0x3f);
  iVar1 = iRam00000000;
  uVar4 = *(uint *)(iRam00000000 + 8) & 0x3f;
  if (uVar4 < (*(uint *)(iRam00000000 + 8) >> 6 & 0x3f)) {
    uVar4 = *(uint *)(iRam00000000 + 8) >> 6 & 0x3f;
  }
  if (uVar4 < (*(uint *)(iRam00000000 + 8) >> 0xc & 0x3f)) {
    uVar4 = *(uint *)(iRam00000000 + 8) >> 0xc & 0x3f;
  }
  if (uVar4 < (*(uint *)(iRam00000000 + 8) >> 0x12 & 0x3f)) {
    uVar4 = *(uint *)(iRam00000000 + 8) >> 0x12 & 0x3f;
  }
  uVar3 = 0x18;
  if (0x27 < uVar4) {
    uVar3 = 0x3f - uVar4;
  ...
  uVar3 = uVar3 & 0xff;
  *(uint *)(iRam00000000 + 8) =
       *(uint *)(iRam00000000 + 8) & 0xffffffc0 | *(int *)(iRam00000000 + 8) + uVar3 & 0x3f;
  *(uint *)(iVar1 + 8) =
       ((*(uint *)(iVar1 + 8) >> 6) + uVar3 & 0x3f) << 6 | *(uint *)(iVar1 + 8) & 0xfffff03f;
  *(uint *)(iVar1 + 8) =
       ((*(uint *)(iVar1 + 8) >> 0xc) + uVar3 & 0x3f) << 0xc | *(uint *)(iVar1 + 8) & 0xfffc0fff;
  *(uint *)(iVar1 + 8) =
       ((*(uint *)(iVar1 + 8) >> 0x12) + uVar3 & 0x3f) << 0x12 | *(uint *)(iVar1 + 8) & 0xff03ffff;
  _LVL772(*(uint *)(iVar1 + 8) & 0x3f);
  FUN_00012b5e(0,*(uint *)(iRam00000000 + 8) >> 6 & 0x3f);
  FUN_00012b90(0,*(uint *)(iRam00000000 + 8) & 0x3f,*(uint *)(iRam00000000 + 8) >> 0xc & 0x3f,
               *(uint *)(iRam00000000 + 8) >> 6 & 0x3f,*(uint *)(iRam00000000 + 8) >> 0x12 & 0x3f);
  _L0();
  if ((unaff_s1 == 2) || (iVar2 == 2)) {
    _DAT_40001014 = _DAT_40001014 & 0xfff3ffff | 0x80000;
  }
  else {
    _DAT_40001014 = _DAT_40001014 | 0xc0000;
...

{
  ...
  *(uint *)(iVar2 + 8) =
  ...
  _LVL772(*(uint *)(iVar2 + 8) & 0x3f);
  FUN_00012b5e(0,*(uint *)(*unaff_s2 + 8) >> 6 & 0x3f);
  iVar2 = *unaff_s2;
  FUN_00012b90(0,*(uint *)(iVar2 + 8) & 0x3f,*(uint *)(iVar2 + 8) >> 0xc & 0x3f,
               *(uint *)(iVar2 + 8) >> 6 & 0x3f,*(uint *)(iVar2 + 8) >> 0x12 & 0x3f);
  _L0();
...

{
  ...
  FUN_00012b5e(0,*(uint *)(*unaff_s2 + 8) >> 6 & 0x3f);
  iVar1 = *unaff_s2;
  FUN_00012b90(0,*(uint *)(iVar1 + 8) & 0x3f,*(uint *)(iVar1 + 8) >> 0xc & 0x3f,
               *(uint *)(iVar1 + 8) >> 6 & 0x3f,*(uint *)(iVar1 + 8) >> 0x12 & 0x3f);
  _L0();
  if ((unaff_s1 == 2) || (unaff_s0 == 2)) {
    _DAT_40001014 = _DAT_40001014 & 0xfff3ffff | 0x80000;
...

{
  ...
  do {
    ...
    _L0(1);
    while (_DAT_400010a0 = _DAT_400010a0 & unaff_s4 - 1U | uVar1 << 0x10, uVar4 != 0xffffffff) {
      _L0(1);
      iVar3 = 1 << (uVar4 & 0x1f);
      if ((int)(_DAT_400010a4 << 0x13) < 0) {
        iVar3 = -iVar3;
...

{
  ...
  while( true ) {
    _L0(param_1);
    while (*(uint *)(unaff_s0 + 0xa0) = *(uint *)(unaff_s0 + 0xa0) & unaff_s4 | unaff_s1 << 0x10,
          unaff_s8 != unaff_s9) {
      _L0(1);
...

{
  ...
  while( true ) {
    ...
    *(undefined4 *)(unaff_s0 + 0xc4) = *unaff_s3;
    _L0(1);
    while (*(uint *)(unaff_s0 + 0xa0) = *(uint *)(unaff_s0 + 0xa0) & unaff_s4 | param_3 << 0x10,
          uVar2 != 0xffffffff) {
      _L0(1);
      iVar1 = 1 << (uVar2 & 0x1f);
      if (*(int *)(unaff_s0 + 0xa4) << 0x13 < 0) {
...

{
  ...
  uVar9 = uRam00000000 & 0xffff;
  uVar2 = uRam00000000 >> 0x10;
  uVar8 = (uint)_DAT_00000004;
  ...
  uVar3 = FUN_00012e84(uVar2);
  uRam00000000 = uRam00000000 & 0xffff0000 | (uint)uVar3;
  iVar10 = 0;
  do {
    uVar2 = uVar2 - 1 & 0xffff;
    uVar9 = _LVL878(uVar2);
    *(short *)(iVar10 + 2) = (short)uVar9;
  ...
  uVar2 = 0;
  do {
    while (uVar8 = uVar2 & 0xffff, *(ushort *)(uVar2 * 2) < *puVar5) {
      uVar2 = (int)((uVar8 + 1) * 0x10000) >> 0x10;
    }
    *puVar5 = ((short)uVar1 + 2) - (short)uVar8;
    if ((int)uVar2 < 1) {
      uVar2 = 0;
    }
    else {
    ...
    puVar5 = puVar5 + 1;
  } while (puVar5 != (ushort *)0x2a);
  puVar5 = (ushort *)0x0;
  _LVL910();
  iVar10 = 0;
  do {
    iVar6 = uRam00000000 + (iVar10 + 8) * 2;
    iVar10 = iVar10 + 1;
    *(ushort *)(iVar6 + 0xc) = *(ushort *)(iVar6 + 0xc) & 0xff00 | *puVar5 & 0xff;
    FUN_00012fd2(0,iVar10);
    puVar5 = puVar5 + 1;
  } while (iVar10 != 0x15);
...

{
  ...
  *(uint *)(unaff_s0 + 0xa4) = *(uint *)(unaff_s0 + 0xa4) & 0xfffffffc | 2;
  ...
  do {
    ...
    if (0xe < uVar1) break;
    _L0(0,uVar1);
    _DAT_400010c0 = _DAT_400010c0 & uVar2;
    _DAT_400010b8 = _DAT_400010b8 | 0x10000;
    _L0(0x32);
    _DAT_400010c0 = _DAT_400010c0 | 0x10000;
    _DAT_400010b8 = _DAT_400010b8 & uVar2;
    _L0(0x32);
  } while( true );
  uVar2 = uVar1 + 1 & 0xffff;
  uVar3 = FUN_00012e84(uVar2);
  ...
  do {
    ...
    *(short *)(iVar8 + 2) = (short)uVar7;
    if (unaff_s3 < uVar7) break;
    iVar8 = iVar8 + 2;
  } while (uVar2 != (uVar1 - 0x26 & 0xffff));
  puVar5 = (ushort *)0x0;
  uVar2 = 0;
  do {
    while (uVar7 = uVar2 & 0xffff, *(ushort *)(uVar2 * 2) < *puVar5) {
      uVar2 = (int)((uVar7 + 1) * 0x10000) >> 0x10;
    }
    *puVar5 = ((short)uVar1 + 2) - (short)uVar7;
    if ((int)uVar2 < 1) {
      uVar2 = 0;
    }
    else {
  ...
  iVar8 = 0;
  do {
    iVar6 = uRam00000000 + (iVar8 + 8) * 2;
    iVar8 = iVar8 + 1;
    *(ushort *)(iVar6 + 0xc) = *(ushort *)(iVar6 + 0xc) & 0xff00 | *puVar5 & 0xff;
    FUN_00012fd2(0,iVar8);
    puVar5 = puVar5 + 1;
  } while (iVar8 != 0x15);
  _DAT_40001014 = _DAT_40001014 | 0x30;
  return;
...

{
  ...
  *(uint *)(unaff_s0 + 0xa4) = *(uint *)(unaff_s0 + 0xa4) & 0xfffffffc | 2;
  ...
  do {
    uVar6 = 6;
    uVar1 = 0x80;
    while (uVar6 != unaff_s9) {
      uVar3 = FUN_00012e66(uVar1);
      if (uVar3 < unaff_s4) {
        iVar7 = -(unaff_s6 << (uVar6 & 0x1f));
      }
      else {
        if (uVar3 <= unaff_s5) break;
        iVar7 = unaff_s6 << (uVar6 & 0x1f);
      }
    ...
    _L0(uVar1);
    _DAT_400010c0 = _DAT_400010c0 & unaff_s1;
    _DAT_400010b8 = _DAT_400010b8 | 0x10000;
    _L0(0x32);
    _DAT_400010c0 = _DAT_400010c0 | 0x10000;
    _DAT_400010b8 = _DAT_400010b8 & unaff_s1;
    _L0(0x32);
  } while( true );
  uVar6 = uVar1 + 1 & 0xffff;
  uVar2 = FUN_00012e84(uVar6);
  uRam00000000 = uRam00000000 & 0xffff0000 | (uint)uVar2;
  iVar7 = 0;
  do {
    uVar6 = uVar6 - 1 & 0xffff;
    uVar3 = _LVL878(uVar6);
    *(short *)(iVar7 + 2) = (short)uVar3;
    if (unaff_s3 < uVar3) break;
    iVar7 = iVar7 + 2;
  } while (uVar6 != (uVar1 - 0x26 & 0xffff));
  puVar4 = (ushort *)0x0;
  uVar6 = 0;
  do {
    while (uVar3 = uVar6 & 0xffff, *(ushort *)(uVar6 * 2) < *puVar4) {
      uVar6 = (int)((uVar3 + 1) * 0x10000) >> 0x10;
    }
    *puVar4 = ((short)uVar1 + 2) - (short)uVar3;
    if ((int)uVar6 < 1) {
      uVar6 = 0;
    }
    else {
    ...
    puVar4 = puVar4 + 1;
  } while (puVar4 != (ushort *)0x2a);
  puVar4 = (ushort *)0x0;
  _LVL910();
  iVar7 = 0;
  do {
    iVar5 = uRam00000000 + (iVar7 + 8) * 2;
    iVar7 = iVar7 + 1;
    *(ushort *)(iVar5 + 0xc) = *(ushort *)(iVar5 + 0xc) & 0xff00 | *puVar4 & 0xff;
    FUN_00012fd2(0,iVar7);
    puVar4 = puVar4 + 1;
  } while (iVar7 != 0x15);
  _DAT_40001014 = _DAT_40001014 | 0x30;
  return;
...

{
  ...
  do {
    uVar2 = FUN_00012e66(param_1);
    if (uVar2 < unaff_s4) {
      iVar6 = -(unaff_s6 << (unaff_s2 & 0x1f));
_L0:
      unaff_s0 = unaff_s0 + iVar6 & 0xffff;
      unaff_s2 = unaff_s2 - 1;
      goto _L0;
    }
    if (unaff_s5 < uVar2) {
    ...
    do {
      if (unaff_s8 < unaff_s0) {
        uVar2 = unaff_s0 + 1 & 0xffff;
        uVar1 = FUN_00012e84(uVar2);
        uRam00000000 = uRam00000000 & 0xffff0000 | (uint)uVar1;
        iVar6 = 0;
        goto _L0;
      }
      _L0(unaff_s0);
...
_L0:
  ...
  while (iVar6 = iVar6 + 2, uVar2 != (unaff_s0 - 0x26 & 0xffff)) {
_L0:
    uVar2 = uVar2 - 1 & 0xffff;
    uVar3 = _LVL878(uVar2);
  ...
  uVar2 = 0;
  do {
    while (uVar3 = uVar2 & 0xffff, *(ushort *)(uVar2 * 2) < *puVar4) {
      uVar2 = (int)((uVar3 + 1) * 0x10000) >> 0x10;
    }
    *puVar4 = ((short)unaff_s0 + 2) - (short)uVar3;
    if ((int)uVar2 < 1) {
      uVar2 = 0;
    }
    else {
  ...
  iVar6 = 0;
  do {
    iVar5 = uRam00000000 + (iVar6 + 8) * 2;
    iVar6 = iVar6 + 1;
    *(ushort *)(iVar5 + 0xc) = *(ushort *)(iVar5 + 0xc) & 0xff00 | *puVar4 & 0xff;
    FUN_00012fd2(0,iVar6);
    puVar4 = puVar4 + 1;
  } while (iVar6 != 0x15);
  _DAT_40001014 = _DAT_40001014 | 0x30;
  return;
...

{
  ...
  do {
    unaff_s1 = unaff_s1 + -1;
    uVar2 = _LVL878(unaff_s1);
    *(short *)(iVar6 + 2) = (short)uVar2;
    if (unaff_s3 < uVar2) break;
    iVar6 = iVar6 + 2;
  } while (unaff_s1 != (short)(unaff_s0 + -0x26));
  puVar3 = (ushort *)0x0;
  uVar2 = 0;
  do {
    while (uVar4 = uVar2 & 0xffff, *(ushort *)(uVar2 * 2) < *puVar3) {
      uVar2 = (int)((uVar4 + 1) * 0x10000) >> 0x10;
    }
    *puVar3 = (unaff_s0 + 2) - (short)uVar4;
    if ((int)uVar2 < 1) {
      uVar2 = 0;
    }
    else {
  ...
  do {
    iVar5 = uRam00000000 + (iVar6 + 8) * 2;
    iVar6 = iVar6 + 1;
    *(ushort *)(iVar5 + 0xc) = *(ushort *)(iVar5 + 0xc) & 0xff00 | *puVar3 & 0xff;
    FUN_00012fd2(0,iVar6);
    puVar3 = puVar3 + 1;
  } while (iVar6 != 0x15);
  _DAT_40001014 = _DAT_40001014 | 0x30;
...

{
  ...
  while( true ) {
    uVar2 = _LVL878(param_1);
    *(short *)(unaff_s4 + 2) = (short)uVar2;
    if ((unaff_s3 < uVar2) || (unaff_s4 = unaff_s4 + 2, unaff_s1 == unaff_s2)) break;
  ...
  uVar2 = 0;
  do {
    while (uVar4 = uVar2 & 0xffff, *(ushort *)(uVar2 * 2 + unaff_s5) < *puVar3) {
      uVar2 = (int)((uVar4 + 1) * 0x10000) >> 0x10;
    }
    *puVar3 = (unaff_s0 + 2) - (short)uVar4;
    if ((int)uVar2 < 1) {
  ...
  iVar1 = 0;
  do {
    iVar5 = iRam00000000 + (iVar1 + 8) * 2;
    iVar1 = iVar1 + 1;
    *(ushort *)(iVar5 + 0xc) = *(ushort *)(iVar5 + 0xc) & 0xff00 | *puVar3 & 0xff;
    FUN_00012fd2(0,iVar1);
    puVar3 = puVar3 + 1;
  } while (iVar1 != 0x15);
  _DAT_40001014 = _DAT_40001014 | 0x30;
  return;
...

{
  ...
  do {
    ...
    *(uint *)(unaff_s0 + 0xb8) = *(uint *)(unaff_s0 + 0xb8) & unaff_s1;
    ...
    uVar5 = 6;
    param_1 = 0x80;
    while (uVar5 != unaff_s9) {
      uVar2 = FUN_00012e66(param_1);
      if (uVar2 < unaff_s4) {
        iVar6 = -(unaff_s6 << (uVar5 & 0x1f));
      }
      else {
        if (uVar2 <= unaff_s5) break;
        iVar6 = unaff_s6 << (uVar5 & 0x1f);
      }
      param_1 = param_1 + iVar6 & 0xffff;
      uVar5 = uVar5 - 1;
    }
  ...
  do {
    ...
    *(short *)(iVar6 + 2) = (short)uVar2;
    if (unaff_s3 < uVar2) break;
    iVar6 = iVar6 + 2;
  } while (uVar5 != (param_1 - 0x26 & 0xffff));
  puVar3 = (ushort *)0x0;
  uVar5 = 0;
  do {
    while (uVar2 = uVar5 & 0xffff, *(ushort *)(uVar5 * 2) < *puVar3) {
      uVar5 = (int)((uVar2 + 1) * 0x10000) >> 0x10;
    }
    *puVar3 = ((short)param_1 + 2) - (short)uVar2;
    if ((int)uVar5 < 1) {
      uVar5 = 0;
    }
    else {
...

{
  ...
  _L0(CONCAT31(in_register_0000202d,chipv));
