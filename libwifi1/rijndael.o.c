...

{
  ...
  if (encrypt == 0) {
    ctx->decrypt = 1;
    if (iVar3 == 0) {
      iVar3 = _LVL17(puVar2,key,bits);
    }
    puVar5 = puVar2;
    puVar7 = ctx->key + iVar3 * 4 + -2;
    while (encrypt < iVar3 * 4 - encrypt) {
      uVar4 = *puVar5;
      encrypt = encrypt + 4;
      *puVar5 = puVar7[2];
      puVar7[2] = uVar4;
    ...
    while (iVar1 < iVar3) {
      ...
      uVar6 = *puVar5;
      iVar1 = iVar1 + 1;
      *puVar5 = *(uint *)((uint)*(byte *)(uVar6 >> 8 & 0xff) * 4) ^
                *(uint *)((uint)*(byte *)(uVar6 >> 0x18) * 4) ^
                *(uint *)((uint)*(byte *)(uVar6 & 0xff) * 4) ^
                *(uint *)((uint)*(byte *)(uVar6 >> 0x10 & 0xff) * 4);
      uVar6 = puVar2[5];
      puVar2[5] = *(uint *)((uint)*(byte *)(uVar6 >> 8 & 0xff) * 4) ^
                  *(uint *)((uint)*(byte *)(uVar6 >> 0x18) * 4) ^
                  *(uint *)((uint)*(byte *)(uVar6 & 0xff) * 4) ^
                  *(uint *)((uint)*(byte *)(uVar6 >> 0x10 & 0xff) * 4);
      uVar6 = puVar2[6];
      puVar2[6] = *(uint *)((uint)*(byte *)(uVar6 >> 8 & 0xff) * 4) ^
                  *(uint *)((uint)*(byte *)(uVar6 >> 0x18) * 4) ^
                  *(uint *)((uint)*(byte *)(uVar6 & 0xff) * 4) ^
                  *(uint *)((uint)*(byte *)(uVar6 >> 0x10 & 0xff) * 4);
      uVar6 = puVar2[7];
      puVar2[7] = *(uint *)((uint)*(byte *)(uVar6 >> 8 & 0xff) * 4) ^
                  *(uint *)((uint)*(byte *)(uVar6 >> 0x18) * 4) ^
                  *(uint *)((uint)*(byte *)(uVar6 & 0xff) * 4) ^
                  *(uint *)((uint)*(byte *)(uVar6 >> 0x10 & 0xff) * 4);
      puVar2 = puVar5;
...

{
  ...
  if (unaff_s2 == 0) {
    *unaff_s0 = 1;
    ...
    while (unaff_s2 < iVar2 * 4 - unaff_s2) {
      uVar4 = *puVar3;
      unaff_s2 = unaff_s2 + 4;
      *puVar3 = puVar5[2];
      puVar5[2] = uVar4;
...

{
  ...
  while (unaff_s2 < iVar2 * 4 - unaff_s2) {
    ...
    *(uint *)(iVar1 + 8) = uVar4;
    uVar4 = puVar3[1];
    puVar3[1] = *(uint *)(iVar1 + 0xc);
    *(uint *)(iVar1 + 0xc) = uVar4;
    uVar4 = puVar3[2];
    puVar3[2] = *(uint *)(iVar1 + 0x10);
    *(uint *)(iVar1 + 0x10) = uVar4;
    uVar4 = puVar3[3];
    puVar3[3] = *(uint *)(iVar1 + 0x14);
