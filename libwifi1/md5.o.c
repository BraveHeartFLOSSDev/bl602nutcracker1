...
union anon_union.conflicta1_for___value { // DWARF DIE: a1
    wint_t __wch;
    uchar __wchb[4];
};

struct _mbstate_t { // DWARF DIE: d3
    int __count;
...
union anon_union.conflicta1 { // DWARF DIE: a1
    wint_t __wch;
    uchar __wchb[4];
};
...
struct la_mem_format { // DWARF DIE: a79
    uint32_t word[4];
};
...
struct debug_env_tag { // DWARF DIE: ab1
...
struct anon_struct.conflict834 { // DWARF DIE: 834
    uchar * _nextf[30];
    uint _nmalloc[30];
};

struct _Bigint { // DWARF DIE: 129
...
struct _rand48 { // DWARF DIE: 6a6
    ushort _seed[3];
    ushort _mult[3];
    ushort _add;
};

struct _glue { // DWARF DIE: 661
    struct _glue * _next;
    int _niobs;
    __FILE * _iobs;
};

struct _on_exit_args { // DWARF DIE: 21c
    void * _fnargs[32];
    void * _dso_handle[32];
    __ULong _fntypes;
    __ULong _is_cxa;
...
struct anon_struct.conflict6ef { // DWARF DIE: 6ef
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict87b_for__new { // DWARF DIE: 87b
    struct anon_struct.conflict6ef _reent;
    struct anon_struct.conflict834 _unused;
};

struct __sbuf { // DWARF DIE: 2d1
    uchar * _base;
    int _size;
};

struct __sFILE { // DWARF DIE: 2ff
    uchar * _p;
    int _r;
    int _w;
    short _flags;
...
struct Bl_MD5_CTX { // DWARF DIE: b19
    ulong state[4];
    ulong count[2];
    ulong scratch[16];
    uchar buffer[64];
...

{
  ...
  uVar1 = 0x40 - (uVar1 >> 3 & 0x3f);
  if (uVar1 <= inputLen) {
    _LVL329();
    FUN_00010948();
    for (; uVar1 + 0x3f < inputLen; uVar1 += 0x40) {
      FUN_0001098c((int)(input + uVar1),0x40);
      FUN_00010998();
    }
  }
  do {
...

{
  ...
  _LVL329();
  FUN_00010948();
  for (; unaff_s1 + 0x3fU < unaff_s2; unaff_s1 += 0x40) {
    FUN_0001098c(unaff_s3 + unaff_s1,0x40);
    FUN_00010998();
  }
  do {
                    // WARNING: Do nothing block with infinite loop
