...
union anon_union.conflict1259_for_field_4 {
...
union anon_union.conflict1234_for_field_3 {
...
union anon_union.conflict127e_for_field_5 {
    uint32_t dataendptr;
...
union anon_union.conflict2c7a_for_field_0 {
...
union anon_union.conflict4801_for_keyEncypt {
...
union anon_union.conflict3c11_for_intf {
    uint32 Interface;
};

union anon_union.conflict569e_for_specDat {
...
struct anon_struct.conflictb29 {
    uint32_t key[4];
};

struct anon_struct.conflictaf2 {
    uint32_t tx_key[2];
    uint32_t rx_key[2];
};

union anon_union.conflictb52 {
...
union anon_union.conflictb52_for_u {
    struct anon_struct.conflictaf2 mic;
    struct anon_struct.conflictb29 mfp;
};
...
union anon_union.conflict4fa1_for_key {
    IEEEtypes_MacAddr_t Bssid;
    char Ssid[32];
};
...
union anon_union.conflict127_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflict3810 {
    uint32_t dummy;
...
struct anon_struct.conflict3743 {
...
union anon_union.conflict390b_for_u {
...
union anon_union.conflict3136_for_rate_map {
    uint8_t ht[4];
};
...
struct anon_struct.conflict8ae {
    uchar * _nextf[30];
    uint _nmalloc[30];
};
...
struct anon_struct.conflict769 {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict8f5_for__new {
...

{
  ...
  iVar2 = _L0(4);
  if (((iVar2 == 0) && ((char)iRam00000000 != '\0')) && (piVar1 = _DAT_00000008, _DAT_00000004 == 0)
     ) {
    while (piVar1 != (int *)0x0) {
      iVar2 = FUN_00010122(piVar1);
...

{
  ...
  iVar2 = _L0();
  if (((iVar2 == 0) && (cRam00000000 != '\0')) && (piVar1 = _DAT_00000008, _DAT_00000004 == 0)) {
    while (piVar1 != (int *)0x0) {
      iVar2 = FUN_00010122(piVar1);
      if ((iVar2 != 0) && (piVar1[1] != 0)) {
        return 0;
