...
union anon_union.conflict2137_for_key {
    IEEEtypes_MacAddr_t Bssid;
    char Ssid[32];
};
...
union anon_union.conflict170f_for_keyEncypt {
...
union anon_union.conflict1255_for_intf {
    uint32 Interface;
};
...
union anon_union.conflict2834_for_specDat {
...

{
  ...
  iVar1 = _LVL10();
  if (iVar1 != 0) {
    uVar2 = FUN_00010058(0x120);
    *(undefined4 *)(iVar1 + 8) = uVar2;
    unaff_s1[1] = iVar1;
    *unaff_s1 = *(undefined4 *)(iVar1 + 8);
    _L0();
  }
  return iVar1 == 0;
}
...

{
  ...
  IEEEtypes_Addr_t *pIVar3;
  
  pcVar1 = (cm_ConnectionInfo_t *)
           _L0(0xec,CONCAT31(in_register_0000202d,bssType),CONCAT31(in_register_00002031,bssNum),
               CONCAT31(in_register_0000203d,channel));
  if (pcVar1 != (cm_ConnectionInfo_t *)0x0) {
    ...
    if (iVar2 == 1) {
      ...
      if (peerMacAddr != (IEEEtypes_MacAddr_t *)0x0) {
        FUN_00010102(pcVar1->peerMacAddr,peerMacAddr,6);
      }
      pIVar3 = (pcVar1->comData).BssId;
      FUN_00010114(pIVar3,0,6);
      FUN_00010126(&pcVar1->comData,0,0x20);
      (pcVar1->comData).SsIdLen = '\0';
      if (bssId != (IEEEtypes_MacAddr_t *)0x0) {
        FUN_0001013a(pIVar3,bssId,6);
        FUN_0001014a(pcVar1->localMacAddr,bssId,6);
      }
    }
  }
  return pcVar1;
  ...
  if (puVar1 != (undefined *)0x0) {
    ...
    *puVar1 = unaff_s3;
    ...
    if (iVar2 == 1) {
      ...
      if (unaff_s2 != 0) {
        FUN_00010102(puVar1 + 0x40,6);
      }
      FUN_00010114(puVar1 + 0x30,0,6);
      FUN_00010126(puVar1 + 0xc,0,0x20);
      puVar1[0x2c] = 0;
      if (unaff_s1 != 0) {
        FUN_0001013a(puVar1 + 0x30,6);
        FUN_0001014a(puVar1 + 0x46,6);
      }
    }
  }
  return puVar1;
...

{
  ...
  *unaff_s0 = unaff_s3;
  ...
  if (iVar1 == 1) {
    ...
    if (unaff_s2 != 0) {
      FUN_00010102(unaff_s0 + 0x40,6);
    }
    FUN_00010114(unaff_s0 + 0x30,0,6);
    FUN_00010126(unaff_s0 + 0xc,0,0x20);
    unaff_s0[0x2c] = 0;
    if (unaff_s1 != 0) {
      FUN_0001013a(unaff_s0 + 0x30,6);
      FUN_0001014a(unaff_s0 + 0x46,6);
    }
  }
  return unaff_s0;
}
...

{
  ...
  if (connPtr->conType == '\x02') {
    puVar1 = (undefined4 *)_L0();
    if (puVar1[1] != 0) {
      FUN_00010178(*(undefined4 *)(puVar1[1] + 8));
      FUN_00010182(puVar1[1]);
      puVar1[1] = 0;
      *puVar1 = 0;
    }
  }
...
{
  if (bssId != (IEEEtypes_MacAddr_t *)0x0) {
    _LVL46((connPtr->comData).BssId,6);
  }
  if (peerMacAddr == (IEEEtypes_MacAddr_t *)0x0) {
    return;
  }
...

{
  ...
  if (ssid != (char *)0x0) {
    IVar1 = FUN_000101f2(ssid);
    (connPtr->comData).SsIdLen = IVar1;
    FUN_00010208(&connPtr->comData,ssid,0x20);
...

{
  ...
  uVar1 = FUN_000101f2();
  *(undefined *)(unaff_s0 + 0x2c) = uVar1;
  FUN_00010208(unaff_s0 + 0xc,in_stack_0000000c,0x20);
