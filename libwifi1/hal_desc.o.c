...
union anon_union.conflictce_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
union anon_union.conflictc3d_for_field_4 {
...
union anon_union.conflictc62_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflictc18_for_field_3 {
