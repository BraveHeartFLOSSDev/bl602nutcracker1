...

{
  ...
  list->last = (co_list_hdr *)0x0;
  uVar1 = 0;
  while (uVar1 != elmt_cnt) {
    if (default_value != (void *)0x0) {
      FUN_00010094(pool,default_value,elmt_size);
    }
    FUN_000100a0(list,pool);
...
_Bool co_list_find(co_list_hdr *list_hdr)

{
  ...
  do {
    ...
    if ((co_list_hdr)list_hdr == in_a1) break;
  } while ((co_list_hdr)list_hdr != (co_list_hdr)0x0);
  return (_Bool)(in_a1 == (co_list_hdr)list_hdr);
}
...
_L0:
    ...
    if (prev_element->next != element) {
      FUN_00010276(0,0,0x169);
    }
    if (element == (co_list_hdr *)0x0) {
_L0:
      FUN_000102a8(0,0,0x16a);
...

{
  ...
  FUN_00010276();
  if ((unaff_s0 == (undefined4 *)0x0) && (FUN_000102a8(0,0,0x16a), unaff_s1 == (undefined4 *)0x0)) {
