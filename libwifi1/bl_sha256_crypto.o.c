...

{
  ...
  while ((uint)uStack98 <= (CONCAT22(in_register_00002046,output_len) + 0xff >> 8 & 0xffU)) {
    ...
    _L0(pKey,CONCAT31(in_register_0000202d,key_len),4,&stack0xffffffa0,vectors + 3,pUVar1);
    pUVar1 = pUVar1 + 0x20;
    uStack98 = uStack98 + 1;
  }
  FUN_0001005e(pOutput,pContext + CONCAT22(in_register_0000203e,context_len),aUStack114[0] >> 3);
  return;
}
...

{
  ...
  while( true ) {
    ...
    in_stack_0000001e = in_stack_0000001e + 1;
  ...
  FUN_0001005e(in_stack_00000008,in_stack_0000000e >> 3);
  return;
}
