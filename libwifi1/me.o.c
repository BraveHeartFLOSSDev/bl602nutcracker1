...
union anon_union.conflict2c59_for_field_0 {
...
struct anon_struct.conflict33de {
    uint8_t mac[6];
    uint8_t used;
};
...
struct anon_struct.conflict382c {
    uint32_t dummy;
...
struct anon_struct.conflict375f {
...
union anon_union.conflict3927_for_u {
...
union anon_union.conflict2641_for_rate_map {
    uint8_t ht[4];
};
