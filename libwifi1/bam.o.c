...
union anon_union.conflict1505_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflict14e0_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflict14bb_for_field_3 {
...
union anon_union.conflict2a1d_for_field_0 {
...
struct anon_struct.conflict34c7 {
...
struct anon_struct.conflict3594 {
    uint32_t dummy;
...
union anon_union.conflict368f_for_u {
...
union anon_union.conflict2ff1_for_rate_map {
    uint8_t ht[4];
};
...

{
  ...
  iVar8 = CONCAT31(in_register_00002029,sta_idx) * 0x1b0;
  bVar1 = *(byte *)(iVar8 + 0x1a);
  _L0(acStack72,0);
  iVar3 = _LVL9(acStack72[0] != '\0',0x100);
  if (iVar3 == 0) {
    return;
  }
  iVar9 = (uint)bVar1 * 0x5d8;
  FUN_0001009c(iVar9,iVar3);
  iVar5 = *(int *)(iVar3 + 0x68);
  *(undefined *)(iVar5 + 0x14c) = 0xd0;
  *(undefined *)(iVar5 + 0x14d) = 0;
  *(undefined *)(iVar5 + 0x14e) = 0;
  *(undefined *)(iVar5 + 0x14f) = 0;
  *(undefined2 *)(iVar5 + 0x150) = *(undefined2 *)(iVar8 + 0x1e);
  *(undefined2 *)(iVar5 + 0x152) = *(undefined2 *)(iVar8 + 0x20);
  *(undefined2 *)(iVar5 + 0x154) = *(undefined2 *)(iVar8 + 0x22);
  *(undefined2 *)(iVar5 + 0x156) = *(undefined2 *)(iVar9 + 0x50);
  *(undefined2 *)(iVar5 + 0x158) = *(undefined2 *)(iVar9 + 0x52);
  *(undefined2 *)(iVar5 + 0x15a) = *(undefined2 *)(iVar9 + 0x54);
  if (*(char *)(iVar9 + 0x56) == '\x02') {
    *(undefined2 *)(iVar5 + 0x15c) = *(undefined2 *)(iVar9 + 0x50);
    *(undefined2 *)(iVar5 + 0x15e) = *(undefined2 *)(iVar9 + 0x52);
    uVar6 = *(undefined2 *)(iVar9 + 0x54);
  }
  else {
    *(undefined2 *)(iVar5 + 0x15c) = *(undefined2 *)(iVar8 + 0x1e);
    *(undefined2 *)(iVar5 + 0x15e) = *(undefined2 *)(iVar8 + 0x20);
    uVar6 = *(undefined2 *)(iVar8 + 0x22);
  }
  *(undefined2 *)(iVar5 + 0x160) = uVar6;
  uVar7 = (uint)_DAT_00000054;
  _DAT_00000054 = (ushort)((uVar7 + 1) * 0x10000 >> 0x10);
  iVar8 = (uVar7 + 1) * 0x100000;
  *(char *)(iVar5 + 0x162) = (char)((uint)iVar8 >> 0x10);
  *(char *)(iVar5 + 0x163) = (char)((uint)iVar8 >> 0x18);
  *(byte *)(iVar3 + 0x2f) = bVar1;
  *(uint8_t *)(iVar3 + 0x30) = sta_idx;
  if (iVar4 == 1) {
    iVar4 = _LVL48(iVar5 + 0x164,bam_env,CONCAT22(in_register_0000203a,param),
                   CONCAT31(in_register_00002035,dialog_token),
                   CONCAT22(in_register_0000203e,status_code));
_L0:
    iVar4 = iVar4 + 0x18;
  }
  else {
    if (iVar4 == 0) {
      uVar2 = *(undefined *)(CONCAT22(in_register_0000203a,param) >> 2 & 0xf);
      iVar4 = _L0(iVar5 + 0x164,bam_env);
      iVar4 = iVar4 + 0x18;
      goto _L0;
    }
    if (iVar4 == 2) {
      iVar4 = _LVL53(iVar5 + 0x164,bam_env,CONCAT22(in_register_0000203e,status_code));
      goto _L0;
    }
    FUN_00010174(0,0,0x25d);
    iVar4 = 0x18;
  }
  uVar2 = 3;
_L0:
  iVar8 = *(int *)(iVar3 + 0x6c);
  *(int *)(iVar8 + 0x18) = *(int *)(iVar8 + 0x14) + -1 + iVar4;
  *(int *)(iVar8 + 0x1c) = iVar4 + 4;
  if (cfm_func != (anon_subr_void_void_ptr_uint32_t *)0x0) {
    *(anon_subr_void_void_ptr_uint32_t **)(iVar3 + 0x2cc) = cfm_func;
    *(bam_env_tag **)(iVar3 + 0x2d0) = bam_env;
  }
  _LVL41(iVar3,uVar2);
  return;
}
...

{
  ...
  _L0();
  iVar2 = _LVL9(in_stack_00000018 != '\0',0x100);
  if (iVar2 == 0) {
    return;
  }
  iVar6 = unaff_s4 * 0x5d8;
  puVar7 = (undefined2 *)(unaff_s8 + unaff_s5 + 0x1e);
  iStack00000008 = iVar6;
  FUN_0001009c(iVar6,iVar2);
  iVar3 = *(int *)(iVar2 + 0x68);
  *(undefined *)(iVar3 + 0x14c) = 0xd0;
  *(undefined *)(iVar3 + 0x14d) = 0;
  *(undefined *)(iVar3 + 0x14e) = 0;
  *(undefined *)(iVar3 + 0x14f) = 0;
  *(undefined2 *)(iVar3 + 0x150) = *puVar7;
  *(undefined2 *)(iVar3 + 0x152) = puVar7[1];
  *(undefined2 *)(iVar3 + 0x154) = puVar7[2];
  *(undefined2 *)(iVar3 + 0x156) = *(undefined2 *)(iVar6 + 0x50);
  *(undefined2 *)(iVar3 + 0x158) = *(undefined2 *)(iVar6 + 0x52);
  *(undefined2 *)(iVar3 + 0x15a) = *(undefined2 *)(iVar6 + 0x54);
  if (*(char *)(iStack00000008 + 0x56) == '\x02') {
    *(undefined2 *)(iVar3 + 0x15c) = *(undefined2 *)(iVar6 + 0x50);
    *(undefined2 *)(iVar3 + 0x15e) = *(undefined2 *)(iVar6 + 0x52);
    uVar4 = *(undefined2 *)(iVar6 + 0x54);
  }
  else {
    *(undefined2 *)(iVar3 + 0x15c) = *puVar7;
    *(undefined2 *)(iVar3 + 0x15e) = puVar7[1];
    uVar4 = puVar7[2];
  }
  *(undefined2 *)(iVar3 + 0x160) = uVar4;
  ...
  *(char *)(iVar2 + 0x2f) = (char)unaff_s4;
  *(undefined *)(iVar2 + 0x30) = unaff_s3;
  if (unaff_s9 == 1) {
    iVar3 = _LVL48(iVar3 + 0x164,in_stack_0000000c);
_L0:
    iVar3 = iVar3 + 0x18;
  }
  else {
    if (unaff_s9 == 0) {
      uVar1 = *(undefined *)(unaff_s0 >> 2 & 0xf);
      iVar3 = _L0(iVar3 + 0x164);
      iVar3 = iVar3 + 0x18;
      goto _L0;
    }
    if (unaff_s9 == 2) {
      iVar3 = _LVL53(iVar3 + 0x164);
      goto _L0;
    }
    FUN_00010174(0,0,0x25d);
    iVar3 = 0x18;
...
_L0:
  ...
  *(int *)(iVar6 + 0x18) = *(int *)(iVar6 + 0x14) + -1 + iVar3;
  *(int *)(iVar6 + 0x1c) = iVar3 + 4;
  if (unaff_s2 != 0) {
    *(int *)(iVar2 + 0x2cc) = unaff_s2;
    *(undefined4 *)(iVar2 + 0x2d0) = unaff_s1;
  }
  _LVL41(iVar2,uVar1);
  return;
}
...

{
  ...
  FUN_0001009c();
  iVar2 = *(int *)(unaff_s10 + 0x68);
  *(undefined *)(iVar2 + 0x14c) = 0xd0;
  *(undefined *)(iVar2 + 0x14d) = 0;
  *(undefined *)(iVar2 + 0x14e) = 0;
  *(undefined *)(iVar2 + 0x14f) = 0;
  *(undefined2 *)(iVar2 + 0x150) = *unaff_s8;
  *(undefined2 *)(iVar2 + 0x152) = unaff_s8[1];
  *(undefined2 *)(iVar2 + 0x154) = unaff_s8[2];
  puVar4 = (undefined2 *)(unaff_s7 + 0x50 + unaff_s11);
  *(undefined2 *)(iVar2 + 0x156) = *puVar4;
  *(undefined2 *)(iVar2 + 0x158) = puVar4[1];
  *(undefined2 *)(iVar2 + 0x15a) = puVar4[2];
  if (*(char *)(in_stack_00000008 + 0x56) == '\x02') {
    *(undefined2 *)(iVar2 + 0x15c) = *puVar4;
    *(undefined2 *)(iVar2 + 0x15e) = puVar4[1];
    uVar3 = puVar4[2];
  }
  else {
    *(undefined2 *)(iVar2 + 0x15c) = *unaff_s8;
    *(undefined2 *)(iVar2 + 0x15e) = unaff_s8[1];
    uVar3 = unaff_s8[2];
  }
  ...
  *(undefined *)(unaff_s10 + 0x30) = unaff_s3;
  if (unaff_s9 == 1) {
    iVar2 = _LVL48(iVar2 + 0x164,in_stack_0000000c);
_L0:
    iVar2 = iVar2 + 0x18;
  }
  else {
  ...
  uVar1 = 3;
_L0:
  iVar6 = *(int *)(unaff_s10 + 0x6c);
  *(int *)(iVar6 + 0x18) = *(int *)(iVar6 + 0x14) + -1 + iVar2;
  *(int *)(iVar6 + 0x1c) = iVar2 + 4;
  if (unaff_s2 != 0) {
...

{
  ...
  iVar1 = _L0();
  iVar2 = *(int *)(unaff_s10 + 0x6c);
  *(int *)(iVar2 + 0x18) = *(int *)(iVar2 + 0x14) + iVar1 + 0x17;
