...
union anon_union.conflictf2e_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflictf53_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflictf09_for_field_3 {
...
struct anon_struct.conflictab1 {
    uint32_t key[4];
};

struct anon_struct.conflicta7a {
    uint32_t tx_key[2];
    uint32_t rx_key[2];
};

union anon_union.conflictada_for_u {
