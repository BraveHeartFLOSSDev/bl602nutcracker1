...

{
  ...
  _L0(L + 0xc,0,0x10);
  FUN_00010082(key,L + 0xc,acStack64);
  if (acStack64[0] < '\0') {
    FUN_000100c2(acStack64,Z + 0xc);
    FUN_000100d6(Z + 0xc,0,K1);
  }
  else {
    FUN_00010096(acStack64,K1);
  }
  if ((char)*K1 < '\0') {
    FUN_000100e4(K1,Z + 0xc);
    FUN_000100f8(Z + 0xc,0,K2);
  }
  else {
    FUN_000100aa(K1,K2);
  }
...

{
  ...
  _L0();
  FUN_00010082(&stack0x00000010);
  if (in_stack_00000000 < '\0') {
    FUN_000100c2(&stack0x00000020);
    FUN_000100d6(&stack0x00000020,0);
  }
  else {
    FUN_00010096();
  }
  if (*unaff_s0 < '\0') {
    FUN_000100e4(&stack0x00000020);
    FUN_000100f8(&stack0x00000020,0);
  }
  else {
    FUN_000100aa();
  }
...

{
  ...
  if (iVar1 == 0) {
    ...
    if ((length & 0xfU) == 0) {
      _L0(input + (iVar1 + -1) * 0x10,padded + 0xc,Y + 0xc);
      FUN_0001018c(aUStack128,0,0x10);
      iVar2 = 0;
      while (iVar2 < iVar1 + -1) {
        FUN_0001020e(aUStack128,input + iVar2 * 0x10,X + 0xc);
        FUN_0001021c(key,X + 0xc,aUStack128);
        iVar2 = iVar2 + 1;
      }
      FUN_000101a2(aUStack128,Y + 0xc,X + 0xc);
      FUN_000101b0(key,X + 0xc,aUStack128);
      iVar1 = 0;
      do {
  ...
  FUN_000101f4(input + (iVar1 + -1) * 0x10,M_last + 0xc,length % 0x10);
  _L0(M_last + 0xc,K1 + 0xc,Y + 0xc);
  return;
}
...

{
  ...
  if (iVar1 == 0) {
    ...
    if ((unaff_s1 & 0xf) == 0) {
      _L0((iVar1 + -1) * 0x10 + unaff_s2,&stack0x00000040,&stack0x00000020);
      FUN_0001018c(0,0x10);
      iVar2 = 0;
      while (iVar2 < iVar1 + -1) {
      ...
      FUN_000101a2(&stack0x00000020,&stack0x00000010);
      FUN_000101b0(&stack0x00000010);
      iVar1 = 0;
      do {
  ...
  FUN_000101f4((iVar1 + -1) * 0x10 + unaff_s2,&stack0x00000030,(int)unaff_s1 % 0x10);
  _L0(&stack0x00000030,&stack0x00000050,&stack0x00000020);
  return;
}
