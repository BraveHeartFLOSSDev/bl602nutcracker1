...
struct anon_struct.conflicta96 {
    uint32_t key[4];
};
...
struct anon_struct.conflicta5f {
    uint32_t tx_key[2];
    uint32_t rx_key[2];
};

union anon_union.conflictabf_for_u {
...
union anon_union.conflict1a02_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflict19dd_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflict1a27_for_field_5 {
    uint32_t dataendptr;
...

{
  ...
  puVar1 = (undefined4 *)_L0(0x40a,CONCAT22(in_register_00002036,src_id),0xc);
  *puVar1 = 0;
  puVar1[1] = 0;
  puVar1[2] = 0;
  _L0();
...

{
  ...
  ppuVar1 = (uint32_t **)_L0(0x403,CONCAT22(in_register_00002036,src_id),8);
...

{
  ...
  puVar1 = (uint32_t *)_L0(0x401,CONCAT22(in_register_00002036,src_id),8);
...

{
  ...
  _L0(0x407,CONCAT22(in_register_00002036,src_id));
  return 0;
}
...

{
  ...
  _L0(0x405,CONCAT22(in_register_00002036,src_id));
  return 0;
}
