...

{
  ...
  if (((uint)elements & 3) != 0) {
    FUN_00010032(0,0,0x2a);
  }
  if ((elem_size & 3) != 0) {
    FUN_00010054(0,0,0x2b);
  }
  pcVar1 = pool_hdr + 1;
  uVar2 = 0;
  while (uVar2 != elem_cnt) {
...

{
  ...
  if (nbelem <= pool->freecnt) {
    ...
    pcVar3 = pcVar1;
    pcVar4 = pcVar1;
    while (pcVar2 = pcVar3, uVar5 != nbelem) {
      uVar5 = uVar5 + 1;
      pcVar3 = pcVar2->next;
      pcVar4 = pcVar2;
    }
...

{
  ...
  if (unaff_s1 <= (uint)unaff_s0[1]) {
    ...
    puVar1 = puVar2;
    puVar5 = puVar2;
    while (puVar3 = puVar1, uVar6 != unaff_s1) {
      uVar6 = uVar6 + 1;
