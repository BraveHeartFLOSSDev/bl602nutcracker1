...
union anon_union.conflict2867_for_key {
...
union anon_union.conflict1e5b_for_keyEncypt {
...
union anon_union.conflict122b_for_intf {
    uint32 Interface;
};
...
union anon_union.conflict2f64_for_specDat {
...
union anon_union.conflictd0d_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflictd32_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflictce8_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};
...

{
  ...
  uVar4 = CONCAT31(in_register_0000202d,ssidLen);
  FUN_00010032(0,_DAT_44b00120 / 1000,0);
  pUVar2 = (UINT8 *)FUN_0001003e(pSsid,uVar4);
  if (pUVar2 == (UINT8 *)0x0) {
    if (cRam00000000 != '\0') {
      FUN_00010096(pSsid,uVar4,0,0);
      iVar3 = FUN_000100a2(pSsid,uVar4);
      uVar1 = FUN_000100b0(0);
      pUVar2 = (UINT8 *)(iVar3 + 0x20);
      FUN_000100ca(pSsid,uVar4,0,uVar1,pUVar2);
    }
  }
  else {
    pUVar2 = pUVar2 + 0x20;
  }
  FUN_0001006a(0,_DAT_44b00120 / 1000,0);
  return pUVar2;
}
...

{
  ...
  if (iVar2 == 0) {
    if (cRam00000000 != '\0') {
      ...
      uVar1 = FUN_000100b0(0);
      iVar2 = iVar2 + 0x20;
      FUN_000100ca(0,uVar1,iVar2);
    }
  }
  else {
    iVar2 = iVar2 + 0x20;
  }
  FUN_0001006a(0,_DAT_44b00120 / 1000);
  return iVar2;
}
...

{
  ...
  uVar1 = FUN_000100b0();
  FUN_000100ca(uVar1,unaff_s0 + 0x20);
  FUN_0001006a(0,_DAT_44b00120 / 1000);
...

{
  ...
  uVar2 = CONCAT31(in_register_00002035,PassphraseLen);
  _L0(0,_DAT_44b00120 / 1000,0,uVar2);
  if (pPassphrase != (UINT8 *)0x0) {
    FUN_00010124(0,pPassphrase,0x40);
    FUN_00010134(pSsid,CONCAT31(in_register_0000202d,ssidLen),pPassphrase,uVar2);
    iVar1 = FUN_00010140(pSsid,CONCAT31(in_register_0000202d,ssidLen));
    FUN_00010156(*(undefined *)(iVar1 + 0x40),0,uVar2,iVar1 + 0x20);
  }
  do {
...

{
  ...
  if (unaff_s1 != 0) {
    ...
    FUN_00010134();
    iVar1 = FUN_00010140();
    FUN_00010156(*(undefined *)(iVar1 + 0x40),0,iVar1 + 0x20);
  }
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
...

{
  ...
  FUN_00010134();
  iVar1 = FUN_00010140();
  FUN_00010156(*(undefined *)(iVar1 + 0x40),iVar1 + 0x20);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...
{
  FUN_000101bc(0,_DAT_44b00120 / 1000,0);
  FUN_000101d2(0,0,0x86);
  FUN_000101e8(0,0,0x40);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...
{
  FUN_00010248(0,_DAT_44b00120 / 1000,0);
  FUN_0001025e(0,0,0x86);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...
{
  FUN_000102be(0,_DAT_44b00120 / 1000,0);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
