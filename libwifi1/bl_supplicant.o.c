...
union anon_union.conflict28a2_for_key {
...
union anon_union.conflict1ec3_for_keyEncypt {
...
union anon_union.conflict1173_for_intf {
    uint32 Interface;
};
...
union anon_union.conflict2f9f_for_specDat {
...
union anon_union.conflictcc5_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflictca0_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflictc7b_for_field_3 {
    uint32_t first_pbd_ptr;
...

{
  ...
  _L0();
  _L0();
  FUN_00010056(0,_DAT_44b00120 / 1000,0);
  return FW_SUCCESS;
}
...

{
  ...
  _L0();
  _L0();
  FUN_00010056(0,*(uint *)(unaff_s2 + 0x120) / unaff_s0);
  return 0;
}
...
{
  FUN_00010096(0,_DAT_44b00120 / 1000,0);
  _L0();
  do {
