...
typedef union anon_union.conflict29ee_for_key anon_union.conflict29ee_for_key, *Panon_union.conflict29ee_for_key;
...
union anon_union.conflict29ee_for_key {
    IEEEtypes_MacAddr_t Bssid;
    char Ssid[32];
};

struct pmkElement_t {
    union anon_union.conflict29ee_for_key key;
    UINT8 PMK[32];
    UINT8 length;
    UINT8 psk_length;
...
typedef union anon_union.conflict29ee anon_union.conflict29ee, *Panon_union.conflict29ee;

union anon_union.conflict29ee {
    IEEEtypes_MacAddr_t Bssid;
    char Ssid[32];
};
...
typedef union anon_union.conflict1fd2 anon_union.conflict1fd2, *Panon_union.conflict1fd2;
...
typedef union anon_union.conflict1fd2_for_keyEncypt anon_union.conflict1fd2_for_keyEncypt, *Panon_union.conflict1fd2_for_keyEncypt;

union anon_union.conflict1fd2_for_keyEncypt {
    struct key_Type_TKIP_t TKIP;
    struct key_Type_AES_t AES1;
    struct key_Type_WEP_t WEP;
    struct key_Type_WAPI_t WAPI;
...
struct key_MgtMaterial_t {
    ...
    UINT16 keyInfo;
    UINT16 keyLen;
    union anon_union.conflict1fd2_for_keyEncypt keyEncypt;
};

typedef struct BufferDesc BufferDesc, *PBufferDesc;

typedef union anon_union.conflict1b18_for_intf anon_union.conflict1b18_for_intf, *Panon_union.conflict1b18_for_intf;

union anon_union.conflict1b18_for_intf {
    uint32 Interface;
};

struct BufferDesc {
    union anon_union.conflict1b18_for_intf intf;
    uint16 DataLen;
    undefined field_0x6;
    undefined field_0x7;
    void * Buffer;
...
typedef union anon_union.conflict1b18 anon_union.conflict1b18, *Panon_union.conflict1b18;
...
typedef union anon_union.conflict30eb_for_specDat anon_union.conflict30eb_for_specDat, *Panon_union.conflict30eb_for_specDat;
...
union anon_union.conflict30eb_for_specDat {
    struct apSpecificData_t apData;
};

union anon_union.conflict1b18 {
    uint32 Interface;
...
struct cm_ConnectionInfo {
    ...
    union anon_union.conflict30eb_for_specDat specDat;
...
typedef union anon_union.conflict30eb anon_union.conflict30eb, *Panon_union.conflict30eb;

union anon_union.conflict30eb {
    struct apSpecificData_t apData;
};
...
typedef union anon_union.conflictd43 anon_union.conflictd43, *Panon_union.conflictd43;

union anon_union.conflictd43 {
    uint32_t dataendptr;
...
typedef union anon_union.conflictcf9 anon_union.conflictcf9, *Panon_union.conflictcf9;

union anon_union.conflictcf9 {
...
typedef union anon_union.conflictcf9_for_field_3 anon_union.conflictcf9_for_field_3, *Panon_union.conflictcf9_for_field_3;

typedef union anon_union.conflictd1e_for_field_4 anon_union.conflictd1e_for_field_4, *Panon_union.conflictd1e_for_field_4;

typedef union anon_union.conflictd43_for_field_5 anon_union.conflictd43_for_field_5, *Panon_union.conflictd43_for_field_5;

union anon_union.conflictd1e_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflictd43_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflictcf9_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};
...
struct tx_hd {
    ...
    union anon_union.conflictcf9_for_field_3 field_3;
    union anon_union.conflictd1e_for_field_4 field_4;
    union anon_union.conflictd43_for_field_5 field_5;
    uint32_t frmlen;
...
typedef union anon_union.conflictd1e anon_union.conflictd1e, *Panon_union.conflictd1e;

union anon_union.conflictd1e {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};
...

{
  ...
  FUN_0001004e(0,0xff,0x43);
  uVar1 = FUN_00010058(phrase);
  FUN_0001006a(pSsid,CONCAT31(in_register_0000202d,ssidLen),phrase,uVar1);
  do {
...

{
  ...
  _LVL14(0,_DAT_44b00120 / 1000,0);
  _L0();
  uVar1 = FUN_000100e6(pPMK);
  FUN_000100f8(pSsid,CONCAT31(in_register_0000202d,ssidLen),pPMK,uVar1);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...

{
  ...
  FUN_00010166(0,_DAT_44b00120 / 1000,0);
  FUN_00010172(pSsid,CONCAT31(in_register_0000202d,ssidLen));
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
