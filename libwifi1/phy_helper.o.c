...
union anon_union.conflictfc_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflicta7e {
    uint32_t tx_key[2];
    uint32_t rx_key[2];
};

struct anon_struct.conflictab5 {
    uint32_t key[4];
};

union anon_union.conflictade_for_u {
...
union anon_union.conflict1252_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflict1277_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflict122d_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};
...
struct anon_struct.conflict74a {
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict8d6_for__new {
...

{
  ...
  _L0(0);
  iVar4 = 0;
  while (iVar4 < (int)(uint)bRam00000000) {
    FUN_0001013e(0,iVar4,*puVar3,puVar3[1]);
    FUN_0001015e(0,puVar3[5],puVar3[5] & 0x3f,(uint)puVar3[5] >> 8 & 0x1ff,
                 *(undefined *)((int)puVar3 + 0x17));
    iVar4 = iVar4 + 1;
    _L0(0,*(undefined2 *)(puVar3 + 6),*(undefined2 *)((int)puVar3 + 0x1a),
        *(undefined2 *)(puVar3 + 7),*(undefined2 *)((int)puVar3 + 0x1e));
    FUN_0001019c(0,*(undefined2 *)(puVar3 + 8),*(undefined2 *)((int)puVar3 + 0x22),
                 *(undefined2 *)(puVar3 + 9),*(undefined2 *)((int)puVar3 + 0x26));
    piVar1 = puVar3 + 3;
    piVar2 = puVar3 + 2;
    puVar3 = puVar3 + 10;
...

{
  ...
  _L0();
  iVar3 = 0;
  while (iVar3 < (int)(uint)bRam00000000) {
    FUN_0001013e(0,iVar3,*unaff_s0,unaff_s0[1]);
    FUN_0001015e(0,unaff_s0[5],unaff_s0[5] & 0x3f,(uint)unaff_s0[5] >> 8 & 0x1ff,
                 *(undefined *)((int)unaff_s0 + 0x17));
    iVar3 = iVar3 + 1;
    _L0(0,*(undefined2 *)(unaff_s0 + 6),*(undefined2 *)((int)unaff_s0 + 0x1a),
        *(undefined2 *)(unaff_s0 + 7),*(undefined2 *)((int)unaff_s0 + 0x1e));
    FUN_0001019c(0,*(undefined2 *)(unaff_s0 + 8),*(undefined2 *)((int)unaff_s0 + 0x22),
                 *(undefined2 *)(unaff_s0 + 9),*(undefined2 *)((int)unaff_s0 + 0x26));
    piVar1 = unaff_s0 + 3;
    piVar2 = unaff_s0 + 2;
...

{
  ...
  while( true ) {
    ...
    FUN_0001015e(unaff_s0[5],unaff_s0[5] & 0x3f,(uint)unaff_s0[5] >> 8 & 0x1ff,
                 *(undefined *)((int)unaff_s0 + 0x17));
    unaff_s1 = unaff_s1 + 1;
    _L0(*(undefined2 *)(unaff_s0 + 6),*(undefined2 *)((int)unaff_s0 + 0x1a),
        *(undefined2 *)(unaff_s0 + 7),*(undefined2 *)((int)unaff_s0 + 0x1e));
    FUN_0001019c(0,*(undefined2 *)(unaff_s0 + 8),*(undefined2 *)((int)unaff_s0 + 0x22),
                 *(undefined2 *)(unaff_s0 + 9),*(undefined2 *)((int)unaff_s0 + 0x26));
...

{
  ...
  while( true ) {
    ...
    FUN_0001015e(unaff_s0[0xf],unaff_s0[0xf] & 0x3f,(uint)unaff_s0[0xf] >> 8 & 0x1ff,
                 *(undefined *)((int)unaff_s0 + 0x3f));
    unaff_s1 = unaff_s1 + 1;
    _L0(*(undefined2 *)(unaff_s0 + 0x10),*(undefined2 *)((int)unaff_s0 + 0x42),
        *(undefined2 *)(unaff_s0 + 0x11),*(undefined2 *)((int)unaff_s0 + 0x46));
...

{
  ...
  while (_LVL26(param_1,param_2,param_3), unaff_s1 < (int)(uint)*unaff_s6) {
...

{
  ...
  puVar4[1] = func_name;
  *puVar4 = uVar1;
  FUN_00010250(puVar4 + 2,puVar4 + 3);
...

{
  ...
  _L0(-(int)(short)rxv_freqoff);
  FUN_00010374(uRam00000000,_DAT_00000004);
  FUN_00010388(uRam00000000,_DAT_00000004);
  fVar1 = (float)_L0();
  return fVar1;
}
...

{
  ...
  _L0((int)(char)rxv_freqoff);
  FUN_000103ba(uRam00000000,_DAT_00000004);
  fVar1 = (float)_L0();
  return fVar1;
}
...

{
  ...
  iVar2 = 0;
  uVar8 = _L0(0,0,0,chanfreq & 0xffff,0);
  do {
    if (nrepeats <= iVar2) {
      _L0(uVar8);
      do {
    ...
    do {
      ...
      iVar6 = (iVar6 - iVar5) - uVar4;
      if (mon_time_ms >> 0x1f < iVar6) break;
    } while ((iVar6 != mon_time_ms >> 0x1f) || (uVar7 <= (uint)mon_time_ms));
    iVar2 = iVar2 + 1;
    uVar9 = _LVL119(_DAT_44c60090 >> 0x10,_DAT_44c60094,(int)lVar10);
    uVar9 = _L0(uVar9);
    uVar8 = FUN_000104d2(0,uVar8,uVar1,uVar9,extraout_a1_00,extraout_fa0);
  } while( true );
}
...

{
  ...
  do {
    ...
    do {
      ...
      uVar2 = _DAT_44c60088;
      uVar1 = _DAT_44c60080;
      iVar6 = (extraout_a1_00 - extraout_a1) - (uint)(uVar4 < uVar4 - iVar3);
      if ((int)unaff_s3 >> 0x1f < iVar6) break;
    } while ((iVar6 != (int)unaff_s3 >> 0x1f) || (uVar4 - iVar3 <= unaff_s3));
    unaff_s1 = unaff_s1 + 1;
    _LVL119(_DAT_44c60090 >> 0x10,_DAT_44c60094);
    uVar5 = _L0();
    FUN_000104d2(0,uVar1,uVar2,uVar5,extraout_a1_01);
  } while( true );
}
...

{
  ...
  do {
    ...
    *unaff_s0 = uVar5 | 0x10;
    *unaff_s0 = uVar5 & 0xffffffef;
    if (uVar4 == 0) {
      *unaff_s0 = uVar5 & 0xffffffee;
    }
    *unaff_s0 = unaff_s6;
    iVar1 = (*unaff_s2)();
    do {
      uVar4 = (*unaff_s2)();
      iVar3 = (extraout_a1_00 - extraout_a1) - (uint)(uVar4 < uVar4 - iVar1);
      if (unaff_s4 < iVar3) break;
    } while ((iVar3 != unaff_s4) || (uVar4 - iVar1 <= unaff_s3));
    uVar5 = unaff_s0[0x20];
    uVar4 = unaff_s0[0x22];
    unaff_s1 = unaff_s1 + 1;
    _LVL119(unaff_s0[0x24] >> 0x10,unaff_s0[0x25]);
    uVar2 = _L0();
    FUN_000104d2(uVar5,uVar4,uVar2,extraout_a1_01);
    if (unaff_s5 <= unaff_s1) {
      _L0();
      do {
                    // WARNING: Do nothing block with infinite loop
...

{
  ...
  do {
    ...
    uVar2 = _L0();
    FUN_000104d2(unaff_s8,in_stack_0000000c,uVar2,extraout_a1_01);
    if (unaff_s5 <= unaff_s1) {
      _L0();
      do {
                    // WARNING: Do nothing block with infinite loop
