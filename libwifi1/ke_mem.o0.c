...
struct co_list_hdr { // DWARF DIE: a58
    struct co_list_hdr * next;
};

struct co_list { // DWARF DIE: a79
    struct co_list_hdr * first;
    struct co_list_hdr * last;
};

struct mblock_free { // DWARF DIE: b01
    struct mblock_free * next;
    uint32_t size;
};

struct ke_env_tag { // DWARF DIE: ab2
...
struct mblock_used { // DWARF DIE: b3b
    uint32_t size;
};
...

{
  ...
  uVar6 = uVar2 + 4;
  if (uVar6 < 8) {
    FUN_00010054(_DAT_0000001c);
  }
  piVar1 = (int *)0x0;
  for (piVar5 = (int *)_DAT_0000001c; piVar5 != (int *)0x0; piVar5 = (int *)*piVar5) {
...

{
  ...
  FUN_00010054(iRam0000001c);
  piVar1 = (int *)0x0;
  for (piVar3 = (int *)iRam0000001c; piVar3 != (int *)0x0; piVar3 = (int *)*piVar3) {
