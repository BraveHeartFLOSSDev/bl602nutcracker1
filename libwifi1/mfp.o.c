...
typedef union anon_union.conflicteb anon_union.conflicteb, *Panon_union.conflicteb;

typedef uint wint_t;

union anon_union.conflicteb {
    wint_t __wch;
    uchar __wchb[4];
};
...
typedef union anon_union.conflicteb_for___value anon_union.conflicteb_for___value, *Panon_union.conflicteb_for___value;

union anon_union.conflicteb_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct _mbstate_t {
    int __count;
    union anon_union.conflicteb_for___value __value;
};
...
typedef union anon_union.conflict276a_for_field_0 anon_union.conflict276a_for_field_0, *Panon_union.conflict276a_for_field_0;

typedef struct dma_desc dma_desc, *Pdma_desc;

typedef struct tx_pbd tx_pbd, *Ptx_pbd;

typedef union anon_union.conflict1064_for_field_3 anon_union.conflict1064_for_field_3, *Panon_union.conflict1064_for_field_3;

typedef union anon_union.conflict1089_for_field_4 anon_union.conflict1089_for_field_4, *Panon_union.conflict1089_for_field_4;

typedef union anon_union.conflict10ae_for_field_5 anon_union.conflict10ae_for_field_5, *Panon_union.conflict10ae_for_field_5;
...
union anon_union.conflict1064_for_field_3 {
...
union anon_union.conflict10ae_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflict1089_for_field_4 {
...
struct tx_hd {
    ...
    union anon_union.conflict1064_for_field_3 field_3;
    union anon_union.conflict1089_for_field_4 field_4;
    union anon_union.conflict10ae_for_field_5 field_5;
    uint32_t frmlen;
...
union anon_union.conflict276a_for_field_0 {
    struct tx_policy_tbl policy_tbl;
    struct tx_compressed_policy_tbl comp_pol_tbl;
};

struct txl_buffer_control {
    union anon_union.conflict276a_for_field_0 field_0;
...
typedef struct anon_struct.conflict3245 anon_struct.conflict3245, *Panon_struct.conflict3245;
...
struct anon_struct.conflict3245 {
    uint32_t dummy;
...
typedef union anon_union.conflict3340_for_u anon_union.conflict3340_for_u, *Panon_union.conflict3340_for_u;

typedef struct mac_bss_info mac_bss_info, *Pmac_bss_info;

typedef struct key_info_tag key_info_tag, *Pkey_info_tag;

typedef struct anon_struct.conflict3178 anon_struct.conflict3178, *Panon_struct.conflict3178;
...
typedef union anon_union.conflictaaa_for_u anon_union.conflictaaa_for_u, *Panon_union.conflictaaa_for_u;

typedef struct anon_struct.conflicta4a anon_struct.conflicta4a, *Panon_struct.conflicta4a;

typedef struct anon_struct.conflicta81 anon_struct.conflicta81, *Panon_struct.conflicta81;
...
struct anon_struct.conflicta81 {
    uint32_t key[4];
};
...
struct anon_struct.conflict3178 {
...
union anon_union.conflict3340_for_u {
    struct anon_struct.conflict3178 sta;
    struct anon_struct.conflict3245 ap;
};

struct anon_struct.conflicta4a {
    uint32_t tx_key[2];
    uint32_t rx_key[2];
};

union anon_union.conflictaaa_for_u {
    struct anon_struct.conflicta4a mic;
    struct anon_struct.conflicta81 mfp;
};

struct key_info_tag {
    uint64_t rx_pn[9];
    uint64_t tx_pn;
    union anon_union.conflictaaa_for_u u;
    uint8_t cipher;
    uint8_t key_idx;
    uint8_t hw_key_idx;
    _Bool valid;
...
struct vif_info_tag {
    ...
    union anon_union.conflict3340_for_u u;
...
typedef union anon_union.conflict3340 anon_union.conflict3340, *Panon_union.conflict3340;

union anon_union.conflict3340 {
    struct anon_struct.conflict3178 sta;
    struct anon_struct.conflict3245 ap;
};
...
typedef union anon_union.conflict2ccf_for_rate_map anon_union.conflict2ccf_for_rate_map, *Panon_union.conflict2ccf_for_rate_map;

union anon_union.conflict2ccf_for_rate_map {
    uint8_t ht[4];
};
...
struct rc_sta_stats {
    ...
    uint8_t format_mod;
    union anon_union.conflict2ccf_for_rate_map rate_map;
    uint16_t rate_map_l;
    uint8_t mcs_max;
    uint8_t r_idx_min;
    uint8_t r_idx_max;
...
typedef union anon_union.conflict2ccf anon_union.conflict2ccf, *Panon_union.conflict2ccf;

union anon_union.conflict2ccf {
    uint8_t ht[4];
};
...
typedef union anon_union.conflictaaa anon_union.conflictaaa, *Panon_union.conflictaaa;

union anon_union.conflictaaa {
    struct anon_struct.conflicta4a mic;
    struct anon_struct.conflicta81 mfp;
};
...
typedef union anon_union.conflict276a anon_union.conflict276a, *Panon_union.conflict276a;

union anon_union.conflict276a {
    struct tx_policy_tbl policy_tbl;
    struct tx_compressed_policy_tbl comp_pol_tbl;
};
...
typedef union anon_union.conflict1089 anon_union.conflict1089, *Panon_union.conflict1089;

union anon_union.conflict1089 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

typedef union anon_union.conflict1064 anon_union.conflict1064, *Panon_union.conflict1064;

union anon_union.conflict1064 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

typedef union anon_union.conflict10ae anon_union.conflict10ae, *Panon_union.conflict10ae;

union anon_union.conflict10ae {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

typedef struct anon_struct.conflict739 anon_struct.conflict739, *Panon_struct.conflict739;
...
struct anon_struct.conflict739 {
    uint _unused_rand;
    char * _strtok_last;
...
typedef union anon_union.conflict8c5_for__new anon_union.conflict8c5_for__new, *Panon_union.conflict8c5_for__new;
...
typedef struct anon_struct.conflict87e anon_struct.conflict87e, *Panon_struct.conflict87e;
...
struct anon_struct.conflict87e {
    uchar * _nextf[30];
    uint _nmalloc[30];
};
...
union anon_union.conflict8c5_for__new {
    struct anon_struct.conflict739 _reent;
    struct anon_struct.conflict87e _unused;
};
...
struct _reent {
    ...
    int _cvtlen;
    char * _cvtbuf;
    union anon_union.conflict8c5_for__new _new;
...
typedef union anon_union.conflict8c5 anon_union.conflict8c5, *Panon_union.conflict8c5;

union anon_union.conflict8c5 {
    struct anon_struct.conflict739 _reent;
    struct anon_struct.conflict87e _unused;
};
