...

{
  ...
  if (0x40 < key_len) {
    _LVL2(auStack584);
    FUN_00010046(auStack584,key,key_len);
    FUN_00010052(pBuf + 0x94,auStack584);
    key_len = 0x10;
    key = pBuf + 0x94;
  }
  _LVL7(tctx.buffer + 0x3c,0,0x40);
  _LVL9(tctx.buffer + 0x3c,key,key_len);
  puVar3 = (uint *)(pBuf + 0x3c);
  ...
  FUN_0001009c(puVar3);
  FUN_000100ac(puVar3,tctx.buffer + 0x3c,0x40);
  FUN_000100ba(puVar3,text_data,text_len);
  FUN_000100c6(digest,puVar3);
  FUN_000100d6(tctx.buffer + 0x3c,0,0x40);
  FUN_000100e4(tctx.buffer + 0x3c,key,key_len);
  puVar1 = (uint *)(tctx.buffer + 0x3c);
  do {
    puVar2 = puVar1 + 1;
  ...
  FUN_00010104(puVar2);
  FUN_00010114(puVar2,tctx.buffer + 0x3c,0x40);
  FUN_00010122(puVar2,digest,0x10);
  FUN_0001012e(digest,puVar2);
  return;
}
...

{
  ...
  _LVL2();
  FUN_00010046(&stack0x00000008);
  FUN_00010052(&stack0x00000138,&stack0x00000008);
  _LVL7(&stack0x000000a0,0,0x40);
  _LVL9(&stack0x000000a0,&stack0x00000138,0x10);
  ...
  FUN_0001009c(&stack0x000000e0);
  FUN_000100ac(&stack0x000000e0,&stack0x000000a0,0x40);
  FUN_000100ba(&stack0x000000e0);
  FUN_000100c6(&stack0x000000e0);
  FUN_000100d6(&stack0x000000a0,0,0x40);
  FUN_000100e4(&stack0x000000a0,&stack0x00000138,0x10);
  puVar1 = (uint *)&stack0x000000a0;
  do {
    puVar2 = puVar1 + 1;
    *puVar1 = *puVar1 ^ 0x5c5c5c5c;
  ...
  FUN_00010104(puVar2);
  FUN_00010114(puVar2,&stack0x000000a0,0x40);
  FUN_00010122(puVar2,0x10);
  FUN_0001012e(puVar2);
  return;
}
...

{
  ...
  FUN_0001009c();
  FUN_000100ac(&stack0x000000a0,0x40);
  FUN_000100ba();
  FUN_000100c6();
  FUN_000100d6(&stack0x000000a0,0,0x40);
  FUN_000100e4(&stack0x000000a0);
  ...
  FUN_00010104(puVar1);
  FUN_00010114(puVar1,&stack0x000000a0,0x40);
  FUN_00010122(puVar1,0x10);
  FUN_0001012e(puVar1);
  return;
}
...
{
  FUN_00010104();
  FUN_00010114(&stack0x000000a0,0x40);
  FUN_00010122(0x10);
  FUN_0001012e();
  return;
}
