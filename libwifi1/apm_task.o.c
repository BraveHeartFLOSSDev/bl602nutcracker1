...
union anon_union.conflict11e2_for_field_4 {
...
union anon_union.conflict11bd_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflict1207_for_field_5 {
    uint32_t dataendptr;
...
union anon_union.conflict2c5a_for_field_0 {
...
union anon_union.conflict50dc_for_keyEncypt {
...
struct anon_struct.conflict2f56 {
    uint8_t mac[6];
    uint8_t used;
};
...
union anon_union.conflict5f79_for_specDat {
    struct apSpecificData_t apData;
};

union anon_union.conflict4386_for_intf {
    uint32 Interface;
};
...
struct anon_struct.conflictb61 {
    uint32_t tx_key[2];
    uint32_t rx_key[2];
};
...
struct anon_struct.conflictb98 {
    uint32_t key[4];
};

union anon_union.conflictbc1_for_u {
...
union anon_union.conflict587c_for_key {
    IEEEtypes_MacAddr_t Bssid;
    char Ssid[32];
};
...
struct anon_struct.conflict3f24 {
...
struct anon_struct.conflict3ff1 {
    uint32_t dummy;
...
union anon_union.conflict40ec_for_u {
...
union anon_union.conflict33fb_for_rate_map {
    uint8_t ht[4];
};
...

{
  ...
  iVar3 = _L0(CONCAT22(in_register_0000202a,msgid),CONCAT22(in_register_00002032,dest_id));
  iVar2 = 0;
  cVar1 = '\0';
  do {
...

{
  ...
  puVar1 = (undefined *)_L0(0x1c0c,CONCAT22(in_register_00002036,src_id),3);
...

{
  ...
  if (((*(char *)(iVar1 + 0x56) == '\x02') && (*(char *)(iVar1 + 0x58) == '\0')) &&
     (iVar1 = _L0(7), iVar1 == 0)) {
    FUN_000101ee(param->vif_idx,CONCAT22(in_register_00002032,dest_id));
    _DAT_00000004 = _DAT_00000004 & 0xffffffef;
  }
  FUN_00010216(0x1c07,CONCAT22(in_register_00002036,src_id),CONCAT22(in_register_00002032,dest_id));
  return 0;
}
...

{
  ...
  iVar1 = _L0();
  if (iVar1 == 0) {
    FUN_000101ee(*unaff_s0,in_stack_0000000c);
    _DAT_00000004 = _DAT_00000004 & 0xffffffef;
  }
  FUN_00010216(0x1c07,in_stack_0000000c);
  return 0;
}
...

{
  ...
  _L0(0x1c0e,CONCAT22(in_register_00002036,src_id));
  return 0;
}
...

{
  ...
  if (*(char *)(iVar3 + 0x56) == '\x02') {
    if ((*(char *)(iVar3 + 0x58) == '\0') &&
       (iVar1 = _L0(7,CONCAT22(in_register_00002032,dest_id)), iVar1 == 0)) {
      uStack44 = (param->chan).band;
      uStack43 = param->ch_width;
      uStack42 = (param->chan).freq;
      req._0_2_ = (undefined2)param->center_freq1;
      req.prim20_freq = (uint16_t)param->center_freq2;
      iVar1 = _L0(&uStack44,&uStack45);
      if (iVar1 == 0) {
        FUN_00010320(param->vif_idx,uStack45);
        _DAT_00000004 = _DAT_00000004 | 0x10;
      }
      else {
        iVar1 = 1;
      }
  ...
  puVar2 = (undefined *)
           FUN_000102a8(0x1c05,CONCAT22(in_register_00002036,src_id),
                        CONCAT22(in_register_00002032,dest_id),2);
  *puVar2 = (char)iVar1;
  puVar2[1] = uStack45;
  _L0();
  return 0;
...

{
  ...
  iVar2 = _L0();
  if (iVar2 == 0) {
    in_stack_00000004 = *(undefined *)(unaff_s0 + 1);
    in_stack_00000005 = *(undefined *)(unaff_s0 + 8);
    in_stack_00000006 = *unaff_s0;
    in_stack_00000008 = (undefined2)*(undefined4 *)(unaff_s0 + 4);
    in_stack_0000000a = (undefined2)*(undefined4 *)(unaff_s0 + 6);
    iVar2 = _L0(&stack0x00000004,&stack0x00000003);
    if (iVar2 == 0) {
      FUN_00010320(*(undefined *)((int)unaff_s0 + 0x11),in_stack_00000003);
      _DAT_00000004 = _DAT_00000004 | 0x10;
    }
    else {
      iVar2 = 1;
  ...
  puVar1 = (undefined *)FUN_000102a8(0x1c05,2);
  *puVar1 = (char)iVar2;
  puVar1[1] = in_stack_00000003;
  _L0();
  return 0;
...

{
  ...
  iVar2 = _L0();
  if (iVar2 == 0) {
    FUN_00010320(*(undefined *)(unaff_s0 + 0x11),in_stack_00000003);
    _DAT_00000004 = _DAT_00000004 | 0x10;
  }
  else {
    iVar2 = 1;
...

{
  ...
  iVar1 = _L0(7,CONCAT22(in_register_00002032,dest_id));
  if ((iVar1 != 1) && (iVar1 = FUN_0001035c(7), iVar1 != 0)) {
    FUN_0001037a(0,0,0xee);
  }
  iVar1 = FUN_00010384(7);
  if (iVar1 == 1) {
    _L0();
  }
  return 0;
...

{
  ...
  if ((*(char *)(iVar2 + 0x56) == '\x02') && (*(char *)(iVar2 + 0x58) != '\0')) {
    iVar2 = FUN_00010460(7,CONCAT22(in_register_00002032,dest_id));
    if (iVar2 != 0) {
      return 2;
    }
    if (DAT_00000014 != '\0') {
    ...
    FUN_0001048c((uint)bVar1 * 0x5d8);
    if (iRam00000000 != 0) {
      _L0();
      FUN_000104a6(iRam00000000);
      iRam00000000 = 0;
    }
  }
  FUN_000104bc(0x1c03,CONCAT22(in_register_00002036,src_id),CONCAT22(in_register_00002032,dest_id));
  return 0;
}
...

{
  ...
  if (iVar1 == 0) {
    ...
    FUN_0001048c(unaff_s0 * 0x5d8 + unaff_s1);
    if (iRam00000000 != 0) {
      _L0();
      FUN_000104a6(iRam00000000);
      iRam00000000 = 0;
...

{
  ...
  _L0(0,0,0x4c,CONCAT22(in_register_00002036,src_id));
  uVar9 = (uint)param->vif_idx;
  iVar8 = uVar9 * 0x5d8;
  uVar10 = 4;
  if (*(char *)(iVar8 + 0x56) == '\x02') {
    iVar4 = FUN_00010534(7);
    if (iVar4 == 0) {
      if (*(char *)(iVar8 + 0x58) == '\0') {
        if (*(int *)(iVar8 + 0x40) != 0) {
          FUN_00010564(0,0,0x67);
        }
        paRam00000000 = param;
        iVar8 = _L0(&uStack51,&param->chan,param->center_freq1,param->center_freq2,param->ch_width);
        uVar10 = 1;
        if (iVar8 == 0) {
          iVar8 = FUN_0001059e((param->chan).band,(param->chan).freq);
          iVar4 = uVar9 * 0x5d8;
          *(int *)(iVar4 + 0x3a4) = iVar8;
          *(int8_t *)(iVar8 + 4) = (param->chan).tx_power;
          *(short *)(iVar4 + 0x3a8) = (short)param->center_freq1;
          *(short *)(iVar4 + 0x3aa) = (short)param->center_freq2;
          uVar7 = param->ch_width;
          if (uVar7 == '\x04') {
            uVar7 = '\x03';
          }
          iVar4 = uVar9 * 0x5d8;
          *(uint8_t *)(iVar4 + 0x3da) = uVar7;
          uVar7 = param->ch_width;
          *(undefined *)(iVar4 + 0x3dc) = 0;
          *(uint8_t *)(iVar4 + 0x3db) = uVar7;
          FUN_000105f8(param->vif_idx,uStack51);
          DAT_00000014 = param->apm_emb_enabled;
          DAT_00000015 = param->hidden_ssid;
          iVar8 = _L0(iVar4);
          if (iVar8 != 0) {
            FUN_00010626(&param->rate_set,param);
            if (param->qos_supported != '\0') {
              *(uint *)(iVar4 + 0x3e0) = *(uint *)(iVar4 + 0x3e0) | 1;
            }
            if (DAT_0000002e != '\0') {
              *(uint *)(uVar9 * 0x5d8 + 0x3e0) = *(uint *)(uVar9 * 0x5d8 + 0x3e0) | 2;
            }
            iVar8 = uVar9 * 0x5d8;
            *(uint16_t *)(iVar8 + 0x412) = param->bcn_int;
            *(ushort *)(iVar8 + 0x3ac) = (ushort)param->beacon_period;
            *(uint8_t *)(iVar8 + 0x418) = param->ap_sec_type;
            _L0(iVar8 + 0x37e,&param->ssid,0x22);
            *(undefined *)((uint)*(byte *)(iVar8 + 0x37e) + iVar8 + 0x37f) = 0;
            *(undefined4 *)(iVar8 + 0x378) = *(undefined4 *)(iVar8 + 0x50);
            *(undefined2 *)(iVar8 + 0x37c) = *(undefined2 *)(iVar8 + 0x54);
            _L0(iVar8 + 0x3b0,&param->rate_set,0xd);
            *(undefined4 *)(iVar8 + 8) = _DAT_44b00200;
            *(undefined4 *)(iVar8 + 0xc) = _DAT_44b00204;
            *(undefined4 *)(iVar8 + 0x10) = _DAT_44b00208;
            uVar1 = _DAT_44b0020c;
            *(undefined *)(iVar8 + 0x3c0) = 0;
            *(undefined4 *)(iVar8 + 0x14) = uVar1;
            *(undefined4 *)(iVar8 + 0x414) = 0xffff0000;
            _DAT_00000010 = _L0(0x14d);
            uVar3 = _L0(*(undefined *)(iVar8 + 0x57),&param->tim_oft,&param->tim_len,DAT_00000015);
            param->bcn_len = uVar3;
            if (param->ap_sec_type == '\0') {
              paRam00000000 = (apm_start_req *)0x0;
            }
            else {
              paRam00000000 = (apm_start_req *)_L0(2,0,0,iVar4 + 0x378,0,0,0);
              _L0(iVar4 + 0x37f,param->phrase);
              FUN_00010760(paRam00000000,iVar4 + 0x37f);
              (paRam00000000->basic_rates).array[1] = param->vif_idx;
              FUN_00010788(0,0,(paRam00000000->basic_rates).array[1]);
              FUN_00010794(paRam00000000);
            }
          }
          if ((param->chan).band == '\0') {
            uVar5 = FUN_000107aa(iVar4 + 0x3b0,1);
            if ((uVar5 & 0xf) == 0) {
              *(undefined *)(uVar9 * 0x5d8 + 0x3d7) = 1;
              iVar8 = _L0();
              return iVar8;
            }
            cVar2 = _L0();
            *(char *)(uVar9 * 0x5d8 + 0x3d7) = '\x1f' - cVar2;
          }
          _L0();
          uStack50 = *(undefined *)(*(int *)(uVar9 * 0x5d8 + 0x3a4) + 4);
          _L0(iVar4,&uStack50,auStack49);
          FUN_0001080a(0);
          return 1;
        }
      }
  ...
  FUN_00010858(0,0,0xcc);
  puVar6 = (undefined *)
           FUN_0001086c(0x1c01,CONCAT22(in_register_00002036,src_id),
                        CONCAT22(in_register_00002032,dest_id),4);
  *puVar6 = uVar10;
  puVar6[1] = param->vif_idx;
  _L0();
  return 0;
}
...
undefined4 _L0(undefined4 uRam00000010,undefined2 param_2,undefined3 param_3)

{
  ...
  _L0();
  uVar8 = (uint)*(byte *)(unaff_s0 + 0x33);
  iVar7 = uVar8 * 0x5d8;
  uVar9 = 4;
  if (*(char *)(iVar7 + 0x56) == '\x02') {
    iVar3 = FUN_00010534(7);
    if (iVar3 == 0) {
      if (*(char *)(iVar7 + 0x58) == '\0') {
        ...
        iVar7 = _L0(&stack0x0000000d,unaff_s0 + 0xe,*(undefined4 *)(unaff_s0 + 0x14),
                    *(undefined4 *)(unaff_s0 + 0x18),*(undefined *)(unaff_s0 + 0x1c));
        uVar9 = 1;
        if (iVar7 == 0) {
          iVar7 = FUN_0001059e(*(undefined *)(unaff_s0 + 0x10),*(undefined2 *)(unaff_s0 + 0xe));
          iVar3 = uVar8 * 0x5d8;
          *(int *)(iVar3 + 0x3a4) = iVar7;
          *(undefined *)(iVar7 + 4) = *(undefined *)(unaff_s0 + 0x12);
          *(short *)(iVar3 + 0x3a8) = (short)*(undefined4 *)(unaff_s0 + 0x14);
          *(short *)(iVar3 + 0x3aa) = (short)*(undefined4 *)(unaff_s0 + 0x18);
          cVar1 = *(char *)(unaff_s0 + 0x1c);
          if (cVar1 == '\x04') {
            cVar1 = '\x03';
          }
          iVar3 = uVar8 * 0x5d8;
          *(char *)(iVar3 + 0x3da) = cVar1;
          uVar9 = *(undefined *)(unaff_s0 + 0x1c);
          *(undefined *)(iVar3 + 0x3dc) = 0;
          *(undefined *)(iVar3 + 0x3db) = uVar9;
          FUN_000105f8(*(undefined *)(unaff_s0 + 0x33),in_stack_0000000d);
          DAT_00000014 = *(undefined *)(unaff_s0 + 0x34);
          DAT_00000015 = *(undefined *)(unaff_s0 + 0x1d);
          iVar7 = _L0(iVar3);
          if (iVar7 != 0) {
            FUN_00010626(unaff_s0 + 0x35);
            if (*(char *)(unaff_s0 + 0x43) != '\0') {
              *(uint *)(iVar3 + 0x3e0) = *(uint *)(iVar3 + 0x3e0) | 1;
            }
            if (DAT_0000002e != '\0') {
              *(uint *)(uVar8 * 0x5d8 + 0x3e0) = *(uint *)(uVar8 * 0x5d8 + 0x3e0) | 2;
            }
            iVar7 = uVar8 * 0x5d8;
            *(undefined2 *)(iVar7 + 0x412) = *(undefined2 *)(unaff_s0 + 0x28);
            *(ushort *)(iVar7 + 0x3ac) = (ushort)*(byte *)(unaff_s0 + 0x42);
            *(undefined *)(iVar7 + 0x418) = *(undefined *)(unaff_s0 + 0x66);
            _L0(iVar7 + 0x37e,unaff_s0 + 0x44,0x22);
            *(undefined *)((uint)*(byte *)(iVar7 + 0x37e) + iVar7 + 0x37f) = 0;
            *(undefined4 *)(iVar7 + 0x378) = *(undefined4 *)(iVar7 + 0x50);
            *(undefined2 *)(iVar7 + 0x37c) = *(undefined2 *)(iVar7 + 0x54);
            _L0(iVar7 + 0x3b0,unaff_s0 + 0x35,0xd);
            *(undefined4 *)(iVar7 + 8) = _DAT_44b00200;
            *(undefined4 *)(iVar7 + 0xc) = _DAT_44b00204;
            *(undefined4 *)(iVar7 + 0x10) = _DAT_44b00208;
            uVar5 = _DAT_44b0020c;
            *(undefined *)(iVar7 + 0x3c0) = 0;
            *(undefined4 *)(iVar7 + 0x14) = uVar5;
            *(undefined4 *)(iVar7 + 0x414) = 0xffff0000;
            uRam00000010 = _L0(0x14d);
            uVar2 = _L0(*(undefined *)(iVar7 + 0x57),unaff_s0 + 0x26,unaff_s0 + 0x32,DAT_00000015);
            *(undefined2 *)(unaff_s0 + 0x24) = uVar2;
            if (*(char *)(unaff_s0 + 0x66) == '\0') {
              iRam00000000 = 0;
            }
            else {
              iRam00000000 = _L0(2,0,0,iVar3 + 0x378,0,0,0);
              _L0(iVar3 + 0x37f,unaff_s0 + 0x67);
              FUN_00010760(iRam00000000,iVar3 + 0x37f);
              *(undefined *)(iRam00000000 + 2) = *(undefined *)(unaff_s0 + 0x33);
              FUN_00010788(0,*(undefined *)(iRam00000000 + 2));
              FUN_00010794(iRam00000000);
            }
          }
          if (*(char *)(unaff_s0 + 0x10) == '\0') {
            uVar4 = FUN_000107aa(iVar3 + 0x3b0,1);
            if ((uVar4 & 0xf) == 0) {
              *(undefined *)(uVar8 * 0x5d8 + 0x3d7) = 1;
              uVar5 = _L0();
              return uVar5;
            }
            cVar1 = _L0();
            *(char *)(uVar8 * 0x5d8 + 0x3d7) = '\x1f' - cVar1;
          }
          _L0();
          uStack0000000e = *(undefined *)(*(int *)(uVar8 * 0x5d8 + 0x3a4) + 4);
          _L0(iVar3,&stack0x0000000e,&stack0x0000000f);
          FUN_0001080a(0);
          return 1;
        }
      }
  ...
  FUN_00010858(0,0xcc);
  puVar6 = (undefined *)FUN_0001086c(0x1c01,4);
  *puVar6 = uVar9;
  puVar6[1] = *(undefined *)(unaff_s0 + 0x33);
  _L0();
  return 0;
}
...
undefined4 FUN_00010534(undefined4 uRam00000010,undefined2 param_2,undefined3 param_3)

{
  ...
  if (iVar3 == 0) {
    if (*(char *)(unaff_s1 + 0x58) == '\0') {
      ...
      iRam00000000 = unaff_s0;
      iVar3 = _L0(&stack0x0000000d,unaff_s0 + 0xe,*(undefined4 *)(unaff_s0 + 0x14),
                  *(undefined4 *)(unaff_s0 + 0x18),*(undefined *)(unaff_s0 + 0x1c));
      uVar8 = 1;
      if (iVar3 == 0) {
        iVar3 = FUN_0001059e(*(undefined *)(unaff_s0 + 0x10),*(undefined2 *)(unaff_s0 + 0xe));
        iVar7 = unaff_s3 * 0x5d8 + unaff_s2;
        *(int *)(iVar7 + 0x3a4) = iVar3;
        *(undefined *)(iVar3 + 4) = *(undefined *)(unaff_s0 + 0x12);
        ...
        *(short *)(iVar7 + 0x3aa) = (short)*(undefined4 *)(unaff_s0 + 0x18);
        ...
        iVar9 = unaff_s2 + iVar7;
        *(char *)(iVar9 + 0x3da) = cVar1;
        uVar8 = *(undefined *)(unaff_s0 + 0x1c);
        *(undefined *)(iVar9 + 0x3dc) = 0;
        *(undefined *)(iVar9 + 0x3db) = uVar8;
        FUN_000105f8(*(undefined *)(unaff_s0 + 0x33),in_stack_0000000d);
        DAT_00000014 = *(undefined *)(unaff_s0 + 0x34);
        DAT_00000015 = *(undefined *)(unaff_s0 + 0x1d);
        iVar3 = _L0(iVar9);
        if (iVar3 != 0) {
          ...
          *(undefined *)(iVar3 + 0x418) = *(undefined *)(unaff_s0 + 0x66);
          _L0(iVar3 + 0x37e,unaff_s0 + 0x44,0x22);
          ...
          *(undefined2 *)(iVar3 + 0x37c) = *(undefined2 *)(iVar3 + 0x54);
          _L0(iVar3 + 0x3b0,unaff_s0 + 0x35,0xd);
          ...
          *(undefined4 *)(unaff_s3 * 0x5d8 + 0x414) = 0xffff0000;
          uRam00000010 = _L0(0x14d);
          uVar2 = _L0(*(undefined *)(iVar3 + 0x57),unaff_s0 + 0x26,unaff_s0 + 0x32,DAT_00000015);
          *(undefined2 *)(unaff_s0 + 0x24) = uVar2;
          if (*(char *)(unaff_s0 + 0x66) == '\0') {
            iRam00000000 = 0;
          }
          else {
            iRam00000000 = _L0(2,0,0,iVar7 + 0x378 + unaff_s2,0,0,0);
            iVar3 = iVar7 + 0x37f + unaff_s2;
            _L0(iVar3,unaff_s0 + 0x67);
            FUN_00010760(iRam00000000,iVar3);
            *(undefined *)(iRam00000000 + 2) = *(undefined *)(unaff_s0 + 0x33);
            FUN_00010788(0,*(undefined *)(iRam00000000 + 2));
            FUN_00010794(iRam00000000);
          }
        ...
        if (*(char *)(unaff_s0 + 0x10) == '\0') {
          uVar4 = FUN_000107aa(iVar7 + 0x3b0 + unaff_s2,1);
          if ((uVar4 & 0xf) == 0) {
          ...
          cVar1 = _L0();
          *(char *)(unaff_s3 * 0x5d8 + unaff_s2 + 0x3d7) = '\x1f' - cVar1;
        }
        _L0();
        uStack0000000e = *(undefined *)(*(int *)(unaff_s2 + unaff_s3 * 0x5d8 + 0x3a4) + 4);
        _L0(iVar9,&stack0x0000000e,&stack0x0000000f);
        FUN_0001080a(0);
        return 1;
      }
    }
...
undefined4 FUN_00010564(undefined4 uRam00000010,undefined2 param_2,undefined3 param_3)

{
  ...
  FUN_00010564();
  iRam00000000 = unaff_s0;
  iVar4 = _L0(&stack0x0000000d,unaff_s0 + 0xe,*(undefined4 *)(unaff_s0 + 0x14),
              *(undefined4 *)(unaff_s0 + 0x18),*(undefined *)(unaff_s0 + 0x1c));
  if (iVar4 == 0) {
    iVar4 = FUN_0001059e(*(undefined *)(unaff_s0 + 0x10),*(undefined2 *)(unaff_s0 + 0xe));
    iVar8 = unaff_s3 * 0x5d8 + unaff_s2;
    *(int *)(iVar8 + 0x3a4) = iVar4;
    *(undefined *)(iVar4 + 4) = *(undefined *)(unaff_s0 + 0x12);
    *(short *)(iVar8 + 0x3a8) = (short)*(undefined4 *)(unaff_s0 + 0x14);
    *(short *)(iVar8 + 0x3aa) = (short)*(undefined4 *)(unaff_s0 + 0x18);
    cVar2 = *(char *)(unaff_s0 + 0x1c);
    if (cVar2 == '\x04') {
      cVar2 = '\x03';
    }
    iVar8 = unaff_s3 * 0x5d8;
    iVar9 = unaff_s2 + iVar8;
    *(char *)(iVar9 + 0x3da) = cVar2;
    uVar1 = *(undefined *)(unaff_s0 + 0x1c);
    *(undefined *)(iVar9 + 0x3dc) = 0;
    *(undefined *)(iVar9 + 0x3db) = uVar1;
    FUN_000105f8(*(undefined *)(unaff_s0 + 0x33),in_stack_0000000d);
    DAT_00000014 = *(undefined *)(unaff_s0 + 0x34);
    DAT_00000015 = *(undefined *)(unaff_s0 + 0x1d);
    iVar4 = _L0(iVar9);
    if (iVar4 != 0) {
      ...
      if (DAT_0000002e != '\0') {
        iVar4 = unaff_s3 * 0x5d8 + unaff_s2;
        *(uint *)(iVar4 + 0x3e0) = *(uint *)(iVar4 + 0x3e0) | 2;
      }
      iVar4 = unaff_s2 + unaff_s3 * 0x5d8;
      *(undefined2 *)(iVar4 + 0x412) = *(undefined2 *)(unaff_s0 + 0x28);
      *(ushort *)(iVar4 + 0x3ac) = (ushort)*(byte *)(unaff_s0 + 0x42);
      *(undefined *)(iVar4 + 0x418) = *(undefined *)(unaff_s0 + 0x66);
      _L0(iVar4 + 0x37e,unaff_s0 + 0x44,0x22);
      *(undefined *)((uint)*(byte *)(iVar4 + 0x37e) + iVar4 + 0x37f) = 0;
      *(undefined4 *)(iVar4 + 0x378) = *(undefined4 *)(iVar4 + 0x50);
      *(undefined2 *)(iVar4 + 0x37c) = *(undefined2 *)(iVar4 + 0x54);
      _L0(iVar4 + 0x3b0,unaff_s0 + 0x35,0xd);
      *(undefined4 *)(iVar4 + 8) = _DAT_44b00200;
      *(undefined4 *)(iVar4 + 0xc) = _DAT_44b00204;
      *(undefined4 *)(iVar4 + 0x10) = _DAT_44b00208;
      uVar6 = _DAT_44b0020c;
      *(undefined *)(iVar4 + 0x3c0) = 0;
      *(undefined4 *)(iVar4 + 0x14) = uVar6;
      *(undefined4 *)(unaff_s3 * 0x5d8 + 0x414) = 0xffff0000;
      uRam00000010 = _L0(0x14d);
      uVar3 = _L0(*(undefined *)(iVar4 + 0x57),unaff_s0 + 0x26,unaff_s0 + 0x32,DAT_00000015);
      *(undefined2 *)(unaff_s0 + 0x24) = uVar3;
      if (*(char *)(unaff_s0 + 0x66) == '\0') {
        iRam00000000 = 0;
      }
      else {
        iRam00000000 = _L0(2,0,0,iVar8 + 0x378 + unaff_s2,0,0,0);
        iVar4 = iVar8 + 0x37f + unaff_s2;
        _L0(iVar4,unaff_s0 + 0x67);
        FUN_00010760(iRam00000000,iVar4);
        *(undefined *)(iRam00000000 + 2) = *(undefined *)(unaff_s0 + 0x33);
        FUN_00010788(0,*(undefined *)(iRam00000000 + 2));
        FUN_00010794(iRam00000000);
      }
    ...
    if (*(char *)(unaff_s0 + 0x10) == '\0') {
      uVar5 = FUN_000107aa(iVar8 + 0x3b0 + unaff_s2,1);
      if ((uVar5 & 0xf) == 0) {
        *(undefined *)(unaff_s3 * 0x5d8 + unaff_s2 + 0x3d7) = 1;
        uVar6 = _L0();
        return uVar6;
      ...
      cVar2 = _L0();
      *(char *)(unaff_s3 * 0x5d8 + unaff_s2 + 0x3d7) = '\x1f' - cVar2;
    }
    _L0();
    uStack0000000e = *(undefined *)(*(int *)(unaff_s2 + unaff_s3 * 0x5d8 + 0x3a4) + 4);
    _L0(iVar9,&stack0x0000000e,&stack0x0000000f);
    ...
    FUN_00010858(0,0xcc);
    puVar7 = (undefined *)FUN_0001086c(0x1c01,4);
    *puVar7 = 1;
    puVar7[1] = *(undefined *)(unaff_s0 + 0x33);
    _L0();
    uVar6 = 0;
  }
  return uVar6;
  ...
  if (iVar4 == 0) {
    ...
    *(undefined *)(unaff_s6 + 0x15) = *(undefined *)(unaff_s0 + 0x1d);
    ...
    if (iVar4 != 0) {
      ...
      *(undefined4 *)(unaff_s3 * 0x5d8 + 0x414) = 0xffff0000;
      uVar5 = _L0(0x14d);
      uVar1 = *(undefined *)(iVar4 + 0x57);
      *(undefined4 *)(unaff_s6 + 0x10) = uVar5;
      uVar3 = _L0(uVar1,unaff_s0 + 0x26,unaff_s0 + 0x32,*(undefined *)(unaff_s6 + 0x15));
      *(undefined2 *)(unaff_s0 + 0x24) = uVar3;
      if (*(char *)(unaff_s0 + 0x66) == '\0') {
        iRam00000000 = 0;
      }
    ...
    if (*(char *)(unaff_s0 + 0x10) == '\0') {
      uVar6 = FUN_000107aa(iVar8 + 0x3b0 + unaff_s2,1);
      if ((uVar6 & 0xf) == 0) {
        *(undefined *)(unaff_s3 * 0x5d8 + unaff_s2 + 0x3d7) = 1;
        uVar5 = _L0();
        return uVar5;
...

{
  ...
  *(short *)(iVar7 + 0x3aa) = (short)*(undefined4 *)(unaff_s0 + 0x18);
  ...
  iVar7 = unaff_s3 * 0x5d8;
  iVar8 = unaff_s2 + iVar7;
  *(char *)(iVar8 + 0x3da) = cVar2;
  uVar1 = *(undefined *)(unaff_s0 + 0x1c);
  *(undefined *)(iVar8 + 0x3dc) = 0;
  *(undefined *)(iVar8 + 0x3db) = uVar1;
  FUN_000105f8(*(undefined *)(unaff_s0 + 0x33),in_stack_0000000d);
  *(undefined *)(unaff_s6 + 0x14) = *(undefined *)(unaff_s0 + 0x34);
  *(undefined *)(unaff_s6 + 0x15) = *(undefined *)(unaff_s0 + 0x1d);
  iVar4 = _L0(iVar8);
  ...
  if (*(char *)(unaff_s0 + 0x10) == '\0') {
    uVar6 = FUN_000107aa(iVar7 + 0x3b0 + unaff_s2,1);
    if ((uVar6 & 0xf) == 0) {
      *(undefined *)(unaff_s3 * 0x5d8 + unaff_s2 + 0x3d7) = 1;
      uVar5 = _L0();
      return uVar5;
  ...
  _L0();
  uStack0000000e = *(undefined *)(*(int *)(unaff_s2 + unaff_s3 * 0x5d8 + 0x3a4) + 4);
  _L0(iVar8,&stack0x0000000e,&stack0x0000000f);
  FUN_0001080a(0);
  return 1;
}
...
undefined4 FUN_000105f8(undefined3 param_1)

{
  ...
  *(undefined *)(unaff_s6 + 0x15) = *(undefined *)(unaff_s0 + 0x1d);
  ...
  if (iVar4 != 0) {
    ...
    *(undefined2 *)(unaff_s0 + 0x24) = uVar3;
    if (*(char *)(unaff_s0 + 0x66) == '\0') {
      ...
      iRam00000000 = _L0(2,0,0,unaff_s4 + 0x378 + unaff_s2,0,0,0);
      iVar4 = unaff_s4 + 0x37f + unaff_s2;
      _L0(iVar4,unaff_s0 + 0x67);
      FUN_00010760(iRam00000000,iVar4);
      *(undefined *)(iRam00000000 + 2) = *(undefined *)(unaff_s0 + 0x33);
      FUN_00010788(0,*(undefined *)(iRam00000000 + 2));
  ...
  if (*(char *)(unaff_s0 + 0x10) == '\0') {
    uVar6 = FUN_000107aa(unaff_s4 + 0x3b0 + unaff_s2,1);
    if ((uVar6 & 0xf) == 0) {
      *(undefined *)(unaff_s3 * 0x5d8 + unaff_s2 + 0x3d7) = 1;
      uVar5 = _L0();
      return uVar5;
...

{
  ...
  if (DAT_0000002e != '\0') {
    ...
    *(uint *)(iVar6 + 0x3e0) = *(uint *)(iVar6 + 0x3e0) | 2;
  }
  ...
  *(undefined *)(iVar6 + 0x418) = *(undefined *)(unaff_s0 + 0x66);
  _L0(iVar6 + 0x37e,unaff_s0 + 0x44,0x22);
  ...
  *(undefined4 *)(unaff_s3 * 0x5d8 + 0x414) = 0xffff0000;
  uVar4 = _L0(0x14d);
  uVar1 = *(undefined *)(iVar6 + 0x57);
  *(undefined4 *)(unaff_s6 + 0x10) = uVar4;
  uVar3 = _L0(uVar1,unaff_s0 + 0x26,unaff_s0 + 0x32,*(undefined *)(unaff_s6 + 0x15));
  *(undefined2 *)(unaff_s0 + 0x24) = uVar3;
  if (*(char *)(unaff_s0 + 0x66) == '\0') {
    iRam00000000 = 0;
    ...
    iRam00000000 = _L0(2,0,0,unaff_s4 + 0x378 + unaff_s2,0,0,0);
    iVar6 = unaff_s4 + 0x37f + unaff_s2;
    _L0(iVar6,unaff_s0 + 0x67);
    FUN_00010760(iRam00000000,iVar6);
    *(undefined *)(iRam00000000 + 2) = *(undefined *)(unaff_s0 + 0x33);
    FUN_00010788(0,*(undefined *)(iRam00000000 + 2));
    FUN_00010794(iRam00000000);
  }
  if (*(char *)(unaff_s0 + 0x10) == '\0') {
    uVar5 = FUN_000107aa(unaff_s4 + 0x3b0 + unaff_s2,1);
    if ((uVar5 & 0xf) == 0) {
      *(undefined *)(unaff_s3 * 0x5d8 + unaff_s2 + 0x3d7) = 1;
      uVar4 = _L0();
      return uVar4;
...

{
  ...
  *(undefined4 *)(unaff_s1 + 0x14) = uVar4;
...

{
  ...
  *(undefined2 *)(unaff_s0 + 0x24) = uVar2;
  if (*(char *)(unaff_s0 + 0x66) == '\0') {
    ...
    iRam00000000 = _L0(2,0,0,unaff_s4 + 0x378 + unaff_s2,0,0,0);
    iVar5 = unaff_s4 + 0x37f + unaff_s2;
    _L0(iVar5,unaff_s0 + 0x67);
    FUN_00010760(iRam00000000,iVar5);
    *(undefined *)(iRam00000000 + 2) = *(undefined *)(unaff_s0 + 0x33);
    FUN_00010788(0,*(undefined *)(iRam00000000 + 2));
    FUN_00010794(iRam00000000);
  }
  if (*(char *)(unaff_s0 + 0x10) == '\0') {
    uVar3 = FUN_000107aa(unaff_s4 + 0x3b0 + unaff_s2,1);
    if ((uVar3 & 0xf) == 0) {
      *(undefined *)(unaff_s3 * 0x5d8 + unaff_s2 + 0x3d7) = 1;
      uVar4 = _L0();
      return uVar4;
...

{
  ...
  iVar2 = _L0();
  *unaff_s1 = iVar2;
  _L0(unaff_s6 + unaff_s2,unaff_s0 + 0x67);
  FUN_00010760(*unaff_s1,unaff_s6 + unaff_s2);
  *(undefined *)(*unaff_s1 + 2) = *(undefined *)(unaff_s0 + 0x33);
  FUN_00010788(0,*(undefined *)(*unaff_s1 + 2));
  FUN_00010794(*unaff_s1);
  if (*(char *)(unaff_s0 + 0x10) == '\0') {
    uVar3 = FUN_000107aa(unaff_s4 + 0x3b0 + unaff_s2,1);
    if ((uVar3 & 0xf) == 0) {
      *(undefined *)(unaff_s3 * 0x5d8 + unaff_s2 + 0x3d7) = 1;
...

{
  ...
  _L0();
  FUN_00010760(*unaff_s1);
  *(undefined *)(*unaff_s1 + 2) = *(undefined *)(unaff_s0 + 0x33);
  FUN_00010788(0,*(undefined *)(*unaff_s1 + 2));
  FUN_00010794(*unaff_s1);
  if (*(char *)(unaff_s0 + 0x10) == '\0') {
    uVar2 = FUN_000107aa(unaff_s4 + 0x3b0 + unaff_s2,1);
    if ((uVar2 & 0xf) == 0) {
      *(undefined *)(unaff_s3 * 0x5d8 + unaff_s2 + 0x3d7) = 1;
      uVar3 = _L0();
      return uVar3;
...

{
  ...
  FUN_00010858();
  puVar1 = (undefined *)FUN_0001086c(0x1c01,4);
  *puVar1 = unaff_s4;
...

{
  ...
  iVar1 = _L0(7,CONCAT22(in_register_00002032,dest_id));
  if ((iVar1 != 1) && (iVar1 = FUN_000108a6(7), iVar1 != 0)) {
    FUN_000108c4(0,0,0x12f);
  }
  iVar1 = FUN_000108ce(7);
  if (iVar1 == 1) {
    if (_DAT_00000004 != 0) {
      FUN_000108fa(0,0,0x135);
    }
    _L0();
  }
  return 0;
