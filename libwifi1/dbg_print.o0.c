...
union anon_union.conflictef_for___value { // DWARF DIE: ef
    wint_t __wch;
    uchar __wchb[4];
};

struct _mbstate_t { // DWARF DIE: 121
    int __count;
...
union anon_union.conflictef { // DWARF DIE: ef
    wint_t __wch;
    uchar __wchb[4];
};
...
struct la_mem_format { // DWARF DIE: a92
    uint32_t word[4];
};
...
struct debug_env_tag { // DWARF DIE: b13
...
struct _rand48 { // DWARF DIE: 6f4
    ushort _seed[3];
    ushort _mult[3];
    ushort _add;
};

struct _glue { // DWARF DIE: 6af
    struct _glue * _next;
    int _niobs;
    __FILE * _iobs;
};

struct anon_struct.conflict882 { // DWARF DIE: 882
    uchar * _nextf[30];
    uint _nmalloc[30];
};

struct __tm { // DWARF DIE: 1e7
    int __tm_sec;
    int __tm_min;
    int __tm_hour;
    int __tm_mday;
...
struct anon_struct.conflict73d { // DWARF DIE: 73d
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict8c9_for__new { // DWARF DIE: 8c9
    struct anon_struct.conflict73d _reent;
    struct anon_struct.conflict882 _unused;
};

struct _on_exit_args { // DWARF DIE: 26a
    void * _fnargs[32];
    void * _dso_handle[32];
    __ULong _fntypes;
    __ULong _is_cxa;
...
struct __sbuf { // DWARF DIE: 31f
    uchar * _base;
    int _size;
};

struct __sFILE { // DWARF DIE: 34d
    uchar * _p;
    int _r;
    int _w;
    short _flags;
