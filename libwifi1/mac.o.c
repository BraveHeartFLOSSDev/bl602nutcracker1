...
union anon_union.conflictc9b_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflictc76_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflictc51_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};
