...
union anon_union.conflictcb3_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflictcd8_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflictcfd_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};
...

{
  ...
  do {
    FUN_0001005c(0,iVar2,puVar1,*puVar1,puVar1[1],puVar1[2],puVar1[3]);
    iVar2 = iVar2 + 1;
    _L0(0,puVar1[4],puVar1[5],puVar1[6],*(undefined2 *)(puVar1 + 7),
        *(undefined2 *)((int)puVar1 + 0x1e));
    FUN_000100a8(0,puVar1[8],puVar1[9],puVar1[0xb],puVar1[0xc],puVar1[0xd],puVar1[0xe],puVar1[0xf]);
    puVar1 = puVar1 + 0x19;
  } while (iVar2 != 0xd);
  FUN_000100c2(0,0xd);
  puVar1 = (undefined4 *)0x0;
  ...
  do {
    ...
    iVar3 = iVar2 + 1;
    FUN_0001010a(0,iVar2,puVar1,iVar4,*puVar1,puVar1[1]);
    puVar1 = puVar1 + 0xd;
    iVar2 = iVar3;
  } while (iVar3 != 0xd);
  return;
...

{
  ...
  iVar2 = 0;
  do {
    FUN_0001005c(0,iVar2,unaff_s0,*unaff_s0,unaff_s0[1],unaff_s0[2],unaff_s0[3]);
    iVar2 = iVar2 + 1;
    _L0(0,unaff_s0[4],unaff_s0[5],unaff_s0[6],*(undefined2 *)(unaff_s0 + 7),
        *(undefined2 *)((int)unaff_s0 + 0x1e));
    FUN_000100a8(0,unaff_s0[8],unaff_s0[9],unaff_s0[0xb],unaff_s0[0xc],unaff_s0[0xd],unaff_s0[0xe],
                 unaff_s0[0xf]);
...

{
  ...
  while( true ) {
    ...
    unaff_s1 = unaff_s1 + 1;
    _L0(unaff_s0[4],unaff_s0[5],unaff_s0[6],*(undefined2 *)(unaff_s0 + 7),
        *(undefined2 *)((int)unaff_s0 + 0x1e));
...

{
  ...
  while (FUN_000100a8(param_1,param_2,param_3,param_4,param_5,param_6,param_7), unaff_s1 != unaff_s2
        ) {
...

{
  ...
  do {
    ...
    iVar2 = iVar1 + 1;
    FUN_0001010a(0,iVar1,unaff_s0,iVar3,*unaff_s0,unaff_s0[1]);
...

{
  ...
  if ((((puVar8 == (undefined4 *)0x0) || (puVar9 == (undefined4 *)0x0)) ||
    ...
    FUN_00010248(0,puVar8,puVar9,puVar2,puVar11,puVar3);
  }
  do {
