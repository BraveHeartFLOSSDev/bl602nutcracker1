...
union anon_union.conflictc63_for_field_3 {
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflictc88_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflictcad_for_field_5 {
    uint32_t dataendptr;
...

{
  ...
  _L0(auStack416,kek,CONCAT31(in_register_0000202d,kekLen) << 6,1);
  FUN_000100a0(auStack416,data,ret);
  return 0;
}
...

{
  ...
  if (n != 0) {
    ...
    FUN_00010102(auStack72,keyIv,8);
    FUN_00010116(cipher + 8,plain,n << 3);
    uVar2 = 0;
    iVar4 = 6;
    do {
      iVar1 = 1;
      while (iVar3 = iVar1 * 8, iVar1 != n + 1) {
        ...
        FUN_0001013c(b + 4,cipher + iVar3,8);
        FUN_0001014c(kek,CONCAT31(in_register_0000202d,kekLen),a + 4);
        FUN_0001015a(auStack72,a + 4,8);
        a[3] = (char)uVar2 + (char)iVar1 ^ a[3];
        iVar1 = iVar1 + 1;
        _L0(cipher + iVar3,b + 4,8);
      }
      iVar4 = iVar4 + -1;
      uVar2 = uVar2 + (n & 0xff) & 0xff;
    } while (iVar4 != 0);
    FUN_0001019c(cipher,auStack72,8);
    return 0;
  }
  return -1;
}
...

{
  ...
  _L0();
  FUN_00010102(&stack0x00000008,8);
  FUN_00010116(unaff_s0 << 3);
  uVar2 = 0;
  iVar4 = 6;
  do {
    iVar1 = 1;
    while (iVar3 = iVar1 * 8 + unaff_s2, iVar1 != unaff_s0 + 1) {
  ...
  FUN_0001019c(&stack0x00000008,8);
  return 0;
}
...

{
  ...
  if (n != 0) {
    _L0(auStack472,0,8);
    FUN_0001020c(a + 4,0,0x10);
    FUN_0001021a(auStack472,cipher,8);
    uVar1 = (n & 0xff) * 5;
    FUN_0001023c(plain,cipher + 8,n * 8);
    _LVL67(b + 0xc,kek,CONCAT31(in_register_0000202d,kekLen) << 6,0);
    iVar4 = 6;
    do {
      UVar2 = n;
      pUVar3 = plain + n * 8 + -8;
...

{
  ...
  _L0();
  FUN_0001020c(&stack0x00000010,0,0x10);
  FUN_0001021a(&stack0x00000008,8);
  uVar1 = (unaff_s2 & 0xff) * 5;
  FUN_0001023c(unaff_s4 + 8,unaff_s2 * 8);
  _LVL67(&stack0x00000020,unaff_s6 << 6,0);
  iVar4 = 6;
  do {
    uVar2 = unaff_s2;
...

{
  ...
  do {
    ...
    unaff_s0 = unaff_s0 - unaff_s7;
    iVar3 = iVar3 + -1;
    iVar1 = unaff_s2;
    iVar2 = unaff_s1;
  } while (iVar3 != 0);
  iVar1 = _L43(&stack0x00000008,8);
  return -(uint)(iVar1 != 0);
}
