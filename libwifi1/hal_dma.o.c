...
void hal_dma_init(undefined4 uRam00000018)

{
  _L0(0);
  uRam00000018._0_2_ = (undefined2)_DAT_44a000a4;
  _L0(8);
  uRam00000018._2_2_ = (short)_DAT_44a000ac;
  return;
}
...

{
  ...
  if (desc->cb == (cb_dma_func_ptr *)0x0) {
    ...
    pdVar1->ctrl = (ushort)*(byte *)type << 8 | *(byte *)type | 0x10 | 0x1000;
    FUN_0001008c(type * 8,desc);
  }
  FUN_000100a0(pdVar1->dest,pdVar1->src,pdVar1->length);
  if ((type != 0) && (type != 1)) {
    do {
      FUN_000100b8(1000);
      FUN_000100c4(0);
...

{
  ...
  FUN_0001008c();
  FUN_000100a0(unaff_s0[1],*unaff_s0,*(undefined2 *)(unaff_s0 + 2));
...

{
  ...
  if (dma_queue == 0) {
    _L0(0x40);
    while (iVar1 = FUN_0001011a(0), iVar1 != 0) {
      if (*(code **)(iVar1 + 8) != (code *)0x0) {
        (**(code **)(iVar1 + 8))(*(undefined4 *)(iVar1 + 0xc),0);
      }
    }
    return;
  }
...

{
  ...
  _L0();
  while (iVar1 = FUN_0001011a(unaff_s1 * 8), iVar1 != 0) {
    if (*(code **)(iVar1 + 8) != (code *)0x0) {
...

{
  ...
  while (iVar1 = FUN_0001011a(), iVar1 != 0) {
    if (*(code **)(iVar1 + 8) != (code *)0x0) {
      (**(code **)(iVar1 + 8))(*(undefined4 *)(iVar1 + 0xc));
    }
  }
