...
union anon_union.conflict13af_for_field_5 {
    uint32_t dataendptr;
...
union anon_union.conflict138a_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflict1365_for_field_3 {
...
union anon_union.conflict2917_for_field_0 {
...

{
  ...
  while (iRam00000000 != 0) {
    iVar1 = _L0();
    pcVar2 = *(code **)(iVar1 * 8);
    if ((0x1a < iVar1) || (pcVar2 == (code *)0x0)) {
      _LVL27(0,0,0xdd);
    }
    (*pcVar2)(((code **)(iVar1 * 8))[1]);
  }
  return;
}
...

{
  ...
  do {
    iVar1 = _L0();
    pcVar2 = *(code **)(unaff_s1 + iVar1 * 8);
    if ((unaff_s4 < iVar1) || (pcVar2 == (code *)0x0)) {
      _LVL27(0xdd);
    }
    (*pcVar2)(*(undefined4 *)(iVar1 * 8 + unaff_s1 + 4));
  } while (*unaff_s0 != 0);
  return;
}
...

{
  ...
  do {
    ...
    } while ((iVar1 <= unaff_s4) && (unaff_s3 != (code *)0x0));
    param_1 = 0xdd;
  } while( true );
}
...
void ke_init(undefined4 uRam00000010,undefined4 uRam00000014,undefined4 uRam00000018,
...

{
  ...
  while (iVar1 = FUN_00010194(4), iVar1 != 0) {
    _L0();
  }
  while (iVar1 = FUN_000101a6(0xc), iVar1 != 0) {
    _L0();
  }
  while (iVar1 = FUN_000101b8(0x14), iVar1 != 0) {
    _L0();
  }
  do {
                    // WARNING: Do nothing block with infinite loop
...

{
  ...
  while (iVar1 = FUN_00010194(param_1), iVar1 != 0) {
    _L0();
    param_1 = unaff_s0 + 4;
  }
  while (iVar1 = FUN_000101a6(0xc), iVar1 != 0) {
...

{
  ...
  while (iVar1 = FUN_000101a6(param_1), iVar1 != 0) {
    _L0();
...

{
  ...
  while (iVar1 = FUN_000101b8(param_1), iVar1 != 0) {
    _L0();
...

{
  ...
  do {
    _L0();
    iVar1 = FUN_000101b8(unaff_s0 + 0x14);
  } while (iVar1 != 0);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
...

{
  ...
  do {
    _L0();
    iVar1 = FUN_000101a6(unaff_s0 + 0xc);
  } while (iVar1 != 0);
  while (iVar1 = FUN_000101b8(0x14), iVar1 != 0) {
    _L0();
  }
