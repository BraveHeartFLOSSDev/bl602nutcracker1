...
union anon_union.conflicte0_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
union anon_union.conflictce4_for_field_4 {
...
union anon_union.conflictd09_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflictcbf_for_field_3 {
...
struct anon_struct.conflict72e {
    uint _unused_rand;
    char * _strtok_last;
...
struct anon_struct.conflict873 {
    uchar * _nextf[30];
    uint _nmalloc[30];
};

union anon_union.conflict8ba_for__new {
...

{
  ...
  puVar1 = (undefined4 *)_L0(CONCAT22(in_register_00002036,param_len) + 0xc);
  if (puVar1 == (undefined4 *)0x0) {
    FUN_0001003a(0,0,0x50);
  }
  ...
  *puVar1 = 0;
  FUN_0001005e(puVar1 + 3,0,CONCAT22(in_register_00002036,param_len));
  return puVar1 + 3;
}
...

{
  if (*(byte *)((int)param_ptr + -6) < 0xf) {
    if (*(byte *)((int)param_ptr + -6) < 0xd) {
      FUN_000100da(4,(int)param_ptr + -0xc);
      do {
    ...
    FUN_000100a4(0,0,0xb6);
  }
  FUN_000100b0((int)param_ptr + -8);
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
