...
struct cfg_element_entry { // DWARF DIE: e12
    uint32_t task;
    uint16_t element;
    uint16_t type;
    char * name;
...
struct ke_msg_handler { // DWARF DIE: bba
    ke_msg_id_t id;
    undefined field_0x2;
    undefined field_0x3;
...
struct ke_state_handler { // DWARF DIE: be6
...
struct anon_struct.conflictcd2 { // DWARF DIE: cd2
    uint32_t task;
    uint32_t element;
    uint32_t type;
    uint32_t length;
...
struct cfg_start_req { // DWARF DIE: d78
Missing member u : anon_union.conflictd1d_for_u at offset 0x4 [exceeds parent struct len]
    uint32_t ops;
};

typedef union anon_union.conflictd1d anon_union.conflictd1d, *Panon_union.conflictd1d;

union anon_union.conflictd1d { // DWARF DIE: d1d
    undefined1 get; // Data type larger than union's declared size: anon_struct.conflictc8a[1]
    undefined1 reset; // Data type larger than union's declared size: anon_struct.conflictc8a[1]
...
struct anon_struct.conflictc3a { // DWARF DIE: c3a
    uint32_t task;
    uint32_t element;
    uint32_t length;
    uint32_t[0] buf;
...

{
  ...
  while (false) {
    FUN_00010084(puVar1);
    _L0(*puVar1);
    FUN_000100a4((uint)*(ushort *)(puVar1 + 1));
    FUN_000100b4((uint)*(ushort *)((int)puVar1 + 6));
    FUN_000100c4(puVar1[2]);
    FUN_000100d6(puVar1[3],(uint)*(byte *)((int)puVar1 + 6));
    FUN_000100e4(extraout_a0);
    FUN_000100f2();
    FUN_00010102(0);
    puVar1 = puVar1 + 7;
  }
...

{
  ...
  _L0();
  for (; unaff_s0 < unaff_s1; unaff_s0 = unaff_s0 + 7) {
    FUN_00010084(unaff_s0);
    _L0(*unaff_s0);
    FUN_000100a4((uint)*(ushort *)(unaff_s0 + 1));
    FUN_000100b4((uint)*(ushort *)((int)unaff_s0 + 6));
    FUN_000100c4(unaff_s0[2]);
    FUN_000100d6(unaff_s0[3],(uint)*(byte *)((int)unaff_s0 + 6));
    FUN_000100e4(extraout_a0);
    FUN_000100f2();
    FUN_00010102(0);
  }
...

{
  ...
  while( true ) {
    _L0(param_1);
    FUN_000100a4((uint)*(ushort *)(unaff_s0 + -6));
    FUN_000100b4((uint)*(ushort *)((int)unaff_s0 + -0x16));
    FUN_000100c4(unaff_s0[-5]);
    FUN_000100d6(unaff_s0[-4],(uint)*(byte *)((int)unaff_s0 + -0x16));
    FUN_000100e4(extraout_a0);
    FUN_000100f2();
    FUN_00010102(0);
...

{
  ...
  for (; FUN_00010102(param_1), unaff_s0 < unaff_s1; unaff_s0 = unaff_s0 + 7) {
    FUN_00010084(unaff_s0);
    _L0(*unaff_s0);
    FUN_000100a4((uint)*(ushort *)(unaff_s0 + 1));
    FUN_000100b4((uint)*(ushort *)((int)unaff_s0 + 6));
