...
struct la_mem_format { // DWARF DIE: f6a
    uint32_t word[4];
};
...
typedef union anon_union.conflict2954_for_field_0 anon_union.conflict2954_for_field_0, *Panon_union.conflict2954_for_field_0;

typedef struct dma_desc dma_desc, *Pdma_desc;

typedef struct tx_pbd tx_pbd, *Ptx_pbd;

typedef union anon_union.conflict1076_for_field_3 anon_union.conflict1076_for_field_3, *Panon_union.conflict1076_for_field_3;

typedef union anon_union.conflict109b_for_field_4 anon_union.conflict109b_for_field_4, *Panon_union.conflict109b_for_field_4;

typedef union anon_union.conflict10c0_for_field_5 anon_union.conflict10c0_for_field_5, *Panon_union.conflict10c0_for_field_5;
...
struct co_list_hdr { // DWARF DIE: ef9
    struct co_list_hdr * next;
};

union anon_union.conflict10c0_for_field_5 { // DWARF DIE: 10c0
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflict1076_for_field_3 { // DWARF DIE: 1076
...
struct hostdesc { // DWARF DIE: 166e
    uint32_t pbuf_addr;
...
struct tx_cfm_tag { // DWARF DIE: 14d3
    uint16_t pn[4];
    uint16_t sn;
    uint16_t timestamp;
    int8_t credits;
...
struct tx_compressed_policy_tbl { // DWARF DIE: 104b
    uint32_t upatterntx;
    uint32_t sec_user_control;
};

struct tx_policy_tbl { // DWARF DIE: fda
    uint32_t upatterntx;
...
union anon_union.conflict2954_for_field_0 { // DWARF DIE: 2954
    struct tx_policy_tbl policy_tbl;
    struct tx_compressed_policy_tbl comp_pol_tbl;
};

struct lmacdesc { // DWARF DIE: 17da
    struct tx_agg_desc * agg_desc;
    struct txl_buffer_tag * buffer;
    struct tx_hw_desc * hw_desc;
};

struct umacdesc { // DWARF DIE: 174a
...
union anon_union.conflict109b_for_field_4 { // DWARF DIE: 109b
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

struct tx_hd { // DWARF DIE: 10e5
    uint32_t upatterntx;
    uint32_t nextfrmexseq_ptr;
    uint32_t nextmpdudesc_ptr;
    union anon_union.conflict1076_for_field_3 field_3;
    union anon_union.conflict109b_for_field_4 field_4;
    union anon_union.conflict10c0_for_field_5 field_5;
    uint32_t frmlen;
...
struct tx_hw_desc { // DWARF DIE: 1552
    struct tx_cfm_tag * cfm_ptr;
    struct tx_hd thd;
};

struct txdesc { // DWARF DIE: 18f6
...
struct txl_buffer_control { // DWARF DIE: 17a6
    union anon_union.conflict2954_for_field_0 field_0;
    uint32_t mac_control_info;
    uint32_t phy_control_info;
};

struct dma_desc { // DWARF DIE: e68
    uint32_t src;
    uint32_t dest;
    uint16_t length;
    uint16_t ctrl;
...
struct txl_buffer_tag { // DWARF DIE: 1815
    uint32_t length;
    uint32_t lenheader;
    uint32_t lenpad;
    uint32_t flags;
...
struct tx_agg_desc { // DWARF DIE: 1583
    uint8_t reserved;
};

typedef struct dma_env_tag dma_env_tag, *Pdma_env_tag;

struct dma_env_tag { // DWARF DIE: ebc
...
struct co_list { // DWARF DIE: f1a
    struct co_list_hdr * first;
    struct co_list_hdr * last;
};

struct mm_timer_env_tag { // DWARF DIE: 1d3f
    struct co_list prog;
};

typedef struct mm_timer_tag mm_timer_tag, *Pmm_timer_tag;

struct mm_timer_tag { // DWARF DIE: 1cfe
    struct co_list_hdr list_hdr;
    void (* cb)(void *);
    void * env;
    uint32_t time;
...
struct rx_swdesc { // DWARF DIE: 130e
    struct co_list_hdr list_hdr;
...
struct phy_channel_info { // DWARF DIE: f42
    uint32_t info1;
    uint32_t info2;
};

struct rx_pbd { // DWARF DIE: 13a3
    uint32_t upattern;
    uint32_t next;
    uint32_t datastartptr;
    uint32_t dataendptr;
...
struct rx_payloaddesc { // DWARF DIE: 1476
    struct rx_pbd pbd;
    uint32_t pd_status;
    uint32_t * buffer_rx;
    void * pbuf_holder[6];
...
struct rx_dmadesc { // DWARF DIE: 1406
    struct rx_hd hd;
...
struct ps_env_tag { // DWARF DIE: 3749
    _Bool ps_on;
    undefined field_0x1;
    ke_task_id_t taskid;
...
struct mm_chan_ctxt_add_req { // DWARF DIE: 1d97
    uint8_t band;
    uint8_t type;
...
struct debug_env_tag { // DWARF DIE: fa2
...
struct mblock_free { // DWARF DIE: 2091
};

struct ke_env_tag { // DWARF DIE: 2042
...
struct txl_list { // DWARF DIE: 27b2
...
struct txl_cntrl_env_tag { // DWARF DIE: 27fa
...
typedef struct anon_struct.conflict33a4 anon_struct.conflict33a4, *Panon_struct.conflict33a4;

struct anon_struct.conflict33a4 { // DWARF DIE: 33a4
...
typedef union anon_union.conflict356c anon_union.conflict356c, *Panon_union.conflict356c;

typedef struct anon_struct.conflict3471 anon_struct.conflict3471, *Panon_struct.conflict3471;
...
struct txl_frame_cfm_tag { // DWARF DIE: 2a4a
    void (* cfm_func)(void *, uint32_t);
    void * env;
};

struct txl_frame_desc_tag { // DWARF DIE: 2a72
    struct txdesc txdesc;
...
struct anon_struct.conflict3471 { // DWARF DIE: 3471
    uint32_t dummy;
...
union anon_union.conflict356c { // DWARF DIE: 356c
    struct anon_struct.conflict33a4 sta;
    struct anon_struct.conflict3471 ap;
};
...
typedef union anon_union.conflict356c_for_u anon_union.conflict356c_for_u, *Panon_union.conflict356c_for_u;
...
struct Cipher_t { // DWARF DIE: 2fec
    UINT8 wep40:1;
    UINT8 wep104:1;
    UINT8 tkip:1;
    UINT8 ccmp:1;
...
union anon_union.conflict356c_for_u { // DWARF DIE: 356c
    struct anon_struct.conflict33a4 sta;
    struct anon_struct.conflict3471 ap;
};

struct chan_tbtt_tag { // DWARF DIE: 1e46
    struct co_list_hdr list_hdr;
    uint32_t time;
    uint8_t vif_index;
    uint8_t priority;
...
struct mobility_domain { // DWARF DIE: 319c
    uint16_t mdid;
...
struct SecurityMode_t { // DWARF DIE: 3052
    UINT16 noRsn:1;
    UINT16 wepStatic:1;
    UINT16 wepDynamic:1;
    UINT16 wpa:1;
...
struct mac_bss_info { // DWARF DIE: 31c4
...
struct vif_info_tag { // DWARF DIE: 358f
    struct co_list_hdr list_hdr;
    uint32_t prevent_sleep;
    ...
    union anon_union.conflict356c_for_u u;
...
struct chan_ctxt_tag { // DWARF DIE: 1e95
    struct co_list_hdr list_hdr;
...
struct vif_mgmt_env_tag { // DWARF DIE: 36ca
...
struct hal_dma_env_tag { // DWARF DIE: 2cda
...
struct hal_dma_desc_tag { // DWARF DIE: 2c93
...
struct txl_frame_env_tag { // DWARF DIE: 2ac6
...
struct bam_env_tag { // DWARF DIE: 1ba8
    uint32_t pkt_cnt;
...
struct sta_mgmt_ba_info { // DWARF DIE: 2533
...
typedef union anon_union.conflict2efb_for_rate_map anon_union.conflict2efb_for_rate_map, *Panon_union.conflict2efb_for_rate_map;

struct rc_rate_stats { // DWARF DIE: 2e5e
    uint16_t attempts;
    uint16_t success;
...
union anon_union.conflict2efb_for_rate_map { // DWARF DIE: 2efb
    uint8_t ht[4];
};

struct step { // DWARF DIE: 2ed4
    uint32_t tp;
    uint16_t idx;
    undefined field_0x6;
    undefined field_0x7;
...
struct rc_sta_stats { // DWARF DIE: 23cd
    ...
    uint8_t format_mod;
    union anon_union.conflict2efb_for_rate_map rate_map;
    uint16_t rate_map_l;
    uint8_t mcs_max;
    uint8_t r_idx_min;
    uint8_t r_idx_max;
...
struct sta_pol_tbl_cntl { // DWARF DIE: 237e
...
struct sta_mgmt_sec_info { // DWARF DIE: 2343
...
struct sta_info_tag { // DWARF DIE: 2582
    struct co_list_hdr list_hdr;
    uint32_t bcn_int;
...
struct sta_info_env_tag { // DWARF DIE: 276b
    struct co_list free_sta_list;
};

typedef struct chan_env_tag chan_env_tag, *Pchan_env_tag;

struct chan_env_tag { // DWARF DIE: 1f25
...
struct scan_start_req { // DWARF DIE: 2ddc
};

typedef union anon_union.conflict2efb anon_union.conflict2efb, *Panon_union.conflict2efb;

union anon_union.conflict2efb { // DWARF DIE: 2efb
    uint8_t ht[4];
};
...
struct me_chan_config_req { // DWARF DIE: 2f40
...
struct me_env_tag { // DWARF DIE: 3108
...
struct ke_msg_handler { // DWARF DIE: 1aaa
    ke_msg_id_t id;
    undefined field_0x2;
    undefined field_0x3;
...
struct ke_state_handler { // DWARF DIE: 1ad6
...
struct scan_env_tag { // DWARF DIE: 2d80
...
struct scan_probe_req_ie_tag { // DWARF DIE: 2d3b
    struct dma_desc dma_desc;
    struct tx_pbd pbd;
    uint32_t buf[50];
};
...
struct txl_buffer_list_tag { // DWARF DIE: 28a3
...
struct txl_buffer_hw_desc_tag { // DWARF DIE: 287b
    struct dma_desc dma_desc;
    struct tx_pbd pbd;
};
...
struct txl_buffer_idx_tag { // DWARF DIE: 28cb
    uint32_t used_area;
    uint32_t free;
    uint32_t free_size;
    uint32_t last;
...
struct txl_buffer_env_tag { // DWARF DIE: 2976
    struct txl_buffer_idx_tag buf_idx[5][1];
    struct txl_buffer_list_tag list[5];
};

typedef union anon_union.conflict2954 anon_union.conflict2954, *Panon_union.conflict2954;

union anon_union.conflict2954 { // DWARF DIE: 2954
    struct tx_policy_tbl policy_tbl;
    struct tx_compressed_policy_tbl comp_pol_tbl;
};

typedef union anon_union.conflict109b anon_union.conflict109b, *Panon_union.conflict109b;

union anon_union.conflict109b { // DWARF DIE: 109b
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

typedef union anon_union.conflict10c0 anon_union.conflict10c0, *Panon_union.conflict10c0;

union anon_union.conflict10c0 { // DWARF DIE: 10c0
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

typedef union anon_union.conflict1076 anon_union.conflict1076, *Panon_union.conflict1076;

union anon_union.conflict1076 { // DWARF DIE: 1076
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};
...
struct rxu_mgt_ind { // DWARF DIE: 3806
    uint16_t length;
    uint16_t framectrl;
...
struct rx_cntrl_ipcdesc { // DWARF DIE: 21d1
    uint32_t host_id;
};
...
struct rx_cntrl_pm_mon { // DWARF DIE: 2219
    struct mac_addr addr;
    uint8_t pm_state;
    _Bool mon;
};

struct rx_cntrl_dupli { // DWARF DIE: 21ee
    struct mac_addr last_src_addr;
    uint16_t last_seq_cntl;
};

struct rx_cntrl_rx_status { // DWARF DIE: 20d6
    uint16_t frame_cntl;
    uint16_t seq_cntl;
    uint16_t sn;
    uint8_t fn;
...
struct rxu_cntrl_env_tag { // DWARF DIE: 2252
