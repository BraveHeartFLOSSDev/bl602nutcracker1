...
union anon_union.conflict1319_for_field_3 {
...
union anon_union.conflict1363_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflict133e_for_field_4 {
...
union anon_union.conflict26e3_for_field_0 {
...
struct anon_struct.conflictac2 {
    uint32_t tx_key[2];
    uint32_t rx_key[2];
};

struct anon_struct.conflictaf9 {
    uint32_t key[4];
};

union anon_union.conflictb22_for_u {
...

{
  ...
  if (iRam00000000 == 0) {
    FUN_00010028(0,0,0x93);
  }
  if (iRam00000000 == 0) {
    FUN_00010060(0,0,2,0);
  }
  else {
    FUN_0001003e(&iStack20);
    if (iStack20 != 0) {
      _L0();
    }
  }
...

{
  ...
  FUN_00010028();
  if (iRam00000000 == 0) {
    FUN_00010060(*unaff_s0,0,2,0);
  }
  else {
    FUN_0001003e(&stack0x0000000c);
...
void ipc_emb_init(undefined4 uRam0000001c)

{
  uRam00000000 = _L0();
  FUN_000100b2(0,0,0x20);
  uRam0000001c = 0x204;
  if (_DAT_44800140 != 0x49504332) {
    FUN_000100f0(0,0,0xbb);
  }
...

{
  ...
  do {
    if ((_DAT_44800104 & 2) == 0) {
      FUN_00010480(0x2000000);
      _DAT_4480010c = 2;
      return;
    }
    _DAT_44800108 = 2;
    puVar1 = (undefined4 *)FUN_000104b8(_DAT_0000000a + 0xc);
    if (puVar1 == (undefined4 *)0x0) {
      FUN_000104d0(0,0,0x1d9);
    }
    *puVar1 = 0;
    *(undefined2 *)(puVar1 + 1) = _DAT_00000004;
    *(undefined2 *)((int)puVar1 + 6) = _DAT_00000006;
    *(undefined2 *)(puVar1 + 2) = 0xd;
    *(ushort *)((int)puVar1 + 10) = _DAT_0000000a;
    puVar5 = (undefined4 *)&DAT_0000000c;
    while ((int)(puVar5 + -3) < (int)(uint)*(ushort *)((int)puVar1 + 10)) {
      uVar2 = *puVar5;
      puVar4 = (undefined4 *)((int)puVar1 + (int)puVar5);
      puVar5 = puVar5 + 1;
      *puVar4 = uVar2;
    }
    bVar3 = DAT_00000015 + 1;
    _DAT_00000008 = (ushort)DAT_00000015;
    DAT_00000015 = bVar3;
    if (*(ushort *)((int)puVar1 + 6) < 0xf) {
      if (0xc < *(ushort *)((int)puVar1 + 6)) goto _L0;
    }
    else {
      FUN_0001052e(0,0,0xb6);
_L0:
      FUN_00010542(0,0,0x1ed);
    }
    _DAT_44800100 = 4;
    FUN_00010570(puVar1 + 3);
  } while( true );
}
...

{
  ...
  do {
    puVar2 = (undefined4 *)FUN_000104b8(param_1);
    if (puVar2 == (undefined4 *)0x0) {
      FUN_000104d0(0x1d9);
    }
    *puVar2 = 0;
    *(undefined2 *)(puVar2 + 1) = *(undefined2 *)(unaff_s1 + 4);
    *(undefined2 *)((int)puVar2 + 6) = *(undefined2 *)(unaff_s1 + 6);
    *(undefined2 *)(puVar2 + 2) = 0xd;
    *(undefined2 *)((int)puVar2 + 10) = *(undefined2 *)(unaff_s1 + 10);
    iVar5 = 0xc;
    while (iVar5 + -0xc < (int)(uint)*(ushort *)((int)puVar2 + 10)) {
      puVar3 = (undefined4 *)(unaff_s1 + iVar5);
    ...
    *(ushort *)(unaff_s1 + 8) = (ushort)bVar1;
    if (*(ushort *)((int)puVar2 + 6) < 0xf) {
      if (0xc < *(ushort *)((int)puVar2 + 6)) goto _L0;
    }
    else {
      FUN_0001052e(0xb6);
_L0:
  ...
  do {
    ...
    do {
      ...
      *(undefined2 *)((int)unaff_s0 + 10) = *(undefined2 *)(unaff_s1 + 10);
      iVar4 = 0xc;
      while (iVar4 + -0xc < (int)(uint)*(ushort *)((int)unaff_s0 + 10)) {
        puVar2 = (undefined4 *)(unaff_s1 + iVar4);
        puVar3 = (undefined4 *)((int)unaff_s0 + iVar4);
        iVar4 = iVar4 + 4;
        *puVar3 = *puVar2;
      }
      bVar1 = *(byte *)(unaff_s2 + 0x15);
...
_L0:
      ...
      _DAT_44800108 = 2;
      unaff_s0 = (undefined4 *)FUN_000104b8(*(ushort *)(unaff_s1 + 10) + 0xc);
    } while (unaff_s0 != (undefined4 *)0x0);
    param_1 = 0x1d9;
  } while( true );
}
...
code_r0x0001052e:
  ...
  do {
    ...
    do {
      ...
      *(byte *)(unaff_s2 + 0x15) = bVar1 + 1;
      *(ushort *)(unaff_s1 + 8) = (ushort)bVar1;
      if (0xe < *(ushort *)((int)unaff_s0 + 6)) {
        param_1 = 0xb6;
        goto code_r0x0001052e;
      }
    } while (*(ushort *)((int)unaff_s0 + 6) < 0xd);
  } while( true );
}
...

{
  ...
  do {
    ...
    _DAT_44800108 = 2;
    param_1 = (undefined4 *)FUN_000104b8(*(ushort *)(unaff_s1 + 10) + 0xc);
    if (param_1 == (undefined4 *)0x0) {
      FUN_000104d0(0x1d9);
    }
    *param_1 = 0;
    *(undefined2 *)(param_1 + 1) = *(undefined2 *)(unaff_s1 + 4);
    *(undefined2 *)((int)param_1 + 6) = *(undefined2 *)(unaff_s1 + 6);
    *(undefined2 *)(param_1 + 2) = 0xd;
    *(undefined2 *)((int)param_1 + 10) = *(undefined2 *)(unaff_s1 + 10);
    iVar4 = 0xc;
    while (iVar4 + -0xc < (int)(uint)*(ushort *)((int)param_1 + 10)) {
      puVar2 = (undefined4 *)(unaff_s1 + iVar4);
      puVar3 = (undefined4 *)((int)param_1 + iVar4);
      iVar4 = iVar4 + 4;
      *puVar3 = *puVar2;
    }
    bVar1 = *(byte *)(unaff_s2 + 0x15);
    *(byte *)(unaff_s2 + 0x15) = bVar1 + 1;
    *(ushort *)(unaff_s1 + 8) = (ushort)bVar1;
    if (*(ushort *)((int)param_1 + 6) < 0xf) {
      if (0xc < *(ushort *)((int)param_1 + 6)) goto _L0;
    }
    else {
      FUN_0001052e(0xb6);
_L0:
