...
union anon_union.conflict10c0_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflict1076_for_field_3 {
...
union anon_union.conflict2954_for_field_0 {
...
union anon_union.conflict109b_for_field_4 {
...
struct anon_struct.conflict33a4 {
...
struct anon_struct.conflict3471 {
    uint32_t dummy;
...
union anon_union.conflict356c_for_u {
    struct anon_struct.conflict33a4 sta;
    struct anon_struct.conflict3471 ap;
};
...
union anon_union.conflict2efb_for_rate_map {
    uint8_t ht[4];
};
