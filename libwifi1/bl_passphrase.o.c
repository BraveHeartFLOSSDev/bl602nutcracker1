...
union anon_union.conflict208f_for_key {
...
union anon_union.conflict155b_for_keyEncypt {
...
union anon_union.conflict16b8_for_intf {
    uint32 Interface;
};
...
union anon_union.conflict278c_for_specDat {
...

{
  ...
  tmpLen = (int)digest;
  _L0(digest,ssid,ssidlength);
  puVar4 = digest + ssidlength;
  *puVar4 = (uchar)((uint)count >> 0x18);
  puVar4[1] = (uchar)((uint)count >> 0x10);
  puVar4[2] = (uchar)((uint)count >> 8);
  puVar4[3] = (uchar)count;
  FUN_00010078(&tmpLen,&iStack56,1,password,uVar2,digest1,0x14);
  FUN_00010086(output,digest1,0x14);
  iVar1 = 1;
  tmpLen = (int)digest1;
  while (iVar1 < iterations) {
    iStack56 = 0x14;
    _L0(&tmpLen,&iStack56,1,password,uVar2,digest,0x14);
    FUN_000100cc(digest1,digest,0x14);
    iVar6 = 0;
    do {
      pbVar3 = output + iVar6;
      pbVar5 = digest + iVar6;
...

{
  ...
  puVar4 = (undefined *)(unaff_s1 + unaff_s0);
  *puVar4 = (char)((uint)in_stack_00000008 >> 0x18);
  puVar4[1] = (char)((uint)in_stack_00000008 >> 0x10);
  puVar4[2] = (char)((uint)in_stack_00000008 >> 8);
  puVar4[3] = (char)in_stack_00000008;
  FUN_00010078(&stack0x0000001c,&stack0x00000018,1,uVar2,0x14);
  FUN_00010086(0x14);
  iVar1 = 1;
  while (iVar1 < unaff_s6) {
    iStack00000018 = 0x14;
    _L0(&stack0x0000001c,&stack0x00000018,1,uVar2,0x14);
    FUN_000100cc(0x14);
    iVar6 = 0;
    do {
      pbVar3 = (byte *)(unaff_s5 + iVar6);
      pbVar5 = (byte *)(unaff_s1 + iVar6);
      iVar6 = iVar6 + 1;
      *pbVar3 = *pbVar5 ^ *pbVar3;
    } while (iVar6 != 0x14);
    iVar1 = iVar1 + 1;
...

{
  ...
  *puVar3 = (char)((uint)in_stack_00000008 >> 0x18);
  ...
  FUN_00010078(&stack0x0000001c,&stack0x00000018,1,0x14);
  FUN_00010086(0x14);
  iVar1 = 1;
  while (iVar1 < unaff_s6) {
    uStack00000018 = 0x14;
...

{
  ...
  if (uVar1 < 0x40) {
    iVar2 = -1;
    if (ssidlength < 0x21) {
      FUN_00010134(digest1 + 0x10,auStack88,password,ssid,ssidlength,0x1000,2,output);
      FUN_00010144(output + 0x14,output,0xc);
      FUN_0001015c(digest1 + 0x10,auStack88,password,ssid,ssidlength,0x1000,1,output);
      iVar2 = 0;
    }
  }
  else {
...

{
  ...
  if (uVar1 < 0x40) {
    uVar2 = 0xffffffff;
    if (unaff_s1 < 0x21) {
      FUN_00010134(&stack0x0000001c,&stack0x00000008,0x1000,2);
      FUN_00010144(unaff_s0 + 0x14,0xc);
      FUN_0001015c(&stack0x0000001c,&stack0x00000008,0x1000,1);
      uVar2 = 0;
    }
  }
  else {
