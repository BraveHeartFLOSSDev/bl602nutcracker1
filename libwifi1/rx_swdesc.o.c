...
union anon_union.conflictc65_for_field_5 {
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

union anon_union.conflictc40_for_field_4 {
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflictc1b_for_field_3 {
    uint32_t first_pbd_ptr;
