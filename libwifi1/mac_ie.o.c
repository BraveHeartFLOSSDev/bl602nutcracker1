...
union anon_union.conflictc0_for___value {
    wint_t __wch;
    uchar __wchb[4];
};
...
struct anon_struct.conflict70e {
    uint _unused_rand;
    char * _strtok_last;
...
struct anon_struct.conflict853 {
    uchar * _nextf[30];
    uint _nmalloc[30];
};

union anon_union.conflict89a_for__new {
