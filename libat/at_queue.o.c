...
struct anon_struct.conflict15d4 {
    uint32_t sleep_time;
    int weakup_pin;
};

struct anon_struct.conflict16d3 {
    char hostname[128];
};

struct anon_struct.conflict151c {
    s32 value;
};

struct anon_struct.conflict175e {
    int ID;
    int mode;
    int pull;
};

struct anon_struct.conflict14f2 {
    char hostname[256];
};

struct anon_struct.conflict154e {
    s32 len;
    u8 * buf;
};
...
struct anon_struct.conflict1745 {
    at_ip_t setdnsip;
};
...
struct anon_struct.conflict16ba {
    char hostname[33];
};
...
struct anon_struct.conflict164b {
    char ssid[64];
    char psk[64];
    int chl;
    int ecn;
...
struct anon_struct.conflict1792 {
    int ID;
    int mode;
};
...
struct anon_struct.conflict1575 {
    int uartId;
    int uartBaud;
    int dataBit;
    int parity;
...
struct anon_struct.conflict1614 {
    char ssid[33];
    char pwd[33];
};
...
union anon_union.conflict180f_for_u {
    ...
    struct anon_struct.conflict151c wifiMode;
    ...
    struct anon_struct.conflict1792 writeiodata_para;
    struct anon_struct.conflict151c readiodata_para;
    struct anon_struct.conflict151c deleteap_para;
};
