...
struct anon_struct.conflict15e9 {
    int uartId;
    int uartBaud;
    int dataBit;
    int parity;
...
struct anon_struct.conflict1566 {
    char hostname[256];
};

struct anon_struct.conflict1688 {
    char ssid[33];
    char pwd[33];
};
...
struct anon_struct.conflict15c2 {
    s32 len;
    u8 * buf;
};

struct anon_struct.conflict17b9 {
    at_ip_t setdnsip;
};

struct anon_struct.conflict1806 {
    int ID;
    int mode;
};

struct anon_struct.conflict16bf {
    char ssid[64];
    char psk[64];
    int chl;
    int ecn;
...
struct anon_struct.conflict17d2 {
    int ID;
    int mode;
    int pull;
};
...
struct anon_struct.conflict1770 {
    char hostname[128];
    uint8_t type;
...
struct anon_struct.conflict1747 {
    char hostname[128];
};
...
struct anon_struct.conflict1648 {
    uint32_t sleep_time;
    int weakup_pin;
};
...
union anon_union.conflict1883_for_u {
    ...
    struct anon_struct.conflict1590 wifiMode;
    ...
    struct anon_struct.conflict1806 writeiodata_para;
    struct anon_struct.conflict1590 readiodata_para;
    struct anon_struct.conflict1590 deleteap_para;
};
...
_L0:
      iVar3 = 0;
      if ((((uVar6 & opt) == 0) || (iVar5 == 0)) || (iVar5 == 0xb)) goto _L0;
      local_120[iVar5] = '\0';
      uVar4 = _L0(local_120);
      *(undefined4 *)pvar = uVar4;
      goto _L0;
    }
    if (cVar1 == '\r') {
      if (pcVar2[1] == '\n') {
...
_L0:
      iVar8 = 0;
      if (((((uVar4 & opt) == 0) || (2 < iVar3 - 1U)) || (uVar4 = _LVL81(acStack324), 0xff < uVar4))
         || (decbuf[iVar6] = (char)uVar4, iVar6 != 3)) goto _L0;
      _LVL84(pvar,0,4);
      FUN_0001031a(pvar,decbuf,4);
      goto _L0;
    }
    if (cVar1 == '\r') {
      if (pcVar7[1] == '\n') {
...
_L0:
      ...
      if (((((uVar3 & in_stack_0000000c) == 0) || (2 < unaff_s1 - 1U)) ||
          (uVar3 = _LVL81(&stack0x0000001c), 0xff < uVar3)) ||
         ((&stack0x00000020)[iVar5] = (char)uVar3, iVar5 != 3)) goto _L0;
      _LVL84(0,4);
      FUN_0001031a(&stack0x00000020,4);
      goto _L0;
    }
    if (cVar1 == '\r') {
      if (unaff_s6[1] == '\n') {
...
_L0:
      ...
      if (((((uVar1 & in_stack_0000000c) == 0) || (2 < unaff_s1 - 1U)) ||
          (uVar1 = _LVL81(&stack0x0000001c), 0xff < uVar1)) ||
...
_L0:
      iVar3 = 0;
      if (((uVar7 & opt) == 0) || (iVar6 != 2)) goto _L96;
      pbVar2 = pbVar2 + 1;
      iVar6 = _L0(abStack324[0]);
      cVar4 = _L0(abStack324[1]);
      hexbuf[iVar9] = (char)(iVar6 << 4) + cVar4;
      _L0(pvar,0,opt & 0x1ff);
      FUN_00010534(pvar,hexbuf,iVar9 + 1);
      goto _L0;
    }
    if (bVar1 == 0xd) {
      if (pbVar2[1] == 10) {
...
_L0:
    ...
    if (bVar1 == 0x22) {
      ...
      if (iVar6 < 2) {
        ...
        pcVar5 = strbuf + iVar6 + 0xfc;
        pbVar2 = pbVar2 + 1;
        abStack324[iVar6] = bVar1;
        iVar6 = iVar6 + 1;
      }
      else {
        if (iVar6 != 2) break;
        iVar6 = FUN_000105d6(abStack324[0],pcVar5);
        pcVar5 = (char *)FUN_000105e4(abStack324[1]);
        hexbuf[iVar9] = extraout_a0 + (char)(iVar6 << 4);
        iVar9 = iVar9 + 1;
        iVar6 = 0;
      }
    }
...

{
  ...
  iVar2 = _L0();
  cVar1 = _L0(in_stack_0000001d);
  (&stack0x00000020)[unaff_s3] = (char)(iVar2 << 4) + cVar1;
  _L0(0);
  FUN_00010534(&stack0x00000020);
  *unaff_s4 = unaff_s0;
  return unaff_s1 << 1 | unaff_s2;
}
...

{
  ...
  cVar1 = _L0();
  (&stack0x00000020)[unaff_s3] = unaff_s7 + cVar1;
  _L0(0);
  FUN_00010534(&stack0x00000020);
  *unaff_s4 = unaff_s0;
  return unaff_s1 << 1 | unaff_s2;
...
code_r0x000105d6:
  iVar4 = FUN_000105d6(param_1);
  cVar3 = FUN_000105e4(in_stack_0000001d);
  (&stack0x00000020)[unaff_s3] = cVar3 + (char)(iVar4 << 4);
  iVar7 = unaff_s3 + 1;
  iVar4 = 0;
_L0:
  do {
    if (unaff_s6 <= iVar7) goto _L0;
    bVar1 = *unaff_s0;
    uVar5 = (uint)bVar1;
    if (uVar5 == unaff_s2) {
      unaff_s0 = unaff_s0 + 1;
...
_L0:
      iVar2 = 0;
      if (((uVar5 & in_stack_0000000c) == 0) || (iVar4 != 2)) goto _L96;
      unaff_s0 = unaff_s0 + 1;
      iVar4 = _L0(in_stack_0000001c);
      cVar3 = _L0(in_stack_0000001d);
      (&stack0x00000020)[iVar7] = (char)(iVar4 << 4) + cVar3;
      _L0(0);
      FUN_00010534(&stack0x00000020,unaff_s3 + 2);
      goto _L0;
    }
    if (uVar5 == unaff_s7) {
      if (unaff_s0[1] == 10) {
...
_L0:
    ...
    if (uVar5 == unaff_s9) goto _L0;
    if (uVar5 == unaff_s10) {
      unaff_s0 = unaff_s0 + 1;
      goto _L0;
    }
    if (unaff_s11 < iVar4) break;
    if ((9 < (uVar5 - 0x30 & 0xff)) && (5 < ((uVar5 & 0xffffffdf) - 0x41 & 0xff))) goto _L0;
    unaff_s0 = unaff_s0 + 1;
...
code_r0x000105e4:
  cVar3 = FUN_000105e4(param_1);
  (&stack0x00000020)[unaff_s3] = cVar3 + (char)(unaff_s1 << 4);
  iVar7 = unaff_s3 + 1;
  iVar4 = 0;
_L0:
  do {
...
_L0:
  ...
  unaff_s1 = FUN_000105d6(in_stack_0000001c);
  ...
  if (pvar != (void *)0x0) {
    if (pt == 3) {
      ...
      if (pt == 2) {
        ...
        iVar2 = 1;
        while (iVar2 < vsize) {
          iVar3 = FUN_00010792(strbuf);
          FUN_000107a8(strbuf + iVar3,0,*(undefined *)((int)pvar + iVar2));
          iVar2 = iVar2 + 1;
        }
      }
      else {
        ...
        iVar2 = 1;
        while (iVar2 < vsize) {
          iVar3 = FUN_000107de(strbuf);
          FUN_000107f4(strbuf + iVar3,0,*(undefined *)((int)pvar + iVar2));
          iVar2 = iVar2 + 1;
        }
      }
    }
...

{
  ...
  while (iVar1 < unaff_s2) {
    iVar2 = FUN_00010792();
    FUN_000107a8(iVar2 + unaff_s3,0,*(undefined *)(unaff_s1 + iVar1));
    iVar1 = iVar1 + 1;
  }
  return 0;
}
...

{
  ...
  do {
    iVar1 = FUN_00010792();
    FUN_000107a8(iVar1 + unaff_s3,*(undefined *)(unaff_s1 + unaff_s0));
    unaff_s0 = unaff_s0 + 1;
...

{
  ...
  while( true ) {
    ...
    param_1 = FUN_00010792();
    param_2 = (uint)*(byte *)(unaff_s1 + unaff_s0);
    param_1 = param_1 + unaff_s3;
  }
  return 0;
}
...

{
  ...
  while (iVar1 < unaff_s2) {
    iVar2 = FUN_000107de();
    FUN_000107f4(iVar2 + unaff_s3,0,*(undefined *)(unaff_s1 + iVar1));
    iVar1 = iVar1 + 1;
  }
  return 0;
}
...

{
  ...
  do {
    iVar1 = FUN_000107de();
    FUN_000107f4(iVar1 + unaff_s3,*(undefined *)(unaff_s1 + unaff_s0));
    unaff_s0 = unaff_s0 + 1;
  } while (unaff_s0 < unaff_s2);
  return 0;
}
