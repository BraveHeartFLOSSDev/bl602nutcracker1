...
struct anon_struct.conflictb93 { // DWARF DIE: b93
    uint32_t vbcore;
    uint32_t iet;
    uint32_t vbcore_11n;
    uint32_t iet_11n;
...
struct regs_to_opti { // DWARF DIE: b93
    uint32_t vbcore;
    uint32_t iet;
    uint32_t vbcore_11n;
    uint32_t iet_11n;
...
struct notch_param { // DWARF DIE: b4c
    uint32_t notch_en;
    int32_t spur_freq;
};
...
struct tx_pwr_index { // DWARF DIE: b05
    uint32_t index;
    int32_t dvga;
};
...
struct anon_struct.conflictb05 { // DWARF DIE: b05
    uint32_t index;
    int32_t dvga;
};

typedef struct anon_struct.conflictb4c anon_struct.conflictb4c, *Panon_struct.conflictb4c;

struct anon_struct.conflictb4c { // DWARF DIE: b4c
    uint32_t notch_en;
    int32_t spur_freq;
};
...

{
  ...
  *(undefined *)(unaff_s0 + 1) = extraout_a0;
  *(undefined2 *)(unaff_s0 + 6) = 0x19;
  return;
}
