...
struct la_mem_format { // DWARF DIE: 113e
    uint32_t word[4];
};
...
typedef union anon_union.conflict2a41_for_field_0 anon_union.conflict2a41_for_field_0, *Panon_union.conflict2a41_for_field_0;

typedef struct dma_desc dma_desc, *Pdma_desc;

typedef struct tx_pbd tx_pbd, *Ptx_pbd;

typedef union anon_union.conflict124a_for_field_3 anon_union.conflict124a_for_field_3, *Panon_union.conflict124a_for_field_3;

typedef union anon_union.conflict126f_for_field_4 anon_union.conflict126f_for_field_4, *Panon_union.conflict126f_for_field_4;

typedef union anon_union.conflict1294_for_field_5 anon_union.conflict1294_for_field_5, *Panon_union.conflict1294_for_field_5;
...
struct tx_compressed_policy_tbl { // DWARF DIE: 121f
    uint32_t upatterntx;
    uint32_t sec_user_control;
};

struct tx_policy_tbl { // DWARF DIE: 11ae
    uint32_t upatterntx;
...
union anon_union.conflict2a41_for_field_0 { // DWARF DIE: 2a41
...
struct hostdesc { // DWARF DIE: 1c4c
    uint32_t pbuf_addr;
...
struct tx_cfm_tag { // DWARF DIE: 16a7
    uint16_t pn[4];
    uint16_t sn;
    uint16_t timestamp;
    int8_t credits;
...
union anon_union.conflict126f_for_field_4 { // DWARF DIE: 126f
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

struct lmacdesc { // DWARF DIE: 1db8
    struct tx_agg_desc * agg_desc;
    struct txl_buffer_tag * buffer;
    struct tx_hw_desc * hw_desc;
};

union anon_union.conflict124a_for_field_3 { // DWARF DIE: 124a
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflict1294_for_field_5 { // DWARF DIE: 1294
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

struct tx_hd { // DWARF DIE: 12b9
    uint32_t upatterntx;
    uint32_t nextfrmexseq_ptr;
    uint32_t nextmpdudesc_ptr;
    union anon_union.conflict124a_for_field_3 field_3;
    union anon_union.conflict126f_for_field_4 field_4;
    union anon_union.conflict1294_for_field_5 field_5;
    uint32_t frmlen;
...
struct tx_hw_desc { // DWARF DIE: 1726
    struct tx_cfm_tag * cfm_ptr;
    struct tx_hd thd;
};

struct umacdesc { // DWARF DIE: 1d28
...
struct dma_desc { // DWARF DIE: 1085
    uint32_t src;
    uint32_t dest;
    uint16_t length;
    uint16_t ctrl;
...
struct txl_buffer_control { // DWARF DIE: 1d84
    union anon_union.conflict2a41_for_field_0 field_0;
    uint32_t mac_control_info;
    uint32_t phy_control_info;
};

struct tx_pbd { // DWARF DIE: 1382
    uint32_t upatterntx;
    uint32_t next;
    uint32_t datastartptr;
    uint32_t dataendptr;
...
struct txl_buffer_tag { // DWARF DIE: 1df3
    uint32_t length;
    uint32_t lenheader;
    uint32_t lenpad;
    uint32_t flags;
...
struct tx_agg_desc { // DWARF DIE: 1757
    uint8_t reserved;
};

typedef struct dma_env_tag dma_env_tag, *Pdma_env_tag;

struct dma_env_tag { // DWARF DIE: 10d9
...
struct mm_timer_env_tag { // DWARF DIE: f1e
    struct co_list prog;
};

typedef struct mm_timer_tag mm_timer_tag, *Pmm_timer_tag;

struct mm_timer_tag { // DWARF DIE: edd
    struct co_list_hdr list_hdr;
    void (* cb)(void *);
    void * env;
    uint32_t time;
...
struct rx_swdesc { // DWARF DIE: 14e2
    struct co_list_hdr list_hdr;
...
struct phy_channel_info { // DWARF DIE: 1116
    uint32_t info1;
    uint32_t info2;
};

struct rx_pbd { // DWARF DIE: 1577
    uint32_t upattern;
    uint32_t next;
    uint32_t datastartptr;
    uint32_t dataendptr;
...
struct rx_payloaddesc { // DWARF DIE: 164a
    struct rx_pbd pbd;
    uint32_t pd_status;
    uint32_t * buffer_rx;
    void * pbuf_holder[6];
...
struct rx_dmadesc { // DWARF DIE: 15da
    struct rx_hd hd;
...
struct ps_env_tag { // DWARF DIE: 3836
    _Bool ps_on;
    undefined field_0x1;
    ke_task_id_t taskid;
...
struct mm_chan_ctxt_add_req { // DWARF DIE: 19ce
    uint8_t band;
    uint8_t type;
...
struct debug_env_tag { // DWARF DIE: 1176
...
struct mblock_free { // DWARF DIE: 1ffd
};

struct ke_env_tag { // DWARF DIE: 1fae
...
struct txl_list { // DWARF DIE: 289f
...
struct txl_cntrl_env_tag { // DWARF DIE: 28e7
...
typedef struct anon_struct.conflict355e anon_struct.conflict355e, *Panon_struct.conflict355e;
...
struct txl_frame_cfm_tag { // DWARF DIE: 2b37
    void (* cfm_func)(void *, uint32_t);
    void * env;
};

struct txl_frame_desc_tag { // DWARF DIE: 2b5f
    struct txdesc txdesc;
...
struct anon_struct.conflict355e { // DWARF DIE: 355e
    uint32_t dummy;
...
typedef union anon_union.conflict3659_for_u anon_union.conflict3659_for_u, *Panon_union.conflict3659_for_u;

typedef struct mac_bss_info mac_bss_info, *Pmac_bss_info;

typedef struct key_info_tag key_info_tag, *Pkey_info_tag;

typedef struct anon_struct.conflict3491 anon_struct.conflict3491, *Panon_struct.conflict3491;
...
struct Cipher_t { // DWARF DIE: 30d9
    UINT8 wep40:1;
    UINT8 wep104:1;
    UINT8 tkip:1;
    UINT8 ccmp:1;
...
struct chan_tbtt_tag { // DWARF DIE: 1a7d
    struct co_list_hdr list_hdr;
    uint32_t time;
    uint8_t vif_index;
    uint8_t priority;
...
struct scan_chan_tag { // DWARF DIE: d1e
    uint16_t freq;
    uint8_t band;
    uint8_t flags;
    int8_t tx_power;
...
struct anon_struct.conflict3491 { // DWARF DIE: 3491
...
union anon_union.conflict3659_for_u { // DWARF DIE: 3659
    struct anon_struct.conflict3491 sta;
    struct anon_struct.conflict355e ap;
};
...
struct SecurityMode_t { // DWARF DIE: 313f
    UINT16 noRsn:1;
    UINT16 wepStatic:1;
    UINT16 wepDynamic:1;
    UINT16 wpa:1;
...
struct mobility_domain { // DWARF DIE: 3289
    uint16_t mdid;
    uint8_t ft_capability_policy;
    undefined field_0x3;
};

struct mac_bss_info { // DWARF DIE: 32b1
...
struct vif_info_tag { // DWARF DIE: 367c
    struct co_list_hdr list_hdr;
    uint32_t prevent_sleep;
    ...
    union anon_union.conflict3659_for_u u;
...
struct chan_ctxt_tag { // DWARF DIE: 1acc
    struct co_list_hdr list_hdr;
...
struct vif_mgmt_env_tag { // DWARF DIE: 37b7
...
typedef union anon_union.conflict3659 anon_union.conflict3659, *Panon_union.conflict3659;

union anon_union.conflict3659 { // DWARF DIE: 3659
    struct anon_struct.conflict3491 sta;
    struct anon_struct.conflict355e ap;
};
...
struct hal_dma_env_tag { // DWARF DIE: 2dc7
...
struct hal_dma_desc_tag { // DWARF DIE: 2d80
...
struct txl_frame_env_tag { // DWARF DIE: 2bb3
...
struct bam_env_tag { // DWARF DIE: 230b
    uint32_t pkt_cnt;
...
struct sta_mgmt_ba_info { // DWARF DIE: 2620
...
typedef union anon_union.conflict2fe8_for_rate_map anon_union.conflict2fe8_for_rate_map, *Panon_union.conflict2fe8_for_rate_map;

struct rc_rate_stats { // DWARF DIE: 2f4b
    uint16_t attempts;
    uint16_t success;
...
union anon_union.conflict2fe8_for_rate_map { // DWARF DIE: 2fe8
    uint8_t ht[4];
};

struct step { // DWARF DIE: 2fc1
    uint32_t tp;
    uint16_t idx;
    undefined field_0x6;
    undefined field_0x7;
...
struct rc_sta_stats { // DWARF DIE: 24ba
    ...
    uint8_t format_mod;
    union anon_union.conflict2fe8_for_rate_map rate_map;
    uint16_t rate_map_l;
    uint8_t mcs_max;
    uint8_t r_idx_min;
    uint8_t r_idx_max;
...
struct sta_pol_tbl_cntl { // DWARF DIE: 246b
...
struct sta_mgmt_sec_info { // DWARF DIE: 2430
...
struct mac_sta_info { // DWARF DIE: d66
    struct mac_rateset rate_set;
    undefined field_0xd;
    undefined field_0xe;
    undefined field_0xf;
...
struct sta_info_tag { // DWARF DIE: 266f
    struct co_list_hdr list_hdr;
    uint32_t bcn_int;
...
struct sta_info_env_tag { // DWARF DIE: 2858
    struct co_list free_sta_list;
};

typedef struct chan_env_tag chan_env_tag, *Pchan_env_tag;

struct chan_env_tag { // DWARF DIE: 1b5c
...
struct td_env_tag { // DWARF DIE: f45
...
struct scan_start_req { // DWARF DIE: 2ec9
};

typedef union anon_union.conflict2fe8 anon_union.conflict2fe8, *Panon_union.conflict2fe8;

union anon_union.conflict2fe8 { // DWARF DIE: 2fe8
    uint8_t ht[4];
};
...
struct me_chan_config_req { // DWARF DIE: 302d
...
struct me_env_tag { // DWARF DIE: 31f5
...
struct ke_msg_handler { // DWARF DIE: 193e
    ke_msg_id_t id;
    undefined field_0x2;
    undefined field_0x3;
...
struct ke_state_handler { // DWARF DIE: 196a
...
struct scan_env_tag { // DWARF DIE: 2e6d
...
struct scan_probe_req_ie_tag { // DWARF DIE: 2e28
    struct dma_desc dma_desc;
    struct tx_pbd pbd;
    uint32_t buf[50];
};
...
struct txl_buffer_list_tag { // DWARF DIE: 2990
...
struct txl_buffer_hw_desc_tag { // DWARF DIE: 2968
    struct dma_desc dma_desc;
    struct tx_pbd pbd;
};

typedef union anon_union.conflict2a41 anon_union.conflict2a41, *Panon_union.conflict2a41;

union anon_union.conflict2a41 { // DWARF DIE: 2a41
    struct tx_policy_tbl policy_tbl;
    struct tx_compressed_policy_tbl comp_pol_tbl;
};
...
struct txl_buffer_idx_tag { // DWARF DIE: 29b8
    uint32_t used_area;
    uint32_t free;
    uint32_t free_size;
    uint32_t last;
...
struct txl_buffer_env_tag { // DWARF DIE: 2a63
    struct txl_buffer_idx_tag buf_idx[5][1];
    struct txl_buffer_list_tag list[5];
};

typedef union anon_union.conflict126f anon_union.conflict126f, *Panon_union.conflict126f;

union anon_union.conflict126f { // DWARF DIE: 126f
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

typedef union anon_union.conflict124a anon_union.conflict124a, *Panon_union.conflict124a;

union anon_union.conflict124a { // DWARF DIE: 124a
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

typedef union anon_union.conflict1294 anon_union.conflict1294, *Panon_union.conflict1294;

union anon_union.conflict1294 { // DWARF DIE: 1294
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};
...
struct rx_cntrl_ipcdesc { // DWARF DIE: 213d
    uint32_t host_id;
};
...
struct rx_cntrl_pm_mon { // DWARF DIE: 2185
    struct mac_addr addr;
    uint8_t pm_state;
    _Bool mon;
};

struct rx_cntrl_dupli { // DWARF DIE: 215a
    struct mac_addr last_src_addr;
    uint16_t last_seq_cntl;
};

struct rx_cntrl_rx_status { // DWARF DIE: 2042
    uint16_t frame_cntl;
    uint16_t seq_cntl;
    uint16_t sn;
    uint8_t fn;
...
struct rxu_cntrl_env_tag { // DWARF DIE: 21be
...

{
  ...
  if (*(char *)((int)env + 0x23) != '\0') {
    ...
    if (((*(byte *)((int)env + 0x21) ^ bVar1) & 0xc) != 0) {
      FUN_00010066(_DAT_00000020);
      FUN_00010076(_DAT_00000020);
    }
    *(byte *)((int)env + 0x21) = bVar1;
  }
  ...
  *(bool *)((int)env + 0x23) =
       *(int *)((uint)*(byte *)((int)env + 0x20) * 0x5d8 + 0x40) == _DAT_00000020;
  do {
...
void FUN_00010066(int iRam00000020)

{
  int unaff_s0;
  undefined unaff_s1;
  
  FUN_00010066(iRam00000020);
  FUN_00010076(iRam00000020);
  *(undefined *)(unaff_s0 + 0x21) = unaff_s1;
  *(undefined4 *)(unaff_s0 + 0x10) = 0;
  *(undefined4 *)(unaff_s0 + 0x14) = 0;
  *(undefined4 *)(unaff_s0 + 0x18) = 0;
  *(undefined4 *)(unaff_s0 + 0x1c) = 0;
  *(bool *)(unaff_s0 + 0x23) =
       *(int *)((uint)*(byte *)(unaff_s0 + 0x20) * 0x5d8 + 0x40) == iRam00000020;
  do {
                    // WARNING: Do nothing block with infinite loop
  } while( true );
}
...
void FUN_00010076(int iRam00000020)
...

{
  ...
  iVar1 = CONCAT31(in_register_00002029,vif_index) * 0x24;
  _L0();
  if (*(char *)(iVar1 + 0x22) != '\0') {
    FUN_0001012a();
  }
  FUN_0001013a();
  iVar2 = CONCAT31(in_register_00002029,vif_index) * 0x24;
  *(undefined4 *)(iVar2 + 4) = 0;
  *(int *)(iVar2 + 8) = iVar1;
  *(uint8_t *)(iVar2 + 0x20) = vif_index;
  return;
}
...

{
  ...
  _L0();
  if (*(char *)(unaff_s1 + 0x22) != '\0') {
    FUN_0001012a();
  }
  FUN_0001013a();
  iVar1 = unaff_s2 * 0x24 + unaff_s0;
  *(undefined4 *)(iVar1 + 4) = 0;
  *(int *)(iVar1 + 8) = unaff_s1;
  *(char *)(iVar1 + 0x20) = (char)unaff_s2;
  return;
}



void FUN_0001012a(void)
