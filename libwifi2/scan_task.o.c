...
struct scan_chan_tag { // DWARF DIE: c87
    uint16_t freq;
    uint8_t band;
    uint8_t flags;
    int8_t tx_power;
...
struct mac_ssid { // DWARF DIE: a17
    uint8_t length;
    uint8_t array[32];
    uint8_t array_tail[1];
};

struct scan_start_req { // DWARF DIE: 1c5d
...
struct scan_start_cfm { // DWARF DIE: 1da0
    uint8_t status;
};
...
struct la_mem_format { // DWARF DIE: 1043
    uint32_t word[4];
};

typedef struct dma_desc dma_desc, *Pdma_desc;

struct dma_desc { // DWARF DIE: f69
    uint32_t src;
    uint32_t dest;
    uint16_t length;
    uint16_t ctrl;
...
struct dma_env_tag { // DWARF DIE: fbd
...
struct co_list_hdr { // DWARF DIE: ddb
    struct co_list_hdr * next;
};

struct co_list { // DWARF DIE: dfc
...
struct rx_swdesc { // DWARF DIE: 134b
...
struct phy_channel_info { // DWARF DIE: 101b
    uint32_t info1;
    uint32_t info2;
};

struct rx_pbd { // DWARF DIE: 13e0
    uint32_t upattern;
    uint32_t next;
...
struct rx_payloaddesc { // DWARF DIE: 14b3
    struct rx_pbd pbd;
    uint32_t pd_status;
    uint32_t * buffer_rx;
    void * pbuf_holder[6];
...
struct rx_dmadesc { // DWARF DIE: 1443
    struct rx_hd hd;
...
struct debug_env_tag { // DWARF DIE: 107b
...
struct hal_dma_env_tag { // DWARF DIE: 1b5b
...
struct hal_dma_desc_tag { // DWARF DIE: 1b14
    struct co_list_hdr hdr;
...
struct bam_env_tag { // DWARF DIE: 20f1
    uint32_t pkt_cnt;
...
struct sta_mgmt_ba_info { // DWARF DIE: 22b6
...
struct anon_struct.conflictaeb { // DWARF DIE: aeb
    uint32_t key[4];
};

struct rc_sta_stats { // DWARF DIE: 22ab
};

struct sta_pol_tbl_cntl { // DWARF DIE: 2251
...
struct mac_rateset { // DWARF DIE: a6c
    uint8_t length;
    uint8_t array[12];
};

struct mac_htcapability { // DWARF DIE: bbf
...
struct anon_struct.conflictab4 { // DWARF DIE: ab4
    uint32_t tx_key[2];
    uint32_t rx_key[2];
};

union anon_union.conflictb14_for_u { // DWARF DIE: b14
    struct anon_struct.conflictab4 mic;
    struct anon_struct.conflictaeb mfp;
};

struct key_info_tag { // DWARF DIE: b39
    uint64_t rx_pn[9];
    uint64_t tx_pn;
...
struct mac_sta_info { // DWARF DIE: cce
...
struct sta_info_tag { // DWARF DIE: 2305
    struct co_list_hdr list_hdr;
    uint32_t bcn_int;
...
struct txl_buffer_control { // DWARF DIE: 22a0
};

typedef struct sta_info_env_tag sta_info_env_tag, *Psta_info_env_tag;

struct sta_info_env_tag { // DWARF DIE: 24ee
...
union anon_union.conflictb14 { // DWARF DIE: b14
    struct anon_struct.conflictab4 mic;
    struct anon_struct.conflictaeb mfp;
};
...
struct ke_msg_handler { // DWARF DIE: 178a
    ke_msg_id_t id;
    undefined field_0x2;
    undefined field_0x3;
...
struct ke_state_handler { // DWARF DIE: 17b6
...
struct scan_env_tag { // DWARF DIE: 1c01
...
struct scan_probe_req_ie_tag { // DWARF DIE: 1bbc
    struct dma_desc dma_desc;
    struct tx_pbd pbd;
    uint32_t buf[50];
};
...
struct mm_env_tag { // DWARF DIE: 2535
...
union anon_union.conflict10d8 { // DWARF DIE: 10d8
    uint32_t datastartptr;
...
struct tx_cfm_tag { // DWARF DIE: 1510
    uint16_t pn[4];
    uint16_t sn;
    uint16_t timestamp;
    int8_t credits;
...
union anon_union.conflict10b3 { // DWARF DIE: 10b3
    uint32_t first_pbd_ptr;
...
union anon_union.conflict10d8_for_field_4 { // DWARF DIE: 10d8
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflict10b3_for_field_3 { // DWARF DIE: 10b3
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflict10fd_for_field_5 { // DWARF DIE: 10fd
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

struct tx_hd { // DWARF DIE: 1122
    uint32_t upatterntx;
...
struct tx_hw_desc { // DWARF DIE: 158f
...
union anon_union.conflict10fd { // DWARF DIE: 10fd
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};
...
struct rx_cntrl_ipcdesc { // DWARF DIE: 1f23
    uint32_t host_id;
};
...
struct rx_cntrl_pm_mon { // DWARF DIE: 1f6b
    struct mac_addr addr;
    uint8_t pm_state;
    _Bool mon;
};

struct rx_cntrl_dupli { // DWARF DIE: 1f40
    struct mac_addr last_src_addr;
    uint16_t last_seq_cntl;
};

struct rx_cntrl_rx_status { // DWARF DIE: 1e28
    uint16_t frame_cntl;
    uint16_t seq_cntl;
    uint16_t sn;
    uint8_t fn;
...
struct rxu_cntrl_env_tag { // DWARF DIE: 1fa4
...

{
  ...
  iVar1 = _L0(_DAT_00000018);
  if (iVar1 == 0) {
    _LVL5();
  }
  else {
    _DAT_00000018 = CONCAT13(1,_DAT_00000018);
  }
  return 0;
}
...

{
  ...
  iVar1 = _L0(uRam00000018);
  if (iVar1 == 0) {
    _LVL5();
  }
  else {
    uRam00000018 = CONCAT13(1,(undefined3)uRam00000018);
  }
  return 0;
}
...

{
  ...
  puVar1 = (undefined *)_L0((int)_DAT_00000010,_DAT_00000018);
  iVar2 = FUN_00010058((int)_DAT_00000010,_DAT_00000018);
  if (iVar2 == 0) {
    if (param->chan_cnt == '\0') {
      FUN_0001007c(_DAT_00000010,_DAT_00000018);
    }
    *puVar1 = 0;
    _DAT_00000018 = (uint3)src_id;
    iVar2 = 1;
    _DAT_00000010 = param;
    _L0();
  }
...
undefined4 _L0(int iRam00000010,uint3 uRam00000018)

{
  ...
  puVar2 = (undefined *)_L0(iRam00000010,uRam00000018);
  iVar3 = FUN_00010058(iRam00000010,uRam00000018);
  if (iVar3 == 0) {
    if (*(char *)(unaff_s1 + 0x14f) == '\0') {
      FUN_0001007c(iRam00000010,uRam00000018);
    }
    *puVar2 = 0;
    uRam00000018 = (uint3)unaff_s2;
    uVar1 = 1;
...
undefined4 FUN_00010058(int iRam00000010,uint3 param_2)

{
  ...
  iVar2 = FUN_00010058(iRam00000010,param_2);
  if (iVar2 == 0) {
    if (*(char *)(unaff_s1 + 0x14f) == '\0') {
      FUN_0001007c(iRam00000010,param_2);
    }
    *unaff_s0 = 0;
    param_2 = (uint3)unaff_s2;
    uVar1 = 1;
    iRam00000010 = unaff_s1;
    _L0();
  }
...
undefined4 FUN_0001007c(undefined4 uRam00000010,uint3 param_2)

{
  ...
  FUN_0001007c(uRam00000010,param_2);
  *unaff_s0 = 0;
  param_2 = (uint3)unaff_s2;
...

{
  ...
  iVar1 = _L0(_DAT_00000010,_DAT_00000018);
  if (iVar1 != 3) {
    FUN_000100f2(_DAT_00000010,_DAT_00000018);
  }
  _DAT_00000004 &= 0xffffddff;
  _DAT_44b00060 = _DAT_00000004 | uRam00000000;
  _DAT_00000018 = _DAT_00000018 & 0xffff | (uint3)(byte)(DAT_0000001a + 1U) << 0x10;
  if (((byte)(DAT_0000001a + 1U) < *(byte *)(_DAT_00000010 + 0x14f)) && (DAT_0000001b == '\0')) {
    _L0();
  }
  else {
    FUN_00010156();
...
undefined4 _L0(int iRam00000010,uint3 param_2)

{
  int iVar1;
  
  iVar1 = _L0(iRam00000010,param_2);
  if (iVar1 != 3) {
    FUN_000100f2(iRam00000010,param_2);
  }
  _DAT_00000004 &= 0xffffddff;
  _DAT_44b00060 = _DAT_00000004 | uRam00000000;
  param_2 = param_2 & 0xffff | (uint3)(byte)(param_2._2_1_ + 1U) << 0x10;
  if (((byte)(param_2._2_1_ + 1U) < *(byte *)(iRam00000010 + 0x14f)) && (DAT_0000001b == '\0')) {
    _L0();
  }
  else {
    FUN_00010156();
...
undefined4 FUN_000100f2(int iRam00000010,uint3 param_2)
