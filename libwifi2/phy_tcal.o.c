...
struct phy_channel_info { // DWARF DIE: be2
    uint32_t info1;
    uint32_t info2;
};
...
union anon_union.conflict151_for___value { // DWARF DIE: 151
    wint_t __wch;
    uchar __wchb[4];
};

struct _mbstate_t { // DWARF DIE: 183
    int __count;
...
union anon_union.conflict151 { // DWARF DIE: 151
    wint_t __wch;
    uchar __wchb[4];
};
...
struct la_mem_format { // DWARF DIE: c0a
    uint32_t word[4];
};
...
struct anon_struct.conflict11cd { // DWARF DIE: 11cd
    uint32_t index;
    int32_t dvga;
};
...
struct regs_to_opti { // DWARF DIE: 125b
    uint32_t vbcore;
    uint32_t iet;
    uint32_t vbcore_11n;
    uint32_t iet_11n;
...
typedef struct anon_struct.conflict1214 anon_struct.conflict1214, *Panon_struct.conflict1214;

struct anon_struct.conflict1214 { // DWARF DIE: 1214
    uint32_t notch_en;
    int32_t spur_freq;
};
...
struct notch_param { // DWARF DIE: 1214
    uint32_t notch_en;
    int32_t spur_freq;
};
...
struct tx_pwr_index { // DWARF DIE: 11cd
    uint32_t index;
    int32_t dvga;
};
...
struct anon_struct.conflict125b { // DWARF DIE: 125b
    uint32_t vbcore;
    uint32_t iet;
    uint32_t vbcore_11n;
    uint32_t iet_11n;
...
struct dma_env_tag { // DWARF DIE: ba5
...
struct tx_cfm_tag { // DWARF DIE: ff8
    uint16_t pn[4];
    uint16_t sn;
    uint16_t timestamp;
    int8_t credits;
...
union anon_union.conflictcc4 { // DWARF DIE: cc4
    uint32_t dataendptr;
...
struct rx_swdesc { // DWARF DIE: ebd
};

struct rx_hd { // DWARF DIE: db2
    uint32_t upatternrx;
    uint32_t next;
...
union anon_union.conflictc7a_for_field_3 { // DWARF DIE: c7a
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflictc9f_for_field_4 { // DWARF DIE: c9f
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflictcc4_for_field_5 { // DWARF DIE: cc4
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

struct tx_hd { // DWARF DIE: ce9
    uint32_t upatterntx;
...
struct tx_hw_desc { // DWARF DIE: 1077
...
union anon_union.conflictc9f { // DWARF DIE: c9f
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};
...
struct rx_payloaddesc { // DWARF DIE: f9b
    struct rx_pbd pbd;
    uint32_t pd_status;
    uint32_t * buffer_rx;
    void * pbuf_holder[6];
...
struct rx_dmadesc { // DWARF DIE: f2b
    struct rx_hd hd;
...
struct debug_env_tag { // DWARF DIE: c42
...
struct anon_struct.conflict8e4 { // DWARF DIE: 8e4
    uchar * _nextf[30];
    uint _nmalloc[30];
};

struct __tm { // DWARF DIE: 249
    int __tm_sec;
    int __tm_min;
    int __tm_hour;
    int __tm_mday;
...
struct _rand48 { // DWARF DIE: 756
    ushort _seed[3];
    ushort _mult[3];
    ushort _add;
};

struct anon_struct.conflict79f { // DWARF DIE: 79f
    uint _unused_rand;
    char * _strtok_last;
...
union anon_union.conflict92b_for__new { // DWARF DIE: 92b
    struct anon_struct.conflict79f _reent;
    struct anon_struct.conflict8e4 _unused;
};

struct _Bigint { // DWARF DIE: 1d9
...
struct _glue { // DWARF DIE: 711
    struct _glue * _next;
    int _niobs;
    __FILE * _iobs;
};

struct _on_exit_args { // DWARF DIE: 2cc
    void * _fnargs[32];
    void * _dso_handle[32];
    __ULong _fntypes;
    __ULong _is_cxa;
...
struct __sbuf { // DWARF DIE: 381
    uchar * _base;
    int _size;
};

struct __sFILE { // DWARF DIE: 3af
    uchar * _p;
    int _r;
    int _w;
    short _flags;
...
struct trpc_env_tag { // DWARF DIE: b8
...
struct tcal_tag { // DWARF DIE: 135e
...

{
  ...
  puVar1 = auStack18;
  _L0(_DAT_0000001c,_DAT_0000002c);
  if (puVar1 != (ushort *)0x0) {
    _LVL9(_DAT_0000001c,_DAT_0000002c);
...

{
  ...
  _L0(iRam0000001c,iRam0000002c);
  sVar3 = sRam00000000;
  if (in_a0 != 0) {
    _LVL9(iRam0000001c,iRam0000002c);
