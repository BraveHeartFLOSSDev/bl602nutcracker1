...
struct la_mem_format { // DWARF DIE: dd8
    uint32_t word[4];
};
...
struct dma_env_tag { // DWARF DIE: d73
...
struct co_list_hdr { // DWARF DIE: adc
    struct co_list_hdr * next;
};

struct mm_timer_tag { // DWARF DIE: b4c
...
struct co_list { // DWARF DIE: b02
    struct co_list_hdr * first;
    struct co_list_hdr * last;
};

struct mm_timer_env_tag { // DWARF DIE: b8d
    struct co_list prog;
};

typedef struct debug_env_tag debug_env_tag, *Pdebug_env_tag;

struct debug_env_tag { // DWARF DIE: e10
...
struct mblock_free { // DWARF DIE: c14
};

struct ke_env_tag { // DWARF DIE: bc5
...
struct rx_swdesc { // DWARF DIE: 108b
};

typedef struct phy_channel_info phy_channel_info, *Pphy_channel_info;

struct phy_channel_info { // DWARF DIE: db0
    uint32_t info1;
    uint32_t info2;
};
...
union anon_union.conflicte92 { // DWARF DIE: e92
    uint32_t dataendptr;
...
struct tx_cfm_tag { // DWARF DIE: 11c6
    uint16_t pn[4];
    uint16_t sn;
    uint16_t timestamp;
    int8_t credits;
...
union anon_union.conflicte6d_for_field_4 { // DWARF DIE: e6d
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};

union anon_union.conflicte48_for_field_3 { // DWARF DIE: e48
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};

union anon_union.conflicte92_for_field_5 { // DWARF DIE: e92
    uint32_t dataendptr;
    uint32_t sec_user3_ptr;
};

struct tx_hd { // DWARF DIE: eb7
    uint32_t upatterntx;
...
struct tx_hw_desc { // DWARF DIE: 1245
...
union anon_union.conflicte6d { // DWARF DIE: e6d
    uint32_t datastartptr;
    uint32_t sec_user2_ptr;
};
...
struct rx_payloaddesc { // DWARF DIE: 1169
    struct rx_pbd pbd;
    uint32_t pd_status;
    uint32_t * buffer_rx;
    void * pbuf_holder[6];
...
struct rx_dmadesc { // DWARF DIE: 10f9
    struct rx_hd hd;
...
union anon_union.conflicte48 { // DWARF DIE: e48
    uint32_t first_pbd_ptr;
    uint32_t sec_user1_ptr;
};
